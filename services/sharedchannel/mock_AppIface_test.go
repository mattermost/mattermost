...
// NotifySharedChannelUserUpdate provides a mock function with given fields: c, user
func (_m *MockAppIface) NotifySharedChannelUserUpdate(c request.CTX, user *model.User) {
	_m.Called(c, user)
}
