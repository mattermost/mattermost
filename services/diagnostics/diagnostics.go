...
func New(srv ServerIface, dbStore store.Store, searchEngine *searchengine.Broker, log *mlog.Logger) *DiagnosticsService {
	...
	service.ensureDiagnosticID()
	service.initDiagnostics("")
	service.initRudder(RUDDER_DATAPLANE_URL)
	return service
}

func (ds *DiagnosticsService) ensureDiagnosticID() {
	if ds.DiagnosticID != "" {
		return
	}
...
func (ds *DiagnosticsService) sendDailyDiagnostics(override bool) {
...
func (ds *DiagnosticsService) sendDiagnostic(event string, properties map[string]interface{}) {
	if ds.diagnosticClient != nil {
		ds.diagnosticClient.Enqueue(analytics.Track{
			Event:      event,
			UserId:     ds.DiagnosticID,
...
func (ds *DiagnosticsService) trackActivity() {
	var userCount int64
	...
	ds.sendDiagnostic(TRACK_ACTIVITY, map[string]interface{}{
...
func (ds *DiagnosticsService) trackConfig() {
	cfg := ds.srv.Config()
	ds.sendDiagnostic(TRACK_CONFIG_SERVICE, map[string]interface{}{
	...
	ds.sendDiagnostic(TRACK_CONFIG_TEAM, map[string]interface{}{
	...
	ds.sendDiagnostic(TRACK_CONFIG_CLIENT_REQ, map[string]interface{}{
	...
	ds.sendDiagnostic(TRACK_CONFIG_SQL, map[string]interface{}{
	...
	ds.sendDiagnostic(TRACK_CONFIG_LOG, map[string]interface{}{
	...
	ds.sendDiagnostic(TRACK_CONFIG_AUDIT, map[string]interface{}{
	...
	ds.sendDiagnostic(TRACK_CONFIG_NOTIFICATION_LOG, map[string]interface{}{
	...
	ds.sendDiagnostic(TRACK_CONFIG_PASSWORD, map[string]interface{}{
	...
	ds.sendDiagnostic(TRACK_CONFIG_FILE, map[string]interface{}{
	...
	ds.sendDiagnostic(TRACK_CONFIG_EMAIL, map[string]interface{}{
	...
	ds.sendDiagnostic(TRACK_CONFIG_RATE, map[string]interface{}{
	...
	ds.sendDiagnostic(TRACK_CONFIG_PRIVACY, map[string]interface{}{
		"show_email_address": cfg.PrivacySettings.ShowEmailAddress,
		"show_full_name":     cfg.PrivacySettings.ShowFullName,
	})

	ds.sendDiagnostic(TRACK_CONFIG_THEME, map[string]interface{}{
	...
	ds.sendDiagnostic(TRACK_CONFIG_OAUTH, map[string]interface{}{
	...
	ds.sendDiagnostic(TRACK_CONFIG_SUPPORT, map[string]interface{}{
	...
	ds.sendDiagnostic(TRACK_CONFIG_LDAP, map[string]interface{}{
	...
	ds.sendDiagnostic(TRACK_CONFIG_COMPLIANCE, map[string]interface{}{
		"enable":       *cfg.ComplianceSettings.Enable,
		"enable_daily": *cfg.ComplianceSettings.EnableDaily,
	})

	ds.sendDiagnostic(TRACK_CONFIG_LOCALIZATION, map[string]interface{}{
	...
	ds.sendDiagnostic(TRACK_CONFIG_SAML, map[string]interface{}{
	...
	ds.sendDiagnostic(TRACK_CONFIG_CLUSTER, map[string]interface{}{
	...
	ds.sendDiagnostic(TRACK_CONFIG_METRICS, map[string]interface{}{
		"enable":             *cfg.MetricsSettings.Enable,
		"block_profile_rate": *cfg.MetricsSettings.BlockProfileRate,
	})

	ds.sendDiagnostic(TRACK_CONFIG_NATIVEAPP, map[string]interface{}{
	...
	ds.sendDiagnostic(TRACK_CONFIG_EXPERIMENTAL, map[string]interface{}{
	...
	ds.sendDiagnostic(TRACK_CONFIG_ANALYTICS, map[string]interface{}{
	...
	ds.sendDiagnostic(TRACK_CONFIG_ANNOUNCEMENT, map[string]interface{}{
	...
	ds.sendDiagnostic(TRACK_CONFIG_ELASTICSEARCH, map[string]interface{}{
	...
	ds.sendDiagnostic(TRACK_CONFIG_PLUGIN, pluginConfigData)

	ds.sendDiagnostic(TRACK_CONFIG_DATA_RETENTION, map[string]interface{}{
	...
	ds.sendDiagnostic(TRACK_CONFIG_MESSAGE_EXPORT, map[string]interface{}{
	...
	ds.sendDiagnostic(TRACK_CONFIG_DISPLAY, map[string]interface{}{
	...
	ds.sendDiagnostic(TRACK_CONFIG_GUEST_ACCOUNTS, map[string]interface{}{
	...
	ds.sendDiagnostic(TRACK_CONFIG_IMAGE_PROXY, map[string]interface{}{
	...
	ds.sendDiagnostic(TRACK_CONFIG_BLEVE, map[string]interface{}{
...
func (ds *DiagnosticsService) trackLicense() {
	if license := ds.srv.License(); license != nil {
		...
		ds.sendDiagnostic(TRACK_LICENSE, data)
	}
}

func (ds *DiagnosticsService) trackPlugins() {
	pluginsEnvironment := ds.srv.GetPluginsEnvironment()
	if pluginsEnvironment == nil {
		return
	}
	...
	ds.sendDiagnostic(TRACK_PLUGINS, map[string]interface{}{
...
func (ds *DiagnosticsService) trackServer() {
	data := map[string]interface{}{
	...
	ds.sendDiagnostic(TRACK_SERVER, data)
}

func (ds *DiagnosticsService) trackPermissions() {
	...
	ds.sendDiagnostic(TRACK_PERMISSIONS_GENERAL, map[string]interface{}{
	...
	ds.sendDiagnostic(TRACK_PERMISSIONS_SYSTEM_SCHEME, map[string]interface{}{
	...
	if schemes, err := ds.srv.GetSchemes(model.SCHEME_SCOPE_TEAM, 0, 100); err == nil {
		for _, scheme := range schemes {
			...
			ds.sendDiagnostic(TRACK_PERMISSIONS_TEAM_SCHEMES, map[string]interface{}{
				"scheme_id":                 scheme.Id,
				"team_admin_permissions":    teamAdminPermissions,
				"team_user_permissions":     teamUserPermissions,
				"team_guest_permissions":    teamGuestPermissions,
...
func (ds *DiagnosticsService) trackElasticsearch() {
	data := map[string]interface{}{}
	...
	ds.sendDiagnostic(TRACK_ELASTICSEARCH, data)
}

func (ds *DiagnosticsService) trackGroups() {
	...
	ds.sendDiagnostic(TRACK_GROUPS, map[string]interface{}{
...
func (ds *DiagnosticsService) trackChannelModeration() {
	...
	ds.sendDiagnostic(TRACK_CHANNEL_MODERATION, map[string]interface{}{
...
func (ds *DiagnosticsService) initDiagnostics(endpoint string) {
	if ds.diagnosticClient == nil {
		...
		ds.diagnosticClient = client
	}
}

func (ds *DiagnosticsService) initRudder(endpoint string) {
	if ds.rudderClient == nil {
...
func (ds *DiagnosticsService) doDiagnosticsIfNeeded(firstRun time.Time) {
	...
	if hoursSinceFirstServerRun < 1 {
		ds.doDiagnostics()
	} else if hoursSinceFirstServerRun <= 12 && time.Since(ds.timestampLastDiagnosticSent) >= time.Hour {
		ds.doDiagnostics()
	} else if hoursSinceFirstServerRun > 12 && time.Since(ds.timestampLastDiagnosticSent) >= 24*time.Hour {
		ds.doDiagnostics()
	}
}

func (ds *DiagnosticsService) RunDiagnosticsJob(firstRun int64) {
	// Send on boot
	ds.doDiagnostics()
	model.CreateRecurringTask("Diagnostics", func() {
		ds.doDiagnosticsIfNeeded(utils.TimeFromMillis(firstRun))
	}, time.Minute*10)
}

func (ds *DiagnosticsService) doDiagnostics() {
	if *ds.srv.Config().LogSettings.EnableDiagnostics {
		ds.timestampLastDiagnosticSent = time.Now()
		ds.sendDailyDiagnostics(false)
	}
}

// Shutdown closes the diagnostic client.
func (ds *DiagnosticsService) Shutdown() error {
	var segmentErr, rudderErr error
	if ds.diagnosticClient != nil {
		segmentErr = ds.diagnosticClient.Close()
	}
