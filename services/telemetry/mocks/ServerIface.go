...
func (_m *ServerIface) IsLeader(_a0 request.CTX) bool {
	ret := _m.Called(_a0)
...
// License provides a mock function with given fields: _a0
func (_m *ServerIface) License(_a0 request.CTX) *model.License {
	ret := _m.Called(_a0)

	var r0 *model.License
	if rf, ok := ret.Get(0).(func(request.CTX) *model.License); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
