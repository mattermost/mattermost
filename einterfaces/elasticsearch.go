...
type ElasticsearchInterface interface {
	...
	SearchUsersInChannel(teamId, channelId string, restrictedChannelIds []string, term string, options *model.UserSearchOptions) ([]string, []string, *model.AppError)
	SearchUsersInTeam(teamId string, restrictedChannelIds []string, term string, options *model.UserSearchOptions) ([]string, *model.AppError)
