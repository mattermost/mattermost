...
type ElasticsearchInterface interface {
	...
	SearchUsersInChannel(teamId, channelId, term string, options *model.UserSearchOptions, listOfAllowedChannels []string) ([]string, []string, *model.AppError)
	SearchUsersInTeam(teamId, term string, options *model.UserSearchOptions, listOfAllowedChannels []string) ([]string, *model.AppError)
