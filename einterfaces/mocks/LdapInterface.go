...
// DoLogin provides a mock function with given fields: ctx, id, password
func (_m *LdapInterface) DoLogin(ctx einterfaces.AppContextInterface, id string, password string) (*model.User, *model.AppError) {
	ret := _m.Called(ctx, id, password)

	var r0 *model.User
	if rf, ok := ret.Get(0).(func(einterfaces.AppContextInterface, string, string) *model.User); ok {
	...
	if rf, ok := ret.Get(1).(func(einterfaces.AppContextInterface, string, string) *model.AppError); ok {
...
// FirstLoginSync provides a mock function with given fields: ctx, user, userAuthService, userAuthData, email
func (_m *LdapInterface) FirstLoginSync(ctx einterfaces.AppContextInterface, user *model.User, userAuthService string, userAuthData string, email string) *model.AppError {
	ret := _m.Called(ctx, user, userAuthService, userAuthData, email)

	var r0 *model.AppError
	if rf, ok := ret.Get(0).(func(einterfaces.AppContextInterface, *model.User, string, string, string) *model.AppError); ok {
		r0 = rf(ctx, user, userAuthService, userAuthData, email)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*model.AppError)
		}
