...
// VerifySameUser provides a mock function with given fields: dbUser, oAuthUser
func (_m *OauthProvider) VerifySameUser(dbUser *model.User, oAuthUser *model.User) bool {
