...
// GetUserConnectionCount provides a mock function with given fields: userId
func (_m *ClusterInterface) GetUserConnectionCount(userId string) (int, *model.AppError) {
