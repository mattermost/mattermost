...
### Pull request media requirements

When creating or updating PRs, include screenshots and demo videos whenever possible.

- For UI-visible changes, include at least one screenshot and one short demo video.
- For non-visual/backend-only changes, include terminal test evidence and note briefly why screenshots/videos are not applicable.
