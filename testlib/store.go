...
func GetMockStoreForSetupFunctions() *mocks.Store {
	...
	systemStore.On("GetByName", model.MIGRATION_KEY_ADD_BILLING_SUBSECTION_PERMISSIONS).Return(&model.System{Name: model.MIGRATION_KEY_ADD_BILLING_SUBSECTION_PERMISSIONS, Value: "true"}, nil)
