...
func GetMockStoreForSetupFunctions() *mocks.Store {
	...
	systemStore.On("GetByName", model.MIGRATION_KEY_ADD_CONVERT_PUBLIC_CHANNEL_TO_PRIVATE_PERMISSION).Return(&model.System{Name: model.MIGRATION_KEY_ADD_CONVERT_PUBLIC_CHANNEL_TO_PRIVATE_PERMISSION, Value: "true"}, nil)
