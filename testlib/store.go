...
func GetMockStoreForSetupFunctions() *mocks.Store {
	...
	systemStore.On("GetByName", model.MIGRATION_KEY_ACCESS_SYSTEM_CONSOLE_PERMISSIONS).Return(&model.System{Name: model.MIGRATION_KEY_ACCESS_SYSTEM_CONSOLE_PERMISSIONS, Value: "true"}, nil)
