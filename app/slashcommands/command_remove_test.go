...
func TestRemoveProviderDoCommand(t *testing.T) {
	...
	th.App.AddUserToChannel(targetUser, publicChannel, true)
	th.App.AddUserToChannel(targetUser, privateChannel, true)
	...
	th.App.AddUserToChannel(th.BasicUser, publicChannel, true)
	args = &model.CommandArgs{
		T:         func(s string, args ...interface{}) string { return s },
		ChannelId: publicChannel.Id,
		UserId:    th.BasicUser.Id,
	...
	th.App.AddUserToChannel(th.BasicUser, privateChannel, true)
	args = &model.CommandArgs{
		T:         func(s string, args ...interface{}) string { return s },
		ChannelId: privateChannel.Id,
		UserId:    th.BasicUser.Id,
	...
	th.App.AddUserToChannel(deactivatedUser, publicChannel, true)
