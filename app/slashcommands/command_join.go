...
func (j *JoinProvider) GetTrigger() string {
	return CMD_JOIN
}

func (j *JoinProvider) GetCommand(a *app.App, T goi18n.TranslateFunc) *model.Command {
...
func (j *JoinProvider) DoCommand(a *app.App, args *model.CommandArgs, message string) *model.CommandResponse {
	channelName := message
