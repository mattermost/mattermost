...
func TestInviteProvider(t *testing.T) {
	...
	privateChannel2 := th.createChannelWithAnotherUser(th.BasicTeam, model.ChannelPrivate, th.BasicUser2.Id)
	...
	groupChannel := th.createChannel(th.BasicTeam, model.ChannelPrivate)
