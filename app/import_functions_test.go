...
func TestImportImportTeam(t *testing.T) {
	...
	data.Type = ptrStr("O")
	err = th.App.importTeam(&data, true)
	require.NoError(t, err, "Received an error validating valid team.")
	...
	data.Type = ptrStr("O")
	err = th.App.importTeam(&data, false)
	require.NoError(t, err, "Received an error importing valid team: %v", err)
	...
	require.NoError(t, err, "Failed to get team from database.")
	...
	data.Type = ptrStr("O")
	err = th.App.importTeam(&data, false)
	require.NoError(t, err, "Received an error importing updated valid team.")
...
func TestImportImportUser(t *testing.T) {
	...
	err = th.App.importUser(&data, true)
	require.NoError(t, err, "Should have succeeded to import valid user.")
	...
	err = th.App.importUser(&data, false)
	require.NoError(t, err, "Should have succeeded to update valid user %v", err)
	...
	require.NoError(t, err, "Failed to get channel from database.")
	...
	require.NoError(t, err, "Failed to get team member count")
	teamMemberCount := len(teamMembers)

	channelMemberCount, err := th.App.GetChannelMemberCount(channel.Id)
	require.NoError(t, err, "Failed to get channel member count")
	...
	require.NoError(t, err, "Failed to get team member from database.")
	...
	require.NoError(t, err, "Failed to get channel member from database.")
	...
	channelMember, err = th.App.GetChannelMember(channel.Id, user.Id)
	require.NoError(t, err, "Failed to get channel member Desktop from database.")
	...
	teamMember, err = th.App.GetTeamMember(team.Id, user.Id)
	require.NoError(t, err, "Failed to get the team member")
	...
	channelMember, err = th.App.GetChannelMember(channel.Id, user.Id)
	require.NoError(t, err, "Failed to get the channel member")
