...
func (a *App) GetTeamMembers(teamId string, offset int, limit int, restrictions *model.ViewUsersRestrictions, teamMembersGetOptions *model.TeamMembersGetOptions) ([]*model.TeamMember, *model.AppError) {
	return a.Srv().Store.Team().GetMembers(teamId, offset, limit, restrictions, teamMembersGetOptions)
}
...
func (a *App) ClearTeamMembersCache(teamID string) {
	...
	for {
		teamMembers, err := a.Srv().Store.Team().GetMembers(teamID, page, perPage, &model.ViewUsersRestrictions{}, nil)
		if err != nil {
