...
type AppIface interface {
	...
	FinishSendAdminNotifyPost(trial bool, now int64, pluginBasedWorkTemplateData map[string][]*model.NotifyAdminData)
	...
	UserAlreadyNotifiedOnRequiredPlan(user string, plan string) bool
