...
type AppIface interface {
	...
	GetPostThread(postId string, skipFetchThreads, collapsedThreads bool) (*model.PostList, *model.AppError)
	...
	GetPostsForChannelAroundLastUnread(channelId, userId string, limitBefore, limitAfter int, skipFetchThreads bool, collapsedThreads bool) (*model.PostList, *model.AppError)
