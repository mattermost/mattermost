...
type AppIface interface {
	...
	CreateRetentionPolicy(policy *model.RetentionPolicyWithTeamAndChannelIds) (*model.RetentionPolicyWithTeamsAndChannels, *model.AppError)
	...
	GetRetentionPolicies(offset, limit uint64) ([]*model.RetentionPolicyWithTeamsAndChannels, *model.AppError)
	GetRetentionPoliciesWithCounts(offset, limit uint64) ([]*model.RetentionPolicyWithTeamAndChannelCounts, *model.AppError)
	GetRetentionPolicy(id string) (*model.RetentionPolicyWithTeamsAndChannels, *model.AppError)
	...
	PatchRetentionPolicy(patch *model.RetentionPolicyWithTeamAndChannelIds) (*model.RetentionPolicyWithTeamsAndChannels, *model.AppError)
	...
	UpdateRetentionPolicy(update *model.RetentionPolicyWithTeamAndChannelIds) (*model.RetentionPolicyWithTeamsAndChannels, *model.AppError)
