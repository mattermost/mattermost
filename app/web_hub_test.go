...
func TestHubIsRegistered(t *testing.T) {
	...
	assert.True(t, th.App.SessionIsRegistered(*wc1.session))
	assert.True(t, th.App.SessionIsRegistered(*wc2.session))
	assert.True(t, th.App.SessionIsRegistered(*wc3.session))
