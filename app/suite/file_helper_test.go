...
func TestFilterInaccessibleFiles(t *testing.T) {
	...
	th.Suite.platform.Store.System().Save(&model.System{
	...
	t.Run("ascending order returns correct files", func(t *testing.T) {
		...
		appErr := th.Suite.filterInaccessibleFiles(fileList, filterFileOptions{assumeSortedCreatedAt: true})
	...
	t.Run("handles mixed create at ordering correctly if correct options given", func(t *testing.T) {
		...
		appErr := th.Suite.filterInaccessibleFiles(fileList, filterFileOptions{assumeSortedCreatedAt: false})
...
func TestGetFilteredAccessibleFiles(t *testing.T) {
	...
	t.Run("ascending order returns correct files", func(t *testing.T) {
		...
		filteredFiles, firstInaccessibleFileTime, appErr := th.Suite.getFilteredAccessibleFiles(files, filterFileOptions{assumeSortedCreatedAt: true})
	...
	t.Run("handles mixed create at ordering correctly if correct options given", func(t *testing.T) {
		...
		filteredFiles, _, appErr := th.Suite.getFilteredAccessibleFiles(files, filterFileOptions{assumeSortedCreatedAt: false})
...
func TestIsInaccessibleFile(t *testing.T) {
	...
	firstInaccessibleFileTime, appErr := th.Suite.isInaccessibleFile(file)
	require.Nil(t, appErr)
