...
// 		validMillis := time.Now().Add(-10 * time.Minute).UnixMilli()
// 		expiredPost := &model.Post{Id: "pid1", ChannelId: channel.Id, Message: "tagging @user-1", UserId: user1.Id, CreateAt: expiredMillis}
// 		validPost := &model.Post{Id: "pid2", ChannelId: channel.Id, Message: "tagging @user-1", UserId: user1.Id, CreateAt: validMillis}
// 		posts := []*model.Post{
// 			expiredPost,
// 			validPost,
// 		}
