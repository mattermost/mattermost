...
func TestSendNotificationsWithManyUsers(t *testing.T) {
	...
	for i := 0; i < 10; i++ {
		...
		th.App.AddUserToChannel(user, th.BasicChannel, true)
...
func TestFilterOutOfChannelMentions(t *testing.T) {
	...
	th.App.AddUserToChannel(guest, channel, true)
	th.App.AddUserToChannel(user4, guestAndUser4Channel, true)
	th.App.AddUserToChannel(guest, guestAndUser4Channel, true)
...
func TestInsertGroupMentions(t *testing.T) {
	...
	th.App.AddUserToChannel(groupChannelMember, channel, true)
	...
	th.App.AddUserToChannel(nonGroupChannelMember, channel, true)
