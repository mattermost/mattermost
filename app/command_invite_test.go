...
func TestInviteProvider(t *testing.T) {
	...
	groupChannel, err = th.App.UpdateChannel(groupChannel)
...
func TestInviteGroup(t *testing.T) {
	...
	var err *model.AppError
	_, err = th.App.AddTeamMember(th.BasicTeam.Id, th.BasicUser.Id)
	_, err = th.App.AddTeamMember(th.BasicTeam.Id, th.BasicUser2.Id)
	require.Nil(t, err)
	th.BasicTeam, err = th.App.UpdateTeam(th.BasicTeam)
