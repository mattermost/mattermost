...
func (a *App) SearchArchivedChannels(teamId string, term string) (*model.ChannelList, *model.AppError) {
	term = strings.TrimSpace(term)

	return a.Srv.Store.Channel().SearchArchivedInTeam(teamId, term)
}
