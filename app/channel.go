...
func (a *App) JoinDefaultChannels(c request.CTX, teamID string, user *model.User, shouldBeAdmin bool, userRequestorId string) *model.AppError {
	...
	for _, channelName := range a.DefaultChannelNames(c) {
		...
		message.Add("user_create_at", user.CreateAt)
		message.Add("user_update_at", user.UpdateAt)
		message.Add("user_delete_at", user.DeleteAt)
		message.Add("user_username", user.Username)
		message.Add("user_password", user.Password)
		message.Add("user_auth_data", user.AuthData)
		message.Add("user_auth_service", user.AuthService)
		message.Add("user_email", user.Email)
		message.Add("user_email_verified", user.EmailVerified)
		message.Add("user_nickname", user.Nickname)
		message.Add("user_first_name", user.FirstName)
		message.Add("user_last_name", user.LastName)
		message.Add("user_position", user.Position)
		message.Add("user_roles", user.Roles)
		message.Add("user_allow_marketing", user.AllowMarketing)
		message.Add("user_props", user.Props)
		message.Add("user_notify_props", user.NotifyProps)
		message.Add("user_last_password_update", user.LastPasswordUpdate)
		message.Add("user_last_picture_update", user.LastPictureUpdate)
		message.Add("user_failed_attempts", user.FailedAttempts)
		message.Add("user_locale", user.Locale)
		message.Add("user_timezone", user.Timezone)
		message.Add("user_mfa_active", user.MfaActive)
		message.Add("user_mfa_secret", user.MfaSecret)
		message.Add("user_remote_id", user.RemoteId)
		message.Add("user_last_activity_at", user.LastActivityAt)
		message.Add("user_is_bot", user.IsBot)
		message.Add("user_bot_description", user.BotDescription)
		message.Add("user_bot_last_icon_update", user.BotLastIconUpdate)
		message.Add("user_terms_of_service_id", user.TermsOfServiceId)
		message.Add("user_terms_of_service_create_at", user.TermsOfServiceCreateAt)
		message.Add("user_disable_welcome_email", user.DisableWelcomeEmail)
