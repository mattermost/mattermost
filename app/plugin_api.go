...
func (api *PluginAPI) GetChannelByName(name, teamId string, options model.GetChannelByNameOptions) (*model.Channel, *model.AppError) {
	return api.app.GetChannelByName(name, teamId, options.IncludeDeletedChannels)
}
