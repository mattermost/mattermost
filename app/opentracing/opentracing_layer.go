...
func (a *OpenTracingAppLayer) GetTopChannelsForTeamSince(teamID string, userID string, opts *model.InsightsOpts) ([]*model.TopChannels, *model.AppError) {
	origCtx := a.ctx
...
func (a *OpenTracingAppLayer) GetTopReactionsForTeamSince(teamID string, userID string, opts *model.InsightsOpts) ([]*model.TopReactions, *model.AppError) {
	origCtx := a.ctx
...
func (a *OpenTracingAppLayer) GetTopReactionsForUserSince(userID string, teamID string, opts *model.InsightsOpts) ([]*model.TopReactions, *model.AppError) {
	origCtx := a.ctx
