...
func (a *OpenTracingAppLayer) FinishSendAdminNotifyPost(trial bool, now int64, userBasedWorkTemplateData map[string][]*model.NotifyAdminData) {
	origCtx := a.ctx
	...
	defer span.Finish()
	a.app.FinishSendAdminNotifyPost(trial, now, userBasedWorkTemplateData)
}
