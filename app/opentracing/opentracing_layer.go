...
func (a *OpenTracingAppLayer) RestoreToPreviousCustomStatus(c request.CTX, userID string) *model.AppError {
	origCtx := a.ctx
	span, newCtx := tracing.StartSpanWithParentByContext(a.ctx, "app.RestoreToPreviousCustomStatus")
	...
	defer span.Finish()
	resultVar0 := a.app.RestoreToPreviousCustomStatus(c, userID)
