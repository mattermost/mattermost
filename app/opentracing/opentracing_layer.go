...
func (a *OpenTracingAppLayer) HandleOfficeFiles(infos []*model.FileInfo) error {
	origCtx := a.ctx
	span, newCtx := tracing.StartSpanWithParentByContext(a.ctx, "app.HandleOfficeFiles")
	...
	defer span.Finish()
	resultVar0 := a.app.HandleOfficeFiles(infos)
