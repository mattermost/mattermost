...
func (a *OpenTracingAppLayer) GetProductNotices(lastViewed int64, userId string, teamId string, client model.NoticeClientType, clientVersion string, locale string) ([]model.NoticeMessage, *model.AppError) {
	origCtx := a.ctx
