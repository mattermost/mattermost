...
func (a *OpenTracingAppLayer) GetTotalUsersNoBotsStats(viewRestrictions *model.ViewUsersRestrictions) (*model.UsersStats, *model.AppError) {
	origCtx := a.ctx
	span, newCtx := tracing.StartSpanWithParentByContext(a.ctx, "app.GetTotalUsersNoBotsStats")
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.GetTotalUsersNoBotsStats(viewRestrictions)
