...
func (a *OpenTracingAppLayer) GetSingleParentPost(postID string, includeDeleted bool) (*model.Post, *model.AppError) {
	origCtx := a.ctx
	span, newCtx := tracing.StartSpanWithParentByContext(a.ctx, "app.GetSingleParentPost")
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.GetSingleParentPost(postID, includeDeleted)
