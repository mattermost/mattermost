...
func (a *OpenTracingAppLayer) GetTotalUsersCount() (int64, error) {
	origCtx := a.ctx
	span, newCtx := tracing.StartSpanWithParentByContext(a.ctx, "app.GetTotalUsersCount")
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.GetTotalUsersCount()
