...
func (a *OpenTracingAppLayer) GetDraft(userID string, channelID string, rootID string, inclDeleted bool) (*model.Draft, *model.AppError) {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.GetDraft(userID, channelID, rootID, inclDeleted)
