...
func (a *OpenTracingAppLayer) GetCloudUsageForMessages(userID string) (int, *model.AppError) {
	origCtx := a.ctx
	span, newCtx := tracing.StartSpanWithParentByContext(a.ctx, "app.GetCloudUsageForMessages")
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.GetCloudUsageForMessages(userID)
