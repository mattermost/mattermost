...
func (a *OpenTracingAppLayer) AddCursorIdsForPostList(c request.CTX, originalList *model.PostList, afterPost string, beforePost string, since int64, page int, perPage int, collapsedThreads bool) {
	origCtx := a.ctx
	...
	defer span.Finish()
	a.app.AddCursorIdsForPostList(c, originalList, afterPost, beforePost, since, page, perPage, collapsedThreads)
}
...
func (a *OpenTracingAppLayer) AdjustInProductLimits(c request.CTX, limits *model.ProductLimits, subscription *model.Subscription) *model.AppError {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0 := a.app.AdjustInProductLimits(c, limits, subscription)
...
func (a *OpenTracingAppLayer) AdjustTeamsFromProductLimits(c request.CTX, teamLimits *model.TeamsLimits) *model.AppError {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0 := a.app.AdjustTeamsFromProductLimits(c, teamLimits)
...
func (a *OpenTracingAppLayer) BroadcastStatus(c request.CTX, status *model.Status) {
	origCtx := a.ctx
	...
	defer span.Finish()
	a.app.BroadcastStatus(c, status)
}
...
func (a *OpenTracingAppLayer) CanNotifyAdmin(c request.CTX, trial bool) bool {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0 := a.app.CanNotifyAdmin(c, trial)
...
func (a *OpenTracingAppLayer) CheckFreemiumLimitsForConfigSave(c request.CTX, oldConfig *model.Config, newConfig *model.Config) *model.AppError {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0 := a.app.CheckFreemiumLimitsForConfigSave(c, oldConfig, newConfig)
...
func (a *OpenTracingAppLayer) CheckPostReminders(c request.CTX) {
	origCtx := a.ctx
...
func (a *OpenTracingAppLayer) ClearTeamMembersCache(c request.CTX, teamID string) error {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0 := a.app.ClearTeamMembersCache(c, teamID)
...
func (a *OpenTracingAppLayer) ClientConfigWithComputed(c request.CTX) map[string]string {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0 := a.app.ClientConfigWithComputed(c)
...
func (a *OpenTracingAppLayer) CompareAndDeletePluginKey(c request.CTX, pluginID string, key string, oldValue []byte) (bool, *model.AppError) {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.CompareAndDeletePluginKey(c, pluginID, key, oldValue)
...
func (a *OpenTracingAppLayer) CompareAndSetPluginKey(c request.CTX, pluginID string, key string, oldValue []byte, newValue []byte) (bool, *model.AppError) {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.CompareAndSetPluginKey(c, pluginID, key, oldValue, newValue)
...
func (a *OpenTracingAppLayer) ComputeLastAccessiblePostTime(c request.CTX) error {
	...
	defer span.Finish()
	resultVar0 := a.app.ComputeLastAccessiblePostTime(c)
...
func (a *OpenTracingAppLayer) CreateGroupWithUserIds(c request.CTX, group *model.GroupWithUserIds) (*model.Group, *model.AppError) {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.CreateGroupWithUserIds(c, group)
...
func (a *OpenTracingAppLayer) DeleteAllExpiredPluginKeys(c request.CTX) *model.AppError {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0 := a.app.DeleteAllExpiredPluginKeys(c)
...
func (a *OpenTracingAppLayer) DeleteAllKeysForPlugin(c request.CTX, pluginID string) *model.AppError {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0 := a.app.DeleteAllKeysForPlugin(c, pluginID)
...
func (a *OpenTracingAppLayer) DeleteEphemeralPost(c request.CTX, userID string, postID string) {
	origCtx := a.ctx
	...
	defer span.Finish()
	a.app.DeleteEphemeralPost(c, userID, postID)
}
...
func (a *OpenTracingAppLayer) DeleteGroupMember(c request.CTX, groupID string, userID string) (*model.GroupMember, *model.AppError) {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.DeleteGroupMember(c, groupID, userID)
...
func (a *OpenTracingAppLayer) DeleteGroupMembers(c request.CTX, groupID string, userIDs []string) ([]*model.GroupMember, *model.AppError) {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.DeleteGroupMembers(c, groupID, userIDs)
...
func (a *OpenTracingAppLayer) DeleteGroupSyncable(c request.CTX, groupID string, syncableID string, syncableType model.GroupSyncableType) (*model.GroupSyncable, *model.AppError) {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.DeleteGroupSyncable(c, groupID, syncableID, syncableType)
...
func (a *OpenTracingAppLayer) DeleteOAuthApp(c request.CTX, appID string) *model.AppError {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0 := a.app.DeleteOAuthApp(c, appID)
...
func (a *OpenTracingAppLayer) DeletePluginKey(c request.CTX, pluginID string, key string) *model.AppError {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0 := a.app.DeletePluginKey(c, pluginID, key)
...
func (a *OpenTracingAppLayer) DoAdvancedPermissionsMigration(c request.CTX) {
	origCtx := a.ctx
	...
	defer span.Finish()
	a.app.DoAdvancedPermissionsMigration(c)
}

func (a *OpenTracingAppLayer) DoAppMigrations(c request.CTX) {
	origCtx := a.ctx
	...
	defer span.Finish()
	a.app.DoAppMigrations(c)
}

func (a *OpenTracingAppLayer) DoCheckForAdminNotifications(c request.CTX, trial bool) *model.AppError {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0 := a.app.DoCheckForAdminNotifications(c, trial)
...
func (a *OpenTracingAppLayer) DoEmojisPermissionsMigration(c request.CTX) {
	origCtx := a.ctx
	...
	defer span.Finish()
	a.app.DoEmojisPermissionsMigration(c)
}

func (a *OpenTracingAppLayer) DoGuestRolesCreationMigration(c request.CTX) {
	origCtx := a.ctx
	...
	defer span.Finish()
	a.app.DoGuestRolesCreationMigration(c)
}
...
func (a *OpenTracingAppLayer) DoSystemConsoleRolesCreationMigration(c request.CTX) {
	origCtx := a.ctx
	...
	defer span.Finish()
	a.app.DoSystemConsoleRolesCreationMigration(c)
}
...
func (a *OpenTracingAppLayer) EnablePlugin(c request.CTX, id string) *model.AppError {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0 := a.app.EnablePlugin(c, id)
...
func (a *OpenTracingAppLayer) ExtendSessionExpiryIfNeeded(c request.CTX, session *model.Session) bool {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0 := a.app.ExtendSessionExpiryIfNeeded(c, session)

	return resultVar0
}

func (a *OpenTracingAppLayer) ExtractContentFromFileInfo(c request.CTX, fileInfo *model.FileInfo) error {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0 := a.app.ExtractContentFromFileInfo(c, fileInfo)
...
func (a *OpenTracingAppLayer) FinishSendAdminNotifyPost(c request.CTX, trial bool, now int64) {
	origCtx := a.ctx
	...
	defer span.Finish()
	a.app.FinishSendAdminNotifyPost(c, trial, now)
}
...
func (a *OpenTracingAppLayer) GetAnalytics(c request.CTX, name string, teamID string) (model.AnalyticsRows, *model.AppError) {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.GetAnalytics(c, name, teamID)
...
func (a *OpenTracingAppLayer) GetComplianceReport(c request.CTX, reportId string) (*model.Compliance, *model.AppError) {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.GetComplianceReport(c, reportId)
...
func (a *OpenTracingAppLayer) GetComplianceReports(c request.CTX, page int, perPage int) (model.Compliances, *model.AppError) {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.GetComplianceReports(c, page, perPage)
...
func (a *OpenTracingAppLayer) GetFile(c request.CTX, fileID string) ([]byte, *model.AppError) {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.GetFile(c, fileID)
...
func (a *OpenTracingAppLayer) GetFileInfo(c request.CTX, fileID string) (*model.FileInfo, *model.AppError) {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.GetFileInfo(c, fileID)
...
func (a *OpenTracingAppLayer) GetFileInfos(c request.CTX, page int, perPage int, opt *model.GetFileInfosOptions) ([]*model.FileInfo, *model.AppError) {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.GetFileInfos(c, page, perPage, opt)
...
func (a *OpenTracingAppLayer) GetFileInfosForPostWithMigration(c request.CTX, postID string, includeDeleted bool) ([]*model.FileInfo, *model.AppError) {
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.GetFileInfosForPostWithMigration(c, postID, includeDeleted)
...
func (a *OpenTracingAppLayer) GetFlaggedPosts(c request.CTX, userID string, offset int, limit int) (*model.PostList, *model.AppError) {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.GetFlaggedPosts(c, userID, offset, limit)
...
func (a *OpenTracingAppLayer) GetFlaggedPostsForChannel(c request.CTX, userID string, channelID string, offset int, limit int) (*model.PostList, *model.AppError) {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.GetFlaggedPostsForChannel(c, userID, channelID, offset, limit)
...
func (a *OpenTracingAppLayer) GetFlaggedPostsForTeam(c request.CTX, userID string, teamID string, offset int, limit int) (*model.PostList, *model.AppError) {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.GetFlaggedPostsForTeam(c, userID, teamID, offset, limit)
...
func (a *OpenTracingAppLayer) GetLastAccessiblePostTime(c request.CTX) (int64, *model.AppError) {
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.GetLastAccessiblePostTime(c)
...
func (a *OpenTracingAppLayer) GetMarketplacePlugins(c request.CTX, filter *model.MarketplacePluginFilter) ([]*model.MarketplacePlugin, *model.AppError) {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.GetMarketplacePlugins(c, filter)
...
func (a *OpenTracingAppLayer) GetNextPostIdFromPostList(c request.CTX, postList *model.PostList, collapsedThreads bool) string {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0 := a.app.GetNextPostIdFromPostList(c, postList, collapsedThreads)
...
func (a *OpenTracingAppLayer) GetOpenGraphMetadata(c request.CTX, requestURL string) ([]byte, error) {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.GetOpenGraphMetadata(c, requestURL)
...
func (a *OpenTracingAppLayer) GetPluginKey(c request.CTX, pluginID string, key string) ([]byte, *model.AppError) {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.GetPluginKey(c, pluginID, key)
...
func (a *OpenTracingAppLayer) GetPostThread(c request.CTX, postID string, opts model.GetPostsOptions, userID string) (*model.PostList, *model.AppError) {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.GetPostThread(c, postID, opts, userID)
...
func (a *OpenTracingAppLayer) GetPosts(c request.CTX, channelID string, offset int, limit int) (*model.PostList, *model.AppError) {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.GetPosts(c, channelID, offset, limit)
...
func (a *OpenTracingAppLayer) GetPostsAfterPost(c request.CTX, options model.GetPostsOptions) (*model.PostList, *model.AppError) {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.GetPostsAfterPost(c, options)
...
func (a *OpenTracingAppLayer) GetPostsAroundPost(c request.CTX, before bool, options model.GetPostsOptions) (*model.PostList, *model.AppError) {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.GetPostsAroundPost(c, before, options)
...
func (a *OpenTracingAppLayer) GetPostsBeforePost(c request.CTX, options model.GetPostsOptions) (*model.PostList, *model.AppError) {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.GetPostsBeforePost(c, options)
...
func (a *OpenTracingAppLayer) GetPostsByIds(c request.CTX, postIDs []string) ([]*model.Post, int64, *model.AppError) {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0, resultVar1, resultVar2 := a.app.GetPostsByIds(c, postIDs)
...
func (a *OpenTracingAppLayer) GetPostsPage(c request.CTX, options model.GetPostsOptions) (*model.PostList, *model.AppError) {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.GetPostsPage(c, options)
...
func (a *OpenTracingAppLayer) GetPostsSince(c request.CTX, options model.GetPostsSinceOptions) (*model.PostList, *model.AppError) {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.GetPostsSince(c, options)
...
func (a *OpenTracingAppLayer) GetPrevPostIdFromPostList(c request.CTX, postList *model.PostList, collapsedThreads bool) string {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0 := a.app.GetPrevPostIdFromPostList(c, postList, collapsedThreads)
...
func (a *OpenTracingAppLayer) GetSession(c request.CTX, token string) (*model.Session, *model.AppError) {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.GetSession(c, token)
...
func (a *OpenTracingAppLayer) GetSinglePost(c request.CTX, postID string, includeDeleted bool) (*model.Post, *model.AppError) {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.GetSinglePost(c, postID, includeDeleted)
...
func (a *OpenTracingAppLayer) GetTeamIdFromQuery(c request.CTX, query url.Values) (string, *model.AppError) {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.GetTeamIdFromQuery(c, query)
...
func (a *OpenTracingAppLayer) HandleImages(c request.CTX, previewPathList []string, thumbnailPathList []string, fileData [][]byte) {
	origCtx := a.ctx
	...
	defer span.Finish()
	a.app.HandleImages(c, previewPathList, thumbnailPathList, fileData)
}
...
func (a *OpenTracingAppLayer) ImportPermissions(c request.CTX, jsonl io.Reader) error {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0 := a.app.ImportPermissions(c, jsonl)
...
func (a *OpenTracingAppLayer) InstallPlugin(c request.CTX, pluginFile io.ReadSeeker, replace bool) (*model.Manifest, *model.AppError) {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.InstallPlugin(c, pluginFile, replace)
...
func (a *OpenTracingAppLayer) InviteGuestsToChannelsGracefully(c request.CTX, teamID string, guestsInvite *model.GuestsInvite, senderId string) ([]*model.EmailInviteWithError, *model.AppError) {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.InviteGuestsToChannelsGracefully(c, teamID, guestsInvite, senderId)
...
func (a *OpenTracingAppLayer) InviteNewUsersToTeamGracefully(c request.CTX, memberInvite *model.MemberInvite, teamID string, senderId string, reminderInterval string) ([]*model.EmailInviteWithError, *model.AppError) {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.InviteNewUsersToTeamGracefully(c, memberInvite, teamID, senderId, reminderInterval)
...
func (a *OpenTracingAppLayer) ListPluginKeys(c request.CTX, pluginID string, page int, perPage int) ([]string, *model.AppError) {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.ListPluginKeys(c, pluginID, page, perPage)
...
func (a *OpenTracingAppLayer) MigrateFilenamesToFileInfos(c request.CTX, post *model.Post) []*model.FileInfo {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0 := a.app.MigrateFilenamesToFileInfos(c, post)
...
func (a *OpenTracingAppLayer) NotifySessionsExpired(c request.CTX) error {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0 := a.app.NotifySessionsExpired(c)
...
func (a *OpenTracingAppLayer) NotifySharedChannelUserUpdate(c request.CTX, user *model.User) {
	origCtx := a.ctx
	...
	defer span.Finish()
	a.app.NotifySharedChannelUserUpdate(c, user)
}
...
func (a *OpenTracingAppLayer) PatchBot(c request.CTX, botUserId string, botPatch *model.BotPatch) (*model.Bot, *model.AppError) {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.PatchBot(c, botUserId, botPatch)
...
func (a *OpenTracingAppLayer) PatchRole(c request.CTX, role *model.Role, patch *model.RolePatch) (*model.Role, *model.AppError) {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.PatchRole(c, role, patch)
...
func (a *OpenTracingAppLayer) PatchTeam(c request.CTX, teamID string, patch *model.TeamPatch) (*model.Team, *model.AppError) {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.PatchTeam(c, teamID, patch)
...
func (a *OpenTracingAppLayer) Publish(c request.CTX, message *model.WebSocketEvent) {
	origCtx := a.ctx
	...
	defer span.Finish()
	a.app.Publish(c, message)
}

func (a *OpenTracingAppLayer) PublishUserTyping(c request.CTX, userID string, channelID string, parentId string) *model.AppError {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0 := a.app.PublishUserTyping(c, userID, channelID, parentId)
...
func (a *OpenTracingAppLayer) RegenerateTeamInviteId(c request.CTX, teamID string) (*model.Team, *model.AppError) {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.RegenerateTeamInviteId(c, teamID)
...
func (a *OpenTracingAppLayer) RemoveTeamIcon(c request.CTX, teamID string) *model.AppError {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0 := a.app.RemoveTeamIcon(c, teamID)
...
func (a *OpenTracingAppLayer) RestoreTeam(c request.CTX, teamID string) *model.AppError {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0 := a.app.RestoreTeam(c, teamID)
...
func (a *OpenTracingAppLayer) RolesGrantPermission(c request.CTX, roleNames []string, permissionId string) bool {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0 := a.app.RolesGrantPermission(c, roleNames, permissionId)
...
func (a *OpenTracingAppLayer) SanitizeTeam(c request.CTX, session model.Session, team *model.Team) *model.Team {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0 := a.app.SanitizeTeam(c, session, team)

	return resultVar0
}

func (a *OpenTracingAppLayer) SanitizeTeams(c request.CTX, session model.Session, teams []*model.Team) []*model.Team {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0 := a.app.SanitizeTeams(c, session, teams)
...
func (a *OpenTracingAppLayer) SaveAndBroadcastStatus(c request.CTX, status *model.Status) {
	origCtx := a.ctx
	...
	defer span.Finish()
	a.app.SaveAndBroadcastStatus(c, status)
}
...
func (a *OpenTracingAppLayer) SaveComplianceReport(c request.CTX, job *model.Compliance) (*model.Compliance, *model.AppError) {
	origCtx := a.ctx
...
func (a *OpenTracingAppLayer) SearchPostsForUser(c request.CTX, terms string, userID string, teamID string, isOrSearch bool, includeDeletedChannels bool, timeZoneOffset int, page int, perPage int, modifier string) (*model.PostSearchResults, *model.AppError) {
	origCtx := a.ctx
...
func (a *OpenTracingAppLayer) SearchPostsInTeam(c request.CTX, teamID string, paramsList []*model.SearchParams) (*model.PostList, *model.AppError) {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.SearchPostsInTeam(c, teamID, paramsList)
...
func (a *OpenTracingAppLayer) SendTestPushNotification(c request.CTX, deviceID string) string {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0 := a.app.SendTestPushNotification(c, deviceID)
...
func (a *OpenTracingAppLayer) SessionHasPermissionTo(c request.CTX, session model.Session, permission *model.Permission) bool {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0 := a.app.SessionHasPermissionTo(c, session, permission)
...
func (a *OpenTracingAppLayer) SessionHasPermissionToCreateJob(c request.CTX, session model.Session, job *model.Job) (bool, *model.Permission) {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.SessionHasPermissionToCreateJob(c, session, job)
...
func (a *OpenTracingAppLayer) SessionHasPermissionToManageBot(c request.CTX, session model.Session, botUserId string) *model.AppError {
	origCtx := a.ctx
...
func (a *OpenTracingAppLayer) SessionHasPermissionToReadJob(c request.CTX, session model.Session, jobType string) (bool, *model.Permission) {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.SessionHasPermissionToReadJob(c, session, jobType)

	return resultVar0, resultVar1
}

func (a *OpenTracingAppLayer) SessionHasPermissionToTeam(c request.CTX, session model.Session, teamID string, permission *model.Permission) bool {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0 := a.app.SessionHasPermissionToTeam(c, session, teamID, permission)
...
func (a *OpenTracingAppLayer) SessionHasPermissionToUserOrBot(c request.CTX, session model.Session, userID string) bool {
	origCtx := a.ctx
...
func (a *OpenTracingAppLayer) SetPluginKey(c request.CTX, pluginID string, key string, value []byte) *model.AppError {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0 := a.app.SetPluginKey(c, pluginID, key, value)
...
func (a *OpenTracingAppLayer) SetPluginKeyWithExpiry(c request.CTX, pluginID string, key string, value []byte, expireInSeconds int64) *model.AppError {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0 := a.app.SetPluginKeyWithExpiry(c, pluginID, key, value, expireInSeconds)
...
func (a *OpenTracingAppLayer) SetPluginKeyWithOptions(c request.CTX, pluginID string, key string, value []byte, options model.PluginKVSetOptions) (bool, *model.AppError) {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.SetPluginKeyWithOptions(c, pluginID, key, value, options)
...
func (a *OpenTracingAppLayer) SetStatusAwayIfNeeded(c request.CTX, userID string, manual bool) {
	origCtx := a.ctx
	...
	defer span.Finish()
	a.app.SetStatusAwayIfNeeded(c, userID, manual)
}

func (a *OpenTracingAppLayer) SetStatusDoNotDisturb(c request.CTX, userID string) {
	origCtx := a.ctx
	...
	defer span.Finish()
	a.app.SetStatusDoNotDisturb(c, userID)
}

func (a *OpenTracingAppLayer) SetStatusDoNotDisturbTimed(c request.CTX, userId string, endtime int64) {
	origCtx := a.ctx
	...
	defer span.Finish()
	a.app.SetStatusDoNotDisturbTimed(c, userId, endtime)
}

func (a *OpenTracingAppLayer) SetStatusLastActivityAt(c request.CTX, userID string, activityAt int64) {
	origCtx := a.ctx
	...
	defer span.Finish()
	a.app.SetStatusLastActivityAt(c, userID, activityAt)
}

func (a *OpenTracingAppLayer) SetStatusOffline(c request.CTX, userID string, manual bool) {
	origCtx := a.ctx
	...
	defer span.Finish()
	a.app.SetStatusOffline(c, userID, manual)
}
...
func (a *OpenTracingAppLayer) SetStatusOutOfOffice(c request.CTX, userID string) {
	origCtx := a.ctx
	...
	defer span.Finish()
	a.app.SetStatusOutOfOffice(c, userID)
}

func (a *OpenTracingAppLayer) SetTeamIcon(c request.CTX, teamID string, imageData *multipart.FileHeader) *model.AppError {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0 := a.app.SetTeamIcon(c, teamID, imageData)
...
func (a *OpenTracingAppLayer) SetTeamIconFromFile(c request.CTX, team *model.Team, file io.Reader) *model.AppError {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0 := a.app.SetTeamIconFromFile(c, team, file)
...
func (a *OpenTracingAppLayer) SetTeamIconFromMultiPartFile(c request.CTX, teamID string, file multipart.File) *model.AppError {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0 := a.app.SetTeamIconFromMultiPartFile(c, teamID, file)
...
func (a *OpenTracingAppLayer) SoftDeleteAllTeamsExcept(c request.CTX, teamID string) *model.AppError {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0 := a.app.SoftDeleteAllTeamsExcept(c, teamID)
...
func (a *OpenTracingAppLayer) SoftDeleteTeam(c request.CTX, teamID string) *model.AppError {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0 := a.app.SoftDeleteTeam(c, teamID)
...
func (a *OpenTracingAppLayer) SyncPlugins(c request.CTX) *model.AppError {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0 := a.app.SyncPlugins(c)
...
func (a *OpenTracingAppLayer) SyncSyncableRoles(c request.CTX, syncableID string, syncableType model.GroupSyncableType) *model.AppError {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0 := a.app.SyncSyncableRoles(c, syncableID, syncableType)
...
func (a *OpenTracingAppLayer) TestFileStoreConnectionWithConfig(c request.CTX, cfg *model.FileSettings) *model.AppError {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0 := a.app.TestFileStoreConnectionWithConfig(c, cfg)
...
func (a *OpenTracingAppLayer) TestLdap(c request.CTX) *model.AppError {
	origCtx := a.ctx
...
func (a *OpenTracingAppLayer) UpdateDNDStatusOfUsers(c request.CTX) {
	origCtx := a.ctx
	...
	defer span.Finish()
	a.app.UpdateDNDStatusOfUsers(c)
}
...
func (a *OpenTracingAppLayer) UpdateGroup(c request.CTX, group *model.Group) (*model.Group, *model.AppError) {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.UpdateGroup(c, group)
...
func (a *OpenTracingAppLayer) UpdateGroupSyncable(c request.CTX, groupSyncable *model.GroupSyncable) (*model.GroupSyncable, *model.AppError) {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.UpdateGroupSyncable(c, groupSyncable)
...
func (a *OpenTracingAppLayer) UpdateLastActivityAtIfNeeded(c request.CTX, session model.Session) {
	origCtx := a.ctx
	...
	defer span.Finish()
	a.app.UpdateLastActivityAtIfNeeded(c, session)
}
...
func (a *OpenTracingAppLayer) UpdatePost(c request.CTX, post *model.Post, safeUpdate bool) (*model.Post, *model.AppError) {
	origCtx := a.ctx
...
func (a *OpenTracingAppLayer) UpdateProductNotices(c request.CTX) *model.AppError {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0 := a.app.UpdateProductNotices(c)
...
func (a *OpenTracingAppLayer) UpdateRole(c request.CTX, role *model.Role) (*model.Role, *model.AppError) {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.UpdateRole(c, role)
...
func (a *OpenTracingAppLayer) UpdateTeam(c request.CTX, team *model.Team) (*model.Team, *model.AppError) {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.UpdateTeam(c, team)
...
func (a *OpenTracingAppLayer) UpdateTeamPrivacy(c request.CTX, teamID string, teamType string, allowOpenInvite bool) *model.AppError {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0 := a.app.UpdateTeamPrivacy(c, teamID, teamType, allowOpenInvite)
...
func (a *OpenTracingAppLayer) UpdateTeamScheme(c request.CTX, team *model.Team) (*model.Team, *model.AppError) {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.UpdateTeamScheme(c, team)
...
func (a *OpenTracingAppLayer) UpdateThreadFollowForUser(c request.CTX, userID string, teamID string, threadID string, state bool) *model.AppError {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0 := a.app.UpdateThreadFollowForUser(c, userID, teamID, threadID, state)
...
func (a *OpenTracingAppLayer) UpdateThreadsReadForUser(c request.CTX, userID string, teamID string) *model.AppError {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0 := a.app.UpdateThreadsReadForUser(c, userID, teamID)
...
func (a *OpenTracingAppLayer) UpdateViewedProductNoticesForNewUser(c request.CTX, userID string) {
	origCtx := a.ctx
	...
	defer span.Finish()
	a.app.UpdateViewedProductNoticesForNewUser(c, userID)
}
...
func (a *OpenTracingAppLayer) UpsertGroupMember(c request.CTX, groupID string, userID string) (*model.GroupMember, *model.AppError) {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.UpsertGroupMember(c, groupID, userID)
...
func (a *OpenTracingAppLayer) UpsertGroupMembers(c request.CTX, groupID string, userIDs []string) ([]*model.GroupMember, *model.AppError) {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.UpsertGroupMembers(c, groupID, userIDs)
...
func (a *OpenTracingAppLayer) UpsertGroupSyncable(c request.CTX, groupSyncable *model.GroupSyncable) (*model.GroupSyncable, *model.AppError) {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.UpsertGroupSyncable(c, groupSyncable)
...
func (a *OpenTracingAppLayer) VerifyUserEmail(c request.CTX, userID string, email string) *model.AppError {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0 := a.app.VerifyUserEmail(c, userID, email)
