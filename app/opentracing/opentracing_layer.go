...
func (a *OpenTracingAppLayer) GetGroupsBySourcePaginated(groupSource model.GroupSource, page int, perPage int) ([]*model.Group, *model.AppError) {
	origCtx := a.ctx
	span, newCtx := tracing.StartSpanWithParentByContext(a.ctx, "app.GetGroupsBySourcePaginated")
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.GetGroupsBySourcePaginated(groupSource, page, perPage)
...
func (a *OpenTracingAppLayer) SourceHasCRUDPermissions(id string) *model.AppError {
	origCtx := a.ctx
	span, newCtx := tracing.StartSpanWithParentByContext(a.ctx, "app.SourceHasCRUDPermissions")
	...
	defer span.Finish()
	resultVar0 := a.app.SourceHasCRUDPermissions(id)
