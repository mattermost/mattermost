...
func (a *OpenTracingAppLayer) GetThreadForUser(userId string, teamId string, threadId string) (*model.ThreadResponse, *model.AppError) {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.GetThreadForUser(userId, teamId, threadId)
