...
func (a *OpenTracingAppLayer) GetTelemetryService() *telemetry.TelemetryService {
	origCtx := a.ctx
	span, newCtx := tracing.StartSpanWithParentByContext(a.ctx, "app.GetTelemetryService")
	...
	defer span.Finish()
	resultVar0 := a.app.GetTelemetryService()
