...
func (a *OpenTracingAppLayer) UndeleteGroup(groupID string) (*model.Group, *model.AppError) {
	origCtx := a.ctx
	span, newCtx := tracing.StartSpanWithParentByContext(a.ctx, "app.UndeleteGroup")
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.UndeleteGroup(groupID)
