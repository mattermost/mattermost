...
func (me *RenameProvider) GetCommand(a *App, T goi18n.TranslateFunc) *model.Command {
	renameAutocompleteData := model.NewAutocompleteData(CMD_RENAME, T("api.command_channel_rename.desc"))
	renameAutocompleteData.AddTextInputArgument("", T("api.command_channel_rename.hint"), "[text]", "")
