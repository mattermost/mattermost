...
func (s *OpenTracingAppLayer) ClusterBusyStateChgHandler(msg *model.ClusterMessage) {
	span, _ := tracing.StartSpanWithParentByContext(s.ctx, "app.ClusterBusyStateChgHandler")

	span.SetTag("msg", msg)

	defer span.Finish()

	s.app.ClusterBusyStateChgHandler(msg)
}

func (s *OpenTracingAppLayer) ClusterClearSessionCacheForAllUsersHandler(msg *model.ClusterMessage) {
	span, _ := tracing.StartSpanWithParentByContext(s.ctx, "app.ClusterClearSessionCacheForAllUsersHandler")

	span.SetTag("msg", msg)

	defer span.Finish()

	s.app.ClusterClearSessionCacheForAllUsersHandler(msg)
}

func (s *OpenTracingAppLayer) ClusterClearSessionCacheForUserHandler(msg *model.ClusterMessage) {
	span, _ := tracing.StartSpanWithParentByContext(s.ctx, "app.ClusterClearSessionCacheForUserHandler")

	span.SetTag("msg", msg)

	defer span.Finish()

	s.app.ClusterClearSessionCacheForUserHandler(msg)
}

func (s *OpenTracingAppLayer) ClusterInstallPluginHandler(msg *model.ClusterMessage) {
	span, _ := tracing.StartSpanWithParentByContext(s.ctx, "app.ClusterInstallPluginHandler")

	span.SetTag("msg", msg)

	defer span.Finish()

	s.app.ClusterInstallPluginHandler(msg)
}

func (s *OpenTracingAppLayer) ClusterInvalidateAllCachesHandler(msg *model.ClusterMessage) {
	span, _ := tracing.StartSpanWithParentByContext(s.ctx, "app.ClusterInvalidateAllCachesHandler")

	span.SetTag("msg", msg)

	defer span.Finish()

	s.app.ClusterInvalidateAllCachesHandler(msg)
}

func (s *OpenTracingAppLayer) ClusterInvalidateCacheForChannelByNameHandler(msg *model.ClusterMessage) {
	span, _ := tracing.StartSpanWithParentByContext(s.ctx, "app.ClusterInvalidateCacheForChannelByNameHandler")

	span.SetTag("msg", msg)

	defer span.Finish()

	s.app.ClusterInvalidateCacheForChannelByNameHandler(msg)
}

func (s *OpenTracingAppLayer) ClusterInvalidateCacheForChannelMembersNotifyPropHandler(msg *model.ClusterMessage) {
	span, _ := tracing.StartSpanWithParentByContext(s.ctx, "app.ClusterInvalidateCacheForChannelMembersNotifyPropHandler")

	span.SetTag("msg", msg)

	defer span.Finish()

	s.app.ClusterInvalidateCacheForChannelMembersNotifyPropHandler(msg)
}

func (s *OpenTracingAppLayer) ClusterInvalidateCacheForUserHandler(msg *model.ClusterMessage) {
	span, _ := tracing.StartSpanWithParentByContext(s.ctx, "app.ClusterInvalidateCacheForUserHandler")

	span.SetTag("msg", msg)

	defer span.Finish()

	s.app.ClusterInvalidateCacheForUserHandler(msg)
}

func (s *OpenTracingAppLayer) ClusterInvalidateCacheForUserTeamsHandler(msg *model.ClusterMessage) {
	span, _ := tracing.StartSpanWithParentByContext(s.ctx, "app.ClusterInvalidateCacheForUserTeamsHandler")

	span.SetTag("msg", msg)

	defer span.Finish()

	s.app.ClusterInvalidateCacheForUserTeamsHandler(msg)
}

func (s *OpenTracingAppLayer) ClusterPublishHandler(msg *model.ClusterMessage) {
	span, _ := tracing.StartSpanWithParentByContext(s.ctx, "app.ClusterPublishHandler")

	span.SetTag("msg", msg)

	defer span.Finish()

	s.app.ClusterPublishHandler(msg)
}

func (s *OpenTracingAppLayer) ClusterRemovePluginHandler(msg *model.ClusterMessage) {
	span, _ := tracing.StartSpanWithParentByContext(s.ctx, "app.ClusterRemovePluginHandler")

	span.SetTag("msg", msg)

	defer span.Finish()

	s.app.ClusterRemovePluginHandler(msg)
}

func (s *OpenTracingAppLayer) ClusterUpdateStatusHandler(msg *model.ClusterMessage) {
	span, _ := tracing.StartSpanWithParentByContext(s.ctx, "app.ClusterUpdateStatusHandler")

	span.SetTag("msg", msg)

	defer span.Finish()

	s.app.ClusterUpdateStatusHandler(msg)
}
...
func (s *OpenTracingAppLayer) ImportAttachment(data *AttachmentImportData, post *model.Post, teamId string, dryRun bool) (*model.FileInfo, *model.AppError) {
	span, _ := tracing.StartSpanWithParentByContext(s.ctx, "app.ImportAttachment")
	...
	return s.app.ImportAttachment(data, post, teamId, dryRun)
}

func (s *OpenTracingAppLayer) ImportChannel(data *ChannelImportData, dryRun bool) *model.AppError {
	span, _ := tracing.StartSpanWithParentByContext(s.ctx, "app.ImportChannel")
	...
	return s.app.ImportChannel(data, dryRun)
}
...
func (s *OpenTracingAppLayer) ImportPost(data *PostImportData, dryRun bool) *model.AppError {
	span, _ := tracing.StartSpanWithParentByContext(s.ctx, "app.ImportPost")
	...
	return s.app.ImportPost(data, dryRun)
}

func (s *OpenTracingAppLayer) ImportReaction(data *ReactionImportData, post *model.Post, dryRun bool) *model.AppError {
	span, _ := tracing.StartSpanWithParentByContext(s.ctx, "app.ImportReaction")
	...
	return s.app.ImportReaction(data, post, dryRun)
}

func (s *OpenTracingAppLayer) ImportReply(data *ReplyImportData, post *model.Post, teamId string, dryRun bool) *model.AppError {
	span, _ := tracing.StartSpanWithParentByContext(s.ctx, "app.ImportReply")
	...
	return s.app.ImportReply(data, post, teamId, dryRun)
}

func (s *OpenTracingAppLayer) ImportRole(data *RoleImportData, dryRun bool, isSchemeRole bool) *model.AppError {
	span, _ := tracing.StartSpanWithParentByContext(s.ctx, "app.ImportRole")

	span.SetTag("data", data)

	span.SetTag("dryRun", dryRun)

	span.SetTag("isSchemeRole", isSchemeRole)

	defer span.Finish()

	return s.app.ImportRole(data, dryRun, isSchemeRole)
}

func (s *OpenTracingAppLayer) ImportScheme(data *SchemeImportData, dryRun bool) *model.AppError {
	span, _ := tracing.StartSpanWithParentByContext(s.ctx, "app.ImportScheme")
	...
	return s.app.ImportScheme(data, dryRun)
}

func (s *OpenTracingAppLayer) ImportTeam(data *TeamImportData, dryRun bool) *model.AppError {
	span, _ := tracing.StartSpanWithParentByContext(s.ctx, "app.ImportTeam")
	...
	return s.app.ImportTeam(data, dryRun)
}

func (s *OpenTracingAppLayer) ImportUser(data *UserImportData, dryRun bool) *model.AppError {
	span, _ := tracing.StartSpanWithParentByContext(s.ctx, "app.ImportUser")
	...
	return s.app.ImportUser(data, dryRun)
}

func (s *OpenTracingAppLayer) ImportUserChannels(user *model.User, team *model.Team, teamMember *model.TeamMember, data *[]UserChannelImportData) *model.AppError {
	span, _ := tracing.StartSpanWithParentByContext(s.ctx, "app.ImportUserChannels")
	...
	return s.app.ImportUserChannels(user, team, teamMember, data)
}

func (s *OpenTracingAppLayer) ImportUserTeams(user *model.User, data *[]UserTeamImportData) *model.AppError {
	span, _ := tracing.StartSpanWithParentByContext(s.ctx, "app.ImportUserTeams")
	...
	return s.app.ImportUserTeams(user, data)
}
...
func (s *OpenTracingAppLayer) RegisterAllClusterMessageHandlers() {
	span, _ := tracing.StartSpanWithParentByContext(s.ctx, "app.RegisterAllClusterMessageHandlers")

	defer span.Finish()

	s.app.RegisterAllClusterMessageHandlers()
}
