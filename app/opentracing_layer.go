...
func (a *OpenTracingAppLayer) GetDynamicListArgument(commandArgs *model.CommandArgs, fetchURL string, parsed string, toBeParsed string) ([]model.AutocompleteListItem, error) {
	origCtx := a.ctx
	span, newCtx := tracing.StartSpanWithParentByContext(a.ctx, "app.GetDynamicListArgument")
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.GetDynamicListArgument(commandArgs, fetchURL, parsed, toBeParsed)
