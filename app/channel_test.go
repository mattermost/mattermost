...
func TestMarkChannelsAsViewedPanic(t *testing.T) {
	...
	mockUserStore.On("Get", mock.Anything, "userID").Return(nil, model.NewAppError("SqlUserStore.Get", "app.user.get.app_error", nil, "user_id=userID", http.StatusInternalServerError))
