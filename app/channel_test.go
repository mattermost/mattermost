...
func TestJoinDefaultChannelsTownSquare(t *testing.T) {
	...
	initialNumTownSquareUsers := len(store.Must(th.App.Srv.Store.ChannelMemberHistory().GetUsersInChannelAt(model.GetMillis()+10, townSquareChannelId)).([]*model.ChannelMemberHistory))
	...
	histories := store.Must(th.App.Srv.Store.ChannelMemberHistory().GetUsersInChannelAt(model.GetMillis()+10, townSquareChannelId)).([]*model.ChannelMemberHistory)
...
func TestJoinDefaultChannelsOffTopic(t *testing.T) {
	...
	initialNumTownSquareUsers := len(store.Must(th.App.Srv.Store.ChannelMemberHistory().GetUsersInChannelAt(model.GetMillis()+10, offTopicChannelId)).([]*model.ChannelMemberHistory))
	...
	// there should be a ChannelMemberHistory record for the user
	histories := store.Must(th.App.Srv.Store.ChannelMemberHistory().GetUsersInChannelAt(model.GetMillis()+10, offTopicChannelId)).([]*model.ChannelMemberHistory)
	assert.Len(t, histories, initialNumTownSquareUsers+1)
...
func TestCreateChannelPublic(t *testing.T) {
	...
	// there should be a ChannelMemberHistory record for the user
	histories := store.Must(th.App.Srv.Store.ChannelMemberHistory().GetUsersInChannelAt(model.GetMillis()+10, publicChannel.Id)).([]*model.ChannelMemberHistory)
...
func TestCreateChannelPrivate(t *testing.T) {
	...
	// there should be a ChannelMemberHistory record for the user
	histories := store.Must(th.App.Srv.Store.ChannelMemberHistory().GetUsersInChannelAt(model.GetMillis()+10, privateChannel.Id)).([]*model.ChannelMemberHistory)
	assert.Len(t, histories, 1)
	assert.Equal(t, th.BasicUser.Id, histories[0].UserId)
...
func TestCreateGroupChannel(t *testing.T) {
	...
	if channel, err := th.App.CreateGroupChannel(groupUserIds, th.BasicUser.Id); err != nil {
		...
		histories := store.Must(th.App.Srv.Store.ChannelMemberHistory().GetUsersInChannelAt(model.GetMillis()+10, channel.Id)).([]*model.ChannelMemberHistory)
