...
func TestPermanentDeleteChannel(t *testing.T) {
	...
	channel, err := th.App.CreateChannel(th.Context, &model.Channel{DisplayName: "deletion-test", Name: "deletion-test", Type: model.ChannelOpen, TeamId: th.BasicTeam.Id}, false)
...
func TestCreateChannelPublicCreatesChannelMemberHistoryRecord(t *testing.T) {
	...
	publicChannel := th.createChannel(th.BasicTeam, model.ChannelOpen)
...
func TestCreateChannelPrivateCreatesChannelMemberHistoryRecord(t *testing.T) {
	...
	privateChannel := th.createChannel(th.BasicTeam, model.ChannelPrivate)
...
func TestCreateChannelDisplayNameTrimsWhitespace(t *testing.T) {
	...
	channel, err := th.App.CreateChannel(th.Context, &model.Channel{DisplayName: "  Public 1  ", Name: "public1", Type: model.ChannelOpen, TeamId: th.BasicTeam.Id}, false)
...
func TestUpdateChannelPrivacy(t *testing.T) {
	...
	privateChannel := th.createChannel(th.BasicTeam, model.ChannelPrivate)
	privateChannel.Type = model.ChannelOpen
	...
	assert.Equal(t, publicChannel.Type, model.ChannelOpen)
}
...
func TestAddUserToChannelCreatesChannelMemberHistoryRecord(t *testing.T) {
	...
	channel := th.createChannel(th.BasicTeam, model.ChannelOpen)
...
func TestFillInChannelProps(t *testing.T) {
	...
	channelPublic1, err := th.App.CreateChannel(th.Context, &model.Channel{DisplayName: "Public 1", Name: "public1", Type: model.ChannelOpen, TeamId: th.BasicTeam.Id}, false)
	require.Nil(t, err)
	defer th.App.PermanentDeleteChannel(channelPublic1)

	channelPublic2, err := th.App.CreateChannel(th.Context, &model.Channel{DisplayName: "Public 2", Name: "public2", Type: model.ChannelOpen, TeamId: th.BasicTeam.Id}, false)
	require.Nil(t, err)
	defer th.App.PermanentDeleteChannel(channelPublic2)

	channelPrivate, err := th.App.CreateChannel(th.Context, &model.Channel{DisplayName: "Private", Name: "private", Type: model.ChannelPrivate, TeamId: th.BasicTeam.Id}, false)
	require.Nil(t, err)
	...
	channelOtherTeam, err := th.App.CreateChannel(th.Context, &model.Channel{DisplayName: "Other Team Channel", Name: "other-team", Type: model.ChannelOpen, TeamId: otherTeam.Id}, false)
	require.Nil(t, err)
...
func TestRenameChannel(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			"Rename open channel",
			th.createChannel(th.BasicTeam, model.ChannelOpen),
			false,
			"newchannelname",
			"newchannelname",
			"New Display Name",
...
func TestSearchChannelsForUser(t *testing.T) {
	...
	c1, err := th.App.CreateChannel(th.Context, &model.Channel{DisplayName: "test-dev-1", Name: "test-dev-1", Type: model.ChannelOpen, TeamId: th.BasicTeam.Id}, false)
	require.Nil(t, err)

	c2, err := th.App.CreateChannel(th.Context, &model.Channel{DisplayName: "test-dev-2", Name: "test-dev-2", Type: model.ChannelOpen, TeamId: th.BasicTeam.Id}, false)
	require.Nil(t, err)

	c3, err := th.App.CreateChannel(th.Context, &model.Channel{DisplayName: "dev-3", Name: "dev-3", Type: model.ChannelOpen, TeamId: th.BasicTeam.Id}, false)
	require.Nil(t, err)
