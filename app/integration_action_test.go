...
func TestPostActionInvalidURL(t *testing.T) {
	...
	require.Nil(t, err)
	attachments, ok := post.GetProps()["attachments"].([]*model.SlackAttachment)
	require.True(t, ok)
...
func TestPostAction(t *testing.T) {
	...
	for _, testCase := range testCases {
		t.Run(testCase.Description, func(t *testing.T) {
			...
			attachments2, ok := post2.GetProps()["attachments"].([]*model.SlackAttachment)
			require.True(t, ok)
			...
			attachmentsPlugin, ok := postplugin.GetProps()["attachments"].([]*model.SlackAttachment)
			require.True(t, ok)
			...
			attachmentsSiteURL, ok := postSiteURL.GetProps()["attachments"].([]*model.SlackAttachment)
			require.True(t, ok)
			...
			attachmentsSubpath, ok := postSubpath.GetProps()["attachments"].([]*model.SlackAttachment)
			require.True(t, ok)
...
func TestPostActionProps(t *testing.T) {
	...
	assert.Nil(t, newPost.GetProps()["B"])
	assert.Nil(t, newPost.GetProps()["override_username"])
	assert.Equal(t, "AA", newPost.GetProps()["A"])
	assert.Equal(t, "old_override_icon", newPost.GetProps()["override_icon_url"])
	assert.Equal(t, false, newPost.GetProps()["from_webhook"])
}
