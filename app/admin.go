...
func (a *App) TestEmail(userId string, cfg *model.Config) *model.AppError {
	...
	if err := mailservice.SendMailUsingConfig(user.Email, T("api.admin.test_email.subject"), T("api.admin.test_email.body"), true, cfg, license != nil && *license.Features.Compliance, ""); err != nil {
