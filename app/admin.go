...
func (a *App) TestEmail(userId string, cfg *model.Config) *model.AppError {
	...
	license := a.License()
	if err := mailservice.SendMailUsingConfig(user.Email, T("api.admin.test_email.subject"), T("api.admin.test_email.body"), cfg, license != nil && *license.Features.Compliance, nil); err != nil {
