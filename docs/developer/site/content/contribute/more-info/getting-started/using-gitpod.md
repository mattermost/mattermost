...
1. Create a new workspace for a ticket/issue that you've claimed by going to the {{<newtabref href="https://github.com/mattermost/mattermost-gitpod-config/tree/master" title="mattermost-gitpod-config">}} repository and clicking the "Open in Gitpod" badge.
    ...
    * You can also use the [Gitpod browser extension](https://www.gitpod.io/docs/configure/user-settings/browser-extension) to open up a repository in Gitpod, or manually prefix GitHub repository URLs with `gitpod.io/#`. What the extension does is add a green Gitpod button to repository pages on GitHub, and clicking it spins up a new environment for the repository on Gitpod.
    ![mattermost-gitpod-config-repo](/img/gitpod/config-repo.jpeg)
...
![mattermost-gitpod-intro](/img/gitpod/intro.jpeg)
...
![mattermost-gitpod-new-branch](/img/gitpod/new-branch.jpeg)
...
![mattermost-gitpod-branch-name](/img/gitpod/branch-name.jpeg)
...
![mattermost-gitpod-commit-message](/img/gitpod/commit-message.jpeg)
...
![mattermost-gitpod-make-fork](/img/gitpod/make-fork.jpeg)
...
![mattermost-gitpod-sign-into-GitHub](/img/gitpod/sign-into-github.jpeg)
...
![mattermost-gitpod-need-perms](/img/gitpod/need-perms.jpeg)
...
![mattermost-gitpod-open-perms](/img/gitpod/open-perms.jpeg)
...
![mattermost-gitpod-select-perms](/img/gitpod/select-perms.jpeg)
...
![mattermost-gitpod-confirm-perms](/img/gitpod/confirm-perms.jpeg)
...
![mattermost-gitpod-open-fork-on-GitHub](/img/gitpod/open-fork-on-github.jpeg)
...
![mattermost-gitpod-create-PR-on-GitHub](/img/gitpod/create-pr-on-github.jpeg)
 
17. You'll be taken to another page on GitHub called "Open a pull request".
![mattermost-gitpod-PR-creation-page](/img/gitpod/pr-creation-page.jpeg)
...
![mattermost-gitpod-real-PR-1](/img/gitpod/real-pr.jpeg)
