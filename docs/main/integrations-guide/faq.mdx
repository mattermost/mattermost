...
Starting in Mattermost v11.10, Mattermost Blocks are the recommended replacement for [message attachments](https://docs.mattermost.com/developers/integrate/reference/message-attachments/). They are the preferred way to create interactive messages for integrations such as [incoming webhooks](/integrations-guide/incoming-webhooks), plugins, and bot accounts.
...
For payload structure, block types, action handling, migration guidance, and troubleshooting, see the [Mattermost Blocks reference](https://docs.mattermost.com/developers/integrate/reference/mm-blocks/) in the developer documentation.
...
Learn about [forking our open source repositories](https://docs.mattermost.com/developers/integrate/customization/customization/) and [customizing the Mattermost source code](https://docs.mattermost.com/developers/integrate/customization/customization/) for your specific operational needs.
