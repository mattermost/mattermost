...
Learn more about [building custom slash commands](https://docs.mattermost.com/developers/integrate/slash-commands/custom/).
...
A command like `/docs search authentication` queries your documentation system and returns a list of relevant articles rendered using [Mattermost Blocks](https://docs.mattermost.com/developers/integrate/reference/mm-blocks/) with links.
