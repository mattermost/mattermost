...
The API is often used in combination with [bot accounts](https://docs.mattermost.com/developers/integrate/reference/bot-accounts/) to authenticate and interact with Mattermost.
...
Learn more about using the [API and available endpoints](https://docs.mattermost.com/api/).
