...
#### User Interface
 ...
 - Pre-packaged Agents plugin version [2.6.1](https://github.com/mattermost/mattermost-plugin-agents/releases/tag/v2.6.1).
...
#### Administration
 ...
 - Updated golang.org/x/image to v0.45.0 and msgpack fork to cap byte-string allocations to address security vulnerabilities.
