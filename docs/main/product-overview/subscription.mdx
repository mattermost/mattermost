...
- Guests in exactly one active channel are treated as single-channel guests. They don't count toward the primary paid seat count and are free up to a 1:1 ratio with licensed seats.
- Guests in multiple active channels continue to count as activated users for billing purposes.
...
<td>Use <a href="/administration-guide/manage/mmctl-command-line-tool#mmctl-group">mmctl</a> to modify group sync settings for the team/channel.</td>
</tr>
<tr>
...
<td>Use <a href="/administration-guide/manage/mmctl-command-line-tool#mmctl-permissions">mmctl</a> to reset permissions to default.</td>
</tr>
<tr>
