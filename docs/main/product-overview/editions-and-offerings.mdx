...
- [Air-gapped deployment workflows](/deployment-guide/deployment-scenarios/air-gapped-deployment)
...
- [Enterprise-scale search with dedicated indexing and usage resourcing via cluster support](/deployment-guide/scale/enterprise-search).
...
- [High availability support with multi-node database deployment](/deployment-guide/server/high-availability-cluster-based-deployment).
- [Horizontal scaling through cluster-based deployment](/deployment-guide/scale/scaling-for-enterprise).
...
- Extensive integration support via [webhooks, APIs, drivers](https://docs.mattermost.com/developers/integrate/getting-started/), and [third-party extensions](https://mattermost.com/marketplace/).
