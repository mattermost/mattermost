...
The lifecycle for Mattermost server and desktop app Extended Support Releases is as follows:
...
- We strongly recommend reviewing [upgrade best practices](https://docs.mattermost.com/administration-guide/upgrade/prepare-to-upgrade-mattermost.html#upgrade-best-practices) for upgrading, and [important upgrade notes](/administration-guide/upgrade/important-upgrade-notes) for all the versions beyond the current ESR version you have currently installed. See the [Mattermost v9 changelog](https://docs.mattermost.com/product-overview/mattermost-v9-changelog.html) for a list of database, API, and `config.json` updates for all v9.x releases.
...
gantt
    ...
    section Releases
    v10.11 & Desktop App v5.13 Extended Support :crit, :done, 2025-08-16, 2026-08-15
    ...
    v11.9                  :done, 2026-07-16, 2026-10-15
    v11.10                 :active, 2026-08-14, 2026-11-15
    v11.11                 :active, 2026-09-16, 2026-12-15
    v12.0                  :active, 2026-10-16, 2027-01-15
    v12.1                  :active, 2026-11-16, 2027-02-15
    v12.4 & Desktop App v6.5 Extended Support (planned) :crit, 2027-02-16, 2028-02-15
```
...
- 🔴 **Red bars**: Extended Support Releases (ESRs), released every 9 months with 12 months of support
  - v12.4 & Desktop App v6.5 (planned): Expected February 2027. Version number and dates are subject to change until the release is announced.
