...
gantt
    ...
    v12.4 Extended Support (planned) :crit, 2027-02-16, 2028-02-15
```
...
- 🔴 **Red bars**: Extended Support Releases (ESRs), released every 9 months with 12 months of support
  - v12.4 (planned): The first v12 ESR, expected February 2027. Version number and dates are provisional until the release is announced.
