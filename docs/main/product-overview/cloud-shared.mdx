...
Connections to [Active Directory/LDAP](/administration-guide/onboard/ad-ldap) can [optionally be secured with TLS or stunnel](/administration-guide/configure/authentication-configuration-settings#adldap-port).
