...
<style>
  ...
  &#125;
  /* Without explicit widths, `table-layout: fixed` divides columns evenly,
     which starves the long "Feature Category" labels and forces every row
     onto multiple wrapped lines while the edition columns (mostly a short
     checkmark/version string) sit on mostly-empty space. */
  table.mattermost-plans th:first-child, table.mattermost-plans td:first-child &#123;
    width: 28%;
  &#125;
  table.mattermost-plans th:nth-child(2), table.mattermost-plans td:nth-child(2),
  table.mattermost-plans th:nth-child(3), table.mattermost-plans td:nth-child(3),
  table.mattermost-plans th:nth-child(4), table.mattermost-plans td:nth-child(4),
  table.mattermost-plans th:nth-child(5), table.mattermost-plans td:nth-child(5),
  table.mattermost-plans th:nth-child(6), table.mattermost-plans td:nth-child(6) &#123;
    width: 10%;
    text-align: center;
  &#125;
  table.mattermost-plans th:last-child, table.mattermost-plans td:last-child &#123;
    width: 22%;
  &#125;
...
<table class="mattermost-plans">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><img src={useBaseUrl('/img/ui/checkmark.svg')} alt="Included" width="16" height="16" /></td><td><img src={useBaseUrl('/img/ui/checkmark.svg')} alt="Included" width="16" height="16" />*</td><td><img src={useBaseUrl('/img/ui/checkmark.svg')} alt="Included" width="16" height="16" /></td><td><img src={useBaseUrl('/img/ui/checkmark.svg')} alt="Included" width="16" height="16" /></td><td><img src={useBaseUrl('/img/ui/checkmark.svg')} alt="Included" width="16" height="16" /></td><td>v9.11+</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td></td><td><img src={useBaseUrl('/img/ui/checkmark.svg')} alt="Included" width="16" height="16" /></td><td></td><td><img src={useBaseUrl('/img/ui/checkmark.svg')} alt="Included" width="16" height="16" /></td><td><img src={useBaseUrl('/img/ui/checkmark.svg')} alt="Included" width="16" height="16" /></td><td>v9.11+</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td></td><td></td><td></td><td><img src={useBaseUrl('/img/ui/checkmark.svg')} alt="Included" width="16" height="16" /></td><td><img src={useBaseUrl('/img/ui/checkmark.svg')} alt="Included" width="16" height="16" /></td><td>v9.11+</td>
    </tr>
    <tr>
    ...
    <tr>
      <td><strong>High availability, horizontally scalable calls and screen share</strong>: Enable <a href="https://docs.mattermost.com/deployment-guide/calls/calls-rtcd-setup.html">high-scale, high availability deployment of audio calling and screen share</a> through dedicated servers managed on an integrated Kubernetes platform.</td>
      <td></td><td></td><td></td><td><img src={useBaseUrl('/img/ui/checkmark.svg')} alt="Included" width="16" height="16" /></td><td><img src={useBaseUrl('/img/ui/checkmark.svg')} alt="Included" width="16" height="16" /></td><td>v9.11+</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td></td><td><img src={useBaseUrl('/img/ui/checkmark.svg')} alt="Included" width="16" height="16" /></td><td></td><td></td><td><img src={useBaseUrl('/img/ui/checkmark.svg')} alt="Included" width="16" height="16" /></td><td>v11.3+</td>
    </tr>
    {/* Workflow automation */}
    ...
    <tr>
      ...
      <td></td><td><img src={useBaseUrl('/img/ui/checkmark.svg')} alt="Included" width="16" height="16" /></td><td></td><td></td><td><img src={useBaseUrl('/img/ui/checkmark.svg')} alt="Included" width="16" height="16" /></td><td>v10.9+</td>
    </tr>
    <tr>
    ...
    <tr>
      <td><strong>Air-gapped deployment workflows</strong>: Specialized deployment workflows and procedures for completely <a href="https://docs.mattermost.com/deployment-guide/deployment-scenarios/air-gapped-deployment.html">disconnected and air-gapped</a> environments with no external network connectivity.</td>
      <td></td><td><img src={useBaseUrl('/img/ui/checkmark.svg')} alt="Included" width="16" height="16" /></td><td></td><td></td><td><img src={useBaseUrl('/img/ui/checkmark.svg')} alt="Included" width="16" height="16" /></td><td>v10.9+</td>
    </tr>
    <tr>
      ...
      <td></td><td><img src={useBaseUrl('/img/ui/checkmark.svg')} alt="Included" width="16" height="16" /></td><td></td><td></td><td><img src={useBaseUrl('/img/ui/checkmark.svg')} alt="Included" width="16" height="16" /></td><td>v11.1+</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td></td><td></td><td><img src={useBaseUrl('/img/ui/checkmark.svg')} alt="Included" width="16" height="16" /></td><td><img src={useBaseUrl('/img/ui/checkmark.svg')} alt="Included" width="16" height="16" /></td><td><img src={useBaseUrl('/img/ui/checkmark.svg')} alt="Included" width="16" height="16" /></td><td>v9.11+</td>
    </tr>
    <tr>
...
Mattermost Enterprise Advanced requires a Mattermost Server running v10.9 or later and a <a href="/deployment-guide/server/prepare-database">PostgreSQL database</a>. Enterprise plugins must be updated to support the new license (most of which are pre-packaged from v10.9).
