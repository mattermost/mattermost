...
- Starting with Mattermost Server v12.0 (October 2026), the ``LocalizationSettings.EnableExperimentalLocales`` configuration setting will be removed and the work-in-progress translation catalogs it exposed. Only the 22 officially supported languages will be selectable. The setting will be ignored if left in an existing ``config.json``.

### Mattermost Mobile App v2.45 (October 2026)

- Starting with Mattermost Mobile App v2.45 (October 2026), the minimum supported mobile operating systems will be iOS v18 and Android v11. Devices running iOS v17 or earlier, or Android v10 or earlier, will no longer receive new versions of the app from the App Store or Google Play; the installed version will continue to work but will not receive further updates, including security fixes. Users should update to iOS v18 or Android v11 or newer before the v2.45 release. See the [forum post](https://forum.mattermost.com/t/deprecation-notice-ios-16-versions/26074) for full details.
