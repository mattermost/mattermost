...
- The minimum supported macOS version is now 15+ and the minimum supported Safari version is now 27+. Earlier versions are no longer supported for the desktop and web apps. See the [software and hardware requirements](/deployment-guide/software-hardware-requirements) documentation for details.
