...
<CardGrid columns={3} cards={[
  {title: 'Install the app', to: '/end-user-guide/access', description: 'Get Mattermost on your laptop and phone.'},
  {title: 'Connect to a workspace', to: '/end-user-guide/access/log-in-and-out', description: 'Sign in for the first time and join your team.'},
