---
title: "Scale Mattermost up to 30,000 users"
---
...
This page describes the Mattermost reference architecture designed for the load of up to 30,000 concurrent users. Unsure which reference architecture to use? See the [scaling for enterprise](/deployment-guide/scale/scaling-for-enterprise) documentation for details.
...
A 30000-person team with medium usage (with a safety factor of 2x) would require between 3TB <sup>1</sup> and 15TB <sup>2</sup> of free space per annum.

<sup>1</sup> 30000 users \* 5 MB \* 12 months \* 2x safety factor

<sup>2</sup> 30000 users \* 25 MB \* 12 months \* 2x safety factor
