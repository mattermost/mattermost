...
---
{/* Snippet include: imported by elasticsearch-setup and opensearch-setup, and
    excluded from the sidebar. Kept as its own page because admin-onboarding-tasks
    deep-links to its "enterprise search limitations" anchor. */}
