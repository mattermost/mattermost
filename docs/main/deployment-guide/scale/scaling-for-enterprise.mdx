...
A [high availability cluster-based deployment](/deployment-guide/scale/high-availability-cluster-based-deployment) enables a Mattermost system to maintain service during outages and hardware failures through the use of redundant infrastructure.
