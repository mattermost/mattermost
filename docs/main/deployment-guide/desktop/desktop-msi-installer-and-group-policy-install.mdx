...
3.  Navigate to the release page for [version v6.3.0](https://github.com/mattermost/desktop/releases/latest) and download the appropriate installer for your version of Windows (32-bit vs. 64-bit).
