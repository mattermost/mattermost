...
2.  Follow the [Mattermost Desktop Development Guide](https://docs.mattermost.com/developers/contribute/more-info/desktop/developer-setup/) to build the application.
