...
Hitting problems with an installation or rollout? See [Desktop app troubleshooting](/deployment-guide/desktop/desktop-troubleshooting), which sits alongside the server and mobile guides under [Troubleshoot deployments](/deployment-guide/deployment-troubleshooting).
