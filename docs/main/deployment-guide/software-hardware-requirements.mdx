...
Please see the [Application architecture](/deployment-guide/application-architecture) documentation for a summary of software systems and components whose requirements are described in this document.
...
<tr>
<td>iOS</td>
<td>Devices with iOS 18.0+</td>
</tr>
<tr>
<td>Android</td>
<td>Android devices with Android 11+</td>
</tr>
</tbody>
</table>
...
<tr>
<td>iOS</td>
<td>iOS 18.0+ with Safari 26.2+ or Chrome 150+</td>
</tr>
<tr>
<td>Android</td>
<td>Android 11+ with Chrome 150+</td>
</tr>
</tbody>
</table>
...
- Ubuntu, Debian Buster, CentOS 6+, CentOS 7+, Red Hat Enterprise Linux 9+, Oracle Linux 6+, Oracle Linux 7+.
...
As of Mattermost Server v12.0 (October 2026), Red Hat Enterprise Linux (RHEL) 7 and RHEL 8 are no longer supported deployment targets. Mattermost v11.11 (September 2026) was the last release to support RHEL 7 and RHEL 8. RHEL 9, Ubuntu 22.04/24.04 LTS, Debian Bookworm, and container-based deployments remain fully supported. If you're running RHEL 7 or RHEL 8, upgrade to RHEL 9 or migrate to another supported platform before upgrading to v12.0. See the [forum post](https://forum.mattermost.com/t/starting-with-mattermost-v12-0-october-2026-rhel-7-and-rhel-8-are-no-longer-supported-deployment-targets/25974) for full details and migration options.
...
Amazon Aurora equivalents of PostgreSQL is also supported. Our [Migration Guide](https://docs.mattermost.com/administration-guide/manage/admin/postgres-migration.html) outlines the steps, tools and support available for migrating from MySQL to PostgreSQL.
...
<tr>
<td><a href="/product-overview/mattermost-v12-changelog#release-v12-0-major-release">v12.0</a></td>
<td>2026-10-16</td>
<td>15.x (EOL 2027-11-11)</td>
</tr>
</tbody>
</table>
...
- If any of the above is an issue, you can [set up and enable enterprise search](/deployment-guide/scale/enterprise-search).
...
In MySQL 8.0.4, the default authentication plugin was changed from `mysql_native_password` to `caching_sha2_password`. If you run into authentication errors while migrating from MySQL to PostgreSQL using `pgloader`, see [Unsupported authentication for MySQL](/administration-guide/manage/admin/postgres-migration#unsupported-authentication-for-mysql).
...
For Enterprise Edition deployments with a multi-server setup, see [our scaling guide](/deployment-guide/scale/scaling-for-enterprise).
...
- Elasticsearch to support highly efficient database searches in a cluster environment. Elasticsearch v8.x and v9.x are supported, and Elasticsearch v9.x or AWS OpenSearch is recommended. As of Mattermost Server v12.0, OpenSearch v2.x is the minimum supported version; OpenSearch v1.x is no longer a supported search backend. [Learn more](/deployment-guide/scale/enterprise-search).
