...
Mattermost documentation can be built and served locally so that installation and configuration guidance is available inside the air-gapped environment. Clone the [mattermost/mattermost repository](https://github.com/mattermost/mattermost) on your internet-connected machine, build the documentation site, and transfer the generated static output across the air gap alongside the rest of your bill of materials.

**Prerequisites**

- Git [\[download\]](https://git-scm.com/downloads)
- Node.js 20 or later [\[download\]](https://nodejs.org/en/download)
