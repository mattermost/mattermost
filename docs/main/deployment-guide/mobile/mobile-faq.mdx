...
Ths **post-proxy relay** [can be configured using the Mattermost Push Proxy installation guide](https://docs.mattermost.com/developers/contribute/more-info/mobile/push-notifications/service/) with connection restrictions to meet your custom security and compliance requirements.
