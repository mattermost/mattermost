...
The following table shows all the configuration options that can be sent from the EMM provider of your choice to the Mattermost mobile apps. You can also [download an XML template](/files/samples/mattermost-specfile.xml) of the configuration file for use with your EMM provider.
...
<table class="mattermost-plans">
  ...
  <tbody>
    <tr>
      ...
      <td><img src="/img/ui/checkmark.svg" alt="Supported" width="16" height="16" /></td>
      <td><img src="/img/ui/checkmark.svg" alt="Supported" width="16" height="16" /></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>Default: <code>false</code><br />Valid: <code>true | false</code></td>
      <td><img src="/img/ui/checkmark.svg" alt="Supported" width="16" height="16" /></td>
      <td><img src="/img/ui/checkmark.svg" alt="Supported" width="16" height="16" /> (since v1.24.0)</td>
    </tr>
    <tr>
