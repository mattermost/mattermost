...
Once you've installed the necessary tools, review the [system requirements and configurations](#system-requirements-and-configurations) documentation, and know what's required [before starting your migration](#before-the-migration) to prepare for your migration.
...
As of `v9.0` Boards will transition to being fully community supported as the Focalboard plugin. Hence this guide covers only version `v7.10.x` of the schema. [Official announcement](/product-overview/deprecated-features#mattermost-server-v9-0-0).
