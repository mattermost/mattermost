...
For instructions on deploying Prometheus and Grafana for Mattermost, please refer to the [Deploy Prometheus and Grafana for Performance Monitoring](/deployment-guide/scale/deploy-prometheus-grafana-for-performance-monitoring) guide.
