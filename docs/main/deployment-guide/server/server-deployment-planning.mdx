...
- [Migrate to FIPS-compliant images](/deployment-guide/server/fips-migration) - Switch an existing Docker or Kubernetes deployment to the FIPS-compliant Mattermost images.
...
<thead>
<tr>
<th scope="col">Mattermost Version</th>
<th scope="col">Release Date</th>
<th scope="col">Minimum PostgreSQL Version</th>
</tr>
</thead>
<tbody>
<tr>
