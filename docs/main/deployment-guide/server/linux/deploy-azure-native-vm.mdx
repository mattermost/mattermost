...
- For sizing guidance and reference architectures, see [high-availability-cluster-based-deployment](/deployment-guide/scale/high-availability-cluster-based-deployment) and [server architecture](/deployment-guide/scale/server-architecture).
