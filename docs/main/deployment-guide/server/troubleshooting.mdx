...
- [PostgreSQL installation troubleshooting](/deployment-guide/server/trouble-postgres) and [MySQL installation troubleshooting](/deployment-guide/server/trouble_mysql), alongside the database setup steps under **Prepare**.
- [Docker deployment troubleshooting](/deployment-guide/server/docker-troubleshooting), alongside the container deployment steps under **Deploy the Server**.
