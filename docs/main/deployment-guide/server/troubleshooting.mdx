...
With the flag enabled, configuration changes that introduce such a path are also rejected, and System Console configuration saves return an error instead of saving.
