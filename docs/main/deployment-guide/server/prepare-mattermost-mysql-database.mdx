...
<Tabs>
<TabItem value="upgrade-to-v7-1" label="Upgrade to v7.1">
...
<TabItem value="upgrade-to-v7-0" label="Upgrade to v7.0">
...
<TabItem value="upgrade-to-v6-7" label="Upgrade to v6.7">
...
<TabItem value="v6-0-database-schema-migrations" label="v6.0 database schema migrations">
