...
- **Protect breach-sensitive notifications** using [ID-only push alerts](/administration-guide/configure/push-notification-server-configuration-settings#id-only-push-notifications) and enhanced mobile security, enabling secure communication without cloud exposure.
