...
- **Ensure secure mobile access on managed or BYOD devices** with [mobile security features](/deployment-guide/mobile/mobile-security-features), Zero Trust enforcement, and [ID-only push notifications](/administration-guide/configure/environment-configuration-settings#id-only-push-notifications) for sensitive alerts.
...
- **Protect data at rest and in motion** using encrypted mobile storage, [secure sandboxing](/deployment-guide/mobile/mobile-security-features#mobile-data-isolation), and [ID-only push notifications](/administration-guide/configure/environment-configuration-settings#id-only-push-notifications) that never expose message content to third-party cloud services.
