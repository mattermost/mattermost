...
- **Ensure communication continuity** during outages using [high availability architecture](/deployment-guide/scale/high-availability-cluster-based-deployment) and [support for disconnected environments](/deployment-guide/deployment-scenarios/air-gapped-deployment).
