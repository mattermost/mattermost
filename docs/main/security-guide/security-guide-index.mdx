...
System administrators can remotely [revoke user sessions](/end-user-guide/preferences/manage-your-security-preferences) across web, mobile devices, and desktop apps. User passwords can be remotely [reset](/administration-guide/configure/user-management-configuration-settings#reset-user-s-password) to enhance security.
