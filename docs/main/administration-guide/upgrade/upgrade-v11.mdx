...
- Confirm the source version is within the supported upgrade matrix. See [Important Upgrade Notes](/administration-guide/upgrade/important-upgrade-notes) for non-sequential upgrade paths.
