...
unlisted: true
---
{/* Snippet include: imported by every SAML identity provider page, and excluded from the sidebar. */}
...
4.  Set the rest of the AD/LDAP settings based on [configuration settings documentation](/administration-guide/configure/authentication-configuration-settings#adldap) to connect Mattermost with your AD/LDAP server.
