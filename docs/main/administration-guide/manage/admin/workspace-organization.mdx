...
Where a channel should exist only for the life of a run, [playbooks](/end-user-guide/workflow-automation/learn-about-playbooks) can create and archive channels automatically. Configure a channel name template on the playbook so each [run](/end-user-guide/workflow-automation/work-with-playbooks#actions) starts with a consistently named channel, which removes much of the cleanup burden for incident and project channels.
