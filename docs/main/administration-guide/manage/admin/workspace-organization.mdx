...
|---|---|---|
| **None** | A single team. [Channel types](/end-user-guide/collaborate/channel-types) and [access controls](/administration-guide/manage/admin/user-management) manage access to information within it, so one team doesn't mean everyone sees everything. | `Acme Company` |
...
- Two distinct populations — such as a red team and blue team, or two separately compartmented program offices — must remain mutually invisible to preserve operational integrity.
