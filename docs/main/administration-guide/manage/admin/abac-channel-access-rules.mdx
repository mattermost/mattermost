...
From Mattermost v12.1, these rules can also restrict **channel read access** and **channel write access** for the channel. See [Channel read and write access actions](/administration-guide/manage/admin/abac-channel-read-write-access) for what each action covers and how denials appear to users.

For system-wide permission policies that restrict these actions across every channel, see [Permission policies](/administration-guide/manage/admin/abac-system-wide-policies#permission-policies).
