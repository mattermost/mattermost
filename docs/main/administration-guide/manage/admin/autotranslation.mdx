...
1.  Go to **System Console \> Site Configuration \> Localization**.
2.  Set [Enable autotranslation](/administration-guide/configure/site-configuration-settings#enable-autotranslation) to **True**.
...
See the [auto-translation configuration reference](/administration-guide/configure/site-configuration-settings#autotranslation) for all available settings.
