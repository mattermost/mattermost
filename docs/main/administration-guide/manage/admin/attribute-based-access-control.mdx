...
- **Permission policies** (managed by System Admins): Attribute-based restrictions on user actions such as file upload, file download, and burn-on-read message creation. See [Permission policies](/administration-guide/manage/admin/abac-system-wide-policies#permission-policies).
...
- Define [permission policies](/administration-guide/manage/admin/abac-system-wide-policies#permission-policies) that restrict actions such as file upload, file download, and burn-on-read message creation based on user attributes.
