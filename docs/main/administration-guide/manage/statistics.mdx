...
Replica DB Conns  
The number of active connections currently on one or more of [your read replica databases](/deployment-guide/scale/high-availability-cluster-based-deployment#database).
