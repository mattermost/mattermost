...
The total number of posts made by a [bot account](https://docs.mattermost.com/developers/integrate/reference/bot-accounts/) on a certain day in all the teams on your system, including deleted posts and posts made using automation.
