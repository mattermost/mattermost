...
Log in to an instance and store credentials. You can log in with [a personal access token](https://docs.mattermost.com/developers/integrate/reference/personal-access-token) instead of using username/password. See [access tokens](#access-tokens) for details.
