...
For information about sizing database servers, see [hardware-sizing-for-enterprise](../../deployment-guide/software-hardware-requirements#hardware-requirements-for-enterprise-deployments-multi-server).
