...
2.  Download and install the production configuration file:
    ...
    - [Download loki-config.yaml](https://github.com/mattermost/docs/blob/master/source/samples/loki/loki-config.yaml)
...
2.  Download and edit the OpenTelemetry Collector configuration:
    ...
    - [Download otel-collector-config-mattermost.yaml](https://github.com/mattermost/docs/blob/master/source/samples/loki/otel-collector-config-mattermost.yaml)
...
- [Download the Mattermost Loki Logs dashboard JSON](https://github.com/mattermost/docs/blob/master/source/samples/grafana-dashboards/mattermost-loki-logs.json)
...
- [Download otel-collector-config-postgres.yaml](https://github.com/mattermost/docs/blob/master/source/samples/loki/otel-collector-config-postgres.yaml)
