...
2.  Download and install the production configuration file:
    ...
    - [Download loki-config.yaml](/samples/loki/loki-config.yaml)
...
2.  Download and edit the OpenTelemetry Collector configuration:
    ...
    - [Download otel-collector-config-mattermost.yaml](/samples/loki/otel-collector-config-mattermost.yaml)
...
- [Download the Mattermost Loki Logs dashboard JSON](/samples/grafana-dashboards/mattermost-loki-logs.json)
...
- [Download otel-collector-config-postgres.yaml](/samples/loki/otel-collector-config-postgres.yaml)
