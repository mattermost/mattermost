...
- Push proxy can be replaced by the Mattermost [hosted push notification service](/administration-guide/configure/environment-configuration-settings#hosted-push-notifications-service-hpns)).
