...
An optional custom header added to each exported EML file when a [custom customer account type](#global-relay-customer-account) is configured. Leave blank to omit. Both the custom header name and value must be set for the header to be included.
...
The value sent with the custom header when a [custom customer account type](#global-relay-customer-account) is configured. Both the custom header name and value must be set for the header to be included.
