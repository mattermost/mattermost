...
You must be a Mattermost system admin to [upload the plugin](#upload) to your Mattermost self-hosted deployment [enable it](#enable), [create surveys](#create-surveys), and [export survey responses](#export-survey-responses) using the System Console.
