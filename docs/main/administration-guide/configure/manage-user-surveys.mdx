...
When a survey starts, all users receive a direct message from a feedback bot containing the active survey. The survey includes one mandatory scale-based question, and optional text-based questions.
