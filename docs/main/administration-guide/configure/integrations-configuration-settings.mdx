...
Developers building integrations can create webhook tokens for public channels. Trigger words are used to fire new message events to external integrations. For security reasons, outgoing webhooks are only available in public channels. See the [outgoing webhooks](https://docs.mattermost.com/developers/integrate/webhooks/outgoing/) developer documentation to learn about creating webhooks and viewing samples.
...
The number of seconds to wait for external integration HTTP requests before timing out, including [custom slash commands](https://docs.mattermost.com/developers/integrate/slash-commands/custom/), [outgoing webhooks](https://docs.mattermost.com/developers/integrate/webhooks/outgoing/), [interactive messages](https://docs.mattermost.com/developers/integrate/plugins/interactive-messages/), and [interactive dialogs](https://docs.mattermost.com/developers/integrate/plugins/interactive-dialogs/). Increase this value if you have external integrations that can take some time to generate an HTTP response, or experience delayed responses due to latency.
...
<tbody>
<tr>
<td>This feature's <code>config.json</code> setting is <code>"OutgoingIntegrationRequestsTimeout": 30</code>.</td>
</tr>
</tbody>
</table>
...
**False**: **(Default)** Webhooks, slash commands, and OAuth 2.0 apps can only post with the profile picture of the account they were set up with. See [https://docs.mattermost.com/developers/integrate/getting-started/](https://docs.mattermost.com/developers/integrate/getting-started/) for more details.
...
**True**: Users can create [personal access tokens](https://docs.mattermost.com/developers/integrate/reference/personal-access-token/) for integrations in **Profile \> Security**. They can be used to authenticate against the API and give full access to the account.
...
**True**: **(Default for Cloud deployments)** Users can create bot accounts for integrations in **Integrations \> Bot Accounts**. Bot accounts are similar to user accounts except they cannot be used to log in. See [documentation](https://docs.mattermost.com/developers/integrate/reference/bot-accounts/) to learn more.
