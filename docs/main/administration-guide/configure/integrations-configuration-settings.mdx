...
**False**: **(Default)** Webhooks, slash commands, and OAuth 2.0 apps can only post with the profile picture of the account they were set up with. See [https://docs.mattermost.com/developers/integrate/](https://docs.mattermost.com/developers/integrate/) for more details.
