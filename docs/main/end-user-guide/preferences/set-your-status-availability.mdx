...
<tbody>
<tr>
<td><img src={useBaseUrl('/img/ui/online.png')} alt="Online status icon" className="theme-icon" /> Online</td>
<td>
...
<tr>
<td><img src={useBaseUrl('/img/ui/away.png')} alt="Away status icon" className="theme-icon" /> Away</td>
<td>
...
<tr>
<td><img src={useBaseUrl('/img/ui/dnd.png')} alt="Do Not Disturb status icon" className="theme-icon" /> Do Not Disturb</td>
<td>
...
<tr>
<td><img src={useBaseUrl('/img/ui/offline.png')} alt="Offline status icon" className="theme-icon" /> Offline</td>
<td>
