...
<tbody>
<tr>
<td rowspan="2"><blockquote><p><strong>Notification Type</strong></p></blockquote><dl><dt>=======================</dt><dd><p>Icon badge (dot)</p><p><img src={useBaseUrl('/images/dot-badge.png')} width="50" alt="A dot on the badge means you have unread activity in at least one channel you&#39;re a member of." /></p></dd></dl></td>
