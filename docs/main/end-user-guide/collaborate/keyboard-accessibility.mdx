...
<tbody>
<tr>
<td>Desktop App: <kbd>F6</kbd><br/>Browser: <kbd>Ctrl</kbd> <kbd>F6</kbd></td>
<td>Move focus to the next section</td>
</tr>
<tr>
<td>Desktop App: <kbd>Shift</kbd> <kbd>F6</kbd><br/>Browser: <kbd>Ctrl</kbd> <kbd>Shift</kbd> <kbd>F6</kbd></td>
