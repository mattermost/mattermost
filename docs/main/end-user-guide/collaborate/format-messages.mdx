...
<tr>
<td colspan="2"><a href="/end-user-guide/collaborate/react-with-emojis-gifs">Add emojis or GIFs</a> | <a href="mm-subst:emoji-icon">emoji-icon</a> |</td>
</tr>
<tr>
<td colspan="2"><a href="/end-user-guide/collaborate/message-priority">Set message priority</a> | <a href="mm-subst:message-priority-icon">message-priority-icon</a></td>
</tr>
</tbody>
</table>
