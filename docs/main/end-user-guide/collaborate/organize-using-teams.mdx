...
How many teams your organization has is a decision your system admin makes. See the [workspace organization](/administration-guide/manage/admin/workspace-organization#choose-a-team-structure) documentation for the trade-offs behind each approach.
