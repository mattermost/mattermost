...
System admin also can enable [personal access tokens](https://docs.mattermost.com/developers/integrate/reference/personal-access-token/) for user accounts. This gives specific users permissions to create personal access tokens via **System Console \> Users**.
