...
Prefixing channel names with emojis is a common way to make related channels easy to spot in a long sidebar. See the [workspace organization](/administration-guide/manage/admin/workspace-organization#channel-naming-conventions) documentation for guidance on applying naming conventions consistently.
...
To describe what a channel is for, beyond what its name conveys, see the [channel purpose and header](/end-user-guide/collaborate/channel-header-purpose) documentation. For guidance on naming channels consistently across your organization, see the [workspace organization](/administration-guide/manage/admin/workspace-organization#channel-naming-conventions) documentation.
