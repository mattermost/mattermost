...
[Create an incoming webhook](/developers/integrate/webhooks/incoming)
...
Outgoing webhooks are supported in public channels only. If you need a trigger that works in a private channel or a direct message, consider using a [slash command](/developers/integrate/slash-commands) instead.
...
[Create an outgoing webhook](/developers/integrate/webhooks/outgoing)
