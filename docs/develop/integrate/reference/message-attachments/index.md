---
title: "Use message attachments"
description: "Message attachments provide rich formatting options for integrations, including bold and italic text, headings, inline images, and tables."
sidebar_label: "Message attachments"
sidebar_position: 40
---
...
`text`: The text to be included in the attachment. It can be formatted using [Markdown](https://docs.mattermost.com/help/messaging/formatting-text.html). For long texts, the message is collapsed and a “Show More” link is added to expand the message. Supports @mentions.
...
`value`: The text value of the field. It can be formatted using [Markdown](https://docs.mattermost.com/help/messaging/formatting-text.html). Supports @mentions.
...
For new interactive content, prefer `props.mm_blocks` and `props.mm_blocks_actions` instead. See [Mattermost Blocks](/developers/integrate/reference/mm-blocks).
...
Yes, you can also use an [incoming webhook](/developers/integrate/webhooks/incoming) to post a message attachment.
