...
func (o *Config) SetDefaults() {
	...
	if o.TeamSettings.TownSquareIsReadOnly == nil {
		o.TeamSettings.TownSquareIsReadOnly = new(bool)
		*o.TeamSettings.TownSquareIsReadOnly = false
	}
