...
// GetTopChannelsForTeamSince will return an ordered list of your top channels in a given team.
func (c *Client4) GetTopChannelsForTeamSince(teamId string, timeRange string, page int, perPage int) ([]*TopChannels, *Response, error) {
