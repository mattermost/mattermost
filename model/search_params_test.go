...
func TestParseSearchParams(t *testing.T) {
	...
	require.Len(t, sp[0].InChannels, 0)
	require.Len(t, sp[0].ExcludedChannels, 0)
	require.Len(t, sp[0].FromUsers, 0)
	require.Len(t, sp[0].ExcludedUsers, 0)
	...
	require.Len(t, sp[0].FromUsers, 0)
	require.Len(t, sp[0].ExcludedUsers, 0)
	require.Len(t, sp[1].InChannels, 0)
	require.Len(t, sp[1].ExcludedChannels, 0)
	require.Len(t, sp[1].FromUsers, 0)
	require.Len(t, sp[1].ExcludedUsers, 0)
