...
func init() {
	...
	SysconsoleAncillaryPermissions = map[string][]*Permission{
		...
		PERMISSION_SYSCONSOLE_READ_BILLING_BILLING_HISTORY.Id: {
			PERMISSION_READ_CLOUD_INVOICES,
		},
		PERMISSION_SYSCONSOLE_READ_BILLING_COMPANY_INFORMATION.Id: {
			PERMISSION_READ_CLOUD_CUSTOMER,
		},
		PERMISSION_SYSCONSOLE_READ_BILLING_PAYMENT_INFORMATION.Id: {
			PERMISSION_READ_CLOUD_CUSTOMER,
		},
		PERMISSION_SYSCONSOLE_WRITE_BILLING_COMPANY_INFORMATION.Id: {
