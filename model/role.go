...
func MakeDefaultRoles() map[string]*Role {
	...
	roles[SYSTEM_USER_MANAGER_ROLE_ID] = &Role{
		...
		Permissions: []string{
			PERMISSION_READ_SYSCONSOLE_USERMANAGEMENT_GROUPS.Id,
			...
			PERMISSION_WRITE_SYSCONSOLE_USERMANAGEMENT_TEAMS.Id,
	...
	roles[SYSTEM_READ_ONLY_ADMIN_ROLE_ID] = &Role{
		...
		Permissions: []string{
			PERMISSION_READ_SYSCONSOLE_ABOUT.Id,
	...
	roles[SYSTEM_MANAGER_ROLE_ID] = &Role{
		...
		Permissions: []string{
			...
			PERMISSION_WRITE_SYSCONSOLE_USERMANAGEMENT_TEAMS.Id,
			PERMISSION_WRITE_SYSCONSOLE_USERMANAGEMENT_CHANNELS.Id,
			PERMISSION_WRITE_SYSCONSOLE_USERMANAGEMENT_PERMISSIONS.Id,
			PERMISSION_READ_SYSCONSOLE_ENVIRONMENT.Id,
	...
	SysconsoleAncillaryPermissions := map[string][]*Permission{
		...
		PERMISSION_READ_SYSCONSOLE_USERMANAGEMENT_USERS.Id: {
		...
		// PERMISSION_READ_SYSCONSOLE_USERMANAGEMENT should have all of the permissions of the
		// PERMISSION_READ_SYSCONSOLE_USERMANAGEMENT_* sub-sections above.
		PERMISSION_READ_SYSCONSOLE_USERMANAGEMENT.Id: {
			PERMISSION_READ_PUBLIC_CHANNEL,
			PERMISSION_READ_CHANNEL,
			PERMISSION_READ_OTHER_USERS_TEAMS,
		...
		// PERMISSION_WRITE_SYSCONSOLE_USERMANAGEMENT should have all of the permissions of the
		// PERMISSION_WRITE_SYSCONSOLE_USERMANAGEMENT_* sub-sections above.
