...
func init() {
	...
	SystemReadOnlyAdminDefaultPermissions = []string{
		...
		PERMISSION_READ_ELASTICSEARCH_POST_INDEXING_JOB.Id,
		PERMISSION_READ_ELASTICSEARCH_POST_AGGREGATION_JOB.Id,
	...
	SystemManagerDefaultPermissions = []string{
		...
		PERMISSION_READ_ELASTICSEARCH_POST_INDEXING_JOB.Id,
		PERMISSION_READ_ELASTICSEARCH_POST_AGGREGATION_JOB.Id,
		PERMISSION_TEST_SITE_URL.Id,
		PERMISSION_RELOAD_CONFIG.Id,
		PERMISSION_INVALIDATE_CACHES.Id,
		PERMISSION_RECYCLE_DATABASE_CONNECTIONS.Id,
		PERMISSION_TEST_ELASTICSEARCH.Id,
		PERMISSION_CREATE_ELASTICSEARCH_POST_INDEXING_JOB.Id,
		PERMISSION_CREATE_ELASTICSEARCH_POST_AGGREGATION_JOB.Id,
		PERMISSION_PURGE_ELASTICSEARCH_INDEXES.Id,
		PERMISSION_TEST_S3.Id,
		PERMISSION_TEST_EMAIL.Id,
		PERMISSION_SYSCONSOLE_READ_SITE.Id,
		PERMISSION_SYSCONSOLE_WRITE_SITE.Id,
		PERMISSION_SYSCONSOLE_READ_AUTHENTICATION.Id,
		PERMISSION_SYSCONSOLE_READ_PLUGINS.Id,
