...
func (z *User) DecodeMsg(dc *msgp.Reader) (err error) {
	...
	z.FirstDayOfWeek, err = dc.ReadInt()
	if err != nil {
		err = msgp.WrapError(err, "FirstDayOfWeek")
		return
	}
	return
}
...
func (z *User) EncodeMsg(en *msgp.Writer) (err error) {
	...
	err = en.WriteInt(z.FirstDayOfWeek)
	if err != nil {
		err = msgp.WrapError(err, "FirstDayOfWeek")
		return
	}
...
func (z *User) MarshalMsg(b []byte) (o []byte, err error) {
	...
	o = msgp.AppendInt(o, z.FirstDayOfWeek)
	return
}
...
func (z *User) UnmarshalMsg(bts []byte) (o []byte, err error) {
	...
	z.FirstDayOfWeek, bts, err = msgp.ReadIntBytes(bts)
	if err != nil {
		err = msgp.WrapError(err, "FirstDayOfWeek")
		return
	}
...
func (z *User) Msgsize() (s int) {
	...
	s += msgp.Int64Size + msgp.BoolSize + msgp.StringPrefixSize + len(z.BotDescription) + msgp.Int64Size + msgp.StringPrefixSize + len(z.TermsOfServiceId) + msgp.Int64Size + msgp.BoolSize + msgp.IntSize
	return
}
