...
func TestSaveReaction(t *testing.T) {
	...
	if err := Client.SaveReaction(channel.Id, &reaction2); err != nil {
		t.Fatal(err)
	}
	...
	if err := Client.SaveReaction(channel.Id, &reaction3); err == nil {
	...
	if err := Client.SaveReaction(channel.Id, &reaction4); err == nil {
	...
	if err := Client.SaveReaction(channel.Id, &reaction5); err == nil {
	...
	if err := Client.SaveReaction(channel.Id, &reaction6); err == nil {
	...
	if err := Client.SaveReaction(channel2.Id, &reaction7); err == nil {
	...
	if err := Client.SaveReaction(directChannel.Id, &reaction8); err != nil {
		t.Fatal(err)
	}
	...
	if err := Client.SaveReaction(channel.Id, &reaction9); err == nil {
...
func TestDeleteReaction(t *testing.T) {
	...
	Client.MustGeneric(nil, Client.SaveReaction(channel.Id, &reaction1))
	...
	Client.MustGeneric(nil, Client.SaveReaction(channel.Id, &reaction1))
	Client.MustGeneric(nil, Client.SaveReaction(channel.Id, &reaction2))
	...
	Client.MustGeneric(nil, Client.SaveReaction(channel.Id, &reaction3))
	...
	Client.MustGeneric(nil, Client.SaveReaction(channel2.Id, &reaction4))
	...
	if err := Client.SaveReaction(channel3.Id, &reaction5); err == nil {
		t.Fatal("should've failed to save reaction to a post that isn't in the given channel")
	}
}
...
func TestListReactions(t *testing.T) {
	...
	for _, reaction := range userReactions {
		Client.MustGeneric(nil, Client.SaveReaction(channel.Id, reaction))
	}
