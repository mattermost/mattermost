...
func TestUpdatePost(t *testing.T) {
	...
	*utils.Cfg.ServiceSettings.AllowEditPost = model.ALLOW_EDIT_POST_ALWAYS
	...
	rpost3, err := app.CreatePost(&model.Post{ChannelId: channel1.Id, Message: "zz" + model.NewId() + "a", Type: model.POST_JOIN_LEAVE, UserId: th.BasicUser.Id}, channel1.TeamId, false)
	if err != nil {
		t.Fatal(err)
	}
