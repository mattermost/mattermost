...
class SuggestionStoreClass extends EventEmitter {
    constructor() {
        super();
    ...
    emitPretextChanged(id) {
        this.emit(PRETEXT_CHANGED_EVENT + id);
    }
    ...
    addSuggestion(id, term, item, type) {
        const suggestion = this.suggestions.get(id);

        suggestion.terms.push(term);
        suggestion.items.push(item);
        suggestion.types.push(type);
    }

    addSuggestions(id, terms, items, type) {
        const suggestion = this.suggestions.get(id);
    ...
    getTypes(id) {
        return this.suggestions.get(id).types;
    }
    ...
    handleEventPayload(payload) {
        ...
        case ActionTypes.SUGGESTION_RECEIVED_SUGGESTIONS:
            ...
            this.addSuggestions(id, other.terms, other.items, other.suggestionType);
...
const SuggestionStore = new SuggestionStoreClass();
