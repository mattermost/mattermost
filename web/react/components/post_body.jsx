...
class PostBody extends React.Component {
    ...
    render() {
        ...
        if (parentPost) {
            ...
            let commentOn = `${formatMessage(messages.commented)} ${name} ${formatMessage(messages.message)} `;
            if (locale === 'es') {
                commentOn = `${formatMessage(messages.commented)} ${formatMessage(messages.message)} ${name}: `;
            }
            comment = (
                <div className='post__link'>
                    <span>
                        `${commentOn} ${formatMessage(messages.message)}:`;
                        <a
                            className='theme'
