...
const messages = defineMessages({
    ...
    importHelp: {
        ...
        defaultMessage: '<p>To import a team from Slack go to Slack > Team Settings > Import/Export Data > Export > Start Export. Slack does not allow you to export files, images, private groups or direct messages stored in Slack. Therefore, Slack import to ZBox Chat only supports importing of text messages in your Slack team\'\s public channels.</p><p>The Slack import to ZBox Chat is in "Beta". Slack bot posts do not yet import and Slack @mentions are not currently supported.</p>'
    }
});
