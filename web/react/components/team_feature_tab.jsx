            ...
            inputs.push(
                <div>
                    <div className='btn-group' data-toggle='buttons-radio'>
                        <button className={'btn btn-default ' + valetActive[0]} onClick={()=> self.handleValetRadio('true')}>On</button>
                        <button className={'btn btn-default ' + valetActive[1]} onClick={()=> self.handleValetRadio('false')}>Off</button>
                    </div>
