...
const messages = defineMessages({
    ...
    failedPwdError: {
        id: 'access_history.failedPwdError',
        defaultMessage: 'failed - tried to update user password who was logged in through oauth'
    },
    updatedRol: {
    ...
    badChannel: {
        id: 'access_history.badChannel',
        defaultMessage: 'fail - bad channel permissions'
    },
    inappropiate: {
        id: 'access_history.inappropiate',
        defaultMessage: 'fail - inappropriate conditions'
    },
    attempt: {
        id: 'access_history.attempt',
        defaultMessage: 'attempt'
    },
    redirectFailed: {
        id: 'access_history.redirectFailed',
        defaultMessage: 'fail - redirect_uri did not match registered callback'
    }
});
...
class AccessHistoryModal extends React.Component {
    ...
    formatAuditInfo(currentAudit) {
        ...
        if (currentActionURL.indexOf('/channels') === 0) {
            ...
            case '/oauth/allow':
                if (oauthInfo[0] === formatMessage(messages.attempt)) {
                ...
                } else if (oauthInfo[0] === formatMessage(messages.redirectFailed)) {
            ...
            switch (currentActionURL) {
            case '/users/login':
                if (userInfo[0] === formatMessage(messages.attempt)) {
            ...
            case '/users/newpassword':
                ...
                } else if (userInfo[0] === formatMessage(messages.failedPwdError)) {
            ...
            case '/hooks/incoming/create':
                if (webhookInfo[0] === formatMessage(messages.attempt)) {
                ...
                } else if (webhookInfo[0] === formatMessage(messages.badChannel)) {
            ...
            case '/hooks/incoming/delete':
                ...
                } else if (webhookInfo[0] === formatMessage(messages.inappropiate)) {
            ...
            if (this.state.moreInfo[i]) {
                if (!currentAudit.session_id) {
                    ...
                    if (currentAudit.action.search('/users/login') >= 0) {
                        if (currentAudit.extra_info === formatMessage(messages.attempt)) {
