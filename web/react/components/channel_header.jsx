...
class ChannelHeader extends React.Component {
    ...
    render() {
        ...
        if (isDirect) {
            ...
            var setHeader = formatMessage(messages.set) + ' ' + channelTerm + formatMessage(messages.description) + '...';
            var setPurpose = formatMessage(messages.set) + ' ' + channelTerm + formatMessage(messages.purpose) + '...';
            if (this.props.intl.locale === 'es') {
                setHeader = formatMessage(messages.set) + formatMessage(messages.description) + ' ' + channelTerm + '...';
