...
const messages = defineMessages({
    ...
    pushDesc: {
        ...
        defaultMessage: 'Typically set to true in production. When true, ZBox Chaht attempts to send iOS and Android push notifications through the push notification server.'
    },
    pushServerTitle: {
                    ...
                    <div className='form-group'>
                        ...
                        <div className='col-sm-8'>
                            <input
                                ...
                                placeholder='E.g.: "https://push.zboxapp.com"'
