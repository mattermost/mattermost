                    ...
                    <div className='form-group'>
                        ...
                        <div className='col-sm-8'>
                            <input
                                ...
                                onChange={this.handleChange}
                            />
                            <p className='help-text'>{'Teams and user acccounts can only be created from a specific domain (e.g. "mattermost.org") or list of comma-separated domains (e.g. "corp.mattermost.com, mattermost.org").'}</p>
                        </div>
                    </div>
