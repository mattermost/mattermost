...
const messages = defineMessages({
    ...
    restrictDescription: {
        ...
        defaultMessage: 'Teams can only be created from a specific domain (e.g. "mattermost.org") or list of comma-separated domains (e.g. "corp.mattermost.com, mattermost.org").'
    },
    saving: {
