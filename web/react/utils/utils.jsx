...
export function applyTheme(theme) {
    ...
    if (theme.centerChannelColor) {
        ...
        changeCss('.search-bar__container .search__form .search-bar, .form-control', 'background: transparent; color:' + theme.centerChannelColor, 1);
        ...
        changeCss('.form-control:focus', 'border-color:' + changeOpacity(theme.centerChannelColor, 0.4), 1);
