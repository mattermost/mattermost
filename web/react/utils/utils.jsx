...
export function applyTheme(theme) {
    ...
    if (theme.centerChannelColor) {
        ...
        changeCss('.post.current--user .post-body, .post.post--comment.other--root.current--user .post-comment, pre', 'background:' + changeOpacity(theme.centerChannelColor, 0.00), 1);
