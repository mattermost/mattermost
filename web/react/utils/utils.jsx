...
export function applyTheme(theme) {
    ...
    if (theme.centerChannelColor) {
        ...
        changeCss('.input-group-addon, .search-bar__container .search__form, .textarea-wrapper, .form-control', 'border-color:' + changeOpacity(theme.centerChannelColor, 0.2), 1);
