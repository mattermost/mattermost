...
export default {
    ...
    HighlightedLanguages: {
        actionscript: {name: 'ActionScript', extensions: ['actionscript', 'as']},
        ...
        erlang: {name: 'Erlang', extensions: ['erlang', 'erl']},
        fortran: {name: 'Fortran', extensions: ['fortran', 'f90', 'f95']},
        ...
        haskell: {name: 'Haskell', extensions: ['haskell', 'hs']},
        haxe: {name: 'Haxe', extensions: ['haxe', 'hx']},
        java: {name: 'Java', extensions: ['java', 'jsp']},
        javascript: {name: 'JavaScript', extensions: ['javascript', 'js', 'jsx']},
        json: {name: 'JSON', extensions: ['json']},
        julia: {name: 'Julia', extensions: ['julia', 'jl']},
        kotlin: {name: 'Kotlin', extensions: ['kotlin', 'kt', 'ktm', 'kts']},
        less: {name: 'Less', extensions: ['less']},
        lisp: {name: 'Lisp', extensions: ['lisp']},
        lua: {name: 'Lua', extensions: ['lua']},
        makefile: {name: 'Makefile', extensions: ['makefile', 'mk', 'mak']},
        markdown: {name: 'Markdown', extensions: ['markdown', 'md', 'mkdown', 'mkd']},
        matlab: {name: 'Matlab', extensions: ['matlab']},
        objectivec: {name: 'Objective C', extensions: ['objectivec', 'mm', 'objc', 'obj-c']},
        ocaml: {name: 'OCaml', extensions: ['ocaml', 'ml']},
        perl: {name: 'Perl', extensions: ['perl', 'pl']},
        php: {name: 'PHP', extensions: ['php', 'php3', 'php4', 'php5', 'php6']},
        powershell: {name: 'PowerShell', extensions: ['powershell', 'ps']},
        puppet: {name: 'Puppet', extensions: ['puppet', 'pp']},
        python: {name: 'Python', extensions: ['python', 'py', 'gyp']},
        r: {name: 'R', extensions: ['r']},
        ruby: {name: 'Ruby', extensions: ['ruby', 'rb', 'gemspec', 'podspec', 'thor', 'irb']},
        rust: {name: 'Rust', extensions: ['rust', 'rs']},
        scala: {name: 'Scala', extensions: ['scala']},
        scheme: {name: 'Scheme', extensions: ['scheme']},
        scss: {name: 'SCSS', extensions: ['scss']},
        smalltalk: {name: 'Smalltalk', extensions: ['smalltalk', 'st']},
        sql: {name: 'SQL', extensions: ['sql']},
        swift: {name: 'Swift', extensions: ['swift']},
        tex: {name: 'TeX', extensions: ['tex']},
        vbnet: {name: 'VB.Net', extensions: ['vbnet', 'vb']},
        vbscript: {name: 'VBScript', extensions: ['vbscript', 'vbs']},
        verilog: {name: 'Verilog', extensions: ['verilog', 'v']},
