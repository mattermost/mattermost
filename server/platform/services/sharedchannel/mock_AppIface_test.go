...
// UpdatePost provides a mock function with given fields: c, post, safeUpdate, updatePostOptions
func (_m *MockAppIface) UpdatePost(c request.CTX, post *model.Post, safeUpdate bool, updatePostOptions *model.UpdatePostOptions) (*model.Post, *model.AppError) {
	ret := _m.Called(c, post, safeUpdate, updatePostOptions)
	...
	var r0 *model.Post
	var r1 *model.AppError
	if rf, ok := ret.Get(0).(func(request.CTX, *model.Post, bool, *model.UpdatePostOptions) (*model.Post, *model.AppError)); ok {
		return rf(c, post, safeUpdate, updatePostOptions)
	}
	if rf, ok := ret.Get(0).(func(request.CTX, *model.Post, bool, *model.UpdatePostOptions) *model.Post); ok {
		r0 = rf(c, post, safeUpdate, updatePostOptions)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*model.Post)
		}
	...
	if rf, ok := ret.Get(1).(func(request.CTX, *model.Post, bool, *model.UpdatePostOptions) *model.AppError); ok {
		r1 = rf(c, post, safeUpdate, updatePostOptions)
	} else {
		if ret.Get(1) != nil {
			r1 = ret.Get(1).(*model.AppError)
		}
