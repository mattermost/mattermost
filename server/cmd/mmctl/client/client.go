...
type Client interface {
	...
	GetPostsSince(ctx context.Context, channelID string, since int64, collapsedThreads bool, until int64, timeType string, perPage int) (*model.PostList, *model.Response, error)
	GetPostsWithCursor(ctx context.Context, channelID string, cursor string, until int64, perPage int, collapsedThreads bool) (*model.PostList, *model.Response, error)
