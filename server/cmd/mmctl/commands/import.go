...
func init() {
	...
	ImportProcessCmd.Flags().Bool("extract-content", true, "If this is set, text attachments will be extracted and indexed during the import process. It is advised to disable it to improve performance.")
