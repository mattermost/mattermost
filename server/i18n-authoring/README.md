...
`make i18n-extract-authoring-check`, which CI runs and which `make i18n-check`
includes, fails if the file is out of date. It compares the ids, the `translation` values and the
