...
// nwaples/rardecode v2.2.0 broke the API of its Reader type, which no longer
// implements the io.WriterTo interface
replace github.com/nwaples/rardecode/v2 => github.com/nwaples/rardecode/v2 v2.1.1
