...
// See MM-63434 for more details. Local replace during development of MM-69725;
// update to a tagged commit once the jgheithcock/pdf MM-69725.pdf branch is merged.
replace github.com/ledongthuc/pdf => /home/alejandro/projects/jgheithcock/pdf
