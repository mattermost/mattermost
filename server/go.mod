...
require (
	...
	github.com/mattermost/mattermost-plugin-ai v1.4.1-0.20251017102756-4704dc7b25de // indirect
...
replace github.com/mattermost-plugin-ai => ../../mattermost-plugin-agents/.worktrees/llm-bridge-cs
