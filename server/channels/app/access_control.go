...
//
// channelID is accepted for API compatibility with team membership evaluation paths, which
// pass an empty string because no channel-scoped role exists at team-join time.
