...
func (a *OpenTracingAppLayer) SystemBus() *systembus.SystemBus {
	origCtx := a.ctx
	span, newCtx := tracing.StartSpanWithParentByContext(a.ctx, "app.SystemBus")
