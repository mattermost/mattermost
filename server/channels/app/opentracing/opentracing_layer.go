...
func (a *OpenTracingAppLayer) ConvertGroupMessageToChannel(c request.CTX, userID string, gmConversionRequest *model.GroupMessageConversionRequestBody) (*model.Channel, *model.AppError) {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.ConvertGroupMessageToChannel(c, userID, gmConversionRequest)
