...
func (a *OpenTracingAppLayer) UpdateChannelBookmark(c request.CTX, updateBookmark *model.ChannelBookmark, connectionId string) ([]*model.ChannelBookmarkWithFileInfo, *model.AppError) {
	origCtx := a.ctx
