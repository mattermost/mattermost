...
func (a *OpenTracingAppLayer) PatchCPAField(id string, patch *model.PropertyFieldPatch) (*model.PropertyField, *model.AppError) {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.PatchCPAField(id, patch)
