...
func (a *OpenTracingAppLayer) CheckPasswordAndAllCriteria(rctx request.CTX, u *model.User, password string, mfaToken string) *model.AppError {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0 := a.app.CheckPasswordAndAllCriteria(rctx, u, password, mfaToken)
