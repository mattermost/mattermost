...
func (a *OpenTracingAppLayer) StartUsersBatchExport(rctx request.CTX, dateRange string) *model.AppError {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0 := a.app.StartUsersBatchExport(rctx, dateRange)
