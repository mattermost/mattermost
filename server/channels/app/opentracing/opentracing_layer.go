...
func (a *OpenTracingAppLayer) SaveComplianceReport(c *request.Context, job *model.Compliance) (*model.Compliance, *model.AppError) {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.SaveComplianceReport(c, job)
