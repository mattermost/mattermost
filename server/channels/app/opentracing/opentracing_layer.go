...
func (a *OpenTracingAppLayer) AddCursorIdsForPostList(originalList *model.PostList, afterPost string, beforePost string, since int64, page int, perPage int, collapsedThreads bool, excludeTypes []string) {
	origCtx := a.ctx
	...
	defer span.Finish()
	a.app.AddCursorIdsForPostList(originalList, afterPost, beforePost, since, page, perPage, collapsedThreads, excludeTypes)
}
...
func (a *OpenTracingAppLayer) GetNextPostIdFromPostList(postList *model.PostList, collapsedThreads bool, excludeTypes []string) string {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0 := a.app.GetNextPostIdFromPostList(postList, collapsedThreads, excludeTypes)
...
func (a *OpenTracingAppLayer) GetPostAfterTime(channelID string, time int64, collapsedThreads bool, excludedTypes []string) (*model.Post, *model.AppError) {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.GetPostAfterTime(channelID, time, collapsedThreads, excludedTypes)
...
func (a *OpenTracingAppLayer) GetPostIdAfterTime(channelID string, time int64, collapsedThreads bool, excludeTypes []string) (string, *model.AppError) {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.GetPostIdAfterTime(channelID, time, collapsedThreads, excludeTypes)
...
func (a *OpenTracingAppLayer) GetPostIdBeforeTime(channelID string, time int64, collapsedThreads bool, excludeTypes []string) (string, *model.AppError) {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.GetPostIdBeforeTime(channelID, time, collapsedThreads, excludeTypes)
...
func (a *OpenTracingAppLayer) GetPostsForChannelAroundLastUnread(c request.CTX, channelID string, userID string, limitBefore int, limitAfter int, skipFetchThreads bool, collapsedThreads bool, collapsedThreadsExtended bool, excludeTypes []string) (*model.PostList, *model.AppError) {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.GetPostsForChannelAroundLastUnread(c, channelID, userID, limitBefore, limitAfter, skipFetchThreads, collapsedThreads, collapsedThreadsExtended, excludeTypes)
...
func (a *OpenTracingAppLayer) GetPrevPostIdFromPostList(postList *model.PostList, collapsedThreads bool, excludeTypes []string) string {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0 := a.app.GetPrevPostIdFromPostList(postList, collapsedThreads, excludeTypes)
