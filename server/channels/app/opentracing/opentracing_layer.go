...
func (a *OpenTracingAppLayer) GetCommandWithToken(commandID string) (*model.Command, *model.AppError) {
	origCtx := a.ctx
	span, newCtx := tracing.StartSpanWithParentByContext(a.ctx, "app.GetCommandWithToken")
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.GetCommandWithToken(commandID)
