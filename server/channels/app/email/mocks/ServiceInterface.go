...
// SendGuestInviteEmails provides a mock function with given fields: rctx, team, channels, senderName, senderUserId, senderProfileImage, invites, siteURL, message, errorWhenNotSent, isSystemAdmin, isFirstAdmin, isGuestMagicLink
func (_m *ServiceInterface) SendGuestInviteEmails(rctx request.CTX, team *model.Team, channels []*model.Channel, senderName string, senderUserId string, senderProfileImage []byte, invites []string, siteURL string, message string, errorWhenNotSent bool, isSystemAdmin bool, isFirstAdmin bool, isGuestMagicLink bool) error {
	ret := _m.Called(rctx, team, channels, senderName, senderUserId, senderProfileImage, invites, siteURL, message, errorWhenNotSent, isSystemAdmin, isFirstAdmin, isGuestMagicLink)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(request.CTX, *model.Team, []*model.Channel, string, string, []byte, []string, string, string, bool, bool, bool, bool) error); ok {
		r0 = rf(rctx, team, channels, senderName, senderUserId, senderProfileImage, invites, siteURL, message, errorWhenNotSent, isSystemAdmin, isFirstAdmin, isGuestMagicLink)
	} else {
		r0 = ret.Error(0)
	}
...
// SendInviteEmails provides a mock function with given fields: rctx, team, senderName, senderUserId, invites, profiles, siteURL, reminderData, errorWhenNotSent, isSystemAdmin, isFirstAdmin
func (_m *ServiceInterface) SendInviteEmails(rctx request.CTX, team *model.Team, senderName string, senderUserId string, invites []string, profiles map[string]*model.MemberInviteProfile, siteURL string, reminderData *model.TeamInviteReminderData, errorWhenNotSent bool, isSystemAdmin bool, isFirstAdmin bool) error {
	ret := _m.Called(rctx, team, senderName, senderUserId, invites, profiles, siteURL, reminderData, errorWhenNotSent, isSystemAdmin, isFirstAdmin)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(request.CTX, *model.Team, string, string, []string, map[string]*model.MemberInviteProfile, string, *model.TeamInviteReminderData, bool, bool, bool) error); ok {
		r0 = rf(rctx, team, senderName, senderUserId, invites, profiles, siteURL, reminderData, errorWhenNotSent, isSystemAdmin, isFirstAdmin)
	} else {
		r0 = ret.Error(0)
	}
...
// SendInviteEmailsToTeamAndChannels provides a mock function with given fields: rctx, team, channels, senderName, senderUserId, senderProfileImage, invites, profiles, siteURL, reminderData, message, errorWhenNotSent, isSystemAdmin, isFirstAdmin
func (_m *ServiceInterface) SendInviteEmailsToTeamAndChannels(rctx request.CTX, team *model.Team, channels []*model.Channel, senderName string, senderUserId string, senderProfileImage []byte, invites []string, profiles map[string]*model.MemberInviteProfile, siteURL string, reminderData *model.TeamInviteReminderData, message string, errorWhenNotSent bool, isSystemAdmin bool, isFirstAdmin bool) ([]*model.EmailInviteWithError, error) {
	ret := _m.Called(rctx, team, channels, senderName, senderUserId, senderProfileImage, invites, profiles, siteURL, reminderData, message, errorWhenNotSent, isSystemAdmin, isFirstAdmin)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(request.CTX, *model.Team, []*model.Channel, string, string, []byte, []string, map[string]*model.MemberInviteProfile, string, *model.TeamInviteReminderData, string, bool, bool, bool) ([]*model.EmailInviteWithError, error)); ok {
		return rf(rctx, team, channels, senderName, senderUserId, senderProfileImage, invites, profiles, siteURL, reminderData, message, errorWhenNotSent, isSystemAdmin, isFirstAdmin)
	}
	if rf, ok := ret.Get(0).(func(request.CTX, *model.Team, []*model.Channel, string, string, []byte, []string, map[string]*model.MemberInviteProfile, string, *model.TeamInviteReminderData, string, bool, bool, bool) []*model.EmailInviteWithError); ok {
		r0 = rf(rctx, team, channels, senderName, senderUserId, senderProfileImage, invites, profiles, siteURL, reminderData, message, errorWhenNotSent, isSystemAdmin, isFirstAdmin)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(request.CTX, *model.Team, []*model.Channel, string, string, []byte, []string, map[string]*model.MemberInviteProfile, string, *model.TeamInviteReminderData, string, bool, bool, bool) error); ok {
		r1 = rf(rctx, team, channels, senderName, senderUserId, senderProfileImage, invites, profiles, siteURL, reminderData, message, errorWhenNotSent, isSystemAdmin, isFirstAdmin)
	} else {
		r1 = ret.Error(1)
	}
