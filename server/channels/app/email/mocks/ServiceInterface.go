...
// SendLicenseUpForRenewalEmail provides a mock function with given fields: _a0, name, locale, ctaTitle, ctaLink, ctaText, daysToExpiration
func (_m *ServiceInterface) SendLicenseUpForRenewalEmail(_a0 string, name string, locale string, ctaTitle string, ctaLink string, ctaText string, daysToExpiration int) error {
	ret := _m.Called(_a0, name, locale, ctaTitle, ctaLink, ctaText, daysToExpiration)
	...
	if rf, ok := ret.Get(0).(func(string, string, string, string, string, string, int) error); ok {
		r0 = rf(_a0, name, locale, ctaTitle, ctaLink, ctaText, daysToExpiration)
	} else {
		r0 = ret.Error(0)
	}
...
// SendRemoveExpiredLicenseEmail provides a mock function with given fields: ctaText, ctaLink, _a2, locale
func (_m *ServiceInterface) SendRemoveExpiredLicenseEmail(ctaText string, ctaLink string, _a2 string, locale string) error {
	ret := _m.Called(ctaText, ctaLink, _a2, locale)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(string, string, string, string) error); ok {
		r0 = rf(ctaText, ctaLink, _a2, locale)
	} else {
		r0 = ret.Error(0)
	}
