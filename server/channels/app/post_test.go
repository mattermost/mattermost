...
func TestCollapsedThreadFetch(t *testing.T) {
	...
	t.Run("should only return root posts, enriched", func(t *testing.T) {
		...
		l, err := th.App.GetPostsForChannelAroundLastUnread(th.Context, channel.Id, user1.Id, 10, 10, true, true, false, nil)
		require.Nil(t, err)
		...
		// try extended fetch
		l, err = th.App.GetPostsForChannelAroundLastUnread(th.Context, channel.Id, user1.Id, 10, 10, true, true, true, nil)
		require.Nil(t, err)
		require.Len(t, l.Order, 1)
