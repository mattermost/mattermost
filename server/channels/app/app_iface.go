...
type AppIface interface {
	...
	Config() *model.Config
	ConvertGroupMessageToChannel(c request.CTX, convertedBy string, gmConversionRequest *model.GroupMessageConversionRequestBody) (*model.Channel, *model.AppError)
