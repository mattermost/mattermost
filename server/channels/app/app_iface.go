...
type AppIface interface {
	...
	AddCursorIdsForPostList(originalList *model.PostList, afterPost, beforePost string, since int64, page, perPage int, collapsedThreads bool, excludePostTypes []string)
	...
	GetNextPostIdFromPostList(postList *model.PostList, collapsedThreads bool, excludePostTypes []string) string
	...
	GetPostAfterTime(channelID string, time int64, collapsedThreads bool, excludePostTypes []string) (*model.Post, *model.AppError)
	GetPostIdAfterTime(channelID string, time int64, collapsedThreads bool, excludePostTypes []string) (string, *model.AppError)
	GetPostIdBeforeTime(channelID string, time int64, collapsedThreads bool, excludePostTypes []string) (string, *model.AppError)
	...
	GetPostsForChannelAroundLastUnread(c request.CTX, channelID, userID string, limitBefore, limitAfter int, skipFetchThreads bool, collapsedThreads, collapsedThreadsExtended bool, excludePostTypes []string) (*model.PostList, *model.AppError)
	...
	GetPrevPostIdFromPostList(postList *model.PostList, collapsedThreads bool, excludePostTypes []string) string
	...
	PostUpdateChannelPostExcludeMessage(c request.CTX, userID string, channel *model.Channel, oldChannelExcluded []string, newChannelExcluded []string) *model.AppError
