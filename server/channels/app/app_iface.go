...
type AppIface interface {
	...
	GetChannelNewPinnedPosts(c request.CTX, channelID string, userID string) ([]*model.Post, *model.AppError)
	...
	UpdateChannelMemberLastViewedPinnedPostAt(c request.CTX, channelID string, userID string, lastViewedPinnedPostAt int64) (*model.ChannelMember, *model.AppError)
