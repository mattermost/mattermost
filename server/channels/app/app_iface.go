...
type AppIface interface {
	...
	AuthenticateDesktopToken(token string, user *model.User) *model.AppError
	...
	CreateDesktopToken(token string) *model.AppError
	...
	ValidateDesktopToken(token string) (*model.User, *model.AppError)
