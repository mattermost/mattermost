...
func TestAssignFlaggedPostReviewer(t *testing.T) {
	...
	t.Run("should successfully assign reviewer to pending flagged post", func(t *testing.T) {
		...
		reviewerValues, err := th.Server.propertyAccessService.SearchPropertyValues("", groupId, model.PropertyValueSearchOpts{
	...
	t.Run("should allow assigning reviewer at all stages", func(t *testing.T) {
		...
		_, err := th.App.PropertyAccessService().UpdatePropertyValue("", groupId, statusValue)
		require.NoError(t, err)
...
func TestCanFlagPost(t *testing.T) {
	...
	t.Run("should not be able to flag post which has already been flagged", func(t *testing.T) {
		...
		statusField, err := th.Server.propertyAccessService.GetPropertyFieldByName("", groupId, "", ContentFlaggingPropertyNameStatus)
		require.NoError(t, err)

		propertyValue, err := th.Server.propertyAccessService.CreatePropertyValue("", &model.PropertyValue{
			TargetID:   post.Id,
			GroupID:    groupId,
		...
		_, err = th.Server.propertyAccessService.UpdatePropertyValue("", groupId, propertyValue)
		require.NoError(t, err)
...
func TestFlagPost(t *testing.T) {
	...
	t.Run("should successfully flag a post with valid data", func(t *testing.T) {
		...
		statusValues, err := th.Server.propertyAccessService.SearchPropertyValues("", groupId, model.PropertyValueSearchOpts{
			TargetIDs: []string{post.Id},
			PerPage:   CONTENT_FLAGGING_MAX_PROPERTY_VALUES,
		...
		userValues, err := th.Server.propertyAccessService.SearchPropertyValues("", groupId, model.PropertyValueSearchOpts{
			TargetIDs: []string{post.Id},
			PerPage:   CONTENT_FLAGGING_MAX_PROPERTY_VALUES,
		...
		reasonValues, err := th.Server.propertyAccessService.SearchPropertyValues("", groupId, model.PropertyValueSearchOpts{
			TargetIDs: []string{post.Id},
			PerPage:   CONTENT_FLAGGING_MAX_PROPERTY_VALUES,
		...
		commentValues, err := th.Server.propertyAccessService.SearchPropertyValues("", groupId, model.PropertyValueSearchOpts{
			TargetIDs: []string{post.Id},
			PerPage:   CONTENT_FLAGGING_MAX_PROPERTY_VALUES,
	...
	t.Run("should set reporting time property", func(t *testing.T) {
		...
		timeValues, err := th.Server.propertyAccessService.SearchPropertyValues("", groupId, model.PropertyValueSearchOpts{
			TargetIDs: []string{post.Id},
			PerPage:   CONTENT_FLAGGING_MAX_PROPERTY_VALUES,
...
func TestPermanentDeleteFlaggedPost(t *testing.T) {
	...
	t.Run("should successfully permanently delete pending flagged post", func(t *testing.T) {
		...
		actorValues, err := th.Server.propertyAccessService.SearchPropertyValues("", groupId, model.PropertyValueSearchOpts{
			TargetIDs: []string{post.Id},
			PerPage:   CONTENT_FLAGGING_MAX_PROPERTY_VALUES,
