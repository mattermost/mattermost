...
func TestGetChannelMembersTimezones(t *testing.T) {
	...
	user3 := model.User{Email: strings.ToLower(model.NewId()) + "success+test@example.com", Nickname: "Darth Vader", Username: "vader" + model.NewId(), Password: model.NewRandomPassword(), AuthService: ""}
	...
	user4 := model.User{Email: strings.ToLower(model.NewId()) + "success+test@example.com", Nickname: "Darth Vader", Username: "vader" + model.NewId(), Password: model.NewRandomPassword(), AuthService: ""}
