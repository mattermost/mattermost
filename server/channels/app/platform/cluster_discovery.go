...
func (cds *ClusterDiscoveryService) Start() {
	...
	go func() {
		mlog.Debug("ClusterDiscoveryService ping writer started", mlog.String("cluster_discovery_id", cds.ClusterDiscovery.Id))
		...
		defer func() {
			...
			mlog.Debug("ClusterDiscoveryService ping writer stopped", mlog.String("cluster_discovery_id", cds.ClusterDiscovery.Id))
		}()
