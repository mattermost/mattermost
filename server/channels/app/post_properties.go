...
type PostPropertyChangeListener func(postId, userID, groupID string, oldProperties, newProperties map[string]json.RawMessage)
...
func contentFlaggingPostPropertyChangeListener(postId, userID, groupID string, oldProperties, newProperties map[string]json.RawMessage) {
	// no-op
}
