...
func (a *App) GetOAuthAccessTokenForCodeFlow(rctx request.CTX, clientId, grantType, redirectURI, code, secret, refreshToken, codeVerifier string) (*model.AccessResponse, *model.AppError) {
	...
	return a.handleRefreshTokenGrant(rctx, oauthApp, refreshToken, clientId)
}
...
func (a *App) handleRefreshTokenGrant(rctx request.CTX, oauthApp *model.OAuthApp, refreshToken, clientId string) (*model.AccessResponse, *model.AppError) {
