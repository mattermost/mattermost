...
func (a *App) GetCPAField(fieldID string) (*model.PropertyField, *model.AppError) {
	...
	field, err := a.Srv().propertyService.GetPropertyField(fieldID, groupID)
	if err != nil {
...
func (a *App) DeleteCPAField(id string) *model.AppError {
	...
	if err := a.Srv().propertyService.DeletePropertyField(id, groupID); err != nil {
		var nfErr *store.ErrNotFound
		switch {
		case errors.As(err, &nfErr):
...
func (a *App) GetCPAValue(valueID string) (*model.PropertyValue, *model.AppError) {
	...
	value, err := a.Srv().propertyService.GetPropertyValue(valueID, groupID)
	if err != nil {
