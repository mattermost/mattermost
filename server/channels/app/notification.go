...
func (m *ExplicitMentions) processText2(text string, pattern *regexp.Regexp, keywords map[string][]string, groups map[string]*model.Group) {
	// b := []byte(text)
...
func (m *ExplicitMentions) processText3(text string, pattern *regexp.Regexp, keywords map[string][]string, groups map[string]*model.Group) {
	b := []byte(text)
	index := suffixarray.New(b)
