...
func (a *App) sendNtfyPush(msg *model.PushNotification) error {
	...
	// Map Mattermost priority to ntfy priority
	switch msg.Priority {
	case model.PushPriorityMax:
		req.Header.Set("Priority", "urgent")
	case model.PushPriorityHigh:
		req.Header.Set("Priority", "high")
	case model.PushPriorityNormal:
		// Default in ntfy, no need to set
	case model.PushPriorityLow:
		req.Header.Set("Priority", "low")
	case model.PushPriorityMin:
