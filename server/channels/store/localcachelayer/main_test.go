...
func getMockStore(t *testing.T) *mocks.Store {
	...
	mockPostStore.On("GetEtag", "channelId", "userId", true, false).Return(mockPostStoreEtagResult)
	mockPostStore.On("GetEtag", "channelId", "userId", false, false).Return(mockPostStoreEtagResult)
