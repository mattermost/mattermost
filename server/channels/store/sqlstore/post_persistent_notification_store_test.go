...
func TestPostPersistentNotificationStore(t *testing.T) {
	StoreTestWithSqlStore(t, testPostPersistentNotificationStore)
}

func testPostPersistentNotificationStore(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
