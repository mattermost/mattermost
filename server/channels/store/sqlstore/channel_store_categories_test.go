...
func TestChannelStoreCategories(t *testing.T) {
	StoreTestWithSqlStore(t, testChannelStoreCategories)
}

func testChannelStoreCategories(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
...
func testGetSidebarCategory(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
...
func testClearSidebarOnTeamLeave(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
...
func testDeleteSidebarCategory(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
...
func testSidebarCategoryConcurrentAccess(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
	for i := range 2 {
