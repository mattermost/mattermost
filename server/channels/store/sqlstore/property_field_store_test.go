...
func TestPropertyFieldStore(t *testing.T) {
	StoreTestWithSqlStore(t, testPropertyFieldStore)
}

func testPropertyFieldStore(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
...
func insertPropertyFieldWithNullColumns(t *testing.T, ss store.Store, s testSqlStore) (string, string) {
	t.Helper()
...
func testGetPropertyField(t *testing.T, _ request.CTX, ss store.Store, s testSqlStore) {
