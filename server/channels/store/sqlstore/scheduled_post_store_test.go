...
func TestScheduledPostStore(t *testing.T) {
	StoreTestWithSqlStore(t, testScheduledPostStore)
}

func testScheduledPostStore(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
...
func testCreateScheduledPost(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
...
func testGetScheduledPosts(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
...
func testPermanentlyDeleteScheduledPosts(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
...
func testUpdatedScheduledPost(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
	channel := &model.Channel{
		TeamId:      "team_id_1",
		Type:        model.ChannelTypeOpen,
		Name:        "channel_name",
...
func testUpdateOldScheduledPosts(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
...
func testPermanentDeleteScheduledPostsByUser(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
