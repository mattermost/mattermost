...
func TestBotStore(t *testing.T) {
	StoreTestWithSqlStore(t, testBotStore)
}
...
func testBotStore(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
...
func testBotStoreGet(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
...
func testBotStoreGetAll(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
