...
// TestMigration000217 verifies the move of select-style field options out of
...
func TestMigration000217(t *testing.T) {
	...
	downSQL := readMigrationSQL(t, "000217_move_property_options_to_table.down.sql")
	upSQL := readMigrationSQL(t, "000217_move_property_options_to_table.up.sql")
