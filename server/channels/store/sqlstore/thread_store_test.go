...
func TestThreadStore(t *testing.T) {
	StoreTestWithSqlStore(t, testThreadStore)
}

func testThreadStore(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
...
func testThreadStorePermanentDeleteBatchThreadMembershipsForRetentionPolicies(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
	const limit = 1000
	userID := model.NewId()
