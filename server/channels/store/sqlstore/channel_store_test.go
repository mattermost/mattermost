...
func TestChannelStore(t *testing.T) {
	StoreTestWithSqlStore(t, testChannelStore)
}
...
func cleanupChannelStoreData(t *testing.T, s testSqlStore) {
	t.Helper()
	db := s.GetMaster()
...
func testChannelStore(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
...
func testChannelStoreSaveDirectChannel(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
	teamID := model.NewId()
...
func testChannelStoreGet(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
	o1 := model.Channel{}
	o1.TeamId = model.NewId()
	o1.DisplayName = "Name"
	o1.Name = newTestID()
...
func testChannelStoreGetMany(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
...
func testChannelStoreGetAllChannels(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
...
func testChannelStoreSearchInTeam(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
	teamID := model.NewId()
	otherTeamID := model.NewId()
...
func testAutocomplete(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
	t1 := &model.Team{
		DisplayName: "t1",
		Name:        newTestID(),
		Email:       makeEmail(),
...
func testMaterializedPublicChannels(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
	teamID := model.NewId()
...
func testChannelStoreRemoveAllDeactivatedMembers(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
...
func testChannelStoreExportAllDirectChannels(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
	teamID := model.NewId()
...
func testChannelStoreExportAllDirectChannelsExcludePrivateAndPublic(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
	teamID := model.NewId()
...
func testChannelStoreExportAllDirectChannelsDeletedChannel(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
	teamID := model.NewId()
