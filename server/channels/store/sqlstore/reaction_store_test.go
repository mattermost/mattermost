...
func TestReactionStore(t *testing.T) {
	StoreTestWithSqlStore(t, testReactionStore)
}

func testReactionStore(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
...
func testReactionGetForPostSince(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
	now := model.GetMillis()
...
func forceUpdateAt(reaction *model.Reaction, updateAt int64, s testSqlStore) error {
...
func forceNULL(reaction *model.Reaction, s testSqlStore) error {
...
func testReactionDeleteAllWithEmojiName(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
