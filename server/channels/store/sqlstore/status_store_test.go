...
func insertNullStatus(t *testing.T, ss store.Store, s testSqlStore) string {
	userId := model.NewId()
...
func testStatusGet(t *testing.T, _ request.CTX, ss store.Store, s testSqlStore) {
...
func testStatusGetByIds(t *testing.T, _ request.CTX, ss store.Store, s testSqlStore) {
