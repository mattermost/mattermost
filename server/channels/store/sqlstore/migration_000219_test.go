...
// TestMigration000219 covers the backfill that moves auto-add off the Active
...
func TestMigration000219(t *testing.T) {
	...
	upSQL := readMigrationSQL(t, "000219_move_auto_add_to_membership_rule.up.sql")
	downSQL := readMigrationSQL(t, "000219_move_auto_add_to_membership_rule.down.sql")
