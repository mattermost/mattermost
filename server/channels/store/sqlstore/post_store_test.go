...
func TestPostStore(t *testing.T) {
	StoreTestWithSqlStore(t, testPostStore)
}
...
func testPostStore(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
...
func testPostStoreGetFlaggedPostsForTeam(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
	c1 := &model.Channel{}
...
func testPostStoreGetDirectPostParentsForExportAfter(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
	teamID := model.NewId()
...
func testPostStoreGetDirectPostParentsForExportAfterDeleted(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
	teamID := model.NewId()
...
func testPostStoreGetDirectPostParentsForExportAfterBatched(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
	teamID := model.NewId()
...
func testGetPostsSinceUpdateForSync(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
	// create some posts.
...
func testGetPostsSinceCreateForSync(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
	// create some posts.
	channelID := model.NewId()
	remoteID := model.NewPointer(model.NewId())
	first := model.GetMillis()
...
func testSetPostReminder(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
	// Basic
	userID := newTestID()
...
func testGetPostReminders(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
...
func testGetPostReminderMetadata(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
	team := &model.Team{
		Name:        "teamname",
		DisplayName: "display",
		Type:        model.TeamOpen,
...
func testGetPostsSinceForSyncExcludeMetadata(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
	// Create a channel
	channelID := model.NewId()
...
func testGetPostsSinceForSyncExcludedPostTypes(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
	channelID := model.NewId()
	first := model.GetMillis()
...
func testGetPostsForReporting(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
	channelID := model.NewId()
	first := model.GetMillis()
...
func testDeleteAllPostRemindersForPost(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
