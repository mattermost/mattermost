...
func TestPropertyValueStore(t *testing.T) {
	StoreTestWithSqlStore(t, testPropertyValueStore)
}

func testPropertyValueStore(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
...
func insertPropertyValueWithNullColumns(t *testing.T, ss store.Store, s testSqlStore) (string, string, string, string) {
	t.Helper()
...
func testGetPropertyValue(t *testing.T, _ request.CTX, ss store.Store, s testSqlStore) {
...
func testGetManyPropertyValues(t *testing.T, _ request.CTX, ss store.Store, s testSqlStore) {
...
func testUpsertPropertyValue(t *testing.T, _ request.CTX, ss store.Store, s testSqlStore) {
	t.Run("should fail if the property value is not valid", func(t *testing.T) {
		value := &model.PropertyValue{
			TargetID:   "",
			TargetType: "test_type",
...
func testSearchPropertyValues(t *testing.T, _ request.CTX, ss store.Store, s testSqlStore) {
	groupID := model.NewId()
	targetID := model.NewId()
	fieldID := model.NewId()
