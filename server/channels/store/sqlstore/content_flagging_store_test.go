...
func TestContentFlaggingStore(t *testing.T) {
	StoreTestWithSqlStore(t, testContentFlaggingStore)
}

func testContentFlaggingStore(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
...
func testSaveReviewerSettings(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
...
func testGetReviewerSettings(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
...
func testSaveAndGetReviewerSettings(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
