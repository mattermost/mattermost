...
// Re-exported from model for backward compatibility.
const (
	SchemeRoleDisplayNameTeamAdmin      = model.SchemeRoleDisplayNameTeamAdmin
	SchemeRoleDisplayNameTeamUser       = model.SchemeRoleDisplayNameTeamUser
	SchemeRoleDisplayNameTeamGuest      = model.SchemeRoleDisplayNameTeamGuest
	SchemeRoleDisplayNameChannelAdmin   = model.SchemeRoleDisplayNameChannelAdmin
	SchemeRoleDisplayNameChannelUser    = model.SchemeRoleDisplayNameChannelUser
	SchemeRoleDisplayNameChannelGuest   = model.SchemeRoleDisplayNameChannelGuest
	SchemeRoleDisplayNamePlaybookAdmin  = model.SchemeRoleDisplayNamePlaybookAdmin
	SchemeRoleDisplayNamePlaybookMember = model.SchemeRoleDisplayNamePlaybookMember
	SchemeRoleDisplayNameRunAdmin       = model.SchemeRoleDisplayNameRunAdmin
	SchemeRoleDisplayNameRunMember      = model.SchemeRoleDisplayNameRunMember
)
