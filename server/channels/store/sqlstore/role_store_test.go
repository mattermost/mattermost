...
func TestRoleStore(t *testing.T) {
	StoreTestWithSqlStore(t, testRoleStore)
}

func testRoleStore(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
...
func testRoleStoreChannelHigherScopedPermissionsBlankTeamSchemeChannelGuest(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
