...
func applyMultiRoleFilters(query sq.SelectBuilder, systemRoles []string, teamRoles []string, channelRoles []string) sq.SelectBuilder {
	...
	if len(systemRoles) > 0 && systemRoles[0] != "" {
		for _, role := range systemRoles {
			...
			case model.SystemGuestRoleId, model.SystemAdminRoleId, model.SystemUserManagerRoleId, model.SystemReadOnlyAdminRoleId, model.SystemManagerRoleId, model.SharedChannelManagerRoleId, model.SecureConnectionManagerRoleId:
