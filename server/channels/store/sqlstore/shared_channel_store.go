...
func (s SqlSharedChannelStore) GetRemoteForUser(remoteId string, userId string) (*model.RemoteCluster, error) {
	builder := s.getQueryBuilder().
		Select("rc.RemoteId", "rc.RemoteTeamId", "rc.Name", "rc.DisplayName", "rc.SiteURL",
			"rc.DefaultTeamId", "rc.CreateAt", "rc.DeleteAt", "rc.LastPingAt",
			"rc.Token", "rc.RemoteToken", "rc.Topics", "rc.CreatorId", "rc.PluginID", "rc.Options").
