...
func TestUserStore(t *testing.T) {
	StoreTestWithSqlStore(t, testUserStore)
}
...
func cleanupStatusStore(t *testing.T, s testSqlStore) {
	_, execerr := s.GetMaster().Exec(`DELETE FROM Status`)
	require.NoError(t, execerr)
}

func testUserStore(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
...
func testUserStoreGetProfilesInChannelByAdmin(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
...
func testUserStoreGetProfilesInChannelByStatus(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
	cleanupStatusStore(t, s)
...
func testUserStoreGetRecentlyActiveUsersForTeam(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
	cleanupStatusStore(t, s)
...
func testUserStoreAnalyticsActiveCount(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
	cleanupStatusStore(t, s)
...
func testUserStoreAnalyticsActiveCountForPeriod(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
	cleanupStatusStore(t, s)
...
func testGetUserReport(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
	numRegularUsers := 90
	numSysAdmins := 10
	numInactiveUsers := 15
