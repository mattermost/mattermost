...
func TestRetentionPolicyStore(t *testing.T) {
	StoreTestWithSqlStore(t, testRetentionPolicyStore)
}

func testRetentionPolicyStore(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
...
func cleanupRetentionPolicyTest(s testSqlStore) {
...
func testRetentionPolicyStoreSave(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
...
func testRetentionPolicyStorePatch(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
	teamIDs, channelIDs := createTeamsAndChannelsForRetentionPolicy(t, rctx, ss)
...
func testRetentionPolicyStoreGet(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
...
func testRetentionPolicyStoreGetCount(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
	defer cleanupRetentionPolicyTest(s)
...
func testRetentionPolicyStoreDelete(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
	teamIDs, channelIDs := createTeamsAndChannelsForRetentionPolicy(t, rctx, ss)
	policy := saveRetentionPolicyWithTeamAndChannelIds(t, ss, "Policy 1", teamIDs, channelIDs)
...
func testRetentionPolicyStoreGetChannels(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
	defer cleanupRetentionPolicyTest(s)
...
func testRetentionPolicyStoreAddChannels(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
	teamIDs, channelIDs := createTeamsAndChannelsForRetentionPolicy(t, rctx, ss)
	policy := saveRetentionPolicyWithTeamAndChannelIds(t, ss, "Policy 1", teamIDs, channelIDs)
...
func testRetentionPolicyStoreRemoveChannels(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
	teamIDs, channelIDs := createTeamsAndChannelsForRetentionPolicy(t, rctx, ss)
	policy := saveRetentionPolicyWithTeamAndChannelIds(t, ss, "Policy 1", teamIDs, channelIDs)
...
func testRetentionPolicyStoreGetTeams(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
	defer cleanupRetentionPolicyTest(s)
...
func testRetentionPolicyStoreAddTeams(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
	teamIDs, channelIDs := createTeamsAndChannelsForRetentionPolicy(t, rctx, ss)
	policy := saveRetentionPolicyWithTeamAndChannelIds(t, ss, "Policy 1", teamIDs, channelIDs)
...
func testRetentionPolicyStoreRemoveTeams(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
	teamIDs, channelIDs := createTeamsAndChannelsForRetentionPolicy(t, rctx, ss)
	policy := saveRetentionPolicyWithTeamAndChannelIds(t, ss, "Policy 1", teamIDs, channelIDs)
...
func testRetentionPolicyStoreGetPoliciesForUser(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
	teamIDs, channelIDs := createTeamsAndChannelsForRetentionPolicy(t, rctx, ss)
...
func testRetentionPolicyStoreRemoveOrphanedRows(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
