...
func (s *SqlRoleStore) AllChannelSchemeRoles() ([]*model.Role, error) {
	query := s.getQueryBuilder().
		Select("Roles.Id", "Roles.Name", "Roles.DisplayName", "Roles.Description", "Roles.CreateAt", "Roles.UpdateAt", "Roles.DeleteAt", "Roles.Permissions", "Roles.SchemeManaged", "Roles.BuiltIn").
		From("Schemes").
...
func (s *SqlRoleStore) ChannelRolesUnderTeamRole(roleName string) ([]*model.Role, error) {
	query := s.getQueryBuilder().
		Select("ChannelSchemeRoles.Id", "ChannelSchemeRoles.Name", "ChannelSchemeRoles.DisplayName", "ChannelSchemeRoles.Description", "ChannelSchemeRoles.CreateAt", "ChannelSchemeRoles.UpdateAt", "ChannelSchemeRoles.DeleteAt", "ChannelSchemeRoles.Permissions", "ChannelSchemeRoles.SchemeManaged", "ChannelSchemeRoles.BuiltIn").
