...
// TestMigration000195 exercises the select→rank conversion for the built-in
...
func TestMigration000195(t *testing.T) {
	...
	upSQL := readMigrationSQL(t, "000195_convert_classification_fields_to_rank.up.sql")
	downSQL := readMigrationSQL(t, "000195_convert_classification_fields_to_rank.down.sql")
