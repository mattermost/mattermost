...
// Scoped to memberships the user still holds, so delta sync can surface an archival
// to clients that were online before it happened.
...
// Returns false without querying when both listing permissions are denied.
