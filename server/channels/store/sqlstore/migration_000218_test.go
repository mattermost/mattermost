...
// TestMigration000218 verifies the move of select-style field options out of
...
func TestMigration000218(t *testing.T) {
	...
	downSQL := readMigrationSQL(t, "000218_move_property_options_to_table.down.sql")
	upSQL := readMigrationSQL(t, "000218_move_property_options_to_table.up.sql")
