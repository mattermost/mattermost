...
func TestFileInfoStore(t *testing.T) {
	StoreTestWithSqlStore(t, testFileInfoStore)
}
...
func testFileInfoStore(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
	t.Cleanup(func() {
...
func testGetUptoNSizeFileTime(t *testing.T, rctx request.CTX, ss store.Store, s testSqlStore) {
