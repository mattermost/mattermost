...
type ThreadStore interface {
	...
	GetTotalThreadsForChannel(channelID, userID string, opts model.GetChannelThreadsOpts) (int64, error)
	GetThreadsForChannel(channelID, userID string, opts model.GetChannelThreadsOpts) ([]*model.ThreadResponse, error)
	...
	MaintainMembership(userID, postID string, opts ThreadMembershipOpts) (*model.ThreadMembership, bool, error)
	PermanentDeleteBatchForRetentionPolicies(now, globalPolicyEndTime, limit int64, cursor model.RetentionPolicyCursor) (int64, model.RetentionPolicyCursor, error)
