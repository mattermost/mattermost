...
type PostStore interface {
	...
	CountFlaggedPosts(userID string) (int64, error)
	CountFlaggedPostsForTeam(userID, teamID string) (int64, error)
	CountFlaggedPostsForChannel(userID, channelID string) (int64, error)
