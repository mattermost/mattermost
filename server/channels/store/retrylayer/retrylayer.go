...
func (s *RetryLayerPostStore) GetEtag(channelID string, language string, allowFromCache bool, collapsedThreads bool) string {

	return s.PostStore.GetEtag(channelID, language, allowFromCache, collapsedThreads)
