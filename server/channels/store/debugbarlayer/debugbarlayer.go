...
func (s *DebugBarLayerOAuthStore) RemoveAuthDataByClientId(clientId string, userId string) error {
	start := time.Now()
	...
	s.Root.debugBar.SendStoreCall("OAuthStore.RemoveAuthDataByClientId", success, elapsed, debugBarLayerParams)
