...
func (s *OpenTracingLayerPostStore) GetPostAfterTime(channelID string, timestamp int64, collapsedThreads bool, excludeTypes []string) (*model.Post, error) {
	origCtx := s.Root.Store.Context()
...
func (s *OpenTracingLayerPostStore) GetPostIdAfterTime(channelID string, timestamp int64, collapsedThreads bool, excludeTypes []string) (string, error) {
	origCtx := s.Root.Store.Context()
...
func (s *OpenTracingLayerPostStore) GetPostIdBeforeTime(channelID string, timestamp int64, collapsedThreads bool, excludeTypes []string) (string, error) {
	origCtx := s.Root.Store.Context()
