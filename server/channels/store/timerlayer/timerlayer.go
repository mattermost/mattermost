...
func (s *TimerLayerTeamStore) GetForExport(teamID string) (*model.TeamForExport, error) {
	start := time.Now()
	...
	if s.Root.Metrics != nil {
		...
		s.Root.Metrics.ObserveStoreMethodDuration("TeamStore.GetForExport", success, elapsed)
	}
	return result, err
}
