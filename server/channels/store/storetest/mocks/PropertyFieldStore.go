...
// GetFromMaster provides a mock function with given fields: groupID, id
func (_m *PropertyFieldStore) GetFromMaster(groupID string, id string) (*model.PropertyField, error) {
	ret := _m.Called(groupID, id)
