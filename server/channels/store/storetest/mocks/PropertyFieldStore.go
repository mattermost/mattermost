...
// GetFieldByName provides a mock function with given fields: groupID, name
func (_m *PropertyFieldStore) GetFieldByName(groupID string, name string) (*model.PropertyField, error) {
