...
// GetUserId provides a mock function with given fields: desktopToken, serverToken, minCreatedAt
func (_m *DesktopTokensStore) GetUserId(desktopToken string, serverToken string, minCreatedAt int64) (*string, error) {
	ret := _m.Called(desktopToken, serverToken, minCreatedAt)

	var r0 *string
	var r1 error
	if rf, ok := ret.Get(0).(func(string, string, int64) (*string, error)); ok {
		return rf(desktopToken, serverToken, minCreatedAt)
	}
	if rf, ok := ret.Get(0).(func(string, string, int64) *string); ok {
		r0 = rf(desktopToken, serverToken, minCreatedAt)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*string)
		}
	...
	if rf, ok := ret.Get(1).(func(string, string, int64) error); ok {
		r1 = rf(desktopToken, serverToken, minCreatedAt)
	} else {
		r1 = ret.Error(1)
	}
...
// SetServerToken provides a mock function with given fields: desktopToken, minCreatedAt, serverToken
func (_m *DesktopTokensStore) SetServerToken(desktopToken string, minCreatedAt int64, serverToken string) error {
	ret := _m.Called(desktopToken, minCreatedAt, serverToken)

	var r0 error
	if rf, ok := ret.Get(0).(func(string, int64, string) error); ok {
		r0 = rf(desktopToken, minCreatedAt, serverToken)
	} else {
		r0 = ret.Error(0)
	}
