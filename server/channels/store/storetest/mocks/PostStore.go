...
// GetEtag provides a mock function with given fields: channelID, language, allowFromCache, collapsedThreads
func (_m *PostStore) GetEtag(channelID string, language string, allowFromCache bool, collapsedThreads bool) string {
	ret := _m.Called(channelID, language, allowFromCache, collapsedThreads)
	...
	if rf, ok := ret.Get(0).(func(string, string, bool, bool) string); ok {
		r0 = rf(channelID, language, allowFromCache, collapsedThreads)
	} else {
		r0 = ret.Get(0).(string)
	}
