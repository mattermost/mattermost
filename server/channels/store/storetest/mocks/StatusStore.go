...
// GetOnlineUsersInactiveSince provides a mock function with given fields: cutoffTime
func (_m *StatusStore) GetOnlineUsersInactiveSince(cutoffTime int64) ([]*model.Status, error) {
	ret := _m.Called(cutoffTime)

	if len(ret) == 0 {
		panic("no return value specified for GetOnlineUsersInactiveSince")
	}
