...
// GetDeleted provides a mock function with given fields: team_id, offset, limit, userID, skipTeamMembershipCheck
func (_m *ChannelStore) GetDeleted(team_id string, offset int, limit int, userID string, skipTeamMembershipCheck bool) (model.ChannelList, error) {
	ret := _m.Called(team_id, offset, limit, userID, skipTeamMembershipCheck)
	...
	if rf, ok := ret.Get(0).(func(string, int, int, string, bool) (model.ChannelList, error)); ok {
		return rf(team_id, offset, limit, userID, skipTeamMembershipCheck)
	}
	if rf, ok := ret.Get(0).(func(string, int, int, string, bool) model.ChannelList); ok {
		r0 = rf(team_id, offset, limit, userID, skipTeamMembershipCheck)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(model.ChannelList)
		}
	...
	if rf, ok := ret.Get(1).(func(string, int, int, string, bool) error); ok {
		r1 = rf(team_id, offset, limit, userID, skipTeamMembershipCheck)
	} else {
		r1 = ret.Error(1)
	}
