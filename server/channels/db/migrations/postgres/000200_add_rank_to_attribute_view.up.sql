-- Extend the AttributeView matview to materialize rank-typed property values
-- as {"name": <option-name>, "rank": <option-rank>} so ABAC policies can
-- compare ranks without storing rank integers in policy expressions.
