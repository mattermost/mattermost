...
type Routes struct {
	...
	ChannelTabs         *mux.Router // 'api/v4/channels/{channel_id:[A-Za-z0-9]+}/bookmarks'
	ChannelTab          *mux.Router // 'api/v4/channels/{channel_id:[A-Za-z0-9]+}/bookmarks/{bookmark_id:[A-Za-z0-9]+}'
...
func Init(srv *app.Server) (*API, error) {
	...
	api.BaseRoutes.ChannelTabs = api.BaseRoutes.Channel.PathPrefix("/bookmarks").Subrouter()
	api.BaseRoutes.ChannelTab = api.BaseRoutes.ChannelTabs.PathPrefix("/{bookmark_id:[A-Za-z0-9]+}").Subrouter()
