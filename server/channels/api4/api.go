...
type Routes struct {
	...
	PostProperties *mux.Router // 'api/v4/properties/post'
}
...
func Init(srv *app.Server) (*API, error) {
	...
	api.BaseRoutes.PostProperties = api.BaseRoutes.APIRoot.PathPrefix("/properties/post").Subrouter()
