...
func TestCreatePostPublic(t *testing.T) {
	...
	user := model.User{Email: th.GenerateTestEmail(), Nickname: "Joram Wilander", Password: model.NewRandomPassword(), Username: GenerateTestUsername(), Roles: model.SystemUserRoleId}
