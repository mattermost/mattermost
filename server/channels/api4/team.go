...
func createTeam(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	_, _, schemeAdminRole, schemeErr := c.App.GetSchemeRolesForTeam(rteam.Id)
	if schemeErr != nil || !c.App.RolesGrantPermission([]string{schemeAdminRole}, model.PermissionInviteUser.Id) {
