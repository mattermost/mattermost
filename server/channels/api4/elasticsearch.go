...
func testElasticsearch(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	if !c.App.SessionHasPermissionToCheckRestrictedAdmin(*c.AppContext.Session(), model.PermissionTestElasticsearch) {
...
func purgeElasticsearchIndexes(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	if !c.App.SessionHasPermissionToCheckRestrictedAdmin(*c.AppContext.Session(), model.PermissionPurgeElasticsearchIndexes) {
