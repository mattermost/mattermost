...
func getUsers(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	if withoutTeamBool, _ := strconv.ParseBool(withoutTeam); withoutTeamBool {
		...
		profiles, appErr = c.App.GetUsersNotInChannelPage(inTeamId, notInChannelId, groupConstrainedBool, c.Params.Page, c.Params.PerPage, c.IsSystemAdmin(), restrictions, cursorId)
	} else if notInTeamId != "" {
