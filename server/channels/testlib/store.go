...
func GetMockStoreForSetupFunctions() *mocks.Store {
	...
	systemStore.On("GetByName", model.MigrationKeyAddCreateAgentPermission).Return(&model.System{Name: model.MigrationKeyAddCreateAgentPermission, Value: "true"}, nil)
