...
func GetMockStoreForSetupFunctions() *mocks.Store {
	...
	systemStore.On("GetByName", model.MigrationKeyFileAttachmentPermissions).Return(&model.System{Name: model.MigrationKeyFileAttachmentPermissions, Value: "true"}, nil)
