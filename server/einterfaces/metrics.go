...
type MetricsInterface interface {
	...
	ObserveMobileClientContentLoadTotalCompressedSize(platform string, contentLoadGroup string, size float64)
	ObserveMobileClientContentLoadUrlCount(platform string, contentLoadGroup string, count float64)
	ObserveMobileClientContentLoadLatency(platform string, contentLoadGroup string, latency float64)
	ObserveMobileClientContentLoadTotalSize(platform string, contentLoadGroup string, size float64)
