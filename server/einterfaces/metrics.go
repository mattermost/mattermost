...
type MetricsInterface interface {
	...
	ObserveMobileClientLoadDuration(platform, userID string, elapsed float64)
	ObserveMobileClientChannelSwitchDuration(platform, userID string, elapsed float64)
	ObserveMobileClientTeamSwitchDuration(platform, userID string, elapsed float64)
