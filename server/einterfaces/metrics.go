...
type MetricsInterface interface {
	...
	ObserveMobileClientContentLoadTotalCompressedSize(platform string, size float64)
	ObserveMobileClientContentLoadUrlCount(platform string, count float64)
	ObserveMobileClientContentLoadLatency(platform string, latency float64)
	ObserveMobileClientContentLoadTotalSize(platform string, size float64)
