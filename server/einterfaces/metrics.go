...
type MetricsInterface interface {
	...
	ObserveMobileClientNetworkRequestsTotalCompressedSize(platform string, networkRequestGroup string, size float64)
	ObserveMobileClientNetworkRequestsTotalRequests(platform string, networkRequestGroup string, count float64)
	ObserveMobileClientNetworkRequestsLatency(platform string, networkRequestGroup string, latency float64)
	ObserveMobileClientNetworkRequestsTotalSize(platform string, networkRequestGroup string, size float64)
	ObserveMobileClientNetworkRequestsElapsedTime(platform string, networkRequestGroup string, elapsedTime float64)
	ObserveMobileClientNetworkRequestsAverageSpeed(platform string, networkRequestGroup string, speed float64)
