...
func (_m *AccessControlServiceInterface) EvaluatePostPolicies(rctx request.CTX, channelID string, post *model.PostWithValues, subject *model.Subject) (bool, *model.AppError) {
