...
// StartSynchronizeJob provides a mock function with given fields: c, waitForJobToFinish, opts
func (_m *LdapInterface) StartSynchronizeJob(c request.CTX, waitForJobToFinish bool, opts *model.LdapSyncOptions) (*model.Job, *model.AppError) {
	ret := _m.Called(c, waitForJobToFinish, opts)
	...
	var r0 *model.Job
	var r1 *model.AppError
	if rf, ok := ret.Get(0).(func(request.CTX, bool, *model.LdapSyncOptions) (*model.Job, *model.AppError)); ok {
		return rf(c, waitForJobToFinish, opts)
	}
	if rf, ok := ret.Get(0).(func(request.CTX, bool, *model.LdapSyncOptions) *model.Job); ok {
		r0 = rf(c, waitForJobToFinish, opts)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(request.CTX, bool, *model.LdapSyncOptions) *model.AppError); ok {
		r1 = rf(c, waitForJobToFinish, opts)
	} else {
		if ret.Get(1) != nil {
			r1 = ret.Get(1).(*model.AppError)
		}
