...
// Source: github.com/mattermost/mattermost-server/server/v7/boards/services/store (interfaces: Store)
...
import (
	...
	model0 "github.com/mattermost/mattermost-server/server/v7/model"
)
