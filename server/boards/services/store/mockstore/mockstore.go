...
import (
	...
	model0 "github.com/mattermost/mattermost-server/server/public/model"
...
func (m *MockStore) GetBoardsForUserAndTeam(arg0, arg1 string, arg2 model.QueryBoardOptions) ([]*model.Board, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetMembersForBoard(arg0 string, arg1 model.QueryPageOptions) ([]*model.BoardMember, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetUserCategories(arg0, arg1 string, arg2 model.QueryUserCategoriesOptions) ([]model.Category, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetUserCategoryBoards(arg0, arg1 string, arg2 model.QueryUserCategoriesOptions) ([]model.CategoryBoards, error) {
	m.ctrl.T.Helper()
