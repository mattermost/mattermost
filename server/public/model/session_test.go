...
func TestIsValidVoIPDeviceId(t *testing.T) {
	testCases := []struct {
		...
		{"oxide apple is not VoIP-capable yet", PushNotifyAppleOxide + ":abcd", false},
		{"oxide android is not VoIP-capable yet", PushNotifyAndroidOxide + ":abcd", false},
...
func TestIsValidStandardDeviceId(t *testing.T) {
	testCases := []struct {
		...
		{"valid apple_oxide", PushNotifyAppleOxide + ":abcd", true},
		{"valid android_oxide", PushNotifyAndroidOxide + ":abcd", true},
		...
		{"apple_oxide-v2", PushNotifyAppleOxide + "-v2:abcd", true},
		{"android_oxide-v2", PushNotifyAndroidOxide + "-v2:abcd", true},
