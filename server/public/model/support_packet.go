...
// SupportPacketDatabaseDiagnostics contains database-specific diagnostics that are
// collected by the store layer and merged into SupportPacketDiagnostics.Database.
