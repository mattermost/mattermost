...
const (
	...
	ChannelMemberUpdated                     WebsocketEventType = "channel_member_updated"
	ChannelSchemeUpdated                     WebsocketEventType = "channel_scheme_updated"
	...
	RestoreTeam                              WebsocketEventType = "restore_team"
	UpdateTeamScheme                         WebsocketEventType = "update_team_scheme"
	UserAdded                                WebsocketEventType = "user_added"
	UserUpdated                              WebsocketEventType = "user_updated"
	UserRoleUpdated                          WebsocketEventType = "user_role_updated"
	MemberroleUpdated                        WebsocketEventType = "memberrole_updated"
	UserRemoved                              WebsocketEventType = "user_removed"
	PreferenceChanged                        WebsocketEventType = "preference_changed"
	PreferencesChanged                       WebsocketEventType = "preferences_changed"
	PreferencesDeleted                       WebsocketEventType = "preferences_deleted"
	EphemeralMessage                         WebsocketEventType = "ephemeral_message"
	StatusChange                             WebsocketEventType = "status_change"
	Hello                                    WebsocketEventType = "hello"
	WebsocketAuthenticationChallenge         WebsocketEventType = "authentication_challenge"
	ReactionAdded                            WebsocketEventType = "reaction_added"
	ReactionRemoved                          WebsocketEventType = "reaction_removed"
	WebsocketEventResponse                   WebsocketEventType = "response"
	EmojiAdded                               WebsocketEventType = "emoji_added"
	ChannelViewed                            WebsocketEventType = "channel_viewed"
	MultipleChannelsViewed                   WebsocketEventType = "multiple_channels_viewed"
	PluginStatusesChanged                    WebsocketEventType = "plugin_statuses_changed"
	PluginEnabled                            WebsocketEventType = "plugin_enabled"
	PluginDisabled                           WebsocketEventType = "plugin_disabled"
	RoleUpdated                              WebsocketEventType = "role_updated"
	LicenseChanged                           WebsocketEventType = "license_changed"
	ConfigChanged                            WebsocketEventType = "config_changed"
	OpenDialog                               WebsocketEventType = "open_dialog"
	GuestsDeactivated                        WebsocketEventType = "guests_deactivated"
	UserActivationStatusChange               WebsocketEventType = "user_activation_status_change"
	ReceivedGroup                            WebsocketEventType = "received_group"
	ReceivedGroupAssociatedToTeam            WebsocketEventType = "received_group_associated_to_team"
	ReceivedGroupNotAssociatedToTeam         WebsocketEventType = "received_group_not_associated_to_team"
	ReceivedGroupAssociatedToChannel         WebsocketEventType = "received_group_associated_to_channel"
	ReceivedGroupNotAssociatedToChannel      WebsocketEventType = "received_group_not_associated_to_channel"
	GroupMemberDelete                        WebsocketEventType = "group_member_deleted"
	GroupMemberAdd                           WebsocketEventType = "group_member_add"
	SidebarCategoryCreated                   WebsocketEventType = "sidebar_category_created"
	SidebarCategoryUpdated                   WebsocketEventType = "sidebar_category_updated"
	SidebarCategoryDeleted                   WebsocketEventType = "sidebar_category_deleted"
	SidebarCategoryOrderUpdated              WebsocketEventType = "sidebar_category_order_updated"
	...
	CloudPaymentStatusUpdated                WebsocketEventType = "cloud_payment_status_updated"
	CloudSubscriptionChanged                 WebsocketEventType = "cloud_subscription_changed"
	ThreadUpdated                            WebsocketEventType = "thread_updated"
	ThreadFollowChanged                      WebsocketEventType = "thread_follow_changed"
	ThreadReadChanged                        WebsocketEventType = "thread_read_changed"
	FirstAdminVisitMarketplaceStatusReceived WebsocketEventType = "first_admin_visit_marketplace_status_received"
	DraftCreated                             WebsocketEventType = "draft_created"
	DraftUpdated                             WebsocketEventType = "draft_updated"
	DraftDeleted                             WebsocketEventType = "draft_deleted"
	AcknowledgementAdded                     WebsocketEventType = "post_acknowledgement_added"
	AcknowledgementRemoved                   WebsocketEventType = "post_acknowledgement_removed"
	PersistentNotificationTriggered          WebsocketEventType = "persistent_notification_triggered"
	HostedCustomerSignupProgressUpdated      WebsocketEventType = "hosted_customer_signup_progress_updated"
)
