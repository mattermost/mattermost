...
func (z *User) DecodeMsg(dc *msgp.Reader) (err error) {
	...
	err = z.CustomAttributes.DecodeMsg(dc)
	if err != nil {
		err = msgp.WrapError(err, "CustomAttributes")
		return
	}
	return
}
...
func (z *User) EncodeMsg(en *msgp.Writer) (err error) {
	...
	err = z.CustomAttributes.EncodeMsg(en)
	if err != nil {
		err = msgp.WrapError(err, "CustomAttributes")
		return
	}
...
func (z *User) MarshalMsg(b []byte) (o []byte, err error) {
	...
	o, err = z.CustomAttributes.MarshalMsg(o)
	if err != nil {
		err = msgp.WrapError(err, "CustomAttributes")
		return
	}
...
func (z *User) UnmarshalMsg(bts []byte) (o []byte, err error) {
	...
	bts, err = z.CustomAttributes.UnmarshalMsg(bts)
	if err != nil {
		err = msgp.WrapError(err, "CustomAttributes")
		return
	}
...
func (z *User) Msgsize() (s int) {
	...
	s += msgp.Int64Size + msgp.BoolSize + msgp.StringPrefixSize + len(z.BotDescription) + msgp.Int64Size + msgp.StringPrefixSize + len(z.TermsOfServiceId) + msgp.Int64Size + msgp.BoolSize + msgp.Int64Size + z.MfaUsedTimestamps.Msgsize() + z.CustomAttributes.Msgsize()
	return
}
