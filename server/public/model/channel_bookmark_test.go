...
func TestChannelBookmarkIsValid(t *testing.T) {
	testCases := []struct {
		...
		{
			"bookmark with mattermost:// URL",
			&ChannelBookmark{
				Id:          NewId(),
				OwnerId:     NewId(),
				ChannelId:   NewId(),
				FileId:      "",
				DisplayName: "In-app link",
				SortOrder:   0,
				LinkUrl:     "mattermost://team/channels/channel-name",
				ImageUrl:    "",
				Emoji:       "",
				Type:        ChannelBookmarkLink,
				CreateAt:    3,
		...
		{
			"bookmark with javascript:// URL (dangerous)",
			&ChannelBookmark{
				Id:          NewId(),
				OwnerId:     NewId(),
				ChannelId:   NewId(),
				FileId:      "",
				DisplayName: "Dangerous link",
				SortOrder:   0,
		...
		{
			"bookmark with data:// URL (dangerous)",
			&ChannelBookmark{
				Id:          NewId(),
				OwnerId:     NewId(),
				ChannelId:   NewId(),
		...
		{
			"bookmark with file:// URL (dangerous)",
			&ChannelBookmark{
				Id:          NewId(),
				OwnerId:     NewId(),
				ChannelId:   NewId(),
		...
		{
			"bookmark with unsupported custom scheme",
			&ChannelBookmark{
				Id:          NewId(),
				OwnerId:     NewId(),
				ChannelId:   NewId(),
