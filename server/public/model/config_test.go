...
func TestImageProxySettingsIsValid(t *testing.T) {
	...
	for _, test := range []struct {
		...
		},
		{
			Name:                    "cactus/go-camo",
			Enable:                  true,
			ImageProxyType:          ImageProxyTypeCactusCamo,
			RemoteImageProxyURL:     "someurl",
			RemoteImageProxyOptions: testHMACKey,
			ExpectError:             false,
		},
		{
			Name:                    "cactus/go-camo, missing url",
			Enable:                  true,
			ImageProxyType:          ImageProxyTypeCactusCamo,
			RemoteImageProxyURL:     "",
			RemoteImageProxyOptions: "garbage",
		...
		{
			Name:                    "cactus/go-camo, missing options",
			Enable:                  true,
			ImageProxyType:          ImageProxyTypeCactusCamo,
			RemoteImageProxyURL:     "someurl",
		...
		{
			Name:                    "cactus/go-camo, short options under FIPS",
			Enable:                  true,
			ImageProxyType:          ImageProxyTypeCactusCamo,
			RemoteImageProxyURL:     "someurl",
		...
		{
			Name:                    "atmos/camo (backward compat)",
			Enable:                  true,
