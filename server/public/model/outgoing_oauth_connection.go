...
const (
	OAuthOutgoingConnectionGrantTypeClientCredentials OutgoingOAuthConnectionGrantType = "client_credentials"
	OAuthOutgoingConnectionGrantTypePassword          OutgoingOAuthConnectionGrantType = "password"
