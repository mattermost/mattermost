...
func (api *apiTimerLayer) CallPlugin(targetPluginID string, method string, request []byte) ([]byte, error) {
	startTime := timePkg.Now()
	_returnsA, _returnsB := api.apiImpl.CallPlugin(targetPluginID, method, request)
