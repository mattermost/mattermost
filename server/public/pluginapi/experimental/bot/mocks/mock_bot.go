...
//
//	mockgen -destination ../server/public/pluginapi/experimental/bot/mocks/mock_bot.go -package mock_bot github.com/mattermost/mattermost/server/public/pluginapi/experimental/bot Bot
//
...
func (m *MockBot) Ensure(stored *model.Bot, iconPath string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Ensure", stored, iconPath)
	ret0, _ := ret[0].(error)
	return ret0
}

// Ensure indicates an expected call of Ensure.
func (mr *MockBotMockRecorder) Ensure(stored, iconPath any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Ensure", reflect.TypeOf((*MockBot)(nil).Ensure), stored, iconPath)
}
