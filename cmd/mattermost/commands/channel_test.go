...
func TestCreateChannel(t *testing.T) {
	...
	t.Run("should create public channel", func(t *testing.T) {
		...
		assert.Equal(t, model.ChannelOpen, channel.Type)
	})
	...
	t.Run("should create private channel", func(t *testing.T) {
		...
		assert.Equal(t, model.ChannelPrivate, channel.Type)
	})
...
func TestModifyChannel(t *testing.T) {
	...
	assert.Equal(t, model.ChannelOpen, res.Type)
	...
	require.NoError(t, err)
	assert.Equal(t, model.ChannelPrivate, res.Type)
