...
describe('Category muting', () => {
    ...
    it('MM-T3488 category headers should be muted and unmuted correctly', () => {
        ...
        // # Mute the category
        clickCategoryMenuItem('CHANNELS', 'Mute Category', 'Channels');
        ...
        // # Unmute the category
        clickCategoryMenuItem('CHANNELS', 'Unmute Category', 'Channels');
    ...
    it('MM-T3489_1 moving a channel into a muted category should mute it', () => {
        ...
        cy.uiCreateSidebarCategory().then((category) => {
            ...
            clickCategoryMenuItem(category.displayName, 'Mute Category', category.displayName.toLowerCase());
