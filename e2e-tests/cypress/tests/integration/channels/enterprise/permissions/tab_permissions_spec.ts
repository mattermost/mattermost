...
const checkChannelTabsPermissionsAreVisibleAndSet = () => {
...
describe('Revoke Tabs Permissions', () => {
    before(() => {
    ...
    it('Channel Tabs permissions should be visible and set in the system scheme', () => {
        cy.apiAdminLogin();
        ...
        checkChannelTabsPermissionsAreVisibleAndSet();
    });

    it('Channel Tabs permissions should be visible and set in a custom scheme', () => {
        cy.apiAdminLogin();
