...
describe('Interactive Dialog - Apps Form without element', () => {
    ...
    it('MM-T2500_1 UI check', () => {
        ...
        cy.get('#appsModal').should('be.visible').within(() => {
            ...
            cy.get('.modal-body').find('.mm-blocks-text-input, .mm-blocks-select-input, .mm-blocks-bool-input, .mm-blocks-date-input, .mm-blocks-datetime-input, .mm-blocks-file-input').should('not.exist');
