...
truncate -s0 ./.env.cypress
# Generate default value for MM_AUTOMATION_DASHBOARD_URL
[ -n "${MM_AUTOMATION_DASHBOARD_URL:-}" ] || echo "MM_AUTOMATION_DASHBOARD_URL=http://${MME2E_DOCKER_GATEWAY}:4000/api" >>./.env.cypress
