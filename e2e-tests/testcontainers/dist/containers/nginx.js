...
export async function createNginxContainer(network, config) {
...
export async function createSubpathNginxContainer(network, config) {
    const image = config.image ?? getNginxImage();
...
export function getNginxConnectionInfo(container, image) {
