...
export interface SubpathConnectionInfo {
    ...
    /** Server 1 postgres connection info */
    server1Postgres: PostgresConnectionInfo;
    /** Server 1 inbucket connection info */
    server1Inbucket: InbucketConnectionInfo;
    /** Server 2 postgres connection info */
    server2Postgres: PostgresConnectionInfo;
    /** Server 2 inbucket connection info */
    server2Inbucket: InbucketConnectionInfo;
    /** Server 1 mattermost connection info */
    server1Mattermost: MattermostConnectionInfo;
    /** Server 2 mattermost connection info */
    server2Mattermost: MattermostConnectionInfo;
}
...
/**
 * Connection information for LibreTranslate
 */
export interface LibreTranslateConnectionInfo {
    host: string;
    port: number;
    url: string;
    /** The Docker image used for this container */
...
export interface DependencyConnectionInfo {
    ...
    libretranslate?: LibreTranslateConnectionInfo;
...
export interface ContainerMetadataMap {
    ...
    libretranslate?: ContainerMetadata;
    /** Nginx load balancer (HA mode only) */
    nginx?: ContainerMetadata;
    /** Subpath mode independent containers (server2) */
    postgres2?: ContainerMetadata;
    inbucket2?: ContainerMetadata;
