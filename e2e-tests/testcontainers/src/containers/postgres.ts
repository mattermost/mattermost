...
import {getPostgresImage, DEFAULT_CREDENTIALS, INTERNAL_PORTS} from '@/config';
import type {PostgresConnectionInfo} from '@/config';
...
export async function createPostgresContainer(
    ...
    const alias = config.networkAlias ?? 'postgres';
