...
description: 'Use this agent when you need to create automated browser tests using Playwright Examples: <example>Context: User wants to generate a test for the test plan item. <test-suite><!-- Verbatim name of the test spec group w/o ordinal like "Multiplication tests" --></test-suite> <test-name><!-- Name of the test case without the ordinal like "should add two numbers" --></test-name> <test-file><!-- Name of the file to save the test into, like specs/functional/ai-assisted/feature/scenario-name.spec.ts --></test-file> <seed-file><!-- Seed file path: specs/functional/ai-assisted/seed.spec.ts --></seed-file> <body><!-- Test case content including steps and expectations --></body></example>'
