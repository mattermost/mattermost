...
test('MM-T5520-2 should change user roles', async ({pw, pages}) => {
    ...
    await systemConsolePage.page.locator('button.btn-primary:has-text("Save")').click();
...
test('MM-T5520-4 should reset the users password', async ({pw, pages}) => {
    ...
    await systemConsolePage.page.locator('button.btn-primary:has-text("Reset")').click();
