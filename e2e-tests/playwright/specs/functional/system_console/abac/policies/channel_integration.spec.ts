...
test('MM-T5788 Add policy to channel from Channel Configuration page', async ({pw}) => {
    ...
    const t5788PolicyId = await getPolicyIdByName(systemConsolePage.page, policyName);
    ...
    // "Link to a policy" renders as an <a> element (role=link, not button).
    // Use the data-testid auto-generated by AdminPanelWithButton.
