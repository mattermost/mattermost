 ...
 */
test('allows signup when the email domain is on the allow list', {tag: '@authentication'}, async ({pw}) => {
 ...
 */
test('rejects a profile email change to a disallowed domain', {tag: '@authentication'}, async ({pw}) => {
 ...
 */
test('rejects team-invite signup when the email domain is not allowed', {tag: '@authentication'}, async ({pw}) => {
