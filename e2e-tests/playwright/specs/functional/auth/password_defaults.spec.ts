 ...
 */
test('shows default password length and requirement checkboxes', {tag: '@authentication'}, async ({pw}) => {
 ...
 */
test('rejects invalid usernames on signup', {tag: '@authentication'}, async ({pw}) => {
