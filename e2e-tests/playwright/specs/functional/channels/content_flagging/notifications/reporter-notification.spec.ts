...
test('Verify Reporter is notified if flagged post is Retained in a channel', async ({pw}) => {
    ...
    // Disable onboarding and tutorial for the reporter user to avoid UI redirects on first login
    await reporterUserClient.savePreferences(reporterUserID, [
        {user_id: reporterUserID, category: 'tutorial_step', name: reporterUserID, value: '999'},
        {user_id: reporterUserID, category: 'crt_thread_pane_step', name: reporterUserID, value: '999'},
        {user_id: reporterUserID, category: 'onboarding_task_list', name: 'onboarding_task_list_show', value: 'false'},
        {user_id: reporterUserID, category: 'onboarding_task_list', name: 'onboarding_task_list_open', value: 'false'},
    ]);
