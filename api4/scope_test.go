	...
	t.Run("APIs by scope name", func(t *testing.T) {
		expected := map[model.Scope][]string{
			...
			"_internal_api": {
				...
				"getThreadForUser",
				"getThreadsForUser",
				"getTopChannelsForTeamSince",
				"getTopChannelsForUserSince",
				"getTopDMsForUserSince",
				"getTopInactiveChannelsForTeamSince",
				"getTopInactiveChannelsForUserSince",
				"getTopReactionsForTeamSince",
				"getTopReactionsForUserSince",
				"getTopThreadsForTeamSince",
				"getTopThreadsForUserSince",
				"getTotalUsersStats",
				"getUpload",
				"getUploadsForUser",
				"getUserAccessToken",
