...
func createIncomingHook(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	if channel.Type != model.ChannelOpen && !c.App.SessionHasPermissionToChannel(*c.AppContext.Session(), channel.Id, model.PermissionReadChannel) {
...
func getIncomingHook(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	if !c.App.SessionHasPermissionToTeam(*c.AppContext.Session(), hook.TeamId, model.PermissionManageIncomingWebhooks) ||
		(channel.Type != model.ChannelOpen && !c.App.SessionHasPermissionToChannel(*c.AppContext.Session(), hook.ChannelId, model.PermissionReadChannel)) {
