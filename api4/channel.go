...
func (api *API) InitChannel() {
	...
	api.BaseRoutes.Channels.Handle("/members/{user_id:[A-Za-z0-9]+}/view", api.APISessionRequired(viewChannel, model.ScopeChannelsRead, model.ScopeUsersRead)).Methods("POST")
	api.BaseRoutes.Channels.Handle("/{channel_id:[A-Za-z0-9]+}/scheme", api.APISessionRequired(updateChannelScheme)).Methods("PUT")

	api.BaseRoutes.ChannelsForTeam.Handle("", api.APISessionRequired(getPublicChannelsForTeam, model.ScopeChannelsRead, model.ScopeTeamsRead)).Methods("GET")
	api.BaseRoutes.ChannelsForTeam.Handle("/deleted", api.APISessionRequired(getDeletedChannelsForTeam, model.ScopeChannelsRead, model.ScopeTeamsRead)).Methods("GET")
	api.BaseRoutes.ChannelsForTeam.Handle("/private", api.APISessionRequired(getPrivateChannelsForTeam, model.ScopeChannelsRead, model.ScopeTeamsRead)).Methods("GET")
	api.BaseRoutes.ChannelsForTeam.Handle("/ids", api.APISessionRequired(getPublicChannelsByIdsForTeam, model.ScopeChannelsRead, model.ScopeTeamsRead)).Methods("POST")
	...
	api.BaseRoutes.ChannelCategories.Handle("", api.APISessionRequired(getCategoriesForTeamForUser, model.ScopeUsersRead, model.ScopeTeamsRead)).Methods("GET")
	api.BaseRoutes.ChannelCategories.Handle("", api.APISessionRequired(createCategoryForTeamForUser, model.ScopeUsersUpdate, model.ScopeTeamsUpdate)).Methods("POST")
	api.BaseRoutes.ChannelCategories.Handle("", api.APISessionRequired(updateCategoriesForTeamForUser, model.ScopeTeamsUpdate, model.ScopeUsersUpdate)).Methods("PUT")
	api.BaseRoutes.ChannelCategories.Handle("/order", api.APISessionRequired(getCategoryOrderForTeamForUser, model.ScopeTeamsRead, model.ScopeUsersRead)).Methods("GET")
	api.BaseRoutes.ChannelCategories.Handle("/order", api.APISessionRequired(updateCategoryOrderForTeamForUser, model.ScopeTeamsUpdate, model.ScopeUsersUpdate)).Methods("PUT")
	api.BaseRoutes.ChannelCategories.Handle("/{category_id:[A-Za-z0-9_-]+}", api.APISessionRequired(getCategoryForTeamForUser, model.ScopeTeamsRead, model.ScopeUsersRead)).Methods("GET")
	api.BaseRoutes.ChannelCategories.Handle("/{category_id:[A-Za-z0-9_-]+}", api.APISessionRequired(updateCategoryForTeamForUser, model.ScopeTeamsUpdate, model.ScopeUsersUpdate)).Methods("PUT")
	api.BaseRoutes.ChannelCategories.Handle("/{category_id:[A-Za-z0-9_-]+}", api.APISessionRequired(deleteCategoryForTeamForUser, model.ScopeTeamsUpdate, model.ScopeUsersUpdate)).Methods("DELETE")

	api.BaseRoutes.Channel.Handle("", api.APISessionRequired(getChannel, model.ScopeChannelsRead)).Methods("GET")
	api.BaseRoutes.Channel.Handle("", api.APISessionRequired(updateChannel, model.ScopeChannelsUpdate)).Methods("PUT")
	api.BaseRoutes.Channel.Handle("/patch", api.APISessionRequired(patchChannel, model.ScopeChannelsUpdate)).Methods("PUT")
	api.BaseRoutes.Channel.Handle("/privacy", api.APISessionRequired(updateChannelPrivacy, model.ScopeChannelsUpdate)).Methods("PUT")
	api.BaseRoutes.Channel.Handle("/restore", api.APISessionRequired(restoreChannel, model.ScopeChannelsUpdate)).Methods("POST")
	api.BaseRoutes.Channel.Handle("", api.APISessionRequired(deleteChannel, model.ScopeChannelsDelete)).Methods("DELETE")
	api.BaseRoutes.Channel.Handle("/stats", api.APISessionRequired(getChannelStats, model.ScopeChannelsRead)).Methods("GET")
	api.BaseRoutes.Channel.Handle("/pinned", api.APISessionRequired(getPinnedPosts, model.ScopeChannelsRead, model.ScopePostsRead)).Methods("GET")
	api.BaseRoutes.Channel.Handle("/timezones", api.APISessionRequired(getChannelMembersTimezones, model.ScopeChannelsRead, model.ScopeUsersRead)).Methods("GET")
	...
	api.BaseRoutes.Channel.Handle("/move", api.APISessionRequired(moveChannel, model.ScopeChannelsUpdate)).Methods("POST")
	api.BaseRoutes.Channel.Handle("/member_counts_by_group", api.APISessionRequired(channelMemberCountsByGroup)).Methods("GET")

	api.BaseRoutes.ChannelForUser.Handle("/unread", api.APISessionRequired(getChannelUnread, model.ScopeChannelsRead)).Methods("GET")

	api.BaseRoutes.ChannelByName.Handle("", api.APISessionRequired(getChannelByName, model.ScopeChannelsRead)).Methods("GET")
	api.BaseRoutes.ChannelByNameForTeamName.Handle("", api.APISessionRequired(getChannelByNameForTeamName, model.ScopeChannelsRead, model.ScopeTeamsRead)).Methods("GET")

	api.BaseRoutes.ChannelMembers.Handle("", api.APISessionRequired(getChannelMembers, model.ScopeChannelsRead, model.ScopeUsersRead)).Methods("GET")
	api.BaseRoutes.ChannelMembers.Handle("/ids", api.APISessionRequired(getChannelMembersByIds, model.ScopeChannelsRead, model.ScopeUsersRead)).Methods("POST")
	api.BaseRoutes.ChannelMembers.Handle("", api.APISessionRequired(addChannelMember, model.ScopeChannelsJoin)).Methods("POST")
	api.BaseRoutes.ChannelMembersForUser.Handle("", api.APISessionRequired(getChannelMembersForTeamForUser, model.ScopeChannelsRead, model.ScopeTeamsRead, model.ScopeUsersRead)).Methods("GET")
	api.BaseRoutes.ChannelMember.Handle("", api.APISessionRequired(getChannelMember, model.ScopeChannelsRead, model.ScopeUsersRead)).Methods("GET")
	api.BaseRoutes.ChannelMember.Handle("", api.APISessionRequired(removeChannelMember, model.ScopeChannelsJoin, model.ScopeUsersUpdate)).Methods("DELETE")
