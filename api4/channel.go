...
func (api *API) InitChannel() {
	...
	api.BaseRoutes.ChannelCategory.Handle("", api.ApiSessionRequired(getCategoryForTeamForUser)).Methods("GET")
	api.BaseRoutes.ChannelCategory.Handle("", api.ApiSessionRequired(updateCategoryForTeamForUser)).Methods("PUT")
	api.BaseRoutes.ChannelCategory.Handle("", api.ApiSessionRequired(deleteCategoryForTeamForUser)).Methods("DELETE")
