...
func (api *API) InitPost() {
	...
	api.BaseRoutes.Post.Handle("/set-unread", api.ApiSessionRequired(setChannelUnread)).Methods("POST")
...
func setChannelUnread(c *Context, w http.ResponseWriter, r *http.Request) {
	c.RequirePostId()
	if c.Err != nil {
		return
	}
