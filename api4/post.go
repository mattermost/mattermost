...
func (api *API) InitPost() {
	api.BaseRoutes.Posts.Handle("", api.APISessionRequired(createPost, model.ScopeMessageWrite)).Methods("POST")
	api.BaseRoutes.Post.Handle("", api.APISessionRequired(getPost, model.ScopeMessageRead)).Methods("GET")
	...
	api.BaseRoutes.Team.Handle("/posts/search", api.APISessionRequiredDisableWhenBusy(searchPostsInTeam, model.ScopeSearchPosts)).Methods("POST")
	api.BaseRoutes.Posts.Handle("/search", api.APISessionRequiredDisableWhenBusy(searchPostsInAllTeams, model.ScopeSearchPosts)).Methods("POST")
