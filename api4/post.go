...
func createPost(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	auditRec.AddMeta("post", audit.NewPost(post))
	...
	auditRec.Success()
	auditRec.AddMeta("post", audit.NewPost(rp)) // overwrite meta
...
func updatePost(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	auditRec.AddMeta("post", audit.NewPost(originalPost))
	...
	auditRec.Success()
	auditRec.AddMeta("update", audit.NewPost(rpost))
...
func patchPost(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	auditRec.Success()
	auditRec.AddMeta("patch", audit.NewPost(patchedPost))
