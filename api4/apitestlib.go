...
func getMockStore() store.Store {
	...
	systemStore.On("GetByName", app.MIGRATION_KEY_EMOJI_PERMISSIONS_SPLIT).Return(&model.System{Name: app.MIGRATION_KEY_EMOJI_PERMISSIONS_SPLIT, Value: "true"}, nil)
	systemStore.On("GetByName", app.MIGRATION_KEY_WEBHOOK_PERMISSIONS_SPLIT).Return(&model.System{Name: app.MIGRATION_KEY_WEBHOOK_PERMISSIONS_SPLIT, Value: "true"}, nil)
	systemStore.On("GetByName", app.MIGRATION_KEY_LIST_JOIN_PUBLIC_PRIVATE_TEAMS).Return(&model.System{Name: app.MIGRATION_KEY_LIST_JOIN_PUBLIC_PRIVATE_TEAMS, Value: "true"}, nil)
	systemStore.On("GetByName", app.MIGRATION_KEY_REMOVE_PERMANENT_DELETE_USER).Return(&model.System{Name: app.MIGRATION_KEY_REMOVE_PERMANENT_DELETE_USER, Value: "true"}, nil)
	systemStore.On("GetByName", app.MIGRATION_KEY_ADD_BOT_PERMISSIONS).Return(&model.System{Name: app.MIGRATION_KEY_ADD_BOT_PERMISSIONS, Value: "true"}, nil)
	systemStore.On("GetByName", app.MIGRATION_KEY_APPLY_CHANNEL_MANAGE_DELETE_TO_CHANNEL_USER).Return(&model.System{Name: app.MIGRATION_KEY_APPLY_CHANNEL_MANAGE_DELETE_TO_CHANNEL_USER, Value: "true"}, nil)
	systemStore.On("GetByName", app.MIGRATION_KEY_REMOVE_CHANNEL_MANAGE_DELETE_FROM_TEAM_USER).Return(&model.System{Name: app.MIGRATION_KEY_REMOVE_CHANNEL_MANAGE_DELETE_FROM_TEAM_USER, Value: "true"}, nil)
	systemStore.On("GetByName", app.MIGRATION_KEY_VIEW_MEMBERS_NEW_PERMISSION).Return(&model.System{Name: app.MIGRATION_KEY_VIEW_MEMBERS_NEW_PERMISSION, Value: "true"}, nil)
	systemStore.On("GetByName", app.MIGRATION_KEY_ADD_MANAGE_GUESTS_PERMISSIONS).Return(&model.System{Name: app.MIGRATION_KEY_ADD_MANAGE_GUESTS_PERMISSIONS, Value: "true"}, nil)
