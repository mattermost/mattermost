...
type Routes struct {
	...
	ChannelPreviewers        *mux.Router // 'api/v4/channels/{channel_id:[A-Za-z0-9]+}/previewers'
	ChannelPreviewer         *mux.Router // 'api/v4/channels/{channel_id:[A-Za-z0-9]+}/previewers/{user_id:[A-Za-z0-9]+}'
...
func Init(srv *app.Server) (*API, error) {
	...
	api.BaseRoutes.ChannelPreviewers = api.BaseRoutes.Channel.PathPrefix("/previewers").Subrouter()
	api.BaseRoutes.ChannelPreviewer = api.BaseRoutes.ChannelPreviewers.PathPrefix("/{user_id:[A-Za-z0-9]+}").Subrouter()
