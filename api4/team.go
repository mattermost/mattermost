...
func (api *API) InitTeam() {
	api.BaseRoutes.Teams.Handle("", api.APISessionRequiredWithDenyScope(createTeam)).Methods("POST")
	api.BaseRoutes.Teams.Handle("", api.APISessionRequiredWithDenyScope(getAllTeams)).Methods("GET")
	api.BaseRoutes.Teams.Handle("/{team_id:[A-Za-z0-9]+}/scheme", api.APISessionRequiredWithDenyScope(updateTeamScheme)).Methods("PUT")
	api.BaseRoutes.Teams.Handle("/search", api.APISessionRequiredDisableWhenBusy(searchTeams, model.ScopeDeny())).Methods("POST")
	api.BaseRoutes.TeamsForUser.Handle("", api.APISessionRequiredWithDenyScope(getTeamsForUser)).Methods("GET")
	api.BaseRoutes.TeamsForUser.Handle("/unread", api.APISessionRequiredWithDenyScope(getTeamsUnreadForUser)).Methods("GET")

	api.BaseRoutes.Team.Handle("", api.APISessionRequiredWithDenyScope(getTeam)).Methods("GET")
	api.BaseRoutes.Team.Handle("", api.APISessionRequiredWithDenyScope(updateTeam)).Methods("PUT")
	api.BaseRoutes.Team.Handle("", api.APISessionRequiredWithDenyScope(deleteTeam)).Methods("DELETE")
	api.BaseRoutes.Team.Handle("/patch", api.APISessionRequiredWithDenyScope(patchTeam)).Methods("PUT")
	api.BaseRoutes.Team.Handle("/restore", api.APISessionRequiredWithDenyScope(restoreTeam)).Methods("POST")
	api.BaseRoutes.Team.Handle("/privacy", api.APISessionRequiredWithDenyScope(updateTeamPrivacy)).Methods("PUT")
	api.BaseRoutes.Team.Handle("/stats", api.APISessionRequiredWithDenyScope(getTeamStats)).Methods("GET")
	api.BaseRoutes.Team.Handle("/regenerate_invite_id", api.APISessionRequiredWithDenyScope(regenerateTeamInviteId)).Methods("POST")

	api.BaseRoutes.Team.Handle("/image", api.APISessionRequiredTrustRequester(getTeamIcon, model.ScopeDeny())).Methods("GET")
	api.BaseRoutes.Team.Handle("/image", api.APISessionRequiredWithDenyScope(setTeamIcon)).Methods("POST")
	api.BaseRoutes.Team.Handle("/image", api.APISessionRequiredWithDenyScope(removeTeamIcon)).Methods("DELETE")

	api.BaseRoutes.TeamMembers.Handle("", api.APISessionRequiredWithDenyScope(getTeamMembers)).Methods("GET")
	api.BaseRoutes.TeamMembers.Handle("/ids", api.APISessionRequiredWithDenyScope(getTeamMembersByIds)).Methods("POST")
	api.BaseRoutes.TeamMembersForUser.Handle("", api.APISessionRequiredWithDenyScope(getTeamMembersForUser)).Methods("GET")
	api.BaseRoutes.TeamMembers.Handle("", api.APISessionRequiredWithDenyScope(addTeamMember)).Methods("POST")
	api.BaseRoutes.Teams.Handle("/members/invite", api.APISessionRequiredWithDenyScope(addUserToTeamFromInvite)).Methods("POST")
	api.BaseRoutes.TeamMembers.Handle("/batch", api.APISessionRequiredWithDenyScope(addTeamMembers)).Methods("POST")
	api.BaseRoutes.TeamMember.Handle("", api.APISessionRequiredWithDenyScope(removeTeamMember)).Methods("DELETE")

	api.BaseRoutes.TeamForUser.Handle("/unread", api.APISessionRequiredWithDenyScope(getTeamUnread)).Methods("GET")

	api.BaseRoutes.TeamByName.Handle("", api.APISessionRequiredWithDenyScope(getTeamByName)).Methods("GET")
	api.BaseRoutes.TeamMember.Handle("", api.APISessionRequiredWithDenyScope(getTeamMember)).Methods("GET")
	api.BaseRoutes.TeamByName.Handle("/exists", api.APISessionRequiredWithDenyScope(teamExists)).Methods("GET")
	api.BaseRoutes.TeamMember.Handle("/roles", api.APISessionRequiredWithDenyScope(updateTeamMemberRoles)).Methods("PUT")
	api.BaseRoutes.TeamMember.Handle("/schemeRoles", api.APISessionRequiredWithDenyScope(updateTeamMemberSchemeRoles)).Methods("PUT")
	api.BaseRoutes.Team.Handle("/import", api.APISessionRequiredWithDenyScope(importTeam)).Methods("POST")
	api.BaseRoutes.Team.Handle("/invite/email", api.APISessionRequiredWithDenyScope(inviteUsersToTeam)).Methods("POST")
	api.BaseRoutes.Team.Handle("/invite-guests/email", api.APISessionRequiredWithDenyScope(inviteGuestsToChannels)).Methods("POST")
	api.BaseRoutes.Teams.Handle("/invites/email", api.APISessionRequiredWithDenyScope(invalidateAllEmailInvites)).Methods("DELETE")
	...
	api.BaseRoutes.Teams.Handle("/{team_id:[A-Za-z0-9]+}/members_minus_group_members", api.APISessionRequiredWithDenyScope(teamMembersMinusGroupMembers)).Methods("GET")
}
