...
func (api *API) InitTeam() {
	api.BaseRoutes.Teams.Handle("", api.APISessionRequired(createTeam, model.ScopeTeamsCreate)).Methods("POST")
	api.BaseRoutes.Teams.Handle("", api.APISessionRequired(getAllTeams, model.ScopeTeamsRead)).Methods("GET")
	api.BaseRoutes.Teams.Handle("/{team_id:[A-Za-z0-9]+}/scheme", api.APISessionRequired(updateTeamScheme)).Methods("PUT")
	api.BaseRoutes.Teams.Handle("/search", api.APISessionRequiredDisableWhenBusy(searchTeams, model.ScopeTeamsSearch, model.ScopeTeamsRead)).Methods("POST")
	api.BaseRoutes.TeamsForUser.Handle("", api.APISessionRequired(getTeamsForUser, model.ScopeTeamsRead, model.ScopeUsersRead)).Methods("GET")
	api.BaseRoutes.TeamsForUser.Handle("/unread", api.APISessionRequired(getTeamsUnreadForUser, model.ScopeTeamsRead, model.ScopeUsersRead)).Methods("GET")

	api.BaseRoutes.Team.Handle("", api.APISessionRequired(getTeam, model.ScopeTeamsRead)).Methods("GET")
	api.BaseRoutes.Team.Handle("", api.APISessionRequired(updateTeam, model.ScopeTeamsUpdate)).Methods("PUT")
	api.BaseRoutes.Team.Handle("", api.APISessionRequired(deleteTeam, model.ScopeTeamsDelete)).Methods("DELETE")
	api.BaseRoutes.Team.Handle("/except", api.APISessionRequired(softDeleteTeamsExcept, model.ScopeTeamsDelete)).Methods("DELETE")
	api.BaseRoutes.Team.Handle("/patch", api.APISessionRequired(patchTeam, model.ScopeTeamsUpdate)).Methods("PUT")
	api.BaseRoutes.Team.Handle("/restore", api.APISessionRequired(restoreTeam, model.ScopeTeamsUpdate)).Methods("POST")
	api.BaseRoutes.Team.Handle("/privacy", api.APISessionRequired(updateTeamPrivacy, model.ScopeTeamsUpdate)).Methods("PUT")
	api.BaseRoutes.Team.Handle("/stats", api.APISessionRequired(getTeamStats, model.ScopeTeamsRead)).Methods("GET")
	api.BaseRoutes.Team.Handle("/regenerate_invite_id", api.APISessionRequired(regenerateTeamInviteId)).Methods("POST")

	api.BaseRoutes.Team.Handle("/image", api.APISessionRequiredTrustRequester(getTeamIcon, model.ScopeTeamsRead)).Methods("GET")
	api.BaseRoutes.Team.Handle("/image", api.APISessionRequired(setTeamIcon, model.ScopeTeamsUpdate)).Methods("POST")
	api.BaseRoutes.Team.Handle("/image", api.APISessionRequired(removeTeamIcon, model.ScopeTeamsUpdate)).Methods("DELETE")

	api.BaseRoutes.TeamMembers.Handle("", api.APISessionRequired(getTeamMembers, model.ScopeTeamsRead, model.ScopeUsersRead)).Methods("GET")
	api.BaseRoutes.TeamMembers.Handle("/ids", api.APISessionRequired(getTeamMembersByIds, model.ScopeTeamsRead, model.ScopeUsersRead)).Methods("POST")
	api.BaseRoutes.TeamMembersForUser.Handle("", api.APISessionRequired(getTeamMembersForUser, model.ScopeTeamsRead, model.ScopeUsersRead)).Methods("GET")
	api.BaseRoutes.TeamMembers.Handle("", api.APISessionRequired(addTeamMember, model.ScopeTeamsJoin)).Methods("POST")
	api.BaseRoutes.Teams.Handle("/members/invite", api.APISessionRequired(addUserToTeamFromInvite)).Methods("POST")
	api.BaseRoutes.TeamMembers.Handle("/batch", api.APISessionRequired(addTeamMembers, model.ScopeTeamsJoin)).Methods("POST")
	api.BaseRoutes.TeamMember.Handle("", api.APISessionRequired(removeTeamMember, model.ScopeTeamsJoin, model.ScopeUsersUpdate)).Methods("DELETE")

	api.BaseRoutes.TeamForUser.Handle("/unread", api.APISessionRequired(getTeamUnread, model.ScopeTeamsRead)).Methods("GET")

	api.BaseRoutes.TeamByName.Handle("", api.APISessionRequired(getTeamByName, model.ScopeTeamsRead)).Methods("GET")
	api.BaseRoutes.TeamMember.Handle("", api.APISessionRequired(getTeamMember, model.ScopeTeamsRead, model.ScopeUsersRead)).Methods("GET")
	api.BaseRoutes.TeamByName.Handle("/exists", api.APISessionRequired(teamExists, model.ScopeTeamsRead)).Methods("GET")
