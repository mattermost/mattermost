...
func TestCreateTermsOfService(t *testing.T) {
	...
	_, resp := Client.CreateTermsOfService("terms of service new", th.BasicUser.Id, true)
...
func TestCreateTermsOfServiceAdminUser(t *testing.T) {
	...
	termsOfService, resp := Client.CreateTermsOfService("terms of service new", th.SystemAdminUser.Id, true)
	...
	termsOfService, resp = Client.CreateTermsOfService("terms of service new_2", th.SystemAdminUser.Id, true)
	CheckNoError(t, resp)
	assert.NotEmpty(t, termsOfService.Id)
	assert.NotEmpty(t, termsOfService.CreateAt)
