...
func (api *API) InitExport() {
	...
	api.BaseRoutes.ExportFile.Handle("", api.APISessionRequired(deleteExport)).Methods("DELETE")
	api.BaseRoutes.ExportFile.Handle("", api.APISessionRequired(downloadExport)).Methods("GET")
}
