...
func (api *API) InitUser() {
	...
	api.BaseRoutes.User.Handle("/sessions/revoke/all_users", api.ApiSessionRequired(revokeAllSessionsAllUser)).Methods("POST")
...
func revokeAllSessionsAllUser(c *Context, w http.ResponseWriter, r *http.Request) {
	c.RequireUserId()
	if c.Err != nil {
		return
	}
