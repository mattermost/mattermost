...
func (api *API) InitUser() {
	...
	api.BaseRoutes.Users.Handle("/autocomplete", api.APISessionRequired(autocompleteUsers, model.ScopeUsersSearch)).Methods("GET")
	...
	api.BaseRoutes.User.Handle("/uploads", api.APISessionRequired(getUploadsForUser, model.ScopeUsersRead, model.ScopeFilesRead)).Methods("GET")
	api.BaseRoutes.User.Handle("/channel_members", api.APISessionRequired(getChannelMembersForUser, model.ScopeUsersRead, model.ScopeChannelsRead)).Methods("GET")
