...
func (api *API) InitUser() {
	...
	api.BaseRoutes.Users.Handle("/password/reset", api.APIHandler(resetPassword, model.ScopeAny)).Methods("POST")
	api.BaseRoutes.Users.Handle("/password/reset/send", api.APIHandler(sendPasswordReset, model.ScopeAny)).Methods("POST")
	api.BaseRoutes.Users.Handle("/email/verify", api.APIHandler(verifyUserEmail, model.ScopeAny)).Methods("POST")
	api.BaseRoutes.Users.Handle("/email/verify/send", api.APIHandler(sendVerificationEmail, model.ScopeAny)).Methods("POST")
