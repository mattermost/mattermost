...
func (api *API) InitUser() {
	api.BaseRoutes.Users.Handle("", api.APIHandler(createUser, model.ScopeUsersCreate)).Methods("POST")

	api.BaseRoutes.Users.Handle("", api.APISessionRequired(getUsers, model.ScopeUsersRead)).Methods("GET")
	api.BaseRoutes.Users.Handle("/ids", api.APISessionRequired(getUsersByIds, model.ScopeUsersRead)).Methods("POST")
	api.BaseRoutes.Users.Handle("/usernames", api.APISessionRequired(getUsersByNames, model.ScopeUsersRead)).Methods("POST")
	api.BaseRoutes.Users.Handle("/known", api.APISessionRequired(getKnownUsers, model.ScopeUsersRead)).Methods("GET")
	api.BaseRoutes.Users.Handle("/search", api.APISessionRequiredDisableWhenBusy(searchUsers, model.ScopeUsersRead, model.ScopeUsersSearch)).Methods("POST")
	api.BaseRoutes.Users.Handle("/autocomplete", api.APISessionRequired(autocompleteUsers, model.ScopeUsersRead, model.ScopeUsersSearch)).Methods("GET")
	...
	api.BaseRoutes.User.Handle("", api.APISessionRequired(getUser, model.ScopeUsersRead)).Methods("GET")
	api.BaseRoutes.User.Handle("/image/default", api.APISessionRequiredTrustRequester(getDefaultProfileImage, model.ScopeUsersRead)).Methods("GET")
	api.BaseRoutes.User.Handle("/image", api.APISessionRequiredTrustRequester(getProfileImage, model.ScopeUsersRead)).Methods("GET")
	api.BaseRoutes.User.Handle("/image", api.APISessionRequired(setProfileImage, model.ScopeUsersUpdate)).Methods("POST")
	api.BaseRoutes.User.Handle("/image", api.APISessionRequired(setDefaultProfileImage, model.ScopeUsersUpdate)).Methods("DELETE")
	api.BaseRoutes.User.Handle("", api.APISessionRequired(updateUser, model.ScopeUsersUpdate)).Methods("PUT")
	api.BaseRoutes.User.Handle("/patch", api.APISessionRequired(patchUser, model.ScopeUsersUpdate)).Methods("PUT")
	api.BaseRoutes.User.Handle("", api.APISessionRequired(deleteUser, model.ScopeUsersDelete)).Methods("DELETE")
	api.BaseRoutes.User.Handle("/roles", api.APISessionRequired(updateUserRoles, model.ScopeUsersUpdate)).Methods("PUT")
	api.BaseRoutes.User.Handle("/active", api.APISessionRequired(updateUserActive, model.ScopeUsersUpdate)).Methods("PUT")
	api.BaseRoutes.User.Handle("/password", api.APISessionRequired(updatePassword)).Methods("PUT")
	api.BaseRoutes.User.Handle("/promote", api.APISessionRequired(promoteGuestToUser, model.ScopeUsersUpdate)).Methods("POST")
	api.BaseRoutes.User.Handle("/demote", api.APISessionRequired(demoteUserToGuest, model.ScopeUsersUpdate)).Methods("POST")
	api.BaseRoutes.User.Handle("/convert_to_bot", api.APISessionRequired(convertUserToBot, model.ScopeUsersUpdate)).Methods("POST")
	api.BaseRoutes.Users.Handle("/password/reset", api.APIHandler(resetPassword, model.ScopeUsersUpdate)).Methods("POST")
	...
	api.BaseRoutes.User.Handle("/auth", api.APISessionRequiredTrustRequester(updateUserAuth, model.ScopeUsersUpdate)).Methods("PUT")
	...
	api.BaseRoutes.Users.Handle("/login", api.APIHandler(login, model.ScopeAny)).Methods("POST")
	...
	api.BaseRoutes.Users.Handle("/logout", api.APIHandler(logout, model.ScopeAny)).Methods("POST")

	api.BaseRoutes.UserByUsername.Handle("", api.APISessionRequired(getUserByUsername, model.ScopeUsersRead)).Methods("GET")
	api.BaseRoutes.UserByEmail.Handle("", api.APISessionRequired(getUserByEmail, model.ScopeUsersRead)).Methods("GET")
	...
	api.BaseRoutes.User.Handle("/typing", api.APISessionRequiredDisableWhenBusy(publishUserTyping, model.ScopeUsersUpdate)).Methods("POST")
	...
	api.BaseRoutes.User.Handle("/uploads", api.APISessionRequired(getUploadsForUser, model.ScopeUsersRead)).Methods("GET")
	api.BaseRoutes.User.Handle("/channel_members", api.APISessionRequired(getChannelMembersForUser, model.ScopeUsersRead)).Methods("GET")
	api.BaseRoutes.User.Handle("/recent_searches", api.APISessionRequiredDisableWhenBusy(getRecentSearches, model.ScopeUsersRead)).Methods("GET")
