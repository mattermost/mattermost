...
func (api *API) InitUser() {
	...
	api.BaseRoutes.Users.Handle("/password/reset", api.APIHandler(resetPassword, model.ScopeNoScope)).Methods("POST")
	api.BaseRoutes.Users.Handle("/password/reset/send", api.APIHandler(sendPasswordReset, model.ScopeNoScope)).Methods("POST")
	api.BaseRoutes.Users.Handle("/email/verify", api.APIHandler(verifyUserEmail, model.ScopeNoScope)).Methods("POST")
	api.BaseRoutes.Users.Handle("/email/verify/send", api.APIHandler(sendVerificationEmail, model.ScopeNoScope)).Methods("POST")
