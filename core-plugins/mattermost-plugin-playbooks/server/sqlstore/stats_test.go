...
func TestTotalInProgressPlaybookRuns(t *testing.T) {
	...
	t.Run("Active Participants - team1", func(t *testing.T) {
	...
	t.Run("Active Participants - team2", func(t *testing.T) {
		result := statsStore.TotalActiveParticipants(&StatsFilters{
			TeamID: team2id,
		})
	...
	t.Run("Active Participants, playbook1", func(t *testing.T) {
		result := statsStore.TotalActiveParticipants(&StatsFilters{
	...
	t.Run("Active Participants, playbook2", func(t *testing.T) {
		result := statsStore.TotalActiveParticipants(&StatsFilters{
	...
	t.Run("Active Participants, all", func(t *testing.T) {
		result := statsStore.TotalActiveParticipants(&StatsFilters{})
		assert.Equal(t, 8, result)
	})

	t.Run("In-progress Playbook Runs - team1", func(t *testing.T) {
	...
	t.Run("In-progress Playbook Runs - team2", func(t *testing.T) {
		result := statsStore.TotalInProgressPlaybookRuns(&StatsFilters{
			TeamID: team2id,
		})
		assert.Equal(t, 3, result)
	...
	t.Run("In-progress Playbook Runs - playbook1", func(t *testing.T) {
		result := statsStore.TotalInProgressPlaybookRuns(&StatsFilters{
			PlaybookID: "playbook1",
		})
	...
	t.Run("In-progress Playbook Runs - playbook2", func(t *testing.T) {
		result := statsStore.TotalInProgressPlaybookRuns(&StatsFilters{
			PlaybookID: "playbook2",
		})
	...
	t.Run("In-progress Playbook Runs - all", func(t *testing.T) {
		result := statsStore.TotalInProgressPlaybookRuns(&StatsFilters{})
		assert.Equal(t, 6, result)
	})
	...
	t.Run("RunsStartedPerWeekLastXWeeks for a playbook with no runs", func(t *testing.T) {
	...
	t.Run("ActiveRunsPerDayLastXDays for a playbook with no runs", func(t *testing.T) {
	...
	t.Run("ActiveParticipantsPerDayLastXDays for a playbook with no runs", func(t *testing.T) {
...
func TestTotalPlaybookRuns(t *testing.T) {
	...
	t.Run("TotalPlaybookRuns", func(t *testing.T) {
...
func TestTotalPlaybooks(t *testing.T) {
	...
	t.Run("TotalPlaybooks", func(t *testing.T) {
