...
func testFileInfoSearchFileInfosIncludingDMs(t *testing.T, th *SearchTestHelper) {
	...
	post, err := th.createPost(th.User.Id, direct.Id, "dm test", "", model.PostDefault, 0, false)
	require.NoError(t, err)
	defer th.deleteUserPosts(th.User.Id)

	post2, err := th.createPost(th.User.Id, th.ChannelBasic.Id, "dm test", "", model.PostDefault, 0, false)
	require.NoError(t, err)
...
func testFileInfoSearchFileInfosWithPagination(t *testing.T, th *SearchTestHelper) {
	...
	post, err := th.createPost(th.User.Id, direct.Id, "dm test", "", model.PostDefault, 10000, false)
	require.NoError(t, err)
	defer th.deleteUserPosts(th.User.Id)

	post2, err := th.createPost(th.User.Id, th.ChannelBasic.Id, "dm test", "", model.PostDefault, 20000, false)
	require.NoError(t, err)
...
func testFileInfoSearchExactPhraseInQuotes(t *testing.T, th *SearchTestHelper) {
	post, err := th.createPost(th.User.Id, th.ChannelBasic.Id, "testmessage", "", model.PostDefault, 0, false)
	require.NoError(t, err)
	defer th.deleteUserPosts(th.User.Id)
...
func testFileInfoSearchOrExcludeFileInfosBySpecificUser(t *testing.T, th *SearchTestHelper) {
	post, err := th.createPost(th.User.Id, th.ChannelPrivate.Id, "testmessage", "", model.PostDefault, 0, false)
	require.NoError(t, err)
	defer th.deleteUserPosts(th.User.Id)
...
func testFileInfoSearchOrExcludeFileInfosInChannel(t *testing.T, th *SearchTestHelper) {
	...
	require.NoError(t, err)
	defer th.deleteUserPosts(th.User.Id)
	post2, err := th.createPost(th.User.Id, th.ChannelPrivate.Id, "testmessage", "", model.PostDefault, 0, false)
	require.NoError(t, err)
	defer th.deleteUserPosts(th.User.Id)
...
func testFileInfoSearchOrExcludeFileInfosInDMGM(t *testing.T, th *SearchTestHelper) {
	...
	post1, err := th.createPost(th.User.Id, direct.Id, "test fromuser", "", model.PostDefault, 0, false)
	require.NoError(t, err)
	post2, err := th.createPost(th.User2.Id, group.Id, "test fromuser 2", "", model.PostDefault, 0, false)
	require.NoError(t, err)
	defer th.deleteUserPosts(th.User.Id)
...
func testFileInfoFilterFilesInSpecificDate(t *testing.T, th *SearchTestHelper) {
	post1, err := th.createPost(th.User.Id, th.ChannelBasic.Id, "testmessage", "", model.PostDefault, 0, false)
	require.NoError(t, err)
	post2, err := th.createPost(th.User.Id, th.ChannelPrivate.Id, "testmessage", "", model.PostDefault, 0, false)
	require.NoError(t, err)
	defer th.deleteUserPosts(th.User.Id)
...
func testFileInfoSearchInDeletedOrArchivedChannels(t *testing.T, th *SearchTestHelper) {
	post1, err := th.createPost(th.User.Id, th.ChannelDeleted.Id, "testmessage", "", model.PostDefault, 0, false)
	require.NoError(t, err)
	defer th.deleteUserPosts(th.User.Id)
	post2, err := th.createPost(th.User.Id, th.ChannelBasic.Id, "testmessage", "", model.PostDefault, 0, false)
	require.NoError(t, err)
	defer th.deleteUserPosts(th.User.Id)
	post3, err := th.createPost(th.User.Id, th.ChannelPrivate.Id, "testmessage", "", model.PostDefault, 0, false)
	require.NoError(t, err)
	defer th.deleteUserPosts(th.User.Id)
