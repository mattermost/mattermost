...
func (s *TimerLayerUserStore) GetUsersWithCustomStatus() ([]*model.User, error) {
	start := timemodule.Now()
	...
	if s.Root.Metrics != nil {
		...
		s.Root.Metrics.ObserveStoreMethodDuration("UserStore.GetUsersWithCustomStatus", success, elapsed)
	}
	return result, err
}
