...
func (s *OpenTracingLayer) Theme() ThemeStore {
	return s.ThemeStore
}
...
type OpenTracingLayerThemeStore struct {
	ThemeStore
	Root *OpenTracingLayer
}
...
func (s *OpenTracingLayerThemeStore) Delete(id string) *model.AppError {
	origCtx := s.Root.Store.Context()
	span, newCtx := tracing.StartSpanWithParentByContext(s.Root.Store.Context(), "ThemeStore.Delete")
	s.Root.Store.SetContext(newCtx)
	defer func() {
		s.Root.Store.SetContext(origCtx)
	}()
...
func (s *OpenTracingLayerThemeStore) Get(id string) (*model.Theme, *model.AppError) {
	origCtx := s.Root.Store.Context()
	span, newCtx := tracing.StartSpanWithParentByContext(s.Root.Store.Context(), "ThemeStore.Get")
	s.Root.Store.SetContext(newCtx)
	defer func() {
		s.Root.Store.SetContext(origCtx)
	}()
...
func (s *OpenTracingLayerThemeStore) GetAll() ([]*model.Theme, *model.AppError) {
	origCtx := s.Root.Store.Context()
	span, newCtx := tracing.StartSpanWithParentByContext(s.Root.Store.Context(), "ThemeStore.GetAll")
	s.Root.Store.SetContext(newCtx)
	defer func() {
		s.Root.Store.SetContext(origCtx)
	}()
...
func (s *OpenTracingLayerThemeStore) Save(theme *model.Theme) (*model.Theme, *model.AppError) {
	origCtx := s.Root.Store.Context()
	span, newCtx := tracing.StartSpanWithParentByContext(s.Root.Store.Context(), "ThemeStore.Save")
	s.Root.Store.SetContext(newCtx)
	defer func() {
		s.Root.Store.SetContext(origCtx)
	}()
...
func NewOpenTracingLayer(childStore Store, ctx context.Context) *OpenTracingLayer {
	...
	newStore.ThemeStore = &OpenTracingLayerThemeStore{ThemeStore: childStore.Theme(), Root: &newStore}
