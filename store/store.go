...
type PostStore interface {
	...
	Get(ctx context.Context, id string, skipFetchThreads, collapsedThreads, collapsedThreadsExtended bool, userID string, sanitizeOptions map[string]bool) (*model.PostList, error)
