...
type UserStore interface {
	...
	Search(teamId string, term string, options map[string]bool, limit int) StoreChannel
	SearchNotInTeam(notInTeamId string, term string, options map[string]bool, limit int) StoreChannel
	SearchInChannel(channelId string, term string, options map[string]bool, limit int) StoreChannel
	SearchNotInChannel(teamId string, channelId string, term string, options map[string]bool, limit int) StoreChannel
	SearchWithoutTeam(term string, options map[string]bool, limit int) StoreChannel
