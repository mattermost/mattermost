...
type TeamStore interface {
	...
	SearchAll(term string) ([]*model.Team, error)
	...
	AnalyticsTeamCount() (int64, error)
	...
	GetMembers(teamId string, offset int, limit int, restrictions *model.ViewUsersRestrictions) ([]*model.TeamMember, error)
...
type ChannelStore interface {
	...
	GetDeleted(team_id string, offset int, limit int) (*model.ChannelList, error)
	...
	GetChannelsByIds(channelIds []string) ([]*model.Channel, error)
	...
	SearchAllChannels(term string, opts ChannelSearchOpts) (*model.ChannelListWithTeamData, error)
...
type UserStore interface {
	...
	GetProfilesInChannel(channelId string, offset int, limit int) ([]*model.User, error)
	GetProfilesInChannelByStatus(channelId string, offset int, limit int) ([]*model.User, error)
...
type RoleStore interface {
	...
	Delete(roldId string) (*model.Role, error)
...
type GroupStore interface {
	...
	TeamMembersToAdd(since int64) ([]*model.UserTeamIDPair, error)
	ChannelMembersToAdd(since int64) ([]*model.UserChannelIDPair, error)

	TeamMembersToRemove() ([]*model.TeamMember, error)
	ChannelMembersToRemove() ([]*model.ChannelMember, error)

	GetGroupsByChannel(channelId string, opts model.GroupSearchOpts) ([]*model.Group, error)
	CountGroupsByChannel(channelId string, opts model.GroupSearchOpts) (int64, error)

	GetGroupsByTeam(teamId string, opts model.GroupSearchOpts) ([]*model.Group, error)
