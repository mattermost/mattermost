...
func (s *RetryLayerThreadStore) ReinstateMembershipsForChannel(userID string, channelID string) error {
...
func (s *RetryLayerThreadStore) RemoveMembershipsForChannel(userID string, channelID string) error {
