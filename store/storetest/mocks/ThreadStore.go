...
// PermanentDeleteBatchThreadMembershipsForRetentionPolicies provides a mock function with given fields: now, limit
func (_m *ThreadStore) PermanentDeleteBatchThreadMembershipsForRetentionPolicies(now int64, limit int64) (int64, error) {
...
// PermanentDeleteBatchThreadsForRetentionPolicies provides a mock function with given fields: now, limit
func (_m *ThreadStore) PermanentDeleteBatchThreadsForRetentionPolicies(now int64, limit int64) (int64, error) {
	ret := _m.Called(now, limit)
