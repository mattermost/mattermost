...
func (_m *ThreadStore) Get(ctx context.Context, id string) (*model.Thread, error) {
	ret := _m.Called(ctx, id)

	var r0 *model.Thread
	if rf, ok := ret.Get(0).(func(context.Context, string) *model.Thread); ok {
		r0 = rf(ctx, id)
	} else {
		if ret.Get(0) != nil {
...
// MaintainMembership provides a mock function with given fields: ctx, userID, postID, opts
func (_m *ThreadStore) MaintainMembership(ctx context.Context, userID string, postID string, opts store.ThreadMembershipOpts) (*model.ThreadMembership, error) {
	ret := _m.Called(ctx, userID, postID, opts)

	var r0 *model.ThreadMembership
	if rf, ok := ret.Get(0).(func(context.Context, string, string, store.ThreadMembershipOpts) *model.ThreadMembership); ok {
		r0 = rf(ctx, userID, postID, opts)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*model.ThreadMembership)
		}
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, string, string, store.ThreadMembershipOpts) error); ok {
		r1 = rf(ctx, userID, postID, opts)
	} else {
		r1 = ret.Error(1)
	}
