...
// GetAllThreadsNewerThanChannelLastViewedAt provides a mock function with given fields:
func (_m *ThreadStore) GetAllThreadsNewerThanChannelLastViewedAt() ([]*model.ThreadsNewerThanChannelLastViewedAt, error) {
	ret := _m.Called()

	var r0 []*model.ThreadsNewerThanChannelLastViewedAt
	if rf, ok := ret.Get(0).(func() []*model.ThreadsNewerThanChannelLastViewedAt); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*model.ThreadsNewerThanChannelLastViewedAt)
		}
	}
