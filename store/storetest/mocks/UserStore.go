...
// GetParticipantProfilesByIds provides a mock function with given fields: ctx, userIds, extended, allowFromCache
func (_m *UserStore) GetParticipantProfilesByIds(ctx context.Context, userIds []string, extended bool, allowFromCache bool) ([]*model.User, error) {
	ret := _m.Called(ctx, userIds, extended, allowFromCache)

	var r0 []*model.User
	if rf, ok := ret.Get(0).(func(context.Context, []string, bool, bool) []*model.User); ok {
		r0 = rf(ctx, userIds, extended, allowFromCache)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*model.User)
		}
	...
	if rf, ok := ret.Get(1).(func(context.Context, []string, bool, bool) error); ok {
		r1 = rf(ctx, userIds, extended, allowFromCache)
	} else {
		r1 = ret.Error(1)
	}
