...
// CacheFactory is an autogenerated mock type for the CacheFactory type
type CacheFactory struct {
	mock.Mock
}

// NewCache provides a mock function with given fields: size
func (_m *CacheFactory) NewCache(size int) store.Cache {
	ret := _m.Called(size)
...
func (_m *CacheFactory) NewCacheWithParams(size int, name string, defaultExpiry int64, invalidateClusterEvent string) store.Cache {
