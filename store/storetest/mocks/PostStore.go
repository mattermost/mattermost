...
func (_m *PostStore) GetPostsByUserInChannelSince(options model.GetPostsSinceOptions, userId string) (*model.PostList, error) {
	ret := _m.Called(options, userId)

	var r0 *model.PostList
	if rf, ok := ret.Get(0).(func(model.GetPostsSinceOptions, string) *model.PostList); ok {
