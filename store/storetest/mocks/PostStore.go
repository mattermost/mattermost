...
// Get provides a mock function with given fields: ctx, id, skipFetchThreads
func (_m *PostStore) Get(ctx context.Context, id string, skipFetchThreads bool) (*model.PostList, error) {
	ret := _m.Called(ctx, id, skipFetchThreads)

	var r0 *model.PostList
	if rf, ok := ret.Get(0).(func(context.Context, string, bool) *model.PostList); ok {
		r0 = rf(ctx, id, skipFetchThreads)
	} else {
		if ret.Get(0) != nil {
