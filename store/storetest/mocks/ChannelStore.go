...
func (_m *ChannelStore) GetAllChannelMembersForUser(ctx context.Context, userId string, allowFromCache bool, includeDeleted bool) (map[string]string, error) {
	ret := _m.Called(ctx, userId, allowFromCache, includeDeleted)

	var r0 map[string]string
	if rf, ok := ret.Get(0).(func(context.Context, string, bool, bool) map[string]string); ok {
