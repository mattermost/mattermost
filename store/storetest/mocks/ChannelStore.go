...
func (_m *ChannelStore) GetTopChannelsForTeamSince(teamID string, userID string, since int64, offset int, limit int) ([]*model.TopChannels, error) {
	ret := _m.Called(teamID, userID, since, offset, limit)

	var r0 []*model.TopChannels
	if rf, ok := ret.Get(0).(func(string, string, int64, int, int) []*model.TopChannels); ok {
		r0 = rf(teamID, userID, since, offset, limit)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*model.TopChannels)
		}
	}
