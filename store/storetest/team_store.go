...
func testTeamStoreSearchAll(t *testing.T, ss store.Store) {
	...
	testCases := []struct {
		...
		},
		{
			...
			&model.TeamSearch{Term: "zzzzzz", AllowOpenInvite: true},
			1,
			[]string{o.Id},
		},
		{
			"Search for all 3 teams filter by exclude allow open invite",
			&model.TeamSearch{Term: "zzzzzz", ExcludeAllowOpenInvite: true},
			2,
			[]string{p.Id, g.Id},
		},
		{
			"Search for all 3 teams filter by group constrained",
			&model.TeamSearch{Term: "zzzzzz", GroupConstrained: true},
			1,
			[]string{g.Id},
		},
		{
			"Search for all 3 teams filter by exclude group constrained",
			&model.TeamSearch{Term: "zzzzzz", ExcludeGroupConstrained: true},
			2,
			[]string{o.Id, p.Id},
		},
		{
			"Search for all 3 teams filter by allow open invite and exclude group constrained",
			&model.TeamSearch{Term: "zzzzzz", AllowOpenInvite: true, ExcludeGroupConstrained: true},
			1,
			[]string{o.Id},
		},
		{
			"Search for all 3 teams filter by allow open invite and include group constrained",
			&model.TeamSearch{Term: "zzzzzz", AllowOpenInvite: true, IncludeGroupConstrained: true},
			2,
			[]string{o.Id, g.Id},
		},
		{
			"Search for all 3 teams filter by group constrained and include group constrained",
			&model.TeamSearch{Term: "zzzzzz", IncludeGroupConstrained: true},
			1,
			[]string{g.Id},
		},
	}
