...
func TestTeamStore(t *testing.T, ss store.Store) {
	...
	t.Run("testGetMembersOrderByUserID", func(t *testing.T) { testGetMembersOrderByUserID(t, ss) })
	t.Run("testGetMembersOrderByUsernameAndExcludeDeletedMembers", func(t *testing.T) { testGetMembersOrderByUsernameAndExcludeDeletedMembers(t, ss) })
	t.Run("testGetMembersExcludedDeletedUsers", func(t *testing.T) { testGetMembersExcludedDeletedUsers(t, ss) })
...
func testGetMembersExcludedDeletedUsers(t *testing.T, ss store.Store) {
	teamId1 := model.NewId()
	teamId2 := model.NewId()
