...
func testReactionSave(t *testing.T, ss store.Store) {
	...
	postList, err := ss.Post().Get(context.Background(), reaction1.PostId, false, false, false, "", map[string]bool{})
	require.NoError(t, err)
	...
	postList, err = ss.Post().Get(context.Background(), reaction2.PostId, false, false, false, "", map[string]bool{})
	require.NoError(t, err)
...
func testReactionDelete(t *testing.T, ss store.Store) {
	t.Run("Delete", func(t *testing.T) {
		...
		result, err := ss.Post().Get(context.Background(), reaction.PostId, false, false, false, "", map[string]bool{})
		require.NoError(t, err)
		...
		postList, err := ss.Post().Get(context.Background(), post.Id, false, false, false, "", map[string]bool{})
		require.NoError(t, err)
...
func testReactionDeleteAllWithEmojiName(t *testing.T, ss store.Store, s SqlStore) {
	...
	postList, err := ss.Post().Get(context.Background(), post.Id, false, false, false, "", map[string]bool{})
	require.NoError(t, err)
	assert.True(t, postList.Posts[post.Id].HasReactions, "post should still have reactions", map[string]bool{})

	postList, err = ss.Post().Get(context.Background(), post2.Id, false, false, false, "", map[string]bool{})
	require.NoError(t, err)
	assert.True(t, postList.Posts[post2.Id].HasReactions, "post should still have reactions", map[string]bool{})

	postList, err = ss.Post().Get(context.Background(), post3.Id, false, false, false, "", map[string]bool{})
	require.NoError(t, err)
