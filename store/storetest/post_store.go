...
func testPostStoreSave(t *testing.T, ss store.Store) {
	...
	if _, err := ss.Post().Save(context.Background(), &o1); err != nil {
...
func testPostStoreSaveChannelMsgCounts(t *testing.T, ss store.Store) {
	...
	_, err = ss.Post().Save(context.Background(), &o1)
	require.Nil(t, err)

	c1, err = ss.Channel().Get(context.Background(), c1.Id, false)
	require.Nil(t, err)
	...
	o2.CreateAt = int64(7)
	_, err = ss.Post().Save(context.Background(), &o2)
	require.Nil(t, err)
...
func testPostStoreGet(t *testing.T, ss store.Store) {
	...
	o1, err := ss.Post().Save(context.Background(), o1)
	require.Nil(t, err)
...
func testPostStoreUpdate(t *testing.T, ss store.Store) {
	...
	o2.ParentId = o1.Id
	o2.RootId = o1.Id
	o2, err = ss.Post().Save(context.Background(), o2)
	require.Nil(t, err)
	...
	o3, err = ss.Post().Save(context.Background(), o3)
	require.Nil(t, err)
	...
	*o3a = *ro3
	...
	o4, err := ss.Post().Save(context.Background(), &model.Post{
...
func testPostStoreDelete2Level(t *testing.T, ss store.Store) {
	...
	o4, err = ss.Post().Save(context.Background(), o4)
	require.Nil(t, err)
...
func testPostStoreGetPostsWithDetails(t *testing.T, ss store.Store) {
	...
	o2a.ParentId = o1.Id
	o2a.RootId = o1.Id
	o2a, err = ss.Post().Save(context.Background(), o2a)
	require.Nil(t, err)
	time.Sleep(2 * time.Millisecond)
	...
	o5.ParentId = o4.Id
	o5.RootId = o4.Id
	o5, err = ss.Post().Save(context.Background(), o5)
	require.Nil(t, err)
	...
	_, err = ss.Post().Save(context.Background(), o6)
	require.Nil(t, err)
...
func testPostStoreGetPostsBeforeAfter(t *testing.T, ss store.Store) {
	t.Run("without threads", func(t *testing.T) {
		...
		for i := 0; i < 10; i++ {
			post, err := ss.Post().Save(context.Background(), &model.Post{
				ChannelId: channelId,
				UserId:    userId,
				Message:   "message",
			})
	...
	t.Run("with threads", func(t *testing.T) {
		...
		post1, err := ss.Post().Save(context.Background(), &model.Post{
			ChannelId: channelId,
			UserId:    userId,
			Message:   "message",
		})
		...
		post2, err := ss.Post().Save(context.Background(), &model.Post{
			ChannelId: channelId,
			UserId:    userId,
			Message:   "message",
		})
		...
		post3, err := ss.Post().Save(context.Background(), &model.Post{
			ChannelId: channelId,
			UserId:    userId,
			ParentId:  post1.Id,
			RootId:    post1.Id,
		...
		post4, err := ss.Post().Save(context.Background(), &model.Post{
			ChannelId: channelId,
			UserId:    userId,
			RootId:    post2.Id,
			ParentId:  post2.Id,
		...
		post5, err := ss.Post().Save(context.Background(), &model.Post{
			ChannelId: channelId,
			UserId:    userId,
			Message:   "message",
		})
		...
		post6, err := ss.Post().Save(context.Background(), &model.Post{
			ChannelId: channelId,
			UserId:    userId,
			ParentId:  post2.Id,
			RootId:    post2.Id,
...
func testPostStoreGetPostBeforeAfter(t *testing.T, ss store.Store) {
	...
	_, err := ss.Post().Save(context.Background(), o0)
	require.Nil(t, err)
	time.Sleep(2 * time.Millisecond)
	...
	o0a.ParentId = o1.Id
	o0a.RootId = o1.Id
	_, err = ss.Post().Save(context.Background(), o0a)
	require.Nil(t, err)
	time.Sleep(2 * time.Millisecond)
	...
	o0b.RootId = o1.Id
	o0b.DeleteAt = 1
	_, err = ss.Post().Save(context.Background(), o0b)
	require.Nil(t, err)
	time.Sleep(2 * time.Millisecond)
	...
	_, err = ss.Post().Save(context.Background(), otherChannelPost)
	require.Nil(t, err)
	time.Sleep(2 * time.Millisecond)
	...
	o2a.ParentId = o2.Id
	o2a.RootId = o2.Id
	_, err = ss.Post().Save(context.Background(), o2a)
	require.Nil(t, err)
...
func testPostStoreSearch(t *testing.T, ss store.Store) {
	...
	_, err = ss.Post().Save(context.Background(), o1a)
	require.Nil(t, err)
	...
	_, err = ss.Post().Save(context.Background(), o3)
	require.Nil(t, err)
	...
	o6.UserId = model.NewId()
	o6.Hashtags = "#hashtag"
	o6, err = ss.Post().Save(context.Background(), o6)
	require.Nil(t, err)
	...
	o7, err = ss.Post().Save(context.Background(), o7)
	require.Nil(t, err)
	...
	o8.Message = "Deleted"
	o8, err = ss.Post().Save(context.Background(), o8)
	require.Nil(t, err)
...
func testPostCountsByDay(t *testing.T, ss store.Store) {
	...
	_, err = ss.Post().Save(context.Background(), b1)
	require.Nil(t, err)
	...
	_, err = ss.Post().Save(context.Background(), b1a)
	require.Nil(t, err)
...
func testPostStoreGetPostsCreatedAt(t *testing.T, ss store.Store) {
	...
	o0, err := ss.Post().Save(context.Background(), o0)
	require.Nil(t, err)
...
func testPostStoreGetParentsForExportAfter(t *testing.T, ss store.Store) {
	...
	p1.CreateAt = 1000
	p1, err = ss.Post().Save(context.Background(), p1)
	require.Nil(t, err)
...
func testPostStoreGetRepliesForExport(t *testing.T, ss store.Store) {
	...
	p2.ParentId = p1.Id
	p2.RootId = p1.Id
	p2, err = ss.Post().Save(context.Background(), p2)
	require.Nil(t, err)
