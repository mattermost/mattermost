...
func testPostStoreGet(t *testing.T, ss store.Store) {
	...
	r1, err := ss.Post().Get(context.Background(), o1.Id, false)
	require.Nil(t, err)
	require.Equal(t, r1.Posts[o1.Id].CreateAt, o1.CreateAt, "invalid returned post")

	_, err = ss.Post().Get(context.Background(), "123", false)
	require.NotNil(t, err, "Missing id should have failed")

	_, err = ss.Post().Get(context.Background(), "", false)
...
func testPostStoreUpdate(t *testing.T, ss store.Store) {
	...
	r2, err := ss.Post().Get(context.Background(), o1.Id, false)
	require.Nil(t, err)
	ro2 := r2.Posts[o2.Id]

	r3, err := ss.Post().Get(context.Background(), o3.Id, false)
	require.Nil(t, err)
	ro3 := r3.Posts[o3.Id]
	...
	r4, err := ss.Post().Get(context.Background(), o4.Id, false)
	require.Nil(t, err)
	ro4 := r4.Posts[o4.Id]
...
func testPostStoreDelete(t *testing.T, ss store.Store) {
	...
	r3, err := ss.Post().Get(context.Background(), o1.Id, false)
...
func testPostStoreDelete1Level(t *testing.T, ss store.Store) {
	...
	_, err = ss.Post().Get(context.Background(), o1.Id, false)
	require.NotNil(t, err, "Deleted id should have failed")

	_, err = ss.Post().Get(context.Background(), o2.Id, false)
	require.NotNil(t, err, "Deleted id should have failed")
}
...
func testPostStoreDelete2Level(t *testing.T, ss store.Store) {
	...
	_, err = ss.Post().Get(context.Background(), o3.Id, false)
	require.NotNil(t, err, "Deleted id should have failed")

	_, err = ss.Post().Get(context.Background(), o4.Id, false)
	require.Nil(t, err)
}
...
func testPostStoreGetWithChildren(t *testing.T, ss store.Store) {
	...
	pl, err := ss.Post().Get(context.Background(), o1.Id, false)
	require.Nil(t, err)
...
func testPostStoreOverwriteMultiple(t *testing.T, ss store.Store) {
	...
	r2, err := ss.Post().Get(context.Background(), o2.Id, false)
	require.Nil(t, err)
	ro2 := r2.Posts[o2.Id]
	...
	r5, err := ss.Post().Get(context.Background(), o5.Id, false)
	require.Nil(t, err)
	ro5 := r5.Posts[o5.Id]
	...
	t.Run("overwrite changing message", func(t *testing.T) {
		...
		r1, nErr := ss.Post().Get(context.Background(), o1.Id, false)
		require.Nil(t, nErr)
		ro1a := r1.Posts[o1.Id]

		r2, nErr = ss.Post().Get(context.Background(), o1.Id, false)
		require.Nil(t, nErr)
		ro2a := r2.Posts[o2.Id]

		r3, nErr = ss.Post().Get(context.Background(), o3.Id, false)
		require.Nil(t, nErr)
		ro3a := r3.Posts[o3.Id]
	...
	t.Run("overwrite clearing filenames", func(t *testing.T) {
		...
		r4, nErr := ss.Post().Get(context.Background(), o4.Id, false)
		require.Nil(t, nErr)
		ro4a := r4.Posts[o4.Id]

		r5, nErr = ss.Post().Get(context.Background(), o5.Id, false)
		require.Nil(t, nErr)
		ro5a := r5.Posts[o5.Id]
