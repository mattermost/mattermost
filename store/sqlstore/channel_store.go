...
func (s SqlChannelStore) UpdateLastViewedAt(channelIds []string, userId string) (map[string]int64, *model.AppError) {
	return nil, model.NewAppError("SqlChannelStore.UpdateLastViewedAt", "store.sql_channel.update_last_viewed_at.app_error", nil, "Driver does not implement this function", http.StatusInternalServerError)
}
...
func (s SqlChannelStore) AutocompleteInTeam(teamId string, term string, includeDeleted bool) (*model.ChannelList, *model.AppError) {
	return nil, model.NewAppError("SqlChannelStore.AutocompleteInTeam", "store.sql_channel.autocomplete_in_team.app_error", nil, "Driver does not implement this function", http.StatusInternalServerError)
}
...
func (s SqlChannelStore) AutocompleteInTeamForSearch(teamId string, userId string, term string, includeDeleted bool) (*model.ChannelList, *model.AppError) {
	return nil, model.NewAppError("SqlChannelStore.AutocompleteInTeamForSearch", "store.sql_channel.autocomplete_in_team_for_search.app_error", nil, "Driver does not implement this function", http.StatusInternalServerError)
}

func (s SqlChannelStore) SearchInTeam(teamId string, term string, includeDeleted bool) (*model.ChannelList, *model.AppError) {
	return nil, model.NewAppError("SqlChannelStore.SearchInTeam", "store.sql_channel.search_in_team.app_error", nil, "Driver does not implement this function", http.StatusInternalServerError)
}

func (s SqlChannelStore) SearchArchivedInTeam(teamId string, term string, userId string) (*model.ChannelList, *model.AppError) {
	return nil, model.NewAppError("SqlChannelStore.SearchArchivedInTeam", "store.sql_channel.search_archived_in_team.app_error", nil, "Driver does not implement this function", http.StatusInternalServerError)
}
...
func (s SqlChannelStore) SearchForUserInTeam(userId string, teamId string, term string, includeDeleted bool) (*model.ChannelList, *model.AppError) {
	return nil, model.NewAppError("SqlChannelStore.SearchForUserInTeam", "store.sql_channel.search_for_user_in_team.app_error", nil, "Driver does not implement this function", http.StatusInternalServerError)
}
...
func (s SqlChannelStore) SearchAllChannels(term string, opts store.ChannelSearchOpts) (*model.ChannelListWithTeamData, int64, *model.AppError) {
	return nil, int64(0), model.NewAppError("SqlChannelStore.SearchAllChannels", "store.sql_channel.search_all_channels.app_error", nil, "Driver does not implement this function", http.StatusInternalServerError)
}

func (s SqlChannelStore) SearchMore(userId string, teamId string, term string) (*model.ChannelList, *model.AppError) {
	return nil, model.NewAppError("SqlChannelStore.SearchMore", "store.sql_channel.search_more.app_error", nil, "Driver does not implement this function", http.StatusInternalServerError)
}

func (s SqlChannelStore) SearchGroupChannels(userId, term string) (*model.ChannelList, *model.AppError) {
	return nil, model.NewAppError("SqlChannelStore.SearchGroupChannels", "store.sql_channel.search_group_channels.app_error", nil, "Driver does not implement this function", http.StatusInternalServerError)
}
