...
// `id` is replaced with _ to pass unused param lint
func (s SqlChannelStore) InvalidateChannel(_ string) {
}
...
// `allowFromCache` replaced with _ to pass unused param lint
func (s SqlChannelStore) Get(id string, _ bool) (*model.Channel, error) {
...
func (s SqlChannelStore) InvalidateMemberCount(_ string) {
}
...
func (s SqlChannelStore) GetMemberCount(channelId string, _ bool) (int64, error) {
...
// `channelId` is replaced with _ to pass unused param lint
func (s SqlChannelStore) InvalidatePinnedPostCount(_ string) {
}

// `allowFromCache` is replaced with _ to pass unused param lint
func (s SqlChannelStore) GetPinnedPostCount(channelId string, _ bool) (int64, error) {
	count, err := s.GetReplica().SelectInt(`
		SELECT count(*)
			FROM Posts
		WHERE
...
// `channelId` is replaced with _ to pass unused param lint
func (s SqlChannelStore) InvalidateGuestCount(_ string) {
}

// `allowFromCache` is replaced with _ to pass unused param lint
func (s SqlChannelStore) GetGuestCount(channelId string, _ bool) (int64, error) {
	count, err := s.GetReplica().SelectInt(`
		SELECT
			count(*)
		FROM
