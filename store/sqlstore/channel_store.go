...
var allChannelMembersForUserCache = cache.NewLFU(&cache.LFUOptions{
	Size: ALL_CHANNEL_MEMBERS_FOR_USER_CACHE_SIZE,
})
var allChannelMembersNotifyPropsForChannelCache = cache.NewLFU(&cache.LFUOptions{
	Size: ALL_CHANNEL_MEMBERS_NOTIFY_PROPS_FOR_CHANNEL_CACHE_SIZE,
})
var channelByNameCache = cache.NewLFU(&cache.LFUOptions{
