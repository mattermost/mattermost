...
const (
	...
	EXIT_INCREASING_EXECUTION_TIMEOUT_MYSQL    = 140
	EXIT_RESTORING_EXECUTION_TIMEOUT_MYSQL     = 141
	EXIT_INCREASING_EXECUTION_TIMEOUT_POSTGRES = 142
	EXIT_RESTORING_EXECUTION_TIMEOUT_POSTGRES  = 143
)
