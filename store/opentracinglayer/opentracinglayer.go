...
func (s *OpenTracingLayerPostStore) Get(id string, skipFetchThreads bool, collapsedThreads bool, collapsedThreadsExtended bool, userId string) (*model.PostList, error) {
	origCtx := s.Root.Store.Context()
