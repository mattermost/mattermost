...
// PushNotificationAck provides a mock function with given fields: c, ackId, recievedAt, ackAt
func (_m *Hooks) PushNotificationAck(c *plugin.Context, ackId string, recievedAt int64, ackAt int64) *model.PushNotification {
	ret := _m.Called(c, ackId, recievedAt, ackAt)

	var r0 *model.PushNotification
	if rf, ok := ret.Get(0).(func(*plugin.Context, string, int64, int64) *model.PushNotification); ok {
		r0 = rf(c, ackId, recievedAt, ackAt)
	} else {
		if ret.Get(0) != nil {
