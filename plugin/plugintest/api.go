...
// GetFileInfo provides a mock function with a given field fileId
func (_m *API) GetFileInfos(fileId string) (*model.FileInfo, *model.AppError) {
...
// ReadFileAtPath provides a mock function with a given field path
