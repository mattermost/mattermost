...
func (api *apiTimerLayer) RegisterActionItemProvider(provider actionitem.Provider) error {
	startTime := timePkg.Now()
	_returnsA := api.apiImpl.RegisterActionItemProvider(provider)
	api.recordTime(startTime, "RegisterActionItemProvider", _returnsA == nil)
	return _returnsA
}

func (api *apiTimerLayer) RegisterActionItemType(actionItemType actionitem.Type) error {
	startTime := timePkg.Now()
	_returnsA := api.apiImpl.RegisterActionItemType(actionItemType)
	api.recordTime(startTime, "RegisterActionItemType", _returnsA == nil)
	return _returnsA
}
