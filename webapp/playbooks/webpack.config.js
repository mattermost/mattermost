...
const config = {
    ...
    resolve: {
        alias: {
            ...
            reselect: path.resolve(__dirname, '../node_modules/mattermost-webapp/src/packages/reselect/src/index'),
            '@mattermost/client': path.resolve(__dirname, '../node_modules/mattermost-webapp/src/packages/client/src/'),
            '@mattermost/components': path.resolve(__dirname, '../node_modules/mattermost-webapp/src/packages/components/src/'),
        },
        modules: [
            'src',
            'node_modules',
