...
export function applyTheme(theme) {
    ...
    if (theme.centerChannelColor) {
        ...
        changeCss('.app__body .post.post--system .post__body, .app__body .modal.modal--fullscreen .modal-body--invite .invite-type__icon', 'color:' + changeOpacity(theme.centerChannelColor, 0.6), 1);
