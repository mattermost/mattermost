...
export function applyTheme(theme) {
    ...
    if (theme.centerChannelBg) {
        ...
        changeCss('.app__body .app__content, .app__body .markdown__table, .app__body .markdown__table tbody tr, .app__body .suggestion-list__content, .app__body .modal .modal-content, .app__body .post.post--compact .post-image__column, .app__body .suggestion-list__divider > span, .app__body .modal--fullscreen', 'background:' + theme.centerChannelBg, 1);
    ...
    if (theme.centerChannelColor) {
        ...
        changeCss('.app__body .post.post--system .post__body, .app__body .modal.modal--fullscreen .modal-body--invite .invite-type__icon, .app__body .modal--fullscreen .modal-header button.close', 'color:' + changeOpacity(theme.centerChannelColor, 0.6), 1);
        changeCss('.app__body .modal.modal--fullscreen, .app__body .input-group-addon, .app__body .app__content, .app__body .post-create__container .post-create-body .btn-file, .app__body .post-create__container .post-create-footer .msg-typing, .app__body .suggestion-list__content .command, .app__body .modal .modal-content, .app__body .dropdown-menu, .app__body .popover, .app__body .mentions__name, .app__body .tip-overlay, .app__body .form-control[disabled], .app__body .form-control[readonly], .app__body fieldset[disabled] .form-control, .app__body .modal--fullscreen .modal-header .modal-title', 'color:' + theme.centerChannelColor, 1);
        ...
        changeCss('.app__body .custom-textarea, .app__body .custom-textarea:focus, .app__body .file-preview, .app__body .post-image__details, .app__body .sidebar--right .sidebar-right__body, .app__body .markdown__table th, .app__body .markdown__table td, .app__body .suggestion-list__content, .app__body .modal .modal-content, .app__body .modal .settings-modal .settings-table .settings-content .divider-light, .app__body .webhooks__container, .app__body .dropdown-menu, .app__body .modal .modal-header, .app__body .popover, .app__body .modal.modal--fullscreen .modal-body--invite .invite-type', 'border-color:' + changeOpacity(theme.centerChannelColor, 0.2), 1);
