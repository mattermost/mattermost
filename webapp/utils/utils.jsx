...
export function applyTheme(theme) {
    ...
    if (theme.centerChannelBg) {
        ...
        changeCss('#post-list .nav-pills__unread-indicator-bottom', 'color:' + theme.centerChannelBg);
    }
    ...
    if (theme.linkColor) {
        ...
        changeCss('#post-list .nav-pills__unread-indicator-bottom', 'background:' + theme.linkColor);
        changeCss('#post-list .nav-pills__unread-indicator-bottom:hover', 'background:' + changeColor(theme.linkColor, 0.1));
    }
