...
export function applyTheme(theme) {
    ...
    if (theme.sidebarText) {
        ...
        changeCss('.app__body .sidebar--left .sidebar__switcher a, .sidebar--left .add-channel-btn:hover, .sidebar--left .add-channel-btn:focus', 'color:' + theme.sidebarText);
    ...
    if (theme.sidebarTextHoverBg) {
        changeCss('.sidebar--left .nav-pills__container li > a:hover, .app__body .modal .settings-modal .nav-pills>li:hover a, .app__body .sidebar__switcher a:hover', 'background:' + theme.sidebarTextHoverBg);
    }
