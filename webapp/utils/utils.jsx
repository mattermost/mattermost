...
export function applyTheme(theme) {
    ...
    if (theme.linkColor) {
        ...
        changeCss('.app__body .post .flag-icon__container, .app__body .post .comment-icon__container, .app__body .post .post__reply', 'fill:' + theme.linkColor, 1);
        changeCss('.app__body .post .flag-icon__container', 'stroke:' + theme.linkColor, 1);
        changeCss('.app__body .channel-header__links .icon:hover', 'stroke:' + theme.linkColor, 1);
        changeCss('.app__body .channel-header__links .icon:hover', 'fill:' + theme.linkColor, 2);
    }
