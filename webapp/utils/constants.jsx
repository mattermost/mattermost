...
export default {
    ActionTypes: keyMirror({
        ...
        RECEIVED_TEAMMATE_MEMBERS: null,
    ...
    OTHER_TEAM_ONLINE_ICON_SVG: "<svg version='1.1' id='Layer_1' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' x='0px' y='0px' viewBox='0 0 14 14' style='enable-background:new 0 0 14 14;' xml:space='preserve'><g><g id='XMLID_26_'><path id='XMLID_27_' class='online--icon' d='M9,10c0,1.1-0.9,2-2,2H4c-1.1,0-2-0.9-2-2V7c0-1.1,0.9-2,2-2h1V3H2C0.9,3,0,3.9,0,5v7c0,1.1,0.9,2,2,2h7c1.1,0,2-0.9,2-2V9H9V10z M12.8,2c-0.1-0.1-0.1-0.1-0.2-0.1L8.1,2.2C8,2.2,7.9,2.3,7.8,2.4c-0.1,0.1,0,0.2,0,0.3l0.9,1L5.5,6.6C5.3,6.8,5.3,7,5.4,7.1l1.4,1.6c0.1,0.1,0.3,0.1,0.5,0l3.3-2.9l0.9,1c0.1,0.1,0.2,0.1,0.3,0.1c0,0,0.1,0,0.1-0.1C12,6.8,12,6.7,12,6.6l0.9-4.4C12.9,2.1,12.9,2,12.8,2z'/></g></g></svg>",
    ...
    OTHER_TEAM_AWAY_ICON_SVG: "<svg version='1.1' id='Layer_1' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' x='0px' y='0px' viewBox='0 0 14 14' style='enable-background:new 0 0 14 14;' xml:space='preserve'><g><g id='XMLID_26_'><path id='XMLID_27_' class='away--icon' d='M9,10c0,1.1-0.9,2-2,2H4c-1.1,0-2-0.9-2-2V7c0-1.1,0.9-2,2-2h1V3H2C0.9,3,0,3.9,0,5v7c0,1.1,0.9,2,2,2h7c1.1,0,2-0.9,2-2V9H9V10z M12.8,2c-0.1-0.1-0.1-0.1-0.2-0.1L8.1,2.2C8,2.2,7.9,2.3,7.8,2.4c-0.1,0.1,0,0.2,0,0.3l0.9,1L5.5,6.6C5.3,6.8,5.3,7,5.4,7.1l1.4,1.6c0.1,0.1,0.3,0.1,0.5,0l3.3-2.9l0.9,1c0.1,0.1,0.2,0.1,0.3,0.1c0,0,0.1,0,0.1-0.1C12,6.8,12,6.7,12,6.6l0.9-4.4C12.9,2.1,12.9,2,12.8,2z'/></g></g></svg>",
    ...
    OTHER_TEAM_OFFLINE_ICON_SVG: "<svg version='1.1' id='Layer_1' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' x='0px' y='0px' viewBox='0 0 14 14' style='enable-background:new 0 0 14 14;' xml:space='preserve'><g><g id='XMLID_26_'><path id='XMLID_27_' class='offline--icon' d='M9,10c0,1.1-0.9,2-2,2H4c-1.1,0-2-0.9-2-2V7c0-1.1,0.9-2,2-2h1V3H2C0.9,3,0,3.9,0,5v7c0,1.1,0.9,2,2,2h7c1.1,0,2-0.9,2-2V9H9V10z M12.8,2c-0.1-0.1-0.1-0.1-0.2-0.1L8.1,2.2C8,2.2,7.9,2.3,7.8,2.4c-0.1,0.1,0,0.2,0,0.3l0.9,1L5.5,6.6C5.3,6.8,5.3,7,5.4,7.1l1.4,1.6c0.1,0.1,0.3,0.1,0.5,0l3.3-2.9l0.9,1c0.1,0.1,0.2,0.1,0.3,0.1c0,0,0.1,0,0.1-0.1C12,6.8,12,6.7,12,6.6l0.9-4.4C12.9,2.1,12.9,2,12.8,2z'/></g></g></svg>",
    ...
    Preferences: {
        ...
        CATEGORY_SEEN_OTHER_TEAM_DIRECT: 'seen_other_team_direct',
