...
export const enum WebSocketEvents {
    ...
    ChannelTabCreated = 'channel_bookmark_created',
    ChannelTabUpdated = 'channel_bookmark_updated',
    ChannelTabDeleted = 'channel_bookmark_deleted',
    ChannelTabSorted = 'channel_bookmark_sorted',
