...
export const enum WebSocketEvents {
    ...
    PlatformNotificationUpserted = 'platform_notification_upserted',
    PlatformNotificationDeleted = 'platform_notification_deleted',
    PlatformNotificationsCleared = 'platform_notifications_cleared',
    PlatformNotificationsReplaced = 'platform_notifications_replaced',
