...
export default class Client4 {
    ...
    getSelfHostedProducts = () => {
        return this.doFetch<Product[]>(
            `${this.getCloudRoute()}/products/selfhosted`,
            { method: "get" },
        );
    };
    ...
    confirmSelfHostedExpansion = (
        setupIntentId: string,
        expandRequest: SelfHostedExpansionRequest,
    ) => {
        return this.doFetch<SelfHostedSignupSuccessResponse>(
    ...
    getLicenseSelfServeStatus = () => {
        return this.doFetch<LicenseSelfServeStatus>(
            `${this.getCloudRoute()}/subscription/self-serve-status`,
            { method: "get" },
        );
    };
    ...
    submitTrueUpReview = () => {
        return this.doFetch(`${this.getBaseRoute()}/license/review`, {
            method: "post",
        });
    };

    getTrueUpReviewStatus = () => {
        return this.doFetch(`${this.getBaseRoute()}/license/review/status`, {
            method: "get",
        });
    };
