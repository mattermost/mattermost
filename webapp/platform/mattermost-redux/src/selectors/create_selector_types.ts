...
export type MemoizeFunction = {
    <F extends Function>(
        func: F, measure: Function | undefined | null, equalityCheck?: <T>(a: T, b: T, index?: number) => boolean,
    ): F;
};

export type CreateSelectorCreatorFunction = {
    (
...
export type CreateStructuredSelectorFunction = {
    <S, T>(
