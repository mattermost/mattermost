...
export function emitPostFocusEvent(postId) {
    ...
    Client.getPermalinkTmp(
        ...
        () => {
            browserHistory.push('/error?message=' + encodeURIComponent(Utils.localizeMessage('permalink.error.access', 'Permalink belongs to a message that has been deleted or exists in a channel you do not have access to')));
        }
    );
}
