...
class TeamSettings extends React.Component {
    ...
    componentWillReceiveProps(nextProps) {
        this.setState({brandText: nextProps.brandText});
    }
    ...
    handleTextChange(e) {
        this.setState({saveNeeded: true, brandText: e.target.value});
    }
        ...
        Client.saveConfig(
            ...
            () => {
                ...
                if (this.refs.CustomBrandText) {
                    Client.saveBrandText(
                        this.refs.CustomBrandText.value,
                        () => {
                            AsyncClient.getBrandText();
                    ...
                    <div className='col-sm-8'>
                        ...
                        <p className='help-text no-margin'>
                            <FormattedHTMLMessage
                                ...
                                defaultMessage='Customize your user experience by adding a 600px by 800px custom image to your login screen. See examples at <a href="http://docs.mattermost.com/administration/config-settings.html#custom-branding" target="_blank">docs.mattermost.com/administration/config-settings.html#custom-branding</a>.'
                            />
                        </p>
                    </div>
                </div>
...
TeamSettings.propTypes = {
    ...
    brandText: React.PropTypes.string
};
