        ...
        var uploadHelpText = (
            <div>
                <FormattedHTMLMessage
                    ...
                    defaultMessage="<p>To import a team from Slack go to Slack > Team Settings > Import/Export Data > Export > Start Export. Slack does not allow you to export files, images, private groups or direct messages stored in Slack. Therefore, Slack import to UChat only supports importing of text messages in your Slack team's public channels.</p><p>The Slack import to UChat is in 'Beta'. Slack bot posts do not yet import.</p>"
                />
            </div>
        );
