        ...
        return (
            <div className='backstage-content emoji-list'>
                ...
                <span className='backstage-list__help'>
                    <FormattedMessage
                        id='emoji_list.help'
                        defaultMessage='Custom emoji are available to everyone on your server and will show up in the emoji autocomplete menu. Other users may need to refresh the page before new emojis show up.'
                    />
                </span>
