...
export default class HelpMessaging extends React.Component {
    render() {
        ...
        message.push(localizeMessage('help.messaging.write', '**Write messages** using the text input box at the bottom of uChat. Press **ENTER** to send a message. Use **Shift+ENTER** to create a new line without sending a message.'));
        ...
        message.push(localizeMessage('help.messaging.attach', '**Attach files** by dragging and dropping into uChat or clicking the attachment icon in the text input box.'));
