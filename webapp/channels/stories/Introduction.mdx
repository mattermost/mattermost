...
- **Styled Components** - Dynamic styling with CSS-in-JS (At least while we remove it from the codebase 💀 🔪 ⚰️ ☠️ 🪦)
...
```
webapp/
├── channels/                    # Main webapp package
│   └── src/**/*.stories.tsx    # Channel-specific components
├── platform/
...
├── tag.tsx
├── tag.stories.tsx    ← Story alongside component
├── tag.test.tsx
└── tag.scss
...
- ✅ **Linted** - ESLint validates all story files
- ✅ **Type-checked** - TypeScript validates stories
- ✅ **Excluded from builds** - Not compiled to production
- ✅ **CI validation** - Checked in GitHub Actions
