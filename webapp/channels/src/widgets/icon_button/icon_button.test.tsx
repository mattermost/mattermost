...
describe('components/widgets/icon_button/IconButton', () => {
    ...
    describe('snapshots', () => {
        test('should match snapshot with default props', () => {
            const {container} = renderWithContext(<IconButton {...baseProps}/>);
        ...
        test('should match snapshot with all size variants', () => {
            ...
            sizes.forEach((size) => {
                ...
                expect(container.firstChild).toMatchSnapshot(`IconButton size ${size}`);
            });
        });

        test('should match snapshot with visual states', () => {
            const {container} = renderWithContext(
                <IconButton
                    {...baseProps}
                    toggled={true}
        ...
        test('should match snapshot with count feature', () => {
            const {container} = renderWithContext(
                <IconButton
                    {...baseProps}
                    count={true}
        ...
        test('should match snapshot with unread indicator', () => {
            const {container} = renderWithContext(
                <IconButton
                    {...baseProps}
                    unread={true}
