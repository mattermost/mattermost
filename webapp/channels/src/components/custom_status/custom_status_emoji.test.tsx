...
describe("components/custom_status/custom_status_emoji", () => {
    ...
    (CustomStatusSelectors.makeGetCustomStatus as jest.Mock).mockReturnValue(
        getCustomStatus,
    );
    (
        CustomStatusSelectors.isCustomStatusEnabled as any as jest.Mock
    ).mockReturnValue(true);
    it("should match snapshot", () => {
        const wrapper = mount(<CustomStatusEmoji />, {
    ...
    it("should not render when custom status is expired", () => {
        ...
        (
            CustomStatusSelectors.isCustomStatusExpired as jest.Mock
        ).mockReturnValue(true);
        const wrapper = mount(<CustomStatusEmoji />, {
            wrappingComponent: Provider,
            wrappingComponentProps: { store },
