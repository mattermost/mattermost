...
const EditedPostItem = ({
    ...
    const handleRestore = async () => {
        if (
            !postCurrentVersion ||
            !post ||
            postCurrentVersion.message === post.message
        ) {
    ...
    const messageContainer = (
        <div className="edit-post-history__content_container">
            ...
            <div className="post__content">
                <div className="search-item-snippet post__body">{message}</div>
            </div>
        </div>
    );

    const tooltip = (
        <Tooltip id="editPostRestoreTooltip" className="hidden-xs">
    ...
    const postContainerClass = classNames("edit-post-history__container", {
    ...
    return (
        <CompassThemeProvider theme={theme}>
            <div className={postContainerClass} onClick={togglePost}>
                <PostAriaLabelDiv
