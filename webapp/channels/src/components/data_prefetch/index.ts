...
function mapStateToProps(state: GlobalState) {
    ...
    const prefetchQueueObj = prefetchQueue(
        unreadChannels,
        memberships,
    ...
    return {
        ...
        dataPrefetchEnabled: getBool(
            state,
            Preferences.CATEGORY_ADVANCED_SETTINGS,
            Preferences.ADVANCED_DATA_PREFETCH,
            true,
        ),
    };
}
