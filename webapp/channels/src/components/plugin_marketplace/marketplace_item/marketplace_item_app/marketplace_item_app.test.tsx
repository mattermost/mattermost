...
describe("components/MarketplaceItemApp", () => {
    describe("MarketplaceItem", () => {
        ...
        test("should render with no plugin description", () => {
            ...
            const wrapper = shallow(<MarketplaceItemApp {...props} />);
        ...
        test("should render with icon", () => {
            const props: MarketplaceItemAppProps = {
                ...baseProps,
                iconURL:
                    "http://localhost:8065/plugins/com.mattermost.apps/apps/com.mattermost.servicenow/static/now-mobile-icon.png",
            };
        ...
        describe("install should trigger track event and close modal", () => {
            ...
            expect(props.trackEvent).toBeCalledWith(
                "plugins",
                "ui_marketplace_install_app",
                {
                    app_id: "id",
                },
            );
