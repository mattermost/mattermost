...
import MarketplaceItemPlugin, {
    UpdateDetails,
    UpdateConfirmationModal,
} from "./marketplace_item_plugin";
import type {
    UpdateDetailsProps,
...
describe("components/MarketplaceItemPlugin", () => {
    describe("UpdateDetails", () => {
        ...
        describe("should render nothing", () => {
            it("when no installed version", () => {
                ...
                const wrapper = mount(<UpdateDetails {...props} />);
    ...
    describe("UpdateConfirmationModal", () => {
        ...
        describe("should render nothing", () => {
            it("if not installed", () => {
                ...
                const wrapper = shallow(<UpdateConfirmationModal {...props} />);
                expect(wrapper.isEmptyRender()).toBe(true);
            });
    ...
    describe("MarketplaceItem", () => {
        ...
        test("should render with no plugin description", () => {
            ...
            const wrapper = shallow(<MarketplaceItemPlugin {...props} />);
