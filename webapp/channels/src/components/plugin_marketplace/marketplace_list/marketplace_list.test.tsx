...
describe("components/marketplace/marketplace_list", () => {
    const samplePlugin: MarketplacePlugin = {
        ...
        download_url:
            "https://github.com/mattermost/mattermost-plugin-nps/releases/download/v1.0.3/com.mattermost.nps-1.0.3.tar.gz",
        ...
        manifest: {
            ...
            description:
                "This plugin sends quarterly user satisfaction surveys to gather feedback and help improve Mattermost",
            version: "1.0.3",
    ...
    it("should render default", () => {
        const wrapper = shallow(
            <MarketplaceList listing={[]} page={0} noResultsMessage="" />,
        );
