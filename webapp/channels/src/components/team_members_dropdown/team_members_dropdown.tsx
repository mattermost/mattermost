    ...
    render() {
        ...
        const menuRemove = (
            <Menu.ItemAction
                ...
                text={defineMessage({id: 'team_members_dropdown.leave_team', defaultMessage: 'Remove From Team'})}
            />
        );
        const menuMakeAdmin = (
            <Menu.ItemAction
                onClick={this.handleMakeAdmin}
                text={defineMessage({id: 'team_members_dropdown.makeAdmin', defaultMessage: 'Make Team Admin'})}
            />
        );
        const menuMakeMember = (
            <Menu.ItemAction
                onClick={this.handleMakeMember}
                text={defineMessage({id: 'team_members_dropdown.makeMember', defaultMessage: 'Make Member'})}
            />
        );
        return (
            <MenuWrapper>
                ...
                <div>
                    <Menu
                        openLeft={true}
                        openUp={openUp}
                        ariaLabel={defineMessage({id: 'team_members_dropdown.menuAriaLabel', defaultMessage: 'Change the role of a team member'})}
                    >
