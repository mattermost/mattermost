...
describe("components/channel_view", () => {
    ...
    it("Should match snapshot if channel is archived", () => {
        const wrapper = shallow(
            <ChannelView {...baseProps} channelIsArchived={true} />,
        );
        expect(wrapper).toMatchSnapshot();
    });
    ...
    it("Should match snapshot if channel is deactivated", () => {
        const wrapper = shallow(
            <ChannelView {...baseProps} deactivatedChannel={true} />,
        );
        expect(wrapper).toMatchSnapshot();
    });
    ...
    it("Should have focusedPostId state based on props", () => {
        ...
        wrapper.setProps({
            ...
            match: {
                url: "/team/channel/channelId/postId",
        ...
        wrapper.setProps({
            channelId: "newChannelId",
            match: {
                url: "/team/channel/channelId/postId1",
