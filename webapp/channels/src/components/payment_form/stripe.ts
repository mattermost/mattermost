...
type ConfirmCardSetupType = (
    clientSecret: string,
    data?: ConfirmCardSetupData | undefined,
    options?: ConfirmCardSetupOptions | undefined,
) =>
    | Promise<{
...
function prodConfirmCardSetup(
    confirmCardSetup: ConfirmCardSetupType,
): ConfirmCardSetupType {
    return confirmCardSetup;
}

function devConfirmCardSetup(
    confirmCardSetup: ConfirmCardSetupType,
): ConfirmCardSetupType {
    return async (
        clientSecret: string,
        ...
        return {
            setupIntent: { id: "testid", status: "succeeded" } as SetupIntent,
        };
    };
}

export const getConfirmCardSetup = (isCwsMockMode?: boolean) =>
    isCwsMockMode ? devConfirmCardSetup : prodConfirmCardSetup;

export const STRIPE_CSS_SRC =
