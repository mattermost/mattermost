...
function ThreadItem({
    ...
    const tipStep = useSelector((state: GlobalState) =>
        getInt(state, Preferences.CRT_TUTORIAL_STEP, currentUserId),
    );
    ...
    const selectHandler = useCallback(
        (e: MouseEvent<HTMLDivElement>) => {
            if (e.altKey) {
                const hasUnreads = thread
                    ? Boolean(thread.unread_replies)
                    : false;
    ...
    const handleFormattedTextClick = useCallback(
        (e) => {
        ...
        >
            <h1>
                {Boolean(newMentions || newReplies) && (
                    <div className="indicator">
                        {newMentions ? (
                            <div
                                className={classNames("dot-mentions", {
                                    over: newMentions > 99,
                                })}
                            >
                ...
                <div className="ThreadItem__tags">
                    ...
                    {isPostPriorityEnabled && thread.is_urgent && (
                        <PriorityBadge
                            className={
                                postAuthor === channel?.display_name
                                    ? "ml-2"
                                    : ""
                            }
            ...
            <div className="menu-anchor alt-visible">
                ...
                >
                    ...
                    >
                        <Button marginTop={true} className="Button___icon">
            ...
            >
                {post.message ? (
                    <Markdown
                        ...
                        imagesMetadata={
                            post?.metadata && post?.metadata?.images
                        }
            ...
            <div className="activity">
                {participantIds?.length ? (
                    <Avatars userIds={participantIds} size="xs" />
                ) : null}
