...
describe("components/threading/common/thread_menu", () => {
    ...
    test("should match snapshot", () => {
        const wrapper = shallow(<ThreadMenu {...props} />);
    ...
    test("should allow following", () => {
        const wrapper = shallow(<ThreadMenu {...props} isFollowing={false} />);
        wrapper.find("button").simulate("click");
        wrapper
            .find(Menu.ItemAction)
            .find({ text: "Follow thread" })
            .simulate("click");
        expect(setThreadFollow).toHaveBeenCalledWith(
            "uid",
            "tid",
    ...
    test("should allow unfollowing", () => {
        const wrapper = shallow(<ThreadMenu {...props} isFollowing={true} />);
        wrapper.find("button").simulate("click");
        wrapper
            .find(Menu.ItemAction)
            .find({ text: "Unfollow thread" })
            .simulate("click");
        expect(setThreadFollow).toHaveBeenCalledWith(
            "uid",
            "tid",
    ...
    test("should allow opening in channel", () => {
        ...
        wrapper
            .find(Menu.ItemAction)
            .find({ text: "Open in channel" })
            .simulate("click");
        expect(mockRouting.goToInChannel).toHaveBeenCalledWith(
            "1y8hpek81byspd4enyk9mp1ncw",
        );
    ...
    test("should allow marking as read", () => {
        ...
        const wrapper = shallow(<ThreadMenu {...props} hasUnreads={true} />);
        wrapper.find("button").simulate("click");
        wrapper
            .find(Menu.ItemAction)
        ...
        expect(updateThreadRead).toHaveBeenCalledWith(
            "uid",
            "tid",
            "1y8hpek81byspd4enyk9mp1ncw",
            1612582579566,
        );
        expect(manuallyMarkThreadAsUnread).toHaveBeenCalledWith(
            "1y8hpek81byspd4enyk9mp1ncw",
            1612582579566,
        );
    ...
    test("should allow marking as unread", () => {
        const wrapper = shallow(<ThreadMenu {...props} hasUnreads={false} />);
        wrapper.find("button").simulate("click");
        wrapper
            .find(Menu.ItemAction)
            .find({ text: "Mark as unread" })
            .simulate("click");
        expect(updateThreadRead).not.toHaveBeenCalled();
        expect(markLastPostInThreadAsUnread).toHaveBeenCalledWith(
            "uid",
            "tid",
            "1y8hpek81byspd4enyk9mp1ncw",
        );
    ...
    test("should allow link copying", () => {
        ...
        expect(copyToClipboard).toHaveBeenCalledWith(
            "http://localhost:8065/team-name-1/pl/1y8hpek81byspd4enyk9mp1ncw",
        );
        expect(mockDispatch).not.toHaveBeenCalled();
    });
});
