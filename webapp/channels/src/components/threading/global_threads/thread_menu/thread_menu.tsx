...
function ThreadMenu({
    ...
    const isSaved = useSelector(
        (state: GlobalState) =>
            get(state, Preferences.CATEGORY_FLAGGED_POST, threadId, null) !=
            null,
        shallowEqual,
    );
        ...
        <MenuWrapper stopPropagationOnToggle={true}>
            ...
            <Menu ariaLabel={""} openLeft={true}>
                    ...
                    {...(isFollowing
                        ? {
                              ...
                              extraText: formatMessage({
                                  ...
                                  defaultMessage:
                                      "You won’t be notified about replies",
                              }),
                          }
                        : {
                              text: formatMessage({
                ...
                <Menu.ItemAction
                    ...
                    onClick={useCallback(() => {
                        dispatch(
                            isSaved ? unsavePost(threadId) : savePost(threadId),
                        );
                    }, [threadId, isSaved])}
                />
                <Menu.ItemAction
