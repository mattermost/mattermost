...
const ThreadList = ({
    ...
    const { total = 0, total_unread_threads: totalUnread } =
        useSelector(getThreadCountsInCurrentTeam) ?? {};
    ...
    const handleKeyDown = useCallback(
        (e: KeyboardEvent) => {
            ...
            const noModalsAreOpen =
                document.getElementsByClassName(A11yClassNames.MODAL).length ===
                0;
            const noPopupsDropdownsAreOpen =
                document.getElementsByClassName(A11yClassNames.POPUP).length ===
                0;
    ...
    const handleLoadMoreItems = useCallback(
        async (startIndex) => {
            ...
            await dispatch(
                getThreads(currentUserId, currentTeamId, {
                    unread,
    ...
    return (
        ...
        >
            ...
            />
            <div className="threads" data-testid={"threads_list"}>
