...
export type Props = Attrs & {
    ...
    actions: {
        ...
        getNewestPostThread: (rootId: string) => void;
        getPostThread: (rootId: string, fetchThreads: boolean) => void;
        getThread: (userId: string, teamId: string, threadId: string, extended: boolean) => Promise<ActionResult>;
        selectPostCard: (post: Post) => void;
        updateThreadLastOpened: (threadId: string, lastViewedAt: number) => void;
        updateThreadRead: (userId: string, teamId: string, threadId: string, timestamp: number) => void;
    };
