...
export function HasSpecialMentions({
    specialMentions,
}: {
    ...
    }, [specialMentions.all, specialMentions.here, specialMentions.channel]);
    ...
    return (
        <FormattedMessage
            ...
            defaultMessage={
                "{mention} can’t be used with persistent notifications"
            }
            values={{
                mention: <FormattedList value={mentions} type="disjunction" />,
            }}
        />
    );
}
