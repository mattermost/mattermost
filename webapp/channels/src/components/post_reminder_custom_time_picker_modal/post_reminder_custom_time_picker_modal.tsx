...
import DateTimeInput, {
    getRoundedTime,
} from "components/custom_status/date_time_input";
...
function PostReminderCustomTimePicker({
    ...
    const [customReminderTime, setCustomReminderTime] =
        useState(initialReminderTime);

    const handleConfirm = useCallback(() => {
        actions.addPostReminder(
            userId,
            postId,
            toUTCUnix(customReminderTime.toDate()),
        );
    }, [customReminderTime]);
