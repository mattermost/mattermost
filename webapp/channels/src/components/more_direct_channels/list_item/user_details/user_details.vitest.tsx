...
describe('components/more_direct_channels/list_item/user_details/UserDetails', () => {
    ...
    test('should show remote organization name in tooltip for remote user', async () => {
        ...
        // Tooltip appears on hover - verify the icon has a tooltip
        // The actual tooltip content is rendered by a portal and may not be easily testable
        // Just verify the icon is present and accessible
    });
    ...
    test('should show generic tooltip for remote user when remote display name not available', async () => {
        ...
        // Tooltip appears on hover - verify the icon is present
        // The tooltip content is rendered in a portal, verification of icon presence is sufficient
    });
