...
describe("components/MoreDirectChannels", () => {
    const baseProps: ComponentProps<typeof MoreDirectChannels> = {
        ...
        actions: {
            ...
            loadProfilesMissingStatus: jest
                .fn()
            ...
            loadStatusesForProfilesList: jest
                .fn()
                .mockResolvedValue({ data: true }),
            loadProfilesForGroupChannels: jest
                .fn()
                .mockResolvedValue({ data: true }),
    ...
    test("should call for modal data on callback of modal onEntered", () => {
        ...
        const wrapper = shallow<MoreDirectChannels>(
            <MoreDirectChannels {...props} />,
        );
        ...
        expect(props.actions.loadProfilesMissingStatus).toHaveBeenCalledTimes(
            1,
        );
        expect(props.actions.loadProfilesMissingStatus).toBeCalledWith(
            baseProps.users,
        );
    });
