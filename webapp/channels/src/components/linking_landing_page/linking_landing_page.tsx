...
export default class LinkingLandingPage extends PureComponent<Props, State> {
    ...
    componentDidMount() {
        ...
        window.addEventListener(
            "beforeunload",
            this.clearLandingPreferenceIfNotChecked,
        );
    }
    ...
    checkLandingPreferenceBrowser = () => {
        const landingPreference = BrowserStore.getLandingPreference(
            this.props.siteUrl,
        );
        return (
            landingPreference &&
            landingPreference === LandingPreferenceTypes.BROWSER
        );
    };
    ...
    checkLandingPreferenceApp = () => {
        ...
        return (
            landingPreference &&
            landingPreference === LandingPreferenceTypes.MATTERMOSTAPP
        );
    };
    ...
    setPreference = (pref: string, clearIfNotChecked?: boolean) => {
        ...
        switch (pref) {
            case LandingPreferenceTypes.MATTERMOSTAPP:
                BrowserStore.setLandingPreferenceToMattermostApp(
                    this.props.siteUrl,
                );
                break;
                ...
                <h1 className="get-app__launching">
                    ...
                    <div
                        className={`get-app__alternative${
                            this.state.redirectPage ? " redirect-page" : ""
                        }`}
                    >
                        <FormattedMessage
        ...
        if (isMobile) {
            viewApp = (
                <FormattedMessage
                    ...
                    values={{
                        siteName: this.props.enableCustomBrand
                            ? ""
                            : " Mattermost",
                    }}
                />
                ...
                <div className="get-app__preference">
                    <button
                        className={`get-app__checkbox ${
                            this.state.rememberChecked ? "checked" : ""
                        }`}
