...
export const CreateAndJoinChannelsTour = () => {
    ...
    const screen = (
        <p>
            <FormattedMessage
                ...
                defaultMessage={
                    "Create new channels or browse available channels to see what your team is discussing. As you join channels, organize them into  categories based on how you work."
                }
            />
        </p>
    );
    ...
    const overlayPunchOut = useMeasurePunchouts(
        ["showMoreChannels", "showNewChannel"],
        [],
        { y: -8, height: 16, x: 0, width: 0 },
    );
