...
export const ChannelsAndDirectMessagesTour = ({ firstChannelName }: Props) => {
    ...
    const screen = (
        <>
            <p>
                {firstChannelName && (
                    <FirstChannel firstChannelName={firstChannelName} />
                )}
                <FormattedMessage
