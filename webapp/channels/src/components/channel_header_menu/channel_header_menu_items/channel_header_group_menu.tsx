...
const ChannelHeaderGroupMenu = ({channel, user, isMuted, isMobile, isFavorite, pluginItems, isChannelTabsEnabled, isChannelAutotranslated, ...rest}: Props) => {
    ...
    return (
        <>
            ...
            {!isArchived && !isGuest(user.roles) && isChannelTabsEnabled && (
                <MenuItemChannelTabs
                    channel={channel}
                />
            )}
