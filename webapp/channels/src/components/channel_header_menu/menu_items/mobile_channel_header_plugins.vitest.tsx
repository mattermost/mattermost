...
describe('components/ChannelHeaderMenu/MenuItems/MobileChannelHeaderPlugins, with no extended components', () => {
    beforeEach(() => {
        ...
        vi.spyOn(appsActions, 'handleBindingClick');
        vi.spyOn(appsActions, 'openAppsModal');
        vi.spyOn(appsActions, 'postEphemeralCallResponseForChannel');
    ...
    test('Processes handleBinding, returns AppCallResponseTypes.OK', async () => {
        vi.spyOn(appsActions, 'handleBindingClick').mockReturnValueOnce(() => {
