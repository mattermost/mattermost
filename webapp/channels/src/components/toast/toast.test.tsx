...
describe("components/Toast", () => {
    const defaultProps: Props = {
        ...
        show: true,
        showActions: true,
        onClickMessage: Utils.localizeMessage(
    ...
    test("should match snapshot to not have actions", () => {
        const wrapper = shallow<Toast>(
            <Toast {...{ ...defaultProps, showActions: false }}>
                <span>{"child"}</span>
            </Toast>,
        );
        expect(wrapper).toMatchSnapshot();
    ...
    test("should dismiss", () => {
        ...
        const wrapper: ReactWrapper<any, any, React.Component> = mountWithIntl(
            <Toast {...defaultProps}>
                <span>{"child"}</span>
            </Toast>,
        );
    ...
    test("should match snapshot to have extraClasses", () => {
        const wrapper = shallow<Toast>(
            <Toast {...{ ...defaultProps, extraClasses: "extraClasses" }}>
                <span>{"child"}</span>
            </Toast>,
        );
        expect(wrapper).toMatchSnapshot();
