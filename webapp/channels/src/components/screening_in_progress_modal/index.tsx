...
import AccessDeniedHappySvg from 'components/svg_images_components/access_denied_happy_svg';

import {useControlScreeningInProgressModal} from 'hooks/useControlModal';
