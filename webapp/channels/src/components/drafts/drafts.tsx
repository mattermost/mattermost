...
function Drafts({ displayName, drafts, draftRemotes, status, user }: Props) {
    ...
    return (
        <div id="app-content" className="Drafts app__content">
            <Header
                level={2}
                ...
                subtitle={formatMessage({
                    id: "drafts.subtitle",
                    defaultMessage:
                        "Any messages you've started will show here",
                })}
            />
