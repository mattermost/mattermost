...
describe('ScheduledPostActions Component', () => {
    let isCurrentUserSystemAdminMock: ReturnType<typeof vi.spyOn>;
    let getMyChannelMembershipsnMock: ReturnType<typeof vi.spyOn>;
    ...
    beforeEach(() => {
        ...
        isCurrentUserSystemAdminMock = vi.spyOn(usersSelectors, 'isCurrentUserSystemAdmin');
        getMyChannelMembershipsnMock = vi.spyOn(commonSelectors, 'getMyChannelMemberships');
