                    ...
                    <div className="button-container">
                        <button
                            className={classNames({
                                highlighted: props.highlightedIndex === 0,
                            })}
                            onClick={() =>
                                props.onSearchTypeSelected &&
                                props.onSearchTypeSelected("messages")
                            }
                            onBlur={() =>
                                props.onElementBlur && props.onElementBlur()
                            }
                            onFocus={() =>
                                props.onElementFocus && props.onElementFocus()
                            }
                        >
                        ...
                        {isFileAttachmentEnabled && (
                            <button
                                className={classNames({
                                    highlighted: props.highlightedIndex === 1,
                                })}
                                onClick={() =>
                                    props.onSearchTypeSelected &&
                                    props.onSearchTypeSelected("files")
                                }
                                onBlur={() =>
                                    props.onElementBlur && props.onElementBlur()
                                }
                                onFocus={() =>
                                    props.onElementFocus &&
                                    props.onElementFocus()
                                }
                            >
                ...
                {props.options.map((option, optionIndex) => (
                    <li
                        className={classNames(
                            ...
                            {
                                highlighted:
                                    optionIndex === props.highlightedIndex,
                            },
                        )}
