...
describe('components/MenuItem', () => {
    ...
    test('should render with icon and appropriate classes', () => {
        ...
        const menuItemEl = screen.getByRole('menuitem');
        expect(menuItemEl).toBeInTheDocument();
        expect(menuItemEl).toHaveAttribute('id', 'test-id');
        expect(menuItemEl).toHaveClass('MenuItem', 'MenuItem--with-icon');
    ...
    test('should render without icon when icon prop is not provided', () => {
        ...
        expect(menuItemEl).toBeInTheDocument();
        expect(menuItemEl).toHaveAttribute('id', 'test-id');
        expect(menuItemEl).toHaveClass('MenuItem');
        expect(menuItemEl).not.toHaveClass('MenuItem--with-icon');
