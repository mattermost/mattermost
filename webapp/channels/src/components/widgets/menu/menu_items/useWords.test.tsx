...
const asAdmin = (highestLimit: LimitSummary | false): Props => ({
    isAdminUser: true,
    highestLimit,
});
const asUser = (highestLimit: LimitSummary | false): Props => ({
    isAdminUser: false,
    highestLimit,
});
const mkLimit = (
    id: LimitSummary["id"],
    usage: LimitSummary["usage"],
    limit: LimitSummary["limit"],
): LimitSummary => ({ id, usage, limit });
    ...
    const tests: Test[] = [
        ...
        },
        {
            ...
            expects: {
                title: "Total messages",
                description:
                    /reached.*message history.*only.*last.*10K.*messages/,
                status: "10K",
            },
        },
        {
        ...
        },
        {
            ...
            props: asAdmin(
                mkLimit(LimitTypes.fileStorage, FileSizes.Gigabyte, oneGb),
            ),
            expects: {
                title: "File storage limit",
