...
export default function useWords(
    ...
    const values: Record<
        ...
        | ((chunks: React.ReactNode | React.ReactNodeArray) => JSX.Element)
    > = {
        callToAction,
        a: (chunks: React.ReactNode | React.ReactNodeArray) => (
            <a
                id="view_plans_cta"
                onClick={() =>
                    openPricingModal({ trackingLocation: callerInfo })
                }
            >
                {chunks}
            </a>
    ...
    if (
        !isAdminUser &&
        (usageRatio >= limitThresholds.danger ||
            usageRatio >= limitThresholds.exceeded)
    ) {
