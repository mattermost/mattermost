        ...
        >
            ...
            {!showTrial && (
                <div className='start_trial_content'>
                    {formatMessage({id: 'navbar_dropdown.freeVersionText', defaultMessage: 'This server is currently on the Free Edition of Mattermost.'})}
                </div>)}
            {showTrial && (<>
                <div className='start_trial_content'>
                    {formatMessage({id: 'navbar_dropdown.freeVersionText', defaultMessage: 'This server is currently on the Free Edition of Mattermost.'})}
                ...
                <button onClick={openLearnMoreTrialModal}>
                    {formatMessage({id: 'navbar_dropdown.tryTrialNow', defaultMessage: 'Try Enterprise for free'})}
                </button>
            </>)}
        </li>
    );
