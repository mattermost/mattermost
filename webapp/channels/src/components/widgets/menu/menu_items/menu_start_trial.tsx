...
const TrialBenefitsModal = makeAsyncComponent(
    "TrialBenefitsModal",
    React.lazy(
        () => import("components/trial_benefits_modal/trial_benefits_modal"),
    ),
);
const LearnMoreTrialModal = makeAsyncComponent(
    "LearnMoreTrialModal",
    React.lazy(
        () =>
            import("components/learn_more_trial_modal/learn_more_trial_modal"),
    ),
);
...
const MenuStartTrial = (props: Props): JSX.Element | null => {
    ...
    const show =
        (isCurrentLicensed === "false" && isPrevLicensed === "false") ||
            ...
            {isCurrentLicenseTrial ? (
                <>
                    <div style={{ display: "inline" }}>
                        <span>
                            {formatMessage({
                                id: "navbar_dropdown.reviewTrialBenefits",
                                defaultMessage:
                                    "Review the features you get with Enterprise. ",
                            })}
                        </span>
                        <button onClick={openTrialBenefitsModal}>
                            {formatMessage({
                                id: "navbar_dropdown.learnMoreTrialBenefits",
                ...
                <>
                    <div className="start_trial_content">
                        {formatMessage({
                            id: "navbar_dropdown.tryTrialNow",
                            defaultMessage: "Try Enterprise for free now!",
                        })}
                    </div>
                    <button onClick={openLearnMoreTrialModal}>
                        {formatMessage({
                            id: "navbar_dropdown.learnMore",
                            defaultMessage: "Learn More",
                        })}
                    </button>
                </>
