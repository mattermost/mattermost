...
const RestrictedIndicator = ({
    ...
    const getTooltipMessageBlocked = useCallback(() => {
        ...
        return typeof tooltipMessageBlocked === "string"
            ? tooltipMessageBlocked
            : formatMessage(tooltipMessageBlocked, {
                  trialLength: FREEMIUM_TO_ENTERPRISE_TRIAL_LENGTH_DAYS,
                  article:
                      minimumPlanRequiredForFeature === LicenseSkus.Enterprise
                          ? "an"
                          : "a",
                  minimumPlanRequiredForFeature,
              });
    ...
    const icon = (
        <i
            className={classNames(
                ...
                "icon",
                blocked ? "icon-key-variant" : "trial",
            )}
        />
    );
                    ...
                    <Tooltip className="RestrictedIndicator__icon-tooltip">
                        <span className="title">
                            {tooltipTitle ||
                                formatMessage(
                                    {
                                        id: "restricted_indicator.tooltip.title",
                                        defaultMessage:
                                            "{minimumPlanRequiredForFeature} feature",
                                    },
                                    {
                                        minimumPlanRequiredForFeature:
                        ...
                        <span className="message">
                            {blocked
                                ...
                                : tooltipMessage ||
                                  formatMessage({
                                      id: "restricted_indicator.tooltip.mesage",
                                      defaultMessage:
                                          "During your trial you are able to use this feature.",
                                  })}
                        </span>
                    </Tooltip>
                }
