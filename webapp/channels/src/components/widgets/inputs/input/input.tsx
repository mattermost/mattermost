...
const Input = React.forwardRef(
    (
        ...
        const limitExceeded =
            limit && value && !Array.isArray(value)
        ...
        return (
            <div
                className={classNames("Input_container", containerClassName, {
                    disabled,
                })}
            >
                <fieldset
                    className={classNames("Input_fieldset", className, {
                        Input_fieldset___error:
                            error || hasError || limitExceeded > 0,
