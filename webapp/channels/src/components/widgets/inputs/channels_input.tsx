...
import type {InputActionMeta, SelectInstance, MultiValue, GroupBase, MultiValueRemoveProps, SelectComponentsConfig} from 'react-select';
...
export default class ChannelsInput<T extends Channel> extends React.PureComponent<Props<T>, State<T>> {
    ...
    components: SelectComponentsConfig<T, true, GroupBase<T>> = {
