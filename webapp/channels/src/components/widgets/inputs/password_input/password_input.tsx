...
const PasswordInput = React.forwardRef(
    (
        ...
        const customMessageError: CustomMessageInputType | null = error
            ? { type: ItemStatus.ERROR, value: error }
            : null;
        const customMessageInfo: CustomMessageInputType | null = info
            ? { type: ItemStatus.INFO, value: info }
            : null;
                ...
                addon={
                    <button
                        ...
                        aria-label={formatMessage({
                            id: "widget.passwordInput.passwordToggle",
                            defaultMessage: "Show or hide password",
                        })}
