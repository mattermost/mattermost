...
const IndicatorsContainer = <T extends OptionType>(props: IndicatorsContainerProps<T, false, GroupBase<T>>) => (
...
const Control = <T extends OptionType>(props: ControlProps<T, false, GroupBase<T>>) => (
