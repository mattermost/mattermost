...
function Content(props: ContentProps) {
    ...
    const currentSubscriptionIsMonthly =
        currentProduct?.recurring_interval === RecurringIntervals.MONTH;
    const isEnterprise = currentProduct?.sku === CloudProducts.ENTERPRISE;
    const isEnterpriseTrial = subscription?.is_free_trial === "true";
    const yearlyProfessionalProduct = findProductBySku(
        yearlyProducts,
        CloudProducts.PROFESSIONAL,
    );
    const professionalPrice = formatNumber(
        (yearlyProfessionalProduct?.price_per_seat || 0) / 12,
    ...
    const currentSubscriptionIsMonthlyProfessional =
        currentSubscriptionIsMonthly && isProfessional;
    const isProfessionalAnnual =
        isProfessional &&
        currentProduct?.recurring_interval === RecurringIntervals.YEAR;
    ...
    const [
        notifyAdminBtnTextProfessional,
        notifyAdminOnProfessionalFeatures,
        professionalNotifyRequestStatus,
    ] = useNotifyAdmin(
        {
            ctaText: formatMessage({
                id: "pricing_modal.noitfy_cta.request",
                defaultMessage: "Request admin to upgrade",
            }),
            successText: (
                <>
                    <i className="icon icon-check" />
                    {formatMessage({
                        id: "pricing_modal.noitfy_cta.request_success",
    ...
    const [
        notifyAdminBtnTextEnterprise,
        notifyAdminOnEnterpriseFeatures,
        enterpriseNotifyRequestStatus,
    ] = useNotifyAdmin(
        {
            ctaText: formatMessage({
                id: "pricing_modal.noitfy_cta.request",
    ...
    const freeTierText =
        !isStarter && !currentSubscriptionIsMonthly
            ? formatMessage({
                  id: "pricing_modal.btn.contactSupport",
                  defaultMessage: "Contact Support",
              })
            : formatMessage({
                  id: "pricing_modal.btn.downgrade",
    ...
    const handleClickDowngrade = (downgradeFeedback?: Feedback) => {
        downgrade(
            "click_pricing_modal_free_card_downgrade_button",
            downgradeFeedback,
        );
    };
    ...
    const starterBriefing = [
        formatMessage(
            {
                ...
                defaultMessage: "Access to {messages} most recent messages",
            },
            { messages: formatNumber(fallbackStarterLimits.messages.history) },
        ),
        formatMessage(
            {
                id: "pricing_modal.briefing.storageStarter",
                defaultMessage: "{storage} file storage limit",
            },
            {
                storage: asGBString(
        ...
        formatMessage({
            id: "pricing_modal.briefing.free.noLimitBoards",
            defaultMessage: "Unlimited board cards",
        }),
        formatMessage({
            id: "pricing_modal.briefing.free.oneTeamPerWorkspace",
            defaultMessage: "One team per workspace",
        }),
        formatMessage({
            id: "pricing_modal.briefing.free.gitLabGitHubGSuite",
            defaultMessage: "GitLab, GitHub, and GSuite SSO",
        }),
        formatMessage({
            id: "pricing_modal.extra_briefing.cloud.free.calls",
            defaultMessage:
                "Group calls of up to 8 people, 1:1 calls, and screen share",
        }),
    ];
    ...
    const professionalBtnDetails = () => {
        if (isAdmin) {
            return {
                action: () =>
                    openPurchaseModal(
                        "click_pricing_modal_professional_card_upgrade_button",
                    ),
                text: adminProfessionalTierText,
                disabled:
                    isProfessionalAnnual ||
                    (isEnterprise && !isEnterpriseTrial),
                customClass:
                    cloudFreeDeprecated || isPostTrial
                        ? ButtonCustomiserClasses.special
                        : ButtonCustomiserClasses.active,
            };
        }
        ...
        return {
            action: (e: React.MouseEvent<HTMLButtonElement, MouseEvent>) => {
                notifyAdminOnProfessionalFeatures(
                    e,
                    "professional_plan_pricing_modal_card",
                );
            },
    ...
    const enterpriseBtnDetails = () => {
        if (cloudFreeDeprecated || (isPostTrial && isAdmin)) {
            return {
                ...
                text: formatMessage({
                    id: "pricing_modal.btn.contactSales",
        ...
        if (!isAdmin) {
            ...
            return {
                action: (
                    ...
                    notifyAdminOnEnterpriseFeatures(
                        e,
                        "enterprise_plan_pricing_modal_card",
                    );
                },
            ...
            return (
                <CloudStartTrialButton
                    message={formatMessage(
                        {
                            id: "pricing_modal.btn.tryDays",
                            defaultMessage: "Try free for {days} days",
                        },
                        { days: "30" },
                    )}
                    telemetryId="start_cloud_trial_from_pricing_modal"
                    disabled={
                        isEnterprise || isEnterpriseTrial || isProfessional
                    }
                    extraClass={`plan_action_btn ${
                        isEnterprise || isEnterpriseTrial || isProfessional
    ...
    const professionalPlanLabelText = () => {
        if (isProfessionalAnnual || !isAdmin) {
            return formatMessage({
                id: "pricing_modal.planLabel.currentPlan",
                defaultMessage: "CURRENT PLAN",
            });
        }

        return formatMessage({
            id: "pricing_modal.planLabel.currentPlanMonthly",
            defaultMessage: "CURRENTLY ON MONTHLY BILLING",
        });
    };
        ...
        <div className="Content">
            <Modal.Header className="PricingModal__header">
                <div className="header_lhs">
                    <h1 className="title">
                        {formatMessage({
                            id: "pricing_modal.title",
                            defaultMessage: "Select a plan",
                        })}
                    </h1>
                    <div>
                        {formatMessage({
                            id: "pricing_modal.subtitle",
                            defaultMessage: "Choose a plan to get started",
                        })}
                    </div>
                </div>
                <button
                    ...
                    <div className="pricing-options-container">
                        <div className="alert-option-container">
                            <div className="alert-option">
                                <span>
                                    {formatMessage({
                                        id: "pricing_modal.lookingToSelfHost",
                                ...
                                >
                                    {formatMessage({
                                        id: "pricing_modal.reviewDeploymentOptions",
                                        defaultMessage:
                ...
                >
                    {!cloudFreeDeprecated && (
                        <Card
                            ...
                            topColor="#339970"
                            plan="Free"
                            planSummary={formatMessage({
                                id: "pricing_modal.planSummary.free",
                                defaultMessage:
                                    "Increased productivity for small teams",
                            })}
                            price="$0"
                            rate={formatMessage({
                                id: "pricing_modal.price.freeForever",
                            ...
                            buttonDetails={{
                                ...
                                customClass:
                                    isStarter || isEnterprise || !isAdmin
                                        ? ButtonCustomiserClasses.grayed
                                        : ButtonCustomiserClasses.secondary,
                            }}
                            briefing={{
                                title: formatMessage({
                                    id: "pricing_modal.briefing.title",
                                    defaultMessage: "Top features",
                                }),
                                items: hasLimits
                                    ? starterBriefing
                                    : legacyStarterBriefing,
                            }}
                        />
                    )}
                    ...
                    <Card
                        ...
                        planSummary={formatMessage(
                            {
                                id: "pricing_modal.planSummary.professional",
                                defaultMessage:
                                    "Scalable solutions {br} for growing teams",
                            },
                            {
                                br: <br />,
                            },
                        ...
                        briefing={{
                            title: cloudFreeDeprecated
                                ? formatMessage({
                                      id: "pricing_modal.briefing.title_no_limit",
                                      defaultMessage:
                                          "No limits on your team’s usage",
                                  })
                                : formatMessage({
                                      id: "pricing_modal.briefing.title",
                                      defaultMessage: "Top features",
                            ...
                            items: [
                                formatMessage({
                                    id: "pricing_modal.briefing.professional.messageBoardsIntegrationsCalls",
                                    defaultMessage:
                                        "Unlimited access to messages and files",
                                }),
                                formatMessage({
                                    id: "pricing_modal.briefing.professional.unLimitedTeams",
                                    defaultMessage: "Unlimited teams",
                                }),
                                formatMessage({
                                    id: "pricing_modal.briefing.professional.advancedPlaybook",
                                    defaultMessage:
                                        "Advanced Playbook workflows with retrospectives",
                                }),
                                formatMessage({
                                    id: "pricing_modal.extra_briefing.professional.ssoSaml",
                                    defaultMessage:
                                        "SSO with SAML 2.0, including Okta, OneLogin, and ADFS",
                                }),
                                formatMessage({
                                    id: "pricing_modal.extra_briefing.professional.ssoadLdap",
                                    defaultMessage:
                                        "SSO support with AD/LDAP, Google, O365, OpenID",
                                }),
                                formatMessage({
                                    id: "pricing_modal.extra_briefing.professional.guestAccess",
                                    defaultMessage:
                    ...
                    <Card
                        ...
                        plan="Enterprise"
                        planSummary={formatMessage({
                            id: "pricing_modal.planSummary.enterprise",
                            defaultMessage:
                                "Administration, security, and compliance for large teams",
                        })}
                        isCloud={true}
                        cloudFreeDeprecated={cloudFreeDeprecated}
                        planLabel={
                        ...
                        planTrialDisclaimer={
                            !isPostTrial && isAdmin && !cloudFreeDeprecated ? (
                                <StartTrialCaution />
                            ) : undefined
                        }
                        contactSalesCTA={
                        ...
                        briefing={{
                            title: cloudFreeDeprecated
                                ? formatMessage({
                                      id: "pricing_modal.briefing.title_large_scale",
                                      defaultMessage:
                            ...
                            items: [
                                formatMessage({
                                    id: "pricing_modal.briefing.enterprise.groupSync",
                                    defaultMessage: "AD/LDAP group sync",
                                }),
                                formatMessage({
                                    id: "pricing_modal.briefing.enterprise.rolesAndPermissions",
                                    defaultMessage:
                                        "Advanced roles and permissions",
                                }),
                                formatMessage({
                                    id: "pricing_modal.briefing.enterprise.advancedComplianceManagement",
                                    defaultMessage:
                                        "Advanced compliance management",
                                }),
                                formatMessage({
                                    id: "pricing_modal.briefing.enterprise.mobileSecurity",
                                    defaultMessage:
                                        "Advanced mobile security via ID-only push notifications",
                                }),
                                formatMessage({
                                    id: "pricing_modal.extra_briefing.enterprise.playBookAnalytics",
                                    defaultMessage:
                        ...
                        planAddonsInfo={{
                            title: formatMessage({
                                id: "pricing_modal.addons.title",
                                defaultMessage: "Available Add-ons",
                            }),
                            items: [
                                {
                                    title: formatMessage({
                                        id: "pricing_modal.addons.premiumSupport",
                                        defaultMessage: "Premium support",
                                    }),
                                },
                                {
                                    title: formatMessage({
                                        id: "pricing_modal.addons.missionCritical",
                                        defaultMessage: "Mission-critical 24x7",
                                    }),
                                },
                                { title: "1hr-L1, 2hr-L2" },
                                {
                                    title: formatMessage({
                                        id: "pricing_modal.addons.USSupport",
                                        defaultMessage:
                                            "U.S.- only based support",
                                    }),
                                },
                                {
                                    title: formatMessage({
                                        id: "pricing_modal.addons.dedicatedDeployment",
                                        defaultMessage:
                                ...
                                {
                                    title: formatMessage({
                                        id: "pricing_modal.addons.dedicatedK8sCluster",
                                        defaultMessage:
                                ...
                                {
                                    title: formatMessage({
                                        id: "pricing_modal.addons.dedicatedDB",
                                        defaultMessage: "Dedicated database",
                                    }),
                                },
                                {
                                    title: formatMessage({
                                        id: "pricing_modal.addons.dedicatedEncryption",
                                        defaultMessage:
                                ...
                                {
                                    title: formatMessage({
                                        id: "pricing_modal.addons.uptimeGuarantee",
                                        defaultMessage: "99% uptime guarantee",
                                    }),
                                },
                            ],
                        }}
