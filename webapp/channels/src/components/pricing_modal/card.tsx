        ...
        <div className="BlankCard">
            ...
            <div className="description">
                ...
                <div className="content">
                    {formatMessage({
                        id: "pricing_modal.reach_out",
                        defaultMessage:
                            "Reach out to us and we’ll help you decide which plan is right for you and your organization.",
                    })}
                </div>
            </div>
            <hr />
            <div className="self-hosted-interest">
                <span className="interested">
                    {formatMessage({
                        id: "pricing_modal.interested_self_hosting",
                        defaultMessage: "Interested in self-hosting?",
                    })}
                </span>
...
function Card(props: CardProps) {
    ...
    const planPriceRateSectionClassName = classNames(
    ...
    return (
        <div id={props.id} className="PlanCard">
            ...
            {(!props.cloudFreeDeprecated || !props.isCloud) && (
                <StyledDiv className="top" bgColor={props.topColor} />
            )}
                ...
                <div className="bottom_container">
                    <div className={planPriceRateSectionClassName}>
                        ...
                        {props.price ? (
                            ...
                            <div className={buildingImgClassName}>
                                <BuildingSvg />
                            </div>
                        )}
                        ...
                        {props.customButtonDetails || (
                            <button
                                ...
                                className={`plan_action_btn ${
                                    props.buttonDetails?.disabled
                                        ? ButtonCustomiserClasses.grayed
                                        : props.buttonDetails?.customClass
                                }`}
                            ...
                            return (
                                <div className="item" key={i.title}>
                                    <div className="item_title">
                                        <i className="fa fa-circle bullet fa-xs" />
                                        <p>{i.title}</p>
                                    </div>
                                    {i.items?.map((sub) => {
                                        return (
                                            <div className="subitem" key={sub}>
                                                <div className="subitem_title">
                                                    <i className="fa fa-circle bullet fa-xs" />
                                                    <p>{sub}</p>
                                                </div>
                                            </div>
