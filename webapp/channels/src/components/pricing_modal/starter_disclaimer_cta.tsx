...
function StarterDisclaimerCTA() {
    ...
    const starterProductName =
        Object.values(products || {})?.find(
            (product: Product) => product?.sku === CloudProducts.STARTER,
        )?.name || "Cloud Free";
    ...
    return (
        ...
        >
            ...
            {intl.formatMessage({
                id: "pricing_modal.planDisclaimer.free",
                defaultMessage: "This plan has data restrictions.",
            })}
        </Disclaimer>
    );
}
