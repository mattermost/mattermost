...
async function renderShareChannelWithWorkspaces(remotes: WorkspaceWithStatus[], initialRemotes: WorkspaceWithStatus[]) {
    const Wrapper = () => {
...
describe('ShareChannelWithWorkspaces', () => {
    ...
    it('should render with toggle off when no remotes', async () => {
        await renderShareChannelWithWorkspaces([], []);
    ...
    it('should render with toggle on when remotes exist', async () => {
        await renderShareChannelWithWorkspaces(mockRemotes, []);
    ...
    it('should show connection status when re-adding a removed workspace without saving', async () => {
        await renderShareChannelWithWorkspaces(mockRemotes, mockRemotes);
