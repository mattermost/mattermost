...
describe('ChannelActivityWarningModal', () => {
    ...
    test('should render modal when isOpen is true', () => {
        ...
        expect(screen.getByText(/view the entire message history/)).toBeInTheDocument();
        expect(screen.getByText(/I acknowledge this change will expose all historical channel messages/)).toBeInTheDocument();
    });
