...
describe('ChannelSettingsConfigurationTab', () => {
    ...
    describe('Share channel with connected workspaces', () => {
        ...
        it('should render ShareChannelWithWorkspaces section when canManageSharedChannels is true', async () => {
            await renderWithContext(
                <ChannelSettingsConfigurationTab
                    {...baseProps}
        ...
        it('should not render ShareChannelWithWorkspaces section when canManageSharedChannels is false', async () => {
            await renderWithContext(
                <ChannelSettingsConfigurationTab
                    {...baseProps}
