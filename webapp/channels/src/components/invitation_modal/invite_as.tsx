...
export default function InviteAs(props: Props) {
    ...
    const isSelfHostedStarter =
        isEnterpriseReady && license.IsLicensed === "false";
    ...
    if (isSystemAdmin && !isPaidSubscription) {
        ...
        if (isFreeTrial) {
            ctaExtraContentMsg = formatMessage({
                id: "free.professional_feature.professional",
                defaultMessage: "Professional feature",
            });
        } else {
            ctaExtraContentMsg =
                hasPriorTrial || cloudFreeDeprecated
                    ? formatMessage({
                          id: "free.professional_feature.upgrade",
                          defaultMessage: "Upgrade",
                      })
                    : formatMessage({
                          id: "free.professional_feature.try_free",
                          defaultMessage:
                              "Professional feature- try it out free",
                      });
        }
        ...
        const restrictedIndicator = (
            <RestrictedIndicator
                ...
                ctaExtraContent={
                    <span className="tag-text">{ctaExtraContentMsg}</span>
                }
                ...
                customSecondaryButtonInModal={
                    hasPriorTrial
                        ...
                        : {
                              msg: formatMessage({
                                  id: "free.professional_feature.back",
                                  defaultMessage: "Back",
                              }),
                              action: () => {
                                  dispatch(
    ...
    return (
        <div className="InviteAs">
            ...
            <div>
                <RadioGroup
                    onChange={(e) =>
                        props.setInviteAs(e.target.value as InviteType)
                    }
                    ...
                    values={[
                        ...
                        },
                        {
                            key: (
                                <span
                                    className={`InviteAs__label ${guestDisabledClass}`}
                                >
                                    <FormattedMessage
