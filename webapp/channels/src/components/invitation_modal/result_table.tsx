...
export default function ResultTable(props: Props) {
    const intl = useIntl();
    let wrapperClass =
        "invitation-modal-confirm invitation-modal-confirm--not-sent";
    let header = (
        <h2>
            <FormattedMessage
    ...
    if (props.sent) {
        wrapperClass =
            "invitation-modal-confirm invitation-modal-confirm--sent";
        header = (
            <h2>
                <FormattedMessage
                ...
                <div className="rows">
                    {props.rows.map((invitation: InviteResult) => {
                        ...
                        if (invitation.hasOwnProperty("user")) {
                            ...
                            reactKey = user.id;
                            const profileImg = imageURLForUser(
                                user.id,
                        ...
                        if (
                            typeof invitation?.reason !== "string" &&
                        ...
                        return (
                            <div key={reactKey} className="InviteResultRow">
