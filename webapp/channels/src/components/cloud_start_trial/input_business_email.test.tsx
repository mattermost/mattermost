...
describe('/components/cloud_start_trial/input_business_email', () => {
    ...
    test('should match snapshot', async () => {
        const {container} = await renderWithContext(<InputBusinessEmail {...baseProps}/>);
        expect(container).toMatchSnapshot();
    });

    test('test input business email displays the input element correctly', async () => {
    ...
    test('test input business email displays the SUCCESS custom message correctly', async () => {
        const {container} = await renderWithContext(
    ...
    test('test input business email displays the WARNING custom message correctly', async () => {
        const {container} = await renderWithContext(
    ...
    test('test input business email displays the ERROR custom message correctly', async () => {
        const {container} = await renderWithContext(
    ...
    test('test input business email displays the INFO custom message correctly', async () => {
        const {container} = await renderWithContext(
    ...
    test('test the input element handles the onChange event correctly', async () => {
        const {container} = await renderWithContext(
            <InputBusinessEmail {...baseProps}/>,
        );
        const inputElement = container.querySelector('input.Input')!;
