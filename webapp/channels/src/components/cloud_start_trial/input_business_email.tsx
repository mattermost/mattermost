...
const InputBusinessEmail = ({
    ...
    return (
        <Input
            ...
            label={formatMessage({
                id: "start_cloud_trial.modal.enter_trial_email.input.label",
                defaultMessage: "Enter business email",
            })}
            placeholder={formatMessage({
                id: "start_cloud_trial.modal.enter_trial_email.input.placeholder",
                defaultMessage: "name@companyname.com",
            })}
