...
export const isAppBarPluginComponent = (
    x: Record<string, any> | undefined,
): x is PluginComponent => {
...
const AppBarPluginComponent = (props: PluginComponentProps) => {
    ...
    const tooltipText =
        component.tooltipText || component.dropdownText || component.pluginId;
    const tooltip = (
    ...
    let content: React.ReactNode = (
        <div role="button" tabIndex={0} className="app-bar__icon-inner">
            <img
                src={iconUrl}
    ...
    const isButtonActive = component.rhsComponentId
        ? activeRhsComponent?.id === component.rhsComponentId
        : component.pluginId === activeRhsComponent?.pluginId;
        ...
        content = (
            <div
                ...
                className={classNames(
                    "app-bar__old-icon app-bar__icon-inner app-bar__icon-inner--centered",
                    { "app-bar__old-icon--active": isButtonActive },
                )}
            >
                {component.icon}
            </div>
    ...
    if (imageLoadState === ImageLoadState.ERROR) {
        content = <PluginIcon className="icon__plugin" />;
    }
        ...
        >
            <div
                ...
                className={classNames("app-bar__icon", {
                    "app-bar__icon--active": isButtonActive,
                })}
                onClick={() => {
