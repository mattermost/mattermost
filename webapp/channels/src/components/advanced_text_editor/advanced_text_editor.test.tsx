...
const initialState = {
    entities: {
        ...
        teams: {
            ...
            teams: {
                current_team_id: TestHelper.getTeamMock({
                    id: "current_team_id",
                }),
            },
            myMembers: {
                current_team_id: TestHelper.getTeamMembershipMock({
                    roles: "team_roles",
                }),
            },
        },
...
const baseProps = {
    ...
    currentChannel: initialState.entities.channels.channels
        .current_channel_id as Channel,
    channelId,
    postId: "",
    errorClass: null,
    serverError: null,
...
describe("components/avanced_text_editor/advanced_text_editor", () => {
    describe("keyDown behavior", () => {
        ...
        it("Ctrl+up should call loadPrevMessage", () => {
            ...
            userEvent.type(
                screen.getByTestId("post_textbox"),
                "{ctrl}{arrowup}",
            );
        ...
        describe("markdown", () => {
            ...
            for (const tc of ttcc) {
                it(`component adds ${tc.markdownMode} markdown`, () => {
                    ...
                    const textbox = screen.getByTestId("post_textbox");
                    userEvent.type(textbox, tc.input, {
