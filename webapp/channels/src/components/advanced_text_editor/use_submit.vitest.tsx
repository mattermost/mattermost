...
import {renderHookWithContext} from 'tests/vitest_react_testing_utils';
...
describe('useSubmit', () => {
    ...
    const mockFocusTextbox: UseSubmitParams[6] = vi.fn();
    const mockSetServerError: UseSubmitParams[7] = vi.fn();
    const mockSetShowPreview: UseSubmitParams[8] = vi.fn();
    const mockHandleDraftChange: UseSubmitParams[9] = vi.fn();
    const mockPrioritySubmitCheck: UseSubmitParams[10] = vi.fn(() => false);
    const mockAfterOptimisticSubmit: UseSubmitParams[11] = vi.fn();
    const mockAfterSubmit: UseSubmitParams[12] = vi.fn();
