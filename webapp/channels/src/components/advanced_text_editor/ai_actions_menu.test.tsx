...
describe('AIActionsMenu', () => {
    test('should not render when there are no plugin items and rewrite is disabled', async () => {
    ...
    test('should render menu with rewrite item when rewrite is enabled', async () => {
    ...
    test('should render plugin items from Redux store', async () => {
    ...
    test('should render plugin items sorted by sortOrder', async () => {
    ...
    test('should render separator between plugin items and rewrite when both are present', async () => {
    ...
    test('should not render separator when only rewrite items are present', async () => {
        await renderWithContext(
            <AIActionsMenu
                {...getBaseProps()}
                aiRewriteEnabled={true}
    ...
    test('should call action with correct props when action item is clicked', async () => {
    ...
    test('should render chevron for component items but not for action items', async () => {
        const MockComponent = () => <div>{'Plugin'}</div>;
    ...
    test('should render plugin component in submenu on hover with correct props including isRHS', async () => {
