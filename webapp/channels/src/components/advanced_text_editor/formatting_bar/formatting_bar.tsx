        ...
        >
            ...
            >
                ...
                >
                    ...
                    {hasAdditionalControls && !showAdditionalControlsInline && hiddenControls.length > 0 && <Separator/>}
                    {hasAdditionalControls && !showAdditionalControlsInline && additionalControls}
                </HiddenControlsContainer>
            </CSSTransition>
        </FormattingBarContainer>
    );
