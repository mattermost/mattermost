...
vi.mock('components/menu', () => ({
    ...vi.importActual('components/menu'),
...
vi.mock('components/common/agents/agent_dropdown', () => ({
...
vi.mock('components/widgets/inputs/input/input', () => {
    ...
    return {default: ForwardRefComponent};
});
...
describe('RewriteMenu', () => {
    ...
    test('should call onCustomPromptKeyDown when key is pressed in prompt input', () => {
        const onCustomPromptKeyDown = vi.fn();
        renderWithContext(
            <RewriteMenu
                {...baseProps}
