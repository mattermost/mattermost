...
import {renderWithContext, screen, userEvent, fireEvent, waitForElementToBeRemoved} from 'tests/vitest_react_testing_utils';

import ConvertChannelModal from './convert_channel_modal';

describe('component/ConvertChannelModal', () => {
    const updateChannelPrivacy = vi.fn().mockImplementation(() => Promise.resolve({}));
    const baseProps = {
        onExited: vi.fn(),
    ...
    beforeEach(() => {
        updateChannelPrivacy.mockClear();
    });
