...
export default class ProfilePicture extends React.PureComponent<Props> {
    ...
    public render() {
        ...
        const profileSrc =
            typeof this.props.profileSrc === "string" &&
            this.props.profileSrc !== ""
                ? this.props.profileSrc
                : this.props.src;

        const profileIconClass = `profile-icon ${
            this.props.isEmoji ? "emoji" : ""
        }`;

        const hideStatus =
            this.props.isBot ||
            this.props.fromAutoResponder ||
            this.props.fromWebhook;
        ...
        if (this.props.userId) {
            return (
                ...
                >
                    <span
                        className={`status-wrapper  ${this.props.wrapperClass}`}
                    >
                        <RoundButton
