...
describe("components/select_team/SelectTeam", () => {
    ...
    test("should match snapshot", () => {
        ...
        expect(props.actions.getTeams).toHaveBeenCalledWith(
            0,
            TEAMS_PER_PAGE,
            true,
        );
        expect(props.actions.loadRolesIfNeeded).toHaveBeenCalledWith(
            baseProps.currentUserRoles.split(" "),
        );
    });

    test("should match snapshot, on loading", () => {
        const wrapper = shallow<SelectTeam>(<SelectTeam {...baseProps} />);
    ...
    test("should match snapshot, on no joinable team but can create team", () => {
        ...
        const wrapper = shallow<SelectTeam>(<SelectTeam {...props} />);
        expect(wrapper).toMatchSnapshot();
    });
    ...
    test("should call emitUserLoggedOutEvent on handleLogoutClick", () => {
        ...
        wrapper
            .instance()
            .handleLogoutClick({ preventDefault: jest.fn() } as any);
