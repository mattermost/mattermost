...
export class SearchableChannelList extends React.PureComponent<Props, State> {
        ...
        const joinViewChannelButton = (
            ...
            >
                <LoadingWrapper
                    ...
                    text={this.props.intl.formatMessage({id: 'joinChannel.joiningButton', defaultMessage: 'Joining...'})}
                >
                    <FormattedMessage
    ...
    render() {
        ...
        if (this.props.loading && channels.length === 0) {
            ...
            listContent = (
                <div
                    ...
                    aria-label={
                        this.state.channelSearchValue.length > 0 ? this.props.intl.formatMessage({id: 'more_channels.noMore', defaultMessage: 'No results for {text}'}, {text: this.state.channelSearchValue}) : this.props.intl.formatMessage({id: 'widgets.channels_input.empty', defaultMessage: 'No channels found'})
                    }
                >
                    <MagnifyingGlassSVG/>
        ...
        if (channels.length === 0) {
            ...
            channelCountLabel = this.props.intl.formatMessage({id: 'more_channels.count', defaultMessage: '{count} Results'}, {count: channels.length});
        } else {
            channelCountLabel = this.props.intl.formatMessage({id: 'more_channels.count_zero', defaultMessage: '0 Results'});
        }
