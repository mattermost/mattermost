...
describe("components/channel_header/components/UserGuideDropdown", () => {
    ...
    test("should match snapshot", () => {
        const wrapper = shallowWithIntl(<UserGuideDropdown {...baseProps} />);
    ...
    test("should match snapshot for false of enableAskCommunityLink", () => {
        ...
        const wrapper = shallowWithIntl(<UserGuideDropdown {...props} />);
    ...
    test("Should call for track event on click of askTheCommunityLink", () => {
        ...
        wrapper
            .find(Menu.ItemExternalLink)
            .find("#askTheCommunityLink")
            .prop("onClick")!({} as unknown as React.MouseEvent);
