...
const ProductMenuList = (props: Props): JSX.Element | null => {
    ...
    const showIntegrations =
        !isMobile && someIntegrationEnabled && canManageIntegrations;
        ...
        <Menu.Group>
            <div onClick={onClick}>
                ...
                <SystemPermissionGate
                    permissions={[
                        Permissions.SYSCONSOLE_WRITE_ABOUT_EDITION_AND_LICENSE,
                    ]}
                >
                    <Menu.StartTrial id="startTrial" />
                </SystemPermissionGate>
                <SystemPermissionGate
                    permissions={Permissions.SYSCONSOLE_READ_PERMISSIONS}
                >
                    <Menu.ItemLink
                        id="systemConsole"
                        show={!isMobile}
                ...
                <Menu.ItemToggleModalRedux
                    ...
                    modalId={ModalIdentifiers.USER_GROUPS}
                    show={
                        enableCustomUserGroups || isStarterFree || isFreeTrial
                    }
                    dialogType={UserGroupsModal}
                    dialogProps={{
                        backButtonAction: openGroupsModal,
                        ...
                        (isStarterFree || isFreeTrial) && (
                            <RestrictedIndicator
                                ...
                                titleAdminPreTrial={formatMessage({
                                    ...
                                    defaultMessage:
                                        "Try unlimited user groups with a free trial",
                                })}
                                ...
                                titleAdminPostTrial={formatMessage({
                                    ...
                                    defaultMessage:
                                        "Upgrade to create unlimited user groups",
                                })}
                                ...
                                titleEndUser={formatMessage({
                                    ...
                                    defaultMessage:
                                        "User groups available in paid plans",
                                })}
                ...
                >
                    <Menu.ItemToggleModalRedux
                        ...
                        show={
                            isMessaging && !isMobile && enablePluginMarketplace
                        }
