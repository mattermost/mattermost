...
function mapStateToProps(state: GlobalState) {
    ...
    const showVisitSystemConsoleTour =
        step ===
        TaskNameMapToSteps[OnboardingTasksName.VISIT_SYSTEM_CONSOLE].STARTED;
    ...
    return {
        ...
        firstAdminVisitMarketplaceStatus:
            getFirstAdminVisitMarketplaceStatus(state),
