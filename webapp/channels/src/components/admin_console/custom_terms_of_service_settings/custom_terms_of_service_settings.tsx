...
import type {
    BaseProps,
    BaseState,
} from "components/admin_console/admin_settings";
    ...
    doSubmit = async (callback?: () => void) => {
        ...
        if (
            ...
            (this.state.receivedTermsText !== this.state.termsText ||
                !this.props.config?.SupportSettings
        ...
        if (data) {
            ...
            this.handleAPIError(
                { id: error.server_error_id, ...error },
                callback,
                config,
            );
        }
