...
const PaymentDetails: React.FC<PaymentDetailsProps> = ({
    ...
    const customerPaymentInfo = useSelector(
        (state: GlobalState) => state.entities.cloud.customer,
    );

    if (
        !customerPaymentInfo?.payment_method &&
        !customerPaymentInfo?.billing_address
    ) {
        return null;
    }
        ...
        <div className="PaymentInfoDisplay__paymentInfo-text">
            ...
            <div className="PaymentInfoDisplay__paymentInfo-cardInfo">
                ...
                <FormattedMarkdownMessage
                    ...
                    values={{
                        month: String(
                            customerPaymentInfo.payment_method.exp_month,
                        ).padStart(2, "0"),
                        year: String(
                            customerPaymentInfo.payment_method.exp_year,
                        ).padStart(2, "0"),
                    }}
                />
            </div>
