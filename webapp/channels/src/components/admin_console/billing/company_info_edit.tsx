...
const CompanyInfoEdit: React.FC<Props> = () => {
    ...
    const [numEmployees, setNumEmployees] = useState<number | undefined>(
        companyInfo?.num_employees || undefined,
    );

    const [address, setAddress] = useState(companyInfo?.company_address?.line1);
    const [address2, setAddress2] = useState(
        companyInfo?.company_address?.line2,
    );
    ...
    const [country, setCountry] = useState(
        companyInfo?.company_address?.country || getName("US"),
    );
    const [state, setState] = useState(companyInfo?.company_address?.state);
    const [contentChanged, setContentChanged] = useState(false);

    const [sameAsBillingAddress, setSameAsBillingAddress] = useState(
        Boolean(
            !companyInfo?.company_address?.line1 &&
    ...
    const billingAddressDisplay = (
        <>
            ...
            <div className="CompanyInfoEdit__companyInfo-address">
                ...
                {companyInfo?.billing_address?.line2 && (
                    <div>{companyInfo?.billing_address?.line2}</div>
                )}
        ...
        <>
            ...
            <div className="form-row">
                <Input
                    ...
                    placeholder={Utils.localizeMessage(
                        "admin.billing.company_info.address",
                        "Address",
                    )}
                    required={true}
                />
            ...
            <div className="form-row">
                <Input
                    ...
                    placeholder={Utils.localizeMessage(
                        "admin.billing.company_info.address_2",
                        "Address 2",
                    )}
                />
            </div>
            <div className="form-row">
                <Input
                    ...
                    placeholder={Utils.localizeMessage(
                        "admin.billing.company_info.city",
                        "City",
                    )}
                    required={true}
                />
            ...
            <div className="form-row">
                ...
                <div className="form-row-third-2">
                    <Input
                        ...
                        placeholder={Utils.localizeMessage(
                            "admin.billing.company_info.zipcode",
                            "Zip/Postal Code",
                        )}
                        required={true}
                    />
                        ...
                        <div className="CompanyInfoEdit__form">
                            ...
                            <div className="form-row">
                                <Input
                                    ...
                                    placeholder={Utils.localizeMessage(
                                        "admin.billing.company_info.companyName",
                                        "Company name",
                                    )}
                                    required={true}
                                />
                            ...
                            <div className="form-row">
                                <Input
                                    ...
                                    placeholder={Utils.localizeMessage(
                                        "admin.billing.company_info.numEmployees",
