...
const BillingSubscriptions = () => {
    ...
    const isCardExpired = isCustomerCardExpired(
    ...
    const isAnnualProfessionalOrEnterprise =
    ...
    useEffect(() => {
        ...
        if (actionQueryParam === "show_purchase_modal") {
            onUpgradeMattermostCloud(
                "billing_subscriptions_external_direct_link",
            );
        }

        if (actionQueryParam === "show_pricing_modal") {
            openPricingModal({
                trackingLocation: "billing_subscriptions_external_direct_link",
            });
        }
        ...
        <div className="wrapper--fixed BillingSubscriptions">
            ...
            <div className="admin-console__wrapper">
                <div className="admin-console__content">
                    ...
                    {!errorLoadingData && (
                        <>
                            <LimitReachedBanner product={product} />
                            ...
                            {showCreditCardBanner &&
                                isCardExpired &&
                                creditCardExpiredBanner(
                                    setShowCreditCardBanner,
                                )}
                            {isFreeTrial && (
                                <CloudTrialBanner trialEndDate={trialEndDate} />
                            )}
