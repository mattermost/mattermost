...
function makeInvoice(
    ...lines: Array<
        [number, (typeof InvoiceLineItemType)[keyof typeof InvoiceLineItemType]]
    >
): Invoice {
    return {
        id: "",
        ...
        line_items: lines.map(([quantity, type], index) => {
            ...
            if (
                type === InvoiceLineItemType.Full ||
                type === InvoiceLineItemType.Partial
            ) {
    ...
    const tests = [
        {
            ...
            expected:
                "1 metered seats, 1 seats at full rate, 1 seats with partial charges",
        },
        {
            name: "Supports cloud invoices with only metered line items",
            invoice: makeInvoice([12.34, InvoiceLineItemType.Metered]),
            expected: "12.34 seats",
        },
        {
            name: "Shows minimum decimal necessary",
            invoice: makeInvoice([12.499, InvoiceLineItemType.Metered]),
            expected: "12.5 seats",
        },
        {
            name: "hides insignificant decimals",
            invoice: makeInvoice([12.002, InvoiceLineItemType.Metered]),
            expected: "12 seats",
        },
        {
        ...
        },
        {
            ...
            invoice: makeInvoice([3, InvoiceLineItemType.OnPremise]),
            expected: "3 seats",
        },
    ];
