...
export const NoBillingHistorySection = (
    props: NoBillingHistorySectionProps,
) => (
    <div className="BillingHistory__noHistory">
        <EmptyBillingHistorySvg width={300} height={210} />
        ...
        <ExternalLink
            ...
            href={
                props.selfHosted
                    ? HostedCustomerLinks.SELF_HOSTED_BILLING
                    : CloudLinks.BILLING_DOCS
            }
            className="BillingHistory__noHistory-link"
            onClick={() =>
                trackEvent("cloud_admin", "click_billing_history", {
                    screen: "billing",
                })
            }
        >
...
const BillingHistory = () => {
    ...
    const invoices = useSelector(
        isCloud ? getCloudInvoices : getSelfHostedInvoices,
    );
    const { invoices: invoicesError } = useSelector(
        isCloud ? getCloudErrors : getSelfHostedErrors,
    );
