...
export const noBillingHistory = (
    <div className="BillingSummary__noBillingHistory">
        <EmptyBillingHistorySvg height={167} width={234} />
        ...
        <ExternalLink
            ...
            onClick={() =>
                trackEvent("cloud_admin", "click_how_billing_works", {
...
export const freeTrial = (
    ...
    <div className="UpgradeMattermostCloud">
        <div className="UpgradeMattermostCloud__image">
            <UpgradeSvg height={167} width={234} />
        </div>
        ...
        <button
            ...
            onClick={() =>
                onUpgradeMattermostCloud(
                    "billing_summary_free_trial_upgrade_button",
                )
            }
...
export const InvoiceInfo = ({
    ...
    return (
        <div className="BillingSummary__lastInvoice">
            ...
            {Boolean(hasMore) && (
                <div className="BillingSummary__lastInvoice-hasMoreItems">
                    <div
