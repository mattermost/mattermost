...
export default function UpsellCard(props: Props) {
    ...
    const ctaClassname = classNames("UpsellCard__cta", {
        btn: props.ctaPrimary,
        "btn-primary": props.ctaPrimary,
    });

    let callToAction = (
        <button className={ctaClassname} onClick={props.ctaAction}>
            {intl.formatMessage(
                {
                    id: props.cta.id,
        ...
        <div className="UpsellCard">
            ...
            <div className="UpsellCard__advantages">
                {props.advantages.map((message: Message) => {
                    return (
                        <div className="advantage" key={message.id}>
                ...
                {props.andMore && (
                    <div className="advantage advantage--more">
                        <i className="fa fa-lock" />
...
export const tryEnterpriseCard = (
    <UpsellCard
        ...
        cta={{
            id: t(
                "admin.billing.subscriptions.billing_summary.try_enterprise.cta",
            ),
...
export const UpgradeToProfessionalCard = () => {
    ...
    return (
        <UpsellCard
            title={{
                id: t(
                    "admin.billing.subscriptions.billing_summary.upgrade_professional",
                ),
                defaultMessage: "Upgrade to the Professional Plan",
            }}
            cta={{
                id: t(
                    "admin.billing.subscriptions.billing_summary.upgrade_professional.cta",
                ),
            ...
            ctaAction={() =>
                openPurchaseModal({
                    trackingLocation:
                        "billing_summary_upsell_professional_card",
                })
            }
            ctaPrimary={true}
            andMore={true}
...
export const ExploreEnterpriseCard = () => {
    return (
        <UpsellCard
            title={{
                id: t(
                    "admin.billing.subscriptions.billing_summary.explore_enterprise",
                ),
                defaultMessage: "Explore Enterprise features",
            }}
            cta={{
                id: t(
                    "admin.billing.subscriptions.billing_summary.explore_enterprise.cta",
                ),
