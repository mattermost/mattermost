...
const AdminDefinition = {
    ...
    environment: {
        ...
        cache: {
            ...
            schema: {
                id: 'Cache',
                name: t('admin.environment.cache'),
                name_default: 'Cache',
                settings: [
                    {
                        type: Constants.SettingsTypes.TYPE_DROPDOWN,
                        key: 'CacheSettings.CacheType',
                        label: t('admin.cache.cacheType'),
                        label_default: 'Cache Type:',
                        help_text: t('admin.cache.cacheTypeDescription'),
                        help_text_default: 'Type of cache to use.',
                        options: [
                            {
                                value: 'lru',
                                display_name: t('admin.cache.type.lru'),
                                display_name_default: 'LRU',
                            },
                            {
                                value: 'redis',
                                display_name: t('admin.cache.type.redis'),
                                display_name_default: 'redis',
                            },
                        ],
                    },
                    {
                        ...
                        label: t('admin.cache.redisAddress'),
                        label_default: 'Address:',
                        help_text: t('admin.cache.redisAddressDescription'),
                        help_text_default: 'URL of your redis server.',
                        isDisabled: it.not(it.stateEquals('CacheSettings.CacheType', 'redis')),
                    },
                    {
                        type: Constants.SettingsTypes.TYPE_TEXT,
                        key: 'CacheSettings.RedisPassword',
                        label: t('admin.cache.redisPassword'),
                        label_default: 'Password:',
                        help_text: t('admin.cache.redisPasswordDescription'),
                        help_text_default: 'Your redis server password.',
                        isDisabled: it.not(it.stateEquals('CacheSettings.CacheType', 'redis')),
                    },
                    {
                        type: Constants.SettingsTypes.TYPE_NUMBER,
                        key: 'CacheSettings.RedisDB',
                        label: t('admin.cache.redisDB'),
                        label_default: 'DB:',
                        help_text: t('admin.cache.redisDBDescription'),
                        help_text_default: 'Your redis server database.',
                        isDisabled: it.not(it.stateEquals('CacheSettings.CacheType', 'redis')),
                    },
                ],
            },
