        ...
        storage: {
            ...
            schema: {
                ...
                settings: [
                    ...
                    {
                        type: Constants.SettingsTypes.TYPE_BOOL,
                        key: 'FileSettings.ShowChannelFileCount',
                        label: t('admin.file.showChannelFileCount'),
                        label_default: 'Show Channel File Count:',
                        help_text: t('admin.file.showChannelFileCountDesc'),
                        help_text_default: 'When true, show the file count in the RHS channel info panel.',
                        isDisabled: it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.ENVIRONMENT.FILE_STORAGE)),
                    },
                ],
            },
