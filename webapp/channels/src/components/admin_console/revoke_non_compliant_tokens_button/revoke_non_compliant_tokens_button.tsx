            ...
            <ConfirmModal
                ...
                message={(
                    <FormattedMessage
                        ...
                        defaultMessage='This will permanently revoke {count, number} personal access {count, plural, one {token} other {tokens}} that {count, plural, one {does} other {do}} not comply with the current maximum lifetime policy, including tokens for user-owned and plugin-owned bot accounts. This cannot be undone.'
