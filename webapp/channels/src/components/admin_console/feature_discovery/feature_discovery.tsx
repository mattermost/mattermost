...
export default class FeatureDiscovery extends React.PureComponent<
    Props,
    State
> {
    ...
    renderPostTrialCta = () => {
        const { minimumSKURequiredForFeature, learnMoreURL } = this.props;
            ...
            return (
                <div className="purchase-card">
                    <button
                        ...
                        onClick={() => {
                            trackEvent(
                                TELEMETRY_CATEGORIES.SELF_HOSTED_ADMIN,
                                "click_enterprise_contact_sales_feature_discovery",
                            );
        ...
        return (
            <div className="purchase-card">
                <>
                    ...
                    />
                    <ContactUsButton eventID="post_trial_contact_sales" />
                </>
            </div>
        );
    };
    ...
    renderStartTrial = (
        learnMoreURL: string,
        gettingTrialError: React.ReactNode,
    ) => {
        const {
            isCloud,
            isCloudTrial,
        ...
        const canRequestCloudFreeTrial =
            isCloud &&
            !isCloudTrial &&
            !hadPrevCloudTrial &&
            !isPaidSubscription;
        ...
        return (
            <>
                ...
                {gettingTrialError}
                {(!this.props.isCloud || canRequestCloudFreeTrial) &&
                    !this.props.cloudFreeDeprecated && (
    ...
    render() {
        ...
        if (
            ...
            this.state.gettingTrialResponseCode === 451
        ) {
            gettingTrialError = (
            ...
            <div className="FeatureDiscovery">
                <div className="FeatureDiscovery_copyWrapper">
                    ...
                    {this.props.prevTrialLicense?.IsLicensed === "true"
                        ? this.renderPostTrialCta()
                        : this.renderStartTrial(
                              learnMoreURL,
                              gettingTrialError,
                          )}
                </div>
...
function FeatureDiscoveryCloudStartTrialButton(
    props: Omit<React.ComponentProps<typeof CloudStartTrialButton>, "message">,
) {
    ...
    return <CloudStartTrialButton {...props} message={message} />;
}
