...
const OpenIDFeatureDiscovery: React.FC = () => {
    return (
        <FeatureDiscovery
            ...
            copyDefault={
                "Use OpenID Connect for authentication and single sign-on (SSO) with any service that supports the OIDC specification such as Google, Office 365, Apple, Okta, OneLogin, and more."
            }
