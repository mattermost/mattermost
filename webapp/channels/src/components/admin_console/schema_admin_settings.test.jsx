...
describe("components/admin_console/SchemaAdminSettings", () => {
        ...
        schema = {
            ...
            settings: [
                ...
                },
                {
                    ...
                    placeholder_default:
                        "e.g. 47KyfOxtk5+ovi1MDHFyzMDHIA6esMWb",
                },
                {
                ...
                },
                {
                    ...
                    help_text_default:
                        "This is some help text for the number field.",
                ...
                },
                {
                    ...
                    help_text_default:
                        "This is some help text for the language field.",
                ...
                },
                {
                    ...
                    help_text_default:
                        "This is some help text for the multiple-language field.",
                ...
                },
                {
                    ...
                    help_text_default:
                        "This is some help text for the button field.",
                    action: () => null,
                ...
                },
                {
                    ...
                    help_text_default:
                        "This is some help text for the second bool field.",
                },
                {
                    ...
                    help_text_default:
                        "This is some help text for the color field.",
                },
                {
                    type: "custom",
                    key: "custom",
                ...
                },
                {
                    ...
                    help_text: "help-text-l",
                    help_text_default:
                        "This is some help text for the jobs table field.",
                    job_type: "test",
                    render_job: () => <p>{"Test"}</p>,
                },
                {
                    ...
                    help_text_default:
                        "This is some help text for the first escaped field.",
                },
            ],
        };
    ...
    test("should render header using a SchemaText", () => {
        const headerText =
            "This is [a link](!https://example.com) in the header";
        const props = {
            config,
            environmentConfig,
            schema: {
    ...
    test("should render footer using a SchemaText", () => {
        const footerText =
            "This is [a link](https://example.com) in the footer";
        const props = {
            config,
            environmentConfig,
            schema: {
