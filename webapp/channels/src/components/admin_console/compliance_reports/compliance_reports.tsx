...
class ComplianceReports extends React.PureComponent<Props, State> {
    ...
    runReport = (e: React.MouseEvent<HTMLButtonElement, MouseEvent>) => {
        ...
        job.start_at = this.fromInput.current
            ? Date.parse(this.fromInput.current.value)
            : undefined;
        job.end_at = this.toInput.current
            ? Date.parse(this.toInput.current.value)
            : undefined;
                ...
                <div className="row">
                    <div className="col-sm-6 col-md-4 form-group">
                        ...
                        <input
                            ...
                            placeholder={this.props.intl.formatMessage({
                                id: "admin.compliance_reports.desc_placeholder",
                    ...
                    <div className="col-sm-3 col-md-2 form-group">
                        ...
                        <input
                            ...
                            ref={this.fromInput}
                            placeholder={this.props.intl.formatMessage({
                                id: "admin.compliance_reports.from_placeholder",
                    ...
                    <div className="col-sm-3 col-md-2 form-group">
                        ...
                        <input
                            ...
                            ref={this.toInput}
                            placeholder={this.props.intl.formatMessage({
                                id: "admin.compliance_reports.to_placeholder",
                ...
                <div className="row">
                    <div className="col-sm-6 col-md-4 form-group">
                        ...
                        <input
                            ...
                            placeholder={this.props.intl.formatMessage({
                                id: "admin.compliance_reports.emails_placeholder",
                                defaultMessage:
                    ...
                    <div className="col-sm-6 col-md-4 form-group">
                        ...
                        <input
                            ...
                            placeholder={this.props.intl.formatMessage({
                                id: "admin.compliance_reports.keywords_placeholder",
