...
const EnterpriseEditionRightPanel = ({
    ...
    const svgImage = () => {
        if (isTrialLicense) {
            return <WomanWithCardSvg width={200} height={200} />;
        }
        if (isEnterpriseOrE20) {
            return <TwoPeopleChattingSvg width={200} height={200} />;
        }
        return <WomanUpArrowsAndCloudsSvg width={200} height={200} />;
    };
    ...
    return (
        <div className="EnterpriseEditionRightPannel">
            ...
            <div className="upgrade-subtitle">{subtitle()}</div>
            <div className="purchase_buttons">{contactSalesBtn}</div>
        </div>
    );
};
