...
describe("components/admin_console/license_settings/LicenseSettings", () => {
    ...
    const defaultProps: ComponentProps<typeof LicenseSettings> = {
        ...
        actions: {
            ...
            upgradeToE0Status: jest
                .fn()
                .mockImplementation(() =>
                    Promise.resolve({ percentage: 0, error: null }),
                ),
            openModal: jest.fn(),
    ...
    test("should match snapshot enterprise build with license and isDisabled set to true", () => {
        const wrapper = shallow<LicenseSettings>(
            <LicenseSettings {...defaultProps} isDisabled={true} />,
        );
        expect(wrapper).toMatchSnapshot();
    });
    ...
    test("upgrade to enterprise click", async () => {
        ...
        actions.upgradeToE0Status = jest
            .fn()
            .mockImplementation(() =>
                Promise.resolve({ percentage: 1, error: null }),
            );
    ...
    test("load screen while upgrading", async () => {
        const actions = {
            ...
            upgradeToE0Status: jest
                .fn()
                .mockImplementation(() =>
                    Promise.resolve({ percentage: 42, error: null }),
                ),
        };
        const props = { ...defaultProps, enterpriseReady: false, actions };
        const wrapper = shallow<LicenseSettings>(
    ...
    test("load screen after upgrading", async () => {
        const actions = {
            ...
            upgradeToE0Status: jest
                .fn()
                .mockImplementation(() =>
                    Promise.resolve({ percentage: 100, error: null }),
                ),
        };
        const props = { ...defaultProps, enterpriseReady: false, actions };
        const wrapper = shallow<LicenseSettings>(
    ...
    test("should match snapshot enterprise build with E20 license", () => {
        const props = {
            ...defaultProps,
            license: { ...defaultProps.license, SkuShortName: LicenseSkus.E20 },
        };
        const wrapper = shallow<LicenseSettings>(
            <LicenseSettings {...props} />,
        );
    ...
    test("should match snapshot enterprise build with E10 license", () => {
        const props = {
            ...defaultProps,
            license: { ...defaultProps.license, SkuShortName: LicenseSkus.E10 },
        };
        const wrapper = shallow<LicenseSettings>(
            <LicenseSettings {...props} />,
        );
    ...
    test("should match snapshot with expiring license", () => {
        ...
        const props = {
            ...
            license: {
                ...defaultProps.license,
                ExpiresAt: expiringDate.toString(),
            },
        };
        const wrapper = shallow<LicenseSettings>(
            <LicenseSettings {...props} />,
