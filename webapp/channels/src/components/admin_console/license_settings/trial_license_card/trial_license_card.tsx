...
const TrialLicenseCard: React.FC<Props> = ({ license }: Props) => {
        ...
        if (currentDate.toDateString() === endDate.toDateString()) {
            return (
                <FormattedMarkdownMessage
                    ...
                    values={{
                        time:
                            moment(endDate).endOf("day").format("h:mm a ") +
                            moment().tz(getBrowserTimezone()).format("z"),
                    }}
                />
            );
        }
        ...
        <div className="RenewLicenseCard TrialLicense">
            <div className="RenewLicenseCard__text">
                ...
                <div className="RenewLicenseCard__buttons">
                    ...
                    />
                    <ContactUsButton customClass="light-blue-btn" />
                </div>
            </div>
        </div>
    );
    ...
    return <AlertBanner mode={"info"} title={cardTitle} message={message} />;
};
