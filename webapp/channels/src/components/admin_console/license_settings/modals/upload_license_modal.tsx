...
const UploadLicenseModal = (props: Props): JSX.Element | null => {
    ...
    const [fileObj, setFileObj] = React.useState<File | null>(
        props.fileObjFromProps,
    );
    ...
    const show = useSelector((state: GlobalState) =>
        isModalOpen(state, ModalIdentifiers.UPLOAD_LICENSE),
    );
    if (!show) {
        return null;
    }
    ...
    const displayFileName = (fileName: string) => {
        ...
        fileNameWithoutExt =
            fileNameWithoutExt.length < 40 - extLen
                ? fileNameWithoutExt
                : `${fileNameWithoutExt.substr(0, 37 - extLen)}...`;
        ...
        <>
            <div className="content-body">
                <div className="svg-image">
                    <WomanArmOnTable width={200} height={200} />
                </div>
                <div className="title">
                    <FormattedMessage
    ...
    if (uploadSuccessful) {
        ...
        const skuName = getSkuDisplayName(
            currentLicense.SkuShortName,
            currentLicense.IsGovSku === "true",
        );
        uploadLicenseContent = (
            <>
                <div className="content-body">
                    <div className="svg-image hands-svg">
                        <HandsSvg width={100} height={100} />
                    </div>
                    <div className="title">
                        <FormattedMessage
