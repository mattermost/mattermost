...
const EELicenseModal: React.FC<Props> = (props: Props): JSX.Element | null => {
    ...
    const show = useSelector((state: GlobalState) =>
        isModalOpen(state, ModalIdentifiers.ENTERPRISE_EDITION_LICENSE),
    );
    if (!show) {
        return null;
    }
