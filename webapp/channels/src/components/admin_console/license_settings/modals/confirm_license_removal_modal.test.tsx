...
describe("components/admin_console/license_settings/modals/confirm_license_removal_modal", () => {
    ...
    test("should call the removal method when confirm button is clicked", () => {
        ...
        const confirmButton = wrapper
            .find("ConfirmLicenseRemovalModal")
            .find("button#confirm-removal");
    ...
    test("should hide the confirm modal", () => {
        ...
        const localStore = {
            ...state,
            views: ConfirmLicenseRemovalModalHidden,
        };
        ...
        expect(
            wrapper.find("ConfirmLicenseRemovalModal").find("div.alert-svg"),
        ).toHaveLength(0);
    });
    ...
    test("should show which SKU is currently being removed in confirmation message", () => {
        ...
        expect(
            ...
            "Removing the license will downgrade your server from Professional to Free. You may lose information. ",
        );
    });
});
