...
describe('components/admin_console/custom_profile_attributes/CustomProfileAttributes', () => {
    ...
    describe('LDAP attributes', () => {
        ...
        test('should save LDAP attribute changes', async () => {
            vi.spyOn(Client4, 'patchCustomProfileAttributeField').mockResolvedValue({
                ...attr1,
                attrs: {
                    ...attr1.attrs,
                    ldap: 'new-department',
    ...
    describe('SAML attributes', () => {
        ...
        test('should render SAML attributes with correct help text', async () => {
            vi.mocked(Client4.getCustomProfileAttributeFields as ReturnType<typeof vi.fn>).mockImplementation(async () => {
                return [samlAttr];
            });
            renderWithContext(
    ...
    test('should handle save errors gracefully', async () => {
        vi.spyOn(Client4, 'patchCustomProfileAttributeField').mockRejectedValue(new Error('Network error'));
