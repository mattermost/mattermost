...
vi.mock('components/searchable_user_list/searchable_user_list_container', () => {
    return {
        default: function MockSearchableUserList({
            users,
            usersPerPage,
            total,
            nextPage,
...
describe('TestResultsModal', () => {
    ...
    test('should render modal with proper title and structure', async () => {
    ...
    test('should fetch users on initial load', async () => {
        renderWithContext(<TestResultsModal {...defaultProps}/>);
    ...
    test('should display users from search results', async () => {
        renderWithContext(<TestResultsModal {...defaultProps}/>);
    ...
    test('should not paginate when loading', async () => {
    ...
    test('should render with isStacked=true prop', async () => {
        renderWithContext(
            <TestResultsModal
                {...defaultProps}
                isStacked={true}
    ...
    test('should render with isStacked=false prop (default)', async () => {
        renderWithContext(
            <TestResultsModal
                {...defaultProps}
                isStacked={false}
    ...
    test('should reset search on new search term', async () => {
    ...
    test('should pass correct props to SearchableUserList', async () => {
        renderWithContext(<TestResultsModal {...defaultProps}/>);
