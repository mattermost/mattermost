    ...
    render(): JSX.Element {
        ...
        let commercialSupport = (
            <Menu.ItemExternalLink
                onClick={() =>
                    trackEvent("admin", "click_administrators_support")
                }
        ...
        return (
            <Menu
                ariaLabel={formatMessage({
                    id: "admin.nav.menuAriaLabel",
                    defaultMessage: "Admin Console Menu",
                })}
            >
                <Menu.Group>
                    {teamToRender}
                ...
                <Menu.Group>
                    <Menu.ItemExternalLink
                        onClick={() =>
                            trackEvent("admin", "click_administrators_guide")
                        }
                        url={adminGuideLink}
                        text={formatMessage({
                    ...
                    <Menu.ItemExternalLink
                        onClick={() =>
                            trackEvent("admin", "click_administrators_forum")
                        }
                        url={
                            "https://forum.mattermost.com/t/how-to-use-the-troubleshooting-forum/150"
                        }
                        text={formatMessage({
                    ...
                    <Menu.ItemToggleModalRedux
                        onClick={() =>
                            trackEvent("admin", "click_administrators_about")
                        }
