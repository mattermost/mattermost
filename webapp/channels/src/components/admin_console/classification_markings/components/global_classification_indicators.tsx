...
const msg = defineMessages({
    sectionTitle: {
        id: "admin.classification_markings.global_banner.section_title",
        defaultMessage: "Global Classification Indicators",
    },
    sectionDescription: {
        id: "admin.classification_markings.global_banner.section_description",
        defaultMessage: "Configure the global classification banner",
    },
    enableTitle: {
        id: "admin.classification_markings.global_banner.enable.title",
        defaultMessage: "Global Classification Banner",
    },
    enableDescription: {
        id: "admin.classification_markings.global_banner.enable.description",
        defaultMessage:
            "Displays a global banner for the system-wide classification.",
    },
    placementTitle: {
        id: "admin.classification_markings.global_banner.placement.title",
        defaultMessage: "Banner visibility",
    },
    placementTop: {
        id: "admin.classification_markings.global_banner.placement.top",
        defaultMessage: "Top only",
    },
    placementTopAndBottom: {
        id: "admin.classification_markings.global_banner.placement.top_and_bottom",
        defaultMessage: "Top and bottom",
    },
    levelTitle: {
        id: "admin.classification_markings.global_banner.level.title",
        defaultMessage: "Global classification level",
    },
    levelDescription: {
        id: "admin.classification_markings.global_banner.level.description",
        defaultMessage:
    ...
    levelMissingError: {
        id: "admin.classification_markings.global_banner.level.missing_error",
        defaultMessage:
...
export default function GlobalClassificationIndicators({
    levels,
    globalBanner,
    disabled,
    onChange,
}: GlobalClassificationIndicatorsProps) {
    ...
    const levelMissing = Boolean(
        globalBanner.enabled && globalBanner.level_name && !selectedLevelOption
    );
    const levelError = levelMissing
        ? formatMessage(msg.levelMissingError)
        : undefined;
                        ...
                        <>
                            ...
                            <GlobalBannerSectionSetting>
                                <Setting
                                    ...
                                    label={
                                        <FormattedMessage {...msg.levelTitle} />
                                    }
                                    helpText={
                                        <FormattedMessage
                                            {...msg.levelDescription}
                                        />
                                    }
                                    setByEnv={false}
                                >
                                    <PresetDropdownWrapper>
                                        <DropdownInput
                                            ...
                                            styles={
                                                classificationPresetDropdownStyles
                                            }
                                            formatOptionLabel={
                                                formatLevelOptionLabel
                                            }
                                            error={levelError}
                                        />
                                    </PresetDropdownWrapper>
