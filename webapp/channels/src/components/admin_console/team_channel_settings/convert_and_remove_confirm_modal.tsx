...
const ConvertAndRemoveConfirmModal = ({
    ...
    const toPublicMsg =
        "When you convert **{displayName}** to a public channel, history and membership are preserved. Public channels are discoverable and can by joined by users on the system without invitation.  \n \nAre you sure you want to convert **{displayName}** to a public channel?";
    const toPrivateMsg =
    ...
    const convertMessageId = toPublic
