...
export const TeamGroups = ({
    ...
    <AdminPanel
        ...
        titleId={
            syncChecked
                ? t("admin.team_settings.team_detail.syncedGroupsTitle")
                : t("admin.team_settings.team_detail.groupsTitle")
        }
        titleDefault={syncChecked ? "Synced Groups" : "Groups"}
        subtitleId={
            syncChecked
                ? t("admin.team_settings.team_detail.syncedGroupsDescription")
                : t("admin.team_settings.team_detail.groupsDescription")
        }
        subtitleDefault={
            syncChecked
