...
export function TeamProfile({
    ...
    const [overrideRestoreDisabled, setOverrideRestoreDisabled] =
        useState(false);
    const [restoreDisabled, setRestoreDisabled] = useState(
        usageDeltas.teams.teamsLoaded &&
            usageDeltas.teams.active >= 0 &&
            isArchived,
    );
        ...
        if (restoreDisabled) {
            return (
                ...
                >
                    ...
                    <div className={"disabled-overlay-wrapper"}>
                        <button
                            type="button"
                            disabled={restoreDisabled}
                            ...
                            <button
                                onClick={() => {
                                    dispatch(
                                        openModal({
                                            modalId:
                                                ModalIdentifiers.PRICING_MODAL,
