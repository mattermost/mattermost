...
describe('admin_console/team_channel_settings/team/TeamList', () => {
    test('should render team list with data', async () => {
        ...
        const actions = {
            ...
            searchTeams: vi.fn().mockResolvedValue(testTeams),
        };
    ...
    test('should render team list with paging', async () => {
        ...
        const actions = {
            getData: vi.fn().mockResolvedValue(Promise.resolve(testTeams)),
            searchTeams: vi.fn().mockResolvedValue(testTeams),
        };
    ...
    test('should handle search functionality', async () => {
        ...
        const actions = {
            getData: vi.fn().mockResolvedValue(testTeams),
            searchTeams: vi.fn().mockResolvedValue({data: {teams: searchResults, total_count: 1}}),
        };
