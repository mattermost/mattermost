...
vi.mock('../../../../channel_settings_modal/channel_access_rules_confirm_modal', () => {
    return {
...
vi.mock('mattermost-redux/selectors/entities/access_control', () => ({
    getAccessControlSettings: vi.fn(() => mockAccessControlSettings),
}));
...
vi.mock('hooks/useChannelAccessControlActions', () => {
    return {
        useChannelAccessControlActions: () => ({
            ...
            searchUsers: vi.fn().mockResolvedValue({data: {users: []}}),
