...
describe("admin_console/team_channel_settings/channel/ChannelMembers", () => {
    ...
    const membership1: ChannelMembership = Object.assign(
        TestHelper.getChannelMembershipMock({ user_id: "user-1" }, {}),
    );
    const user2: UserProfile = Object.assign(
        TestHelper.getUserMock({ id: "user-2" }),
    );
    const membership2: ChannelMembership = Object.assign(
        TestHelper.getChannelMembershipMock({ user_id: "user-2" }, {}),
    );
    const user3: UserProfile = Object.assign(
        TestHelper.getUserMock({ id: "user-3" }),
    );
    const membership3: ChannelMembership = Object.assign(
        TestHelper.getChannelMembershipMock({ user_id: "user-3" }, {}),
    );
