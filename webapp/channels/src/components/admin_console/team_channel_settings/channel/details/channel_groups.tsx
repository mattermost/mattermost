...
export const ChannelGroups: React.FunctionComponent<ChannelGroupsProps> = (
    props: ChannelGroupsProps,
): JSX.Element => {
    const {
        onGroupRemoved,
        onAddCallback,
        ...
        <AdminPanel
            ...
            titleId={
                synced
                    ...
                    : t("admin.channel_settings.channel_detail.groupsTitle")
            }
            ...
            subtitleDefault={
                synced
                    ...
                    : "Select groups to be added to this channel."
            }
            button={
                <ToggleModalButton
