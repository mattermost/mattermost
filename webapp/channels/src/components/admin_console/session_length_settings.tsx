...
export default class SessionLengthSettings extends AdminSettings<Props, State> {
    getConfigFromState = (config: AdminConfig) => {
        ...
        config.ServiceSettings.ExtendSessionLengthWithActivity =
            this.state.extendSessionLengthWithActivity;
        config.ServiceSettings.SessionLengthWebInHours = this.parseIntNonZero(
            this.state.sessionLengthWebInHours,
        );
        config.ServiceSettings.SessionLengthMobileInHours =
            this.parseIntNonZero(this.state.sessionLengthMobileInHours);
        config.ServiceSettings.SessionLengthSSOInHours = this.parseIntNonZero(
            this.state.sessionLengthSSOInHours,
        );
        config.ServiceSettings.SessionCacheInMinutes = this.parseIntNonZero(
            this.state.sessionCacheInMinutes,
        );
        config.ServiceSettings.SessionIdleTimeoutInMinutes =
            this.parseIntZeroOrMin(
                this.state.sessionIdleTimeoutInMinutes,
    ...
    getStateFromConfig(config: AdminConfig) {
        return {
            ...
            sessionLengthWebInHours:
                config.ServiceSettings.SessionLengthWebInHours,
            sessionLengthMobileInHours:
                config.ServiceSettings.SessionLengthMobileInHours,
            sessionLengthSSOInHours:
                config.ServiceSettings.SessionLengthSSOInHours,
            ...
            sessionTimeoutSetting = (
                <TextSetting
                    ...
                    placeholder={Utils.localizeMessage(
                        "admin.service.sessionIdleTimeoutEx",
                        'E.g.: "60"',
                    )}
                    helpText={
                    ...
                    setByEnv={this.isSetByEnv(
                        "ServiceSettings.SessionIdleTimeoutInMinutes",
                    )}
        ...
        return (
            <SettingsGroup>
                ...
                <TextSetting
                    ...
                    onChange={this.handleChange}
                    setByEnv={this.isSetByEnv(
                        "ServiceSettings.SessionLengthWebInHours",
                    )}
                    disabled={this.props.isDisabled}
                    type="number"
                />
                ...
                <TextSetting
                    ...
                    onChange={this.handleChange}
                    setByEnv={this.isSetByEnv(
                        "ServiceSettings.SessionLengthSSOInHours",
                    )}
                    disabled={this.props.isDisabled}
                    type="number"
                />
                <TextSetting
                    ...
                    placeholder={Utils.localizeMessage(
                        "admin.service.sessionMinutesEx",
                        'E.g.: "10"',
                    )}
                    helpText={
                        <FormattedMessage
                    ...
                    onChange={this.handleChange}
                    setByEnv={this.isSetByEnv(
                        "ServiceSettings.SessionCacheInMinutes",
                    )}
                    disabled={this.props.isDisabled}
                    type="number"
                />
