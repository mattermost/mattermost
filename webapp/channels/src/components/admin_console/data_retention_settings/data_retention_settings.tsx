...
type Props = {
    ...
    actions: {
        getDataRetentionCustomPolicies: (
            page: number,
        ) => Promise<{ data: DataRetentionCustomPolicies }>;
...
export default class DataRetentionSettings extends React.PureComponent<
    Props,
    State
> {
    ...
    getGlobalPolicyRows = (): Row[] => {
        ...
        return [
            {
                cells: {
                    description: Utils.localizeMessage(
                    ...
                    channel_messages: (
                        <div data-testid="global_message_retention_cell">
                            {this.getMessageRetentionSetting(
                        ...
                        >
                            ...
                            >
                                <Menu.ItemAction
                                    ...
                                    onClick={() => {
                                        getHistory().push(
                                            "/admin_console/compliance/data_retention_settings/global_policy",
                                        );
                                    }}
                                    text={Utils.localizeMessage(
                                        "admin.data_retention.globalPoliciesTable.edit",
                                        "Edit",
                                    )}
                                    disabled={false}
    ...
    getCustomPolicyRows = (startCount: number, endCount: number): Row[] => {
        ...
        return policies.map((policy: DataRetentionCustomPolicy) => {
            ...
            return {
                cells: {
                    description: (
                        <div id={desciptionId}>{policy.display_name}</div>
                    ),
                    channel_messages: (
                        <div id={durationId}>
                            {this.getMessageRetentionSetting(
                                policy.post_duration !== -1,
                                policy.post_duration,
                            )}
                        </div>
                    ),
                    applied_to: (
                        ...
                        >
                            ...
                            >
                                <Menu.ItemAction
                                    ...
                                    onClick={() => {
                                        getHistory().push(
                                            `/admin_console/compliance/data_retention_settings/custom_policy/${policy.id}`,
                                        );
                                    }}
                                    text={Utils.localizeMessage(
                                        "admin.data_retention.globalPoliciesTable.edit",
                                ...
                                <Menu.ItemAction
                                    ...
                                    text={Utils.localizeMessage(
                                        "admin.data_retention.globalPoliciesTable.delete",
                                        "Delete",
                                    )}
                                    disabled={false}
                                />
    ...
    componentDidUpdate = (prevProps: Props, prevState: State) => {
        if (
            prevState.showEditJobTime !== this.state.showEditJobTime &&
    ...
    handleCreateJob = async (e?: React.SyntheticEvent) => {
        ...
        await this.props.actions.getJobsByType(
            JobTypes.DATA_RETENTION as JobType,
        );
    };
    ...
    getJobStartTime = (): JSX.Element | null => {
        const { DataRetentionSettings } = this.props.config;
        const timeArray =
            DataRetentionSettings?.DeletionJobStartTime?.split(":");
        if (!timeArray) {
            return null;
        }
                        ...
                        <Card expanded={true} className={"console"}>
                            <Card.Header>
                                <TitleAndButtonCardHeader
                                    ...
                                    onClick={() => {
                                        getHistory().push(
                                            "/admin_console/compliance/data_retention_settings/custom_policy",
                                        );
                                    }}
                                />
                            </Card.Header>
                            <Card.Body expanded={true}>
                                <div id="custom_policy_table">
                                    <DataGrid
                                        ...
                                        loading={
                                            this.state.customPoliciesLoading
                                        }
                            ...
                            <Card.Header>
                                <TitleAndButtonCardHeader
                                    ...
                                    isDisabled={
                                        ...
                                        this.props.customPoliciesCount === 0
                                    }
                                        ...
                                        <div>
                                            ...
                                            {this.state.showEditJobTime ? (
                                                <ReactSelect
                                                    ...
                                                    onBlur={() => {
                                                        this.showEditJobTime(
                                                            false,
                                                        );
                                                    }}
                                                    value={
                                                        {
                                                            label: this.getJobStartTime(),
                                                            value: DataRetentionSettings?.DeletionJobStartTime,
                                                        } as OptionType
                                                    }
                                                ...
                                                <span className="JobSelectedtime">
                                                    <b>
                                                        {this.getJobStartTime()}
                                                    </b>
                                                </span>
                                            )}
                                            <a
