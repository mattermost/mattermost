            ...
            if (role) {
                rows.push({
                    cells: {
                        ...
                        description: (
                            <FormattedMessage
                                id={`admin.permissions.roles.${role.name}.description`}
                            />
                        ),
                        type: (
                            <FormattedMessage
                                id={`admin.permissions.roles.${role.name}.type`}
                            />
                        ),
                        edit: (
                            <span
                            ...
                            >
                                <Link
                                    to={`/admin_console/user_management/system_roles/${role.id}`}
                                >
                                    <FormattedMessage
                    ...
                    onClick: () =>
                        getHistory().push(
                            `/admin_console/user_management/system_roles/${role.id}`,
                        ),
                });
            }
        });
                ...
                <div className="admin-console__wrapper">
                    <div className="admin-console__content">
                        <AdminPanel
                            id="SystemRoles"
                            titleId={t(
                                "admin.permissions.systemRolesBannerTitle",
                            )}
                            titleDefault="Admin Roles"
                            subtitleId={t(
                                "admin.permissions.systemRolesBannerText",
                            )}
