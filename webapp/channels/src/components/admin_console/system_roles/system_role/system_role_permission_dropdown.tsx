...
export default class SystemRolePermissionDropdown extends React.PureComponent<Props> {
    ...
    render() {
        ...
        const ariaLabel = defineMessage({id: 'admin.permissions.system_role_permissions.change_access', defaultMessage: 'Change role access on a system console section'});
        return (
            <MenuWrapper
