    ...
    getRows = (permissionsMap: Record<string, boolean>, permissionsToUpdate: PermissionsToUpdate, visibleSections: Record<string, boolean>) => {
        ...
        if (this.props.role.name === Constants.PERMISSIONS_SYSTEM_CUSTOM_GROUP_ADMIN) {
            return (
                <>
                    <FormattedMessage
                        id='admin.permissions.roles.system_custom_group_admin.detail_text1'
                        defaultMessage='The built-in Custom Group Manager role can be used to delegate the administration of <link>Custom Groups</link> to users other than the System Admin.'
                        values={{
                            link: (msg: React.ReactNode) => (
                                <ExternalLink
                                    href='https://docs.mattermost.com/welcome/manage-custom-groups.html'
                                    location='system_role_permissions'
                                >
                                    {msg}
                                </ExternalLink>
                            ),
                    ...
                    <br/>
                    <FormattedMessage
                        id='admin.permissions.roles.system_custom_group_admin.detail_text2'
                    ...
                    <br/>
                    <FormattedMessage
                        id='admin.permissions.roles.system_custom_group_admin.detail_text3'
                        defaultMessage='This role has permission to create, edit, and delete custom user groups by selecting <strong>User groups</strong> from the Products menu.'
                        values={{
