...
describe("components/ClusterSettings", () => {
    ...
    test("should match snapshot, encryption disabled", () => {
        ...
        const wrapper = shallow(<ClusterSettings {...props} config={config} />);
        expect(wrapper).toMatchSnapshot();

        expect(
            wrapper.find("#EnableExperimentalGossipEncryption").prop("value"),
        ).toBe(false);
    });
    ...
    test("should match snapshot, compression enabled", () => {
        ...
        expect(wrapper.find("#EnableGossipCompression").prop("value")).toBe(
            true,
        );
    });
