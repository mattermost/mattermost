...
describe('SchemaText', () => {
    ...
    test('should open external markdown links in the new window', () => {
        ...
        expect(span?.innerHTML).toBe('This is <a href="https://example.com" rel="noopener noreferrer" target="_blank">a link</a>');
    });
    ...
    test('should open internal markdown links in the same window', () => {
        ...
        const span = container.querySelector('span');
        expect(span?.innerHTML).toBe('This is <a href="http://localhost:8065/api/v4/users/src_id">a link</a>');
    });
