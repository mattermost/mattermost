...
describe("components/admin_console/jobs/table", () => {
    ...
    test("should call create job func", () => {
        const wrapper = shallow(<JobTable {...baseProps} />);

        wrapper
            .find(".job-table__create-button > div > .btn-tertiary")
    ...
    test("files column should not show", () => {
        ...
        const wrapper = shallow(
            <JobTable {...baseProps} downloadExportResults={false} />,
        );
    ...
    test("hide create job button", () => {
        const wrapper = shallow(
            <JobTable {...baseProps} hideJobCreateButton={true} />,
        );
    ...
    test("add custom class", () => {
        const wrapper = shallow(
            <JobTable {...baseProps} className={"job-table__data-retention"} />,
        );
