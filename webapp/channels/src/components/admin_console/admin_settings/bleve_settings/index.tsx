...
const getStateFromConfig: GetStateFromConfigFunction = (config) => {
    return {
        [FIELD_IDS.ENABLE_INDEXING]: config.BleveSettings.EnableIndexing,
        [FIELD_IDS.INDEX_DIR]: config.BleveSettings.IndexDir,
        [FIELD_IDS.ENABLE_SEARCHING]: config.BleveSettings.EnableSearching,
        [FIELD_IDS.ENABLE_AUTOCOMPLETE]: config.BleveSettings.EnableAutocomplete,
        [FIELD_IDS.CAN_PURGE_AND_INDEX]: config.BleveSettings.EnableIndexing,
    };
};
