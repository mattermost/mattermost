...
export type Props = {
    ...
    actions: {
        ...
        updateTeamScheme: (
            teamId: string,
            schemeId: string,
        ) => Promise<{ error: ServerError; data: Scheme }>;
        createScheme: (
            scheme: Scheme,
        ) => Promise<{ error: ServerError; data: Scheme }>;
...
export class PermissionTeamSchemeSettings extends React.PureComponent<
...
> {
    ...
    getStateRoles = () => {
        ...
        if (this.props.schemeId && this.props.scheme) {
            if (this.isLoaded(this.props)) {
                teamGuest =
                    this.props.roles[this.props.scheme.default_team_guest_role];
                teamUser =
                    this.props.roles[this.props.scheme.default_team_user_role];
                teamAdmin =
                    this.props.roles[this.props.scheme.default_team_admin_role];
                channelGuest =
                    this.props.roles[
                        this.props.scheme.default_channel_guest_role
                    ];
                channelUser =
                    this.props.roles[
                ...
                playbookAdmin =
                    this.props.roles[
                        this.props.scheme.default_playbook_admin_role
                    ];
                playbookMember =
                    this.props.roles[
                        this.props.scheme.default_playbook_member_role
                    ];
                runMember =
                    this.props.roles[this.props.scheme.default_run_member_role];
            }
        ...
        return {
            ...
            guests: {
                name: "guests",
                displayName: "Guests",
                permissions: teamGuest?.permissions.concat(
                    channelGuest?.permissions || [],
                ),
            },
        };
    };
    ...
    handleSubmit = async () => {
        ...
        if (this.props.schemeId) {
            ...
            teamGuest = {
                ...teamGuest,
                id: this.props.roles[newScheme.default_team_guest_role].id,
            };
            teamUser = {
                ...teamUser,
            ...
            channelGuest = {
                ...channelGuest,
                id: this.props.roles[newScheme.default_channel_guest_role].id,
            };
            channelUser = {
                ...channelUser,
            ...
            playbookAdmin = {
                ...playbookAdmin,
                id: this.props.roles[newScheme.default_playbook_admin_role].id,
            } as Role;
            playbookMember = {
                ...playbookMember,
                id: this.props.roles[newScheme.default_playbook_member_role].id,
            } as Role;
            runMember = {
                ...runMember,
                id: this.props.roles[newScheme.default_run_member_role].id,
            } as Role;
        }
                ...
                <div className="admin-console__wrapper">
                    <div className="admin-console__content">
                        ...
                        <AdminPanelWithButton
                            ...
                            buttonTextId={t(
                                "admin.permissions.teamScheme.addTeams",
                            )}
