        ...
        describe("for non-enterprise license", () => {
            [
                ...
                test(licenseSku, () => {
                    ...
                    expect((groups[0] as Group | Permission).id).toStrictEqual(
                        "playbook_public",
                    );
                    expect((groups[1] as Group | Permission).id).toStrictEqual(
                        "runs",
                    );
                }),
            );
        ...
        describe("for enterprise license", () => {
            [LicenseSkus.E20, LicenseSkus.Enterprise].forEach((licenseSku) =>
                test(licenseSku, () => {
                    ...
                    expect((groups[2] as Group | Permission).id).toStrictEqual(
                        "runs",
                    );
                }),
            );
