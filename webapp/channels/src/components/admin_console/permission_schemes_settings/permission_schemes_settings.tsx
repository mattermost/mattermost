...
> {
    ...
    renderTeamOverrideSchemes = () => {
        const schemes = Object.values(this.props.schemes).map(
            (scheme: Scheme) => (
        ...
        const hasCustomSchemes =
            ...
            this.props.license.SkuShortName === LicenseSkus.Professional;
        ...
        if (hasCustomSchemes) {
            return (
                <AdminPanelWithLink
                    ...
                    disabled={
                        teamOverrideView !== null || this.props.isDisabled
                    }
                    linkTextId={t(
                ...
                >
                    ...
                    {schemes.length === PAGE_SIZE * (this.state.page + 1) && (
                        <button
                            ...
                            disabled={
                                this.props.isDisabled || this.state.loadingMore
                            }
                        >
                            <LoadingWrapper
