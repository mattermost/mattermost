...
import {renderWithContext, screen, waitFor, waitForElementToBeRemoved} from 'tests/vitest_react_testing_utils';
...
const getUserMock = vi.fn().mockResolvedValue({data: user, error: null});
const getLdapUserMock = vi.fn().mockResolvedValue({data: ldapUser, error: null});
...
describe('SystemUserDetail', () => {
    const defaultProps: Props = {
        ...
        getCustomProfileAttributeFields: vi.fn().mockResolvedValue({data: []}),
        getCustomProfileAttributeValues: vi.fn().mockResolvedValue({data: {}}),
        saveCustomProfileAttribute: vi.fn().mockResolvedValue({data: {}}),
        intl: {
            formatMessage: vi.fn(),
