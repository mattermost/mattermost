                ...
                <span>
                    {isSynced ? (
                        ...
                        <FormattedMessage
                            ...
                            defaultMessage='Managed by plugin: {source}'
                            values={{
                                source: field.attrs?.source_plugin_id || this.props.intl.formatMessage({id: 'admin.userManagement.userDetail.unknownPlugin', defaultMessage: 'unknown'}),
                            }}
                        />
                    )}
                </span>
