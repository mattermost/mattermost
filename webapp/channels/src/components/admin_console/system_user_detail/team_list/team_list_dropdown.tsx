...
export default class TeamListDropdown extends React.PureComponent<
    Props,
    State
> {
                ...
                <div>
                    ...
                    >
                        <Menu.ItemAction
                            ...
                            onClick={() =>
                                this.props.doMakeUserTeamAdmin(team.id)
                            }
                        ...
                        <Menu.ItemAction
                            ...
                            onClick={() =>
                                this.props.doMakeUserTeamMember(team.id)
                            }
                            text={localizeMessage(
                        ...
                        <Menu.ItemAction
                            ...
                            show={true}
                            onClick={() =>
                                this.props.doRemoveUserFromTeam(team.id)
                            }
                            text={localizeMessage(
