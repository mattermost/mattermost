...
describe('custom plugin sections and settings', () => {
    ...
    test('empty sections and settings', () => {
        renderWithContext(
    ...
    test('all custom sections with plugin disabled should show single warning', () => {
        const state = {
            ...baseState,
            entities: {
                admin: {
    ...
    test('all custom sections with plugin disabled and fallback enabled should render available settings', () => {
        const state = {
            ...baseState,
            entities: {
                admin: {
    ...
    test('custom sections with plugin enabled should render as expected', () => {
