...
export default class ElasticsearchSettings extends AdminSettings<Props, State> {
    getConfigFromState = (config: AdminConfig) => {
        ...
        config.ElasticsearchSettings.SkipTLSVerification =
            this.state.skipTLSVerification;
        ...
        config.ElasticsearchSettings.EnableSearching =
            this.state.enableSearching;
        config.ElasticsearchSettings.EnableAutocomplete =
            this.state.enableAutocomplete;
        config.ElasticsearchSettings.IgnoredPurgeIndexes =
            this.state.ignoredPurgeIndexes;
        ...
        return (
            <SettingsGroup>
                ...
                <TextSetting
                    ...
                    placeholder={Utils.localizeMessage(
                        "admin.elasticsearch.caExample",
                        'E.g.: "./elasticsearch/ca.pem"',
                    )}
                    helpText={
                        <FormattedMessage
                ...
                <TextSetting
                    ...
                    placeholder={Utils.localizeMessage(
                        "admin.elasticsearch.clientCertExample",
                        'E.g.: "./elasticsearch/client-cert.pem"',
                    )}
                    helpText={
                        <FormattedMessage
                    ...
                    onChange={this.handleSettingChanged}
                    setByEnv={this.isSetByEnv(
                        "ElasticsearchSettings.ClientCert",
                    )}
                />
                <TextSetting
                    id="clientKey"
                    ...
                    placeholder={Utils.localizeMessage(
                        "admin.elasticsearch.clientKeyExample",
                        'E.g.: "./elasticsearch/client-key.pem"',
                    )}
                    helpText={
                        <FormattedMessage
                ...
                <BooleanSetting
                    ...
                    onChange={this.handleSettingChanged}
                    setByEnv={this.isSetByEnv(
                        "ElasticsearchSettings.SkipTLSVerification",
                    )}
                />
                <TextSetting
                    id="username"
                ...
                <div className="form-group">
                    ...
                    <div className="col-sm-8">
                        <div className="job-table-setting">
                            <JobsTable
                                jobType={
                                    JobTypes.ELASTICSEARCH_POST_INDEXING as JobType
                                }
                                disabled={
                                    !this.state.canPurgeAndIndex ||
                ...
                <RequestButton
                    ...
                    disabled={
                        this.props.isDisabled || !this.state.canPurgeAndIndex
                    }
                    label={
                        <FormattedMessage
