...
// render the entire section or the name of the section (name), the section in
// the config file (id), and a list of options to configure (settings).
//
// All text fields contains a MessageDescriptor or a JSX.Element. If they contain
// a MessageDescriptor, the <field>_values field can be used to provide values when
...
//   - label: which define the main text of the setting.
...
//   - help_text: Long description of the field.
...
//   - placeholder: Placeholder text to show in the input.
...
//   - error_message: Error to show if action doesn't work.
//   - success_message: Success message to show if action doesn't work.
//
// Language Widget (extends from Setting Widget)
//   - multiple: If you can select multiple languages.
//   - no_result: Text to show on not results found (only for multiple = true).
//   - not_present: Text to show when the default language is not present (only for multiple = true).
//
// Dropdown Widget (extends from Setting Widget)
//   - options: List of options of the dropdown (each options has value, display_name, and optionally help_text, help_text_values fields).
//
...
//   - remove_help_text:  Long description of the field when a file is uploaded.
//   - remove_help_text_values: Values to fill the translation (if needed).
//   - remove_button_text: Button text for remove when the file is uploaded.
//   - removing_text: Text shown while the system is removing the file.
//   - uploading_text: Text shown while the system is uploading the file.
                    ...
                    settings: [
                        ...
                        },
                        {
                            ...
                            help_text: defineMessage({
                                ...
                                defaultMessage: "<b>Generic description with only sender name</b> - Includes only the name of the person who sent the message in push notifications, with no information about channel name or message contents.\n<b>Generic description with sender and channel names</b> - Includes the name of the person who sent the message and the channel it was sent in, but not the message contents.\n<b>Full message content sent in the notification payload</b> - Includes the message contents in the push notification payload that is relayed through Apple's Push Notification Service (APNS) or Google's Firebase Cloud Messaging (FCM). It is <b>highly recommended</b> this option only be used with an \"https\" protocol to encrypt the connection and protect confidential information sent in messages.\n<strong>Full message content fetched from the server on receipt</strong> - The notification payload relayed through APNS or FCM contains no message content, instead it contains a unique message ID used to fetch message content from the server when a push notification is received by a device. If the server cannot be reached, a generic notification will be displayed.",
                            }),
                            help_text_values: {
                                b: (msg: React.ReactNode) => <b>{msg}</b>,
                            },
                                ...
                                },
                                {
                                    ...
                                    help_text: (
                                        <>
                                            <p>
                                                <FormattedMessage
                                                    id='admin.ldap.adminFilterDesc1'
                                                    defaultMessage='(Optional) Enter an AD/LDAP filter to use for designating System Admins. The users selected by the query will have access to your Mattermost server as System Admins. By default, System Admins have complete access to the Mattermost System Console.'
                                                />
                                            </p>
                                            <p>
                                                <FormattedMessage
                                                    id='admin.ldap.adminFilterDesc2'
                                            ...
                                            <p>
                                                <FormattedMessage
                                                    id='admin.ldap.adminFilterDesc3'
                        ...
                        },
                        {
                            ...
                            help_text: (
                                <>
                                    <p>
                                        <FormattedMessage
                                            id='admin.saml.guestAttrDesc1'
                                            defaultMessage='(Optional) Requires Guest Access to be enabled before being applied. The attribute in the SAML Assertion that will be used to apply a guest role to users in Mattermost. Guests are prevented from accessing teams or channels upon logging in until they are assigned a team and at least one channel.'
                                        />
                                    </p>
                                    <p>
                                        <FormattedMessage
                                            id='admin.saml.guestAttrDesc2'
                                            defaultMessage='Note: If this attribute is removed/changed from your guest user in SAML and the user is still active, they will not be promoted to a member and will retain their Guest role. Guests can be promoted in <b>System Console > User Management</b>.'
                                            values={{
                                                b: (msg: React.ReactNode) => <b>{msg}</b>,
                                            }}
                                        />
                    ...
                    settings: [
                        {
                            ...
                            help_text: (
                                <>
                                    <p>
                                        <FormattedMessage
                                            id='admin.gitlab.enableDescription1'
                    ...
                    settings: [
                        ...
                        },
                        {
                            ...
                            help_text: defineMessage({
                                ...
                                defaultMessage: '<link>Multi-factor authentication</link> is currently not enabled.',
                            }),
                            help_text_values: {
                    ...
                    settings: [
                        ...
                        },
                        {
                            ...
                            help_text: defineMessage({
                                ...
                                defaultMessage: 'When true, users may deactivate their own account from <b>Settings > Advanced</b>. If a user deactivates their own account, they will get an email notification confirming they were deactivated. When false, users may not deactivate their own account.',
                            }),
                            help_text_values: {
                                b: (msg: React.ReactNode) => <b>{msg}</b>,
                            },
                        ...
                        },
                        {
                            ...
                            help_text: defineMessage({
                                ...
                                defaultMessage: 'When true, users can enable Automatic Replies in <b>Settings > Notifications</b>. Users set a custom message that will be automatically sent in response to Direct Messages. When false, disables the Automatic Direct Message Replies feature and hides it from Settings.',
                            }),
                            help_text_values: {
                                b: (msg: React.ReactNode) => <b>{msg}</b>,
                            },
