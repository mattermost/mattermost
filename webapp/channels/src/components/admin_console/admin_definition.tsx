            ...
            customization: {
                ...
                schema: {
                    ...
                    settings: [
                        ...
                        {
                            type: 'text',
                            key: 'NativeAppSettings.WindowsAppDownloadLink',
                            label: defineMessage({id: 'admin.customization.windowsAppDownloadLinkTitle', defaultMessage: 'Windows App Download Link:'}),
                            help_text: defineMessage({id: 'admin.customization.windowsAppDownloadLinkDesc', defaultMessage: 'Add a link to download the Windows app.'}),
                            isDisabled: it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.SITE.CUSTOMIZATION)),
                            isHidden: it.configIsTrue('ExperimentalSettings', 'RestrictSystemAdmin'),
                        },
                        {
                            type: 'text',
                            key: 'NativeAppSettings.LinuxAppDownloadLink',
                            label: defineMessage({id: 'admin.customization.linuxAppDownloadLinkTitle', defaultMessage: 'Linux App Download Link:'}),
                            help_text: defineMessage({id: 'admin.customization.linuxAppDownloadLinkDesc', defaultMessage: 'Add a link to download the Linux app.'}),
                            isDisabled: it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.SITE.CUSTOMIZATION)),
                            isHidden: it.configIsTrue('ExperimentalSettings', 'RestrictSystemAdmin'),
                        },
                        {
                            type: 'text',
                            key: 'NativeAppSettings.MacosIntelAppDownloadLink',
                            label: defineMessage({id: 'admin.customization.macosIntelAppDownloadLinkTitle', defaultMessage: 'macOS Intel App Download Link:'}),
                            help_text: defineMessage({id: 'admin.customization.macosIntelAppDownloadLinkDesc', defaultMessage: 'Add a link to download the macOS Intel app.'}),
                            isDisabled: it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.SITE.CUSTOMIZATION)),
                            isHidden: it.configIsTrue('ExperimentalSettings', 'RestrictSystemAdmin'),
                        },
                        {
                            type: 'text',
                            key: 'NativeAppSettings.MacosMAppDownloadLink',
                            label: defineMessage({id: 'admin.customization.macosMAppDownloadLinkTitle', defaultMessage: 'macOS Apple Silicon App Download Link:'}),
                            help_text: defineMessage({id: 'admin.customization.macosMAppDownloadLinkDesc', defaultMessage: 'Add a link to download the macOS Apple Silicon app.'}),
                            isDisabled: it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.SITE.CUSTOMIZATION)),
                            isHidden: it.configIsTrue('ExperimentalSettings', 'RestrictSystemAdmin'),
                        },
                        {
