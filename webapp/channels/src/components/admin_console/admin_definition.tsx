...
export const it: It = {
    ...
    enterpriseReady: (config, state, license, enterpriseReady) =>
        enterpriseReady,
    ...
    userHasReadPermissionOnResource:
        (key) => (config, state, license, enterpriseReady, consoleAccess) =>
            consoleAccess?.read?.[key],
    userHasReadPermissionOnSomeResources: (key) =>
        Object.values(key).some((resource) =>
            it.userHasReadPermissionOnResource(resource)
        ),
    userHasWritePermissionOnResource:
        (key) => (config, state, license, enterpriseReady, consoleAccess) =>
            consoleAccess?.write?.[key],
    isSystemAdmin: (
        config,
        state,
        license,
...
const AdminDefinition = {
    ...
    user_management: {
        ...
        system_users: {
            ...
            title_default: "Users",
            searchableStrings: [["admin.system_users.title", { siteName: "" }]],
            isDisabled: it.not(
                it.userHasWritePermissionOnResource(
    ...
    site: {
            ...
            schema: {
                ...
                settings: [
                    ...
                    },
                    {
                        ...
                        help_text_default:
                            "When false, hides the email address of members from everyone except System Administrators.",
                        isDisabled: it.not(
                            it.userHasWritePermissionOnResource(
                                RESOURCE_KEYS.SITE.USERS_AND_TEAMS
                            )
            ...
            schema: {
                ...
                settings: [
                    ...
                    },
                    {
                        ...
                        isHidden: it.not(
                            it.licensedForFeature("EmailNotificationContents")
                        ),
                        isDisabled: it.not(
                            it.userHasWritePermissionOnResource(
                                RESOURCE_KEYS.SITE.NOTIFICATIONS
                    ...
                    },
                    {
                        ...
                        isHidden: it.not(
                            it.licensedForFeature("IDLoadedPushNotifications")
                        ),
                        isDisabled: it.not(
                            it.userHasWritePermissionOnResource(
                                RESOURCE_KEYS.SITE.NOTIFICATIONS
            ...
            schema: {
                ...
                settings: [
                    ...
                    },
                    {
                        ...
                        help_text_default:
                            '32-character salt added to signing of public image links. Randomly generated on install. Click "Regenerate" to create new salt.',
                        isDisabled: it.not(
                            it.userHasWritePermissionOnResource(
                                RESOURCE_KEYS.SITE.PUBLIC_LINKS
                            )
        ...
        notices: {
            ...
            isHidden: it.not(
                it.userHasReadPermissionOnResource(RESOURCE_KEYS.SITE.NOTICES)
            ),
            schema: {
                id: "NoticesSettings",
                                ...
                                render_job: (job) => {
                                    ...
                                    if (job && job.data) {
                                        if (
                                            ...
                                            job.data.ldap_users_count.length > 0
                                        ) {
                                            ldapUsers =
                                                job.data.ldap_users_count;
                                        }
                                        ...
                                        if (
                                            job.data.group_member_delete_count
                                        ) {
                    ...
                    },
                    {
                        ...
                        options: [
                            ...
                            },
                            {
                                ...
                                isHidden: it.all(
                                    it.not(
                                        it.licensedForFeature("Office365OAuth")
                                    ),
                                    it.not(it.cloudLicensed)
                                ),
                                help_text: t(
    ...
    products: {
        ...
        isHidden: it.any(
            it.not(
                it.userHasReadPermissionOnSomeResources(RESOURCE_KEYS.PRODUCTS)
            )
        ),
        boards: {
            url: "products/boards",
                ...
                settings: [
                    {
                        ...
                        label: t(
                            "admin.customization.enablePublicSharedBoardsTitle"
                        ),
                        label_default: "Enable Public Shared Boards:",
                        help_text: t(
                            "admin.customization.enablePublicSharedBoardsDesc"
                        ),
                        help_text_default:
            ...
            schema: {
                ...
                settings: [
                    ...
                    },
                    {
                        ...
                        help_text: t(
                            "admin.customization.gfycatApiKeyDescription"
                        ),
                        help_text_default:
                    ...
                    },
                    {
                        ...
                        help_text: t(
                            "admin.customization.gfycatApiSecretDescription"
                        ),
                        help_text_default:
            ...
            schema: {
                ...
                settings: [
                    ...
                    },
                    {
                        ...
                        label: t(
                            "admin.experimental.experimentalTimezone.title"
                        ),
                        label_default: "Timezone:",
                        help_text: t(
                            "admin.experimental.experimentalTimezone.desc"
                        ),
                        help_text_default:
                            "Select the timezone used for timestamps in the user interface and email notifications. When true, the Timezone section is visible in the Settings and a time zone is automatically assigned in the next active session. When false, the Timezone setting is hidden in the Settings.",
                        help_text_markdown: false,
                        isDisabled: it.not(
                            it.userHasWritePermissionOnResource(
                                RESOURCE_KEYS.EXPERIMENTAL.FEATURES
