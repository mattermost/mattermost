                ...
                schema: {
                    ...
                    settings: [
                        ...
                        },
                        {
                            ...
                            help_text: defineMessage({id: 'admin.openid.usePreferredUsernameDescription', defaultMessage: 'When true, use the `preferred_username` claim as the Mattermost username for the user.'}),
                            help_text_markdown: true,
                            isHidden: it.not(it.stateEquals('openidType', Constants.GITLAB_SERVICE)),
                            isDisabled: it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.AUTHENTICATION.OPENID)),
                        },
                        ...
                        },
                        {
                            ...
                            label: defineMessage({id: 'admin.openid.usePreferredUsernameTitle', defaultMessage: 'Use Preferred Username:'}),
                            help_text: defineMessage({id: 'admin.openid.usePreferredUsernameDescription', defaultMessage: 'When true, use the OIDC `preferred_username` claim as the Mattermost username for the user. The OIDC scope must include `profile` to use this feature.'}),
                            help_text_markdown: true,
