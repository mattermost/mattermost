                    ...
                    sections: [
                        {
                            ...
                            settings: [
                                ...
                                {
                                    type: 'bool',
                                    key: 'AccessControlSettings.EnableChannelIndicators',
                                    label: defineMessage({id: 'admin.accesscontrol.enableChannelIndicatorsTitle', defaultMessage: 'Show channel access indicators to end users'}),
                                    help_text: defineMessage({id: 'admin.accesscontrol.enableChannelIndicatorsDesc', defaultMessage: 'When enabled, channels restricted by a membership access policy display the matching user attributes as tags in the channel members list and the invite dialog. Disable this to avoid revealing policy details to end users.'}),
