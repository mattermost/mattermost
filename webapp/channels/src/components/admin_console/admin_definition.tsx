                ...
                schema: {
                    ...
                    settings: [
                        ...
                        },
                        {
                            ...
                            label_default: 'Refresh Post Stats Run Time:',
                            help_text: t('admin.team.refreshPostStatsRunTimeDescription'),
                            help_text_default: "The time of day to refresh the user's post stats, including their number of posts and the last record post timestamp.",
