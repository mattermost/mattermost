...
export const it = {
    ...
    stateMatches:
        ...
        (config: DeepPartial<AdminConfig>, state: any) =>
    ...
    stateEquals:
        ...
        (config: DeepPartial<AdminConfig>, state: any) =>
            state[key] === value,
    stateIsTrue:
        (key: string) => (config: DeepPartial<AdminConfig>, state: any) =>
            Boolean(state[key]),
    stateIsFalse:
        (key: string) => (config: DeepPartial<AdminConfig>, state: any) =>
            !state[key],
    configIsTrue:
        (group: keyof DeepPartial<AdminConfig>, setting: string) =>
        (config: DeepPartial<AdminConfig>) =>
    ...
    configContains:
        (
            group: keyof DeepPartial<AdminConfig>,
            setting: string,
            word: string,
        ) =>
        (config: DeepPartial<AdminConfig>) =>
    ...
    cloudLicensed: (
        ...
        state: any,
        license?: ClientLicense,
    ) => Boolean(license?.IsLicenced && isCloudLicense(license)),
    licensedForFeature:
        (feature: string) =>
        (
            config: DeepPartial<AdminConfig>,
    ...
    hidePaymentInfo: (
        ...
        const isCloudFreeProduct = isCloudFreePlan(
            subscriptionProduct,
            limits as Limits,
        );
        return (
            cloud?.subscription?.is_free_trial === "true" || isCloudFreeProduct
        );
    },
...
const AdminDefinition: AdminDefinitionType = {
    about: {
        ...
        isHidden: it.any(
            ...
            it.not(
                it.userHasReadPermissionOnSomeResources(RESOURCE_KEYS.ABOUT),
            ),
        ),
        subsections: {
            license: {
    ...
    billing: {
        ...
        subsections: {
            ...
            billing_history: {
                ...
                searchableStrings: ["admin.billing.history.title"],
                schema: {
                    id: "BillingHistory",
            ...
            company_info: {
                ...
                searchableStrings: ["admin.billing.company_info.title"],
                schema: {
                    id: "CompanyInfo",
            ...
            payment_info: {
                ...
                searchableStrings: ["admin.billing.payment_info.title"],
                schema: {
                    id: "PaymentInfo",
                ...
                schema: {
                    ...
                    settings: [
                        ...
                        },
                        {
                            ...
                            success_message: t(
                                "admin.service.testSiteURLSuccess",
                            ),
                        ...
                        },
                        {
                            ...
                            options: [
                                ...
                                },
                                {
                                    value: "uncompressed",
                                    display_name: t(
                                        "admin.webserverModeUncompressed",
                                    ),
            ...
            database: {
                ...
                searchableStrings: [
                    ...
                    [
                        ...
                        { featureName: "", reloadConfiguration: "" },
                    ],
                ...
                schema: {
                    ...
                    settings: [
                        ...
                        },
                        {
                            ...
                            placeholder: t(
                                "admin.image.amazonS3PathPrefixExample",
                            ),
                            placeholder_default:
                        ...
                        },
                        {
                            ...
                            placeholder: t(
                                "admin.image.amazonS3EndpointExample",
                            ),
                    ...
                    settings: [
                        {
                            ...
                            placeholder: t(
                                "admin.environment.smtp.smtpServer.placeholder",
                            ),
                            placeholder_default:
                                'Ex: "smtp.yourcompany.com", "email-smtp.us-east-1.amazonaws.com"',
                            help_text: t(
                                "admin.environment.smtp.smtpServer.description",
                            ),
                        ...
                        },
                        {
                            ...
                            placeholder: t(
                                "admin.environment.smtp.smtpPort.placeholder",
                            ),
                            placeholder_default: 'Ex: "25", "465", "587"',
                            help_text: t(
                                "admin.environment.smtp.smtpPort.description",
                            ),
                        ...
                        },
                        {
                            ...
                            label: t(
                                "admin.environment.smtp.smtpUsername.title",
                            ),
                            label_default: "SMTP Server Username:",
                            placeholder: t(
                                "admin.environment.smtp.smtpUsername.placeholder",
                            ),
                            placeholder_default:
                        ...
                        },
                        {
                            ...
                            label: t(
                                "admin.environment.smtp.smtpPassword.title",
                            ),
                            label_default: "SMTP Server Password:",
                            placeholder: t(
                                "admin.environment.smtp.smtpPassword.placeholder",
                            ),
                            placeholder_default:
                        ...
                        },
                        {
                            ...
                            label: t(
                                "admin.environment.smtp.connectionSecurity.title",
                            ),
                            label_default: "Connection Security:",
                            help_text:
                        ...
                        },
                        {
                            ...
                            label: t(
                                "admin.environment.smtp.connectionSmtpTest",
                            ),
                            label_default: "Test Connection",
                ...
                schema: {
                    ...
                    settings: [
                        ...
                        },
                        {
                            ...
                            label: t(
                                "admin.customization.androidAppDownloadLinkTitle",
                            ),
                    ...
                    settings: [
                        {
                            ...
                            label: t(
                                "admin.general.localization.serverLocaleTitle",
                            ),
                        ...
                        },
                        {
                            ...
                            label: t(
                                "admin.general.localization.clientLocaleTitle",
                            ),
                        ...
                        },
                        {
                            ...
                            label: t(
                                "admin.general.localization.availableLocalesTitle",
                            ),
                            ...
                            not_present: t(
                                "admin.general.localization.availableLocalesNotPresent",
                            ),
                            not_present_default:
                                "The default client language must be included in the available list",
                            isDisabled: it.not(
                                it.userHasWritePermissionOnResource(
                                    RESOURCE_KEYS.SITE.LOCALIZATION,
                                ),
                ...
                schema: {
                    ...
                    settings: [
                        ...
                        },
                        {
                            ...
                            label: t(
                                "admin.environment.notifications.enable.label",
                            ),
                        ...
                        },
                        {
                            ...
                            label: t(
                                "admin.environment.notifications.contents.label",
                            ),
                            ...
                            options: [
                                {
                                    value: "full",
                                    display_name: t(
                                        "admin.environment.notifications.contents.full",
                                    ),
                                    display_name_default:
                                ...
                                },
                                {
                                    value: "generic",
                                    display_name: t(
                                        "admin.environment.notifications.contents.generic",
                                    ),
                                    display_name_default:
                ...
                schema: {
                    ...
                    settings: [
                        ...
                        },
                        {
                            ...
                            label: t(
                                "admin.customization.announcement.bannerTextTitle",
                            ),
                            label_default: "Banner Text:",
                            help_text: t(
                                "admin.customization.announcement.bannerTextDesc",
                            ),
                            help_text_default:
                ...
                schema: {
                    ...
                    settings: [
                        ...
                        },
                        {
                            ...
                            label: t(
                                "admin.customization.enableCustomEmojiTitle",
                            ),
                    ...
                    settings: [
                        {
                            ...
                            label: t(
                                "admin.experimental.threadAutoFollow.title",
                            ),
                        ...
                        },
                        {
                            ...
                            label: t(
                                "admin.experimental.collapsedThreads.title",
                            ),
                            ...
                            options: [
                                {
                                    value: "disabled",
                                    display_name: t(
                                        "admin.experimental.collapsedThreads.off",
                                    ),
                                    display_name_default: "Disabled",
                                },
                                {
                                    value: "default_off",
                                    display_name: t(
                                        "admin.experimental.collapsedThreads.default_off",
                                    ),
                                    display_name_default:
                                        "Enabled (Default Off)",
                                },
                                {
                                    value: "default_on",
                                    display_name: t(
                                        "admin.experimental.collapsedThreads.default_on",
                                    ),
                                    display_name_default:
                                        "Enabled (Default On)",
                                },
                                {
                                    value: "always_on",
                                    display_name: t(
                                        "admin.experimental.collapsedThreads.always_on",
                                    ),
                        ...
                        },
                        {
                            ...
                            label: t(
                                "admin.posts.persistentNotifications.title",
                            ),
                        ...
                        },
                        {
                            ...
                            label: t(
                                "admin.posts.persistentNotificationsGuests.title",
                            ),
                            label_default:
                        ...
                        },
                        {
                            ...
                            label: t(
                                "admin.customization.restrictLinkPreviewsTitle",
                            ),
                            label_default:
                            ...
                            placeholder: t(
                                "admin.customization.restrictLinkPreviewsExample",
                            ),
                            placeholder_default:
                        ...
                        },
                        {
                            ...
                            label: t(
                                "admin.customization.enableInlineLatexTitle",
                            ),
                        ...
                        },
                        {
                            ...
                            label: t(
                                "admin.customization.maxMarkdownNodesTitle",
                            ),
                ...
                schema: {
                    ...
                    settings: [
                        ...
                        },
                        {
                            ...
                            error_message: t(
                                "admin.team.invalidateEmailInvitesFail",
                            ),
                            error_message_default:
                                "Unable to invalidate pending email invites: {error}",
                            success_message: t(
                                "admin.team.invalidateEmailInvitesSuccess",
                            ),
                            success_message_default:
                    ...
                    sections: [
                        {
                            ...
                            settings: [
                                ...
                                },
                                {
                                    ...
                                    help_text: t(
                                        "admin.ldap.privateKeyFileFileDesc",
                                    ),
                                    help_text_default:
                                    ...
                                    remove_help_text: t(
                                        "admin.ldap.privateKeyFileFileRemoveDesc",
                                    ),
                                    remove_help_text_default:
                                        "Remove the private key file for TLS Certificate.",
                                    remove_button_text: t(
                                        "admin.ldap.remove.privKey",
                                    ),
                                    remove_button_text_default:
                                        "Remove TLS Certificate Private Key",
                                    removing_text: t(
                                        "admin.ldap.removing.privKey",
                                    ),
                                    removing_text_default:
                                        "Removing Private Key...",
                                    uploading_text: t(
                                        "admin.ldap.uploading.privateKey",
                                    ),
                                    uploading_text_default:
                                ...
                                },
                                {
                                    ...
                                    label: t(
                                        "admin.ldap.publicCertificateFileTitle",
                                    ),
                                    label_default: "Public Certificate:",
                                    help_text: t(
                                        "admin.ldap.publicCertificateFileDesc",
                                    ),
                                    help_text_default:
                                    ...
                                    remove_button_text: t(
                                        "admin.ldap.remove.sp_certificate",
                                    ),
                                    remove_button_text_default:
                                    ...
                                    uploading_text: t(
                                        "admin.ldap.uploading.certificate",
                                    ),
                                    uploading_text_default:
                        ...
                        },
                        {
                            ...
                            settings: [
                                ...
                                },
                                {
                                    ...
                                    label: t(
                                        "admin.ldap.enableAdminFilterTitle",
                                    ),
                        ...
                        },
                        {
                            ...
                            settings: [
                                ...
                                },
                                {
                                    ...
                                    help_text_default:
                                        "The attribute in the AD/LDAP server used to populate the profile picture in Mattermost.",
                                    isDisabled: it.any(
                                        it.not(
                                            it.userHasWritePermissionOnResource(
                                                RESOURCE_KEYS.AUTHENTICATION
                        ...
                        },
                        {
                            ...
                            settings: [
                                ...
                                },
                                {
                                    ...
                                    label: t(
                                        "admin.ldap.groupIdAttributeTitle",
                                    ),
                                    label_default: "Group ID Attribute:",
                                    help_text: t(
                                        "admin.ldap.groupIdAttributeDesc",
                                    ),
                                    help_text_default:
                ...
                schema: {
                    ...
                    settings: [
                        ...
                        },
                        {
                            ...
                            error_message: t(
                                "admin.saml.getSamlMetadataFromIDPFail",
                            ),
                            error_message_default:
                        ...
                        },
                        {
                            ...
                            label: t(
                                "admin.saml.serviceProviderIdentifierTitle",
                            ),
                        ...
                        },
                        {
                            ...
                            uploading_text: t(
                                "admin.saml.uploading.privateKey",
                            ),
                            ...
                            options: [
                                {
                                    ...
                                    display_name: t(
                                        "admin.saml.signatureAlgorithmDisplay.sha1",
                                    ),
                                    display_name_default:
                                        SAML_SETTINGS_SIGNATURE_ALGORITHM_SHA1,
                                    help_text: t(
                                ...
                                },
                                {
                                    ...
                                    display_name: t(
                                        "admin.saml.signatureAlgorithmDisplay.sha256",
                                    ),
                                    display_name_default:
                                        SAML_SETTINGS_SIGNATURE_ALGORITHM_SHA256,
                                    help_text: t(
                                ...
                                },
                                {
                                    ...
                                    display_name: t(
                                        "admin.saml.signatureAlgorithmDisplay.sha512",
                                    ),
                                    display_name_default:
                            ...
                            options: [
                                {
                                    ...
                                    display_name: t(
                                        "admin.saml.canonicalAlgorithmDisplay.n10",
                                    ),
                                    display_name_default:
                                ...
                                },
                                {
                                    ...
                                    display_name: t(
                                        "admin.saml.canonicalAlgorithmDisplay.n11",
                                    ),
                                    display_name_default:
                ...
                schema: {
                    ...
                    settings: [
                        ...
                        },
                        {
                            ...
                            placeholder: t(
                                "admin.office365.clientSecretExample",
                            ),
                            placeholder_default:
                        ...
                        },
                        {
                            ...
                            placeholder: t(
                                "admin.office365.directoryIdExample",
                            ),
                            placeholder_default:
                                'E.g.: "adf3sfa2-ag3f-sn4n-ids0-sh1hdax192qq"',
                            isHidden: it.not(
                ...
                schema: {
                    ...
                    settings: [
                        ...
                        },
                        {
                            ...
                            label_default: "Discovery Endpoint:",
                            help_text: t(
                                "admin.office365.discoveryEndpointDesc",
                            ),
                            help_text_default:
                        ...
                        },
                        {
                            ...
                            label_default: "Discovery Endpoint:",
                            placeholder: t(
                                "admin.openid.discovery.placeholder",
                            ),
                            placeholder_default:
                ...
                schema: {
                    ...
                    settings: [
                        ...
                        },
                        {
                            ...
                            label: t(
                                "admin.guest_access.whitelistedDomainsTitle",
                            ),
                        ...
                        },
                        {
                            ...
                            label_default:
                                "Enforce Multi-factor Authentication: ",
                            help_text: t(
                                "admin.guest_access.mfaDescriptionMFANotEnabled",
                            ),
                            help_text_default:
                    ...
                    settings: [
                        {
                            ...
                            label: t(
                                "admin.customization.enableGifPickerTitle",
                            ),
                            label_default: "Enable GIF Picker:",
                            help_text: t(
                                "admin.customization.enableGifPickerDesc",
                            ),
                            help_text_default:
                ...
                schema: {
                    ...
                    settings: [
                        ...
                        },
                        {
                            ...
                            help_text: t(
                                "admin.service.corsExposedHeadersDescription",
                            ),
                            help_text_default:
                    ...
                    settings: [
                        {
                            ...
                            label_markdown: true,
                            label_default:
                                "This feature is replaced by a new [Compliance Export]({siteURL}/admin_console/compliance/export) feature, and will be removed in a future release. We recommend migrating to the new system.",
    ...
    experimental: {
        ...
        subsections: {
                ...
                schema: {
                    ...
                    settings: [
                        ...
                        },
                        {
                            ...
                            label: t(
                                "admin.experimental.emailBatchingBufferSize.title",
                            ),
                        ...
                        },
                        {
                            ...
                            label: t(
                                "admin.experimental.emailBatchingInterval.title",
                            ),
                            ...
                            help_text_markdown: false,
                            placeholder: t(
                                "admin.experimental.emailBatchingInterval.example",
                            ),
                        ...
                        },
                        {
                            ...
                            label: t(
                                "admin.experimental.enableUserDeactivation.title",
                            ),
                        ...
                        },
                        {
                            ...
                            help_text_default:
                                "When true, preview features can be enabled from **Settings > Advanced > Preview pre-release features**. When false, disables and hides preview features from **Settings > Advanced > Preview pre-release features**.",
                            help_text_markdown: true,
                            isDisabled: it.not(
                                it.userHasWritePermissionOnResource(
                                    RESOURCE_KEYS.EXPERIMENTAL.FEATURES,
                        ...
                        },
                        {
                            ...
                            label: t(
                                "admin.experimental.enableThemeSelection.title",
                            ),
                        ...
                        },
                        {
                            ...
                            label: t(
                                "admin.experimental.allowCustomThemes.title",
                            ),
                            label_default: "Allow Custom Themes:",
                            help_text: t(
                                "admin.experimental.allowCustomThemes.desc",
                            ),
                            help_text_default:
                        ...
                        },
                        {
                            ...
                            help_text: t(
                                "admin.experimental.defaultTheme.desc",
                            ),
                            help_text_default:
                        ...
                        },
                        {
                            ...
                            label: t(
                                "admin.experimental.enableOnboardingFlow.title",
                            ),
                        ...
                        },
                        {
                            ...
                            label: t(
                                "admin.experimental.experimentalPrimaryTeam.title",
                            ),
                        ...
                        },
                        {
                            ...
                            label: t(
                                "admin.experimental.experimentalUseNewSAMLLibrary.title",
                            ),
                            label_default: "Use Improved SAML Library (Beta):",
                            help_text: t(
                                "admin.experimental.experimentalUseNewSAMLLibrary.desc",
                            ),
                            help_text_default:
                            ...
                            isHidden:
                                true || it.not(it.licensedForFeature("SAML")),
                            isDisabled: it.not(
                                it.userHasWritePermissionOnResource(
                                    RESOURCE_KEYS.EXPERIMENTAL.FEATURES,
                                ),
                        ...
                        },
                        {
                            ...
                            label: t(
                                "admin.experimental.userStatusAwayTimeout.title",
                            ),
                            ...
                            help_text_markdown: false,
                            placeholder: t(
                                "admin.experimental.userStatusAwayTimeout.example",
                            ),
            ...
            feature_flags: {
                ...
                isDisabled: true,
                searchableStrings: ["admin.feature_flags.title"],
                schema: {
                    id: "Feature Flags",
