    ...
    experimental: {
        ...
        subsections: {
            ...
            audit_logging: {
                ...
                isHidden: it.any(it.not(it.userHasReadPermissionOnResource(RESOURCE_KEYS.EXPERIMENTAL.FEATURES)), it.configIsFalse('FeatureFlags', 'ExperimentalAuditSettingsSystemConsoleUI')),
                schema: {
