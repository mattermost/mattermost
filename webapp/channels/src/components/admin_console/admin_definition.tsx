                ...
                schema: {
                    ...
                    settings: [
                        ...
                        },
                        {
                            ...
                            help_text: defineMessage({id: 'admin.mattermost_extended.statuses.enableStatusLogs.desc', defaultMessage: 'When enabled, status changes are logged to the database and displayed in the Status Logs dashboard. Real-time updates are streamed via WebSocket.'}),
                        },
                        {
                            type: 'number',
                            key: 'MattermostExtendedSettings.Statuses.StatusLogRetentionDays',
                            label: defineMessage({id: 'admin.mattermost_extended.statuses.statusLogRetentionDays.title', defaultMessage: 'Status Log Retention (days):'}),
                            help_text: defineMessage({id: 'admin.mattermost_extended.statuses.statusLogRetentionDays.desc', defaultMessage: 'Number of days to keep status logs in the database. Older logs are automatically deleted. Set to 0 to disable cleanup (logs kept forever).'}),
                            placeholder: defineMessage({id: 'admin.mattermost_extended.statuses.statusLogRetentionDays.placeholder', defaultMessage: 'E.g. 7'}),
                        },
                        {
                            type: 'number',
                        ...
                        {
                            type: 'text',
                            key: 'MattermostExtendedSettings.Statuses.StatusPauseAllowedUsers',
                            label: defineMessage({id: 'admin.mattermost_extended.statuses.statusPauseAllowedUsers.title', defaultMessage: 'Status Pause Allowed Users:'}),
                            help_text: defineMessage({id: 'admin.mattermost_extended.statuses.statusPauseAllowedUsers.desc', defaultMessage: 'Comma-separated usernames that can pause their status tracking. When paused, LastActivityAt freezes and auto-status transitions are disabled, allowing users to set Offline/Away without the system overriding them.'}),
                            placeholder: defineMessage({id: 'admin.mattermost_extended.statuses.statusPauseAllowedUsers.placeholder', defaultMessage: 'E.g. admin,user1,user2'}),
                        },
                        {
                            type: 'text',
                            key: 'MattermostExtendedSettings.Statuses.InvisibilityAllowedUsers',
                            label: defineMessage({id: 'admin.mattermost_extended.statuses.invisibilityAllowedUsers.title', defaultMessage: 'Invisibility Allowed Users:'}),
                            help_text: defineMessage({id: 'admin.mattermost_extended.statuses.invisibilityAllowedUsers.desc', defaultMessage: 'Comma-separated usernames that can set themselves Offline even when NoOffline is enabled. Their LastActivityAt still updates normally — they just appear Offline to others.'}),
                            placeholder: defineMessage({id: 'admin.mattermost_extended.statuses.invisibilityAllowedUsers.placeholder', defaultMessage: 'E.g. admin,user1,user2'}),
                        },
                    ],
                },
            },
