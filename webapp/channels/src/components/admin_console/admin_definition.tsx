...
const AdminDefinition: AdminDefinitionType = {
    ...
    environment: {
        ...
        subsections: {
            ...
            cache: {
                url: 'environment/cache',
                title: defineMessage({id: 'admin.sidebar.Cache', defaultMessage: 'Cache'}),
                isHidden: it.any(
                    it.not(it.userHasReadPermissionOnResource(RESOURCE_KEYS.ENVIRONMENT.CACHE)),
                    it.configIsTrue('ExperimentalSettings', 'RestrictSystemAdmin'),
                ),
                schema: {
                    id: 'Cache',
                    name: defineMessage({id: 'admin.environment.cache', defaultMessage: 'Cache'}),
                    settings: [
                        {
                            type: Constants.SettingsTypes.TYPE_DROPDOWN,
                            key: 'CacheSettings.CacheType',
                            label: defineMessage({id: 'admin.cache.cacheType', defaultMessage: 'Cache Type:'}),
                            help_text: defineMessage({id: 'admin.cache.cacheTypeDescription', defaultMessage: 'Type of cache to use.'}),
                            options: [
                                {
                                    value: 'lru',
                                    display_name: defineMessage({id: 'admin.cache.type.lru', defaultMessage: 'LRU'}),
                                },
                                {
                                    value: 'redis',
                                    display_name: defineMessage({id: 'admin.cache.type.redis', defaultMessage: 'Redis'}),
                                },
                            ],
                        },
                        {
                            ...
                            label: defineMessage({id: 'admin.cache.redisAddress', defaultMessage: 'Address:'}),
                            help_text: defineMessage({id: 'admin.cache.redisAddressDescription', defaultMessage: 'URL of your Redis server.'}),
                            isDisabled: it.not(it.stateEquals('CacheSettings.CacheType', 'redis')),
                        },
                        {
                            type: Constants.SettingsTypes.TYPE_TEXT,
                            key: 'CacheSettings.RedisPassword',
                            label: defineMessage({id: 'admin.cache.redisPassword', defaultMessage: 'Password:'}),
                            help_text: defineMessage({id: 'admin.cache.redisPasswordDescription', defaultMessage: 'Your Redis server password.'}),
                            isDisabled: it.not(it.stateEquals('CacheSettings.CacheType', 'redis')),
                        },
                        {
                            type: Constants.SettingsTypes.TYPE_NUMBER,
                            key: 'CacheSettings.RedisDB',
                            label: defineMessage({id: 'admin.cache.redisDB', defaultMessage: 'DB:'}),
                            help_text: defineMessage({id: 'admin.cache.redisDBDescription', defaultMessage: 'Your Redis server database.'}),
                            isDisabled: it.not(it.stateEquals('CacheSettings.CacheType', 'redis')),
                        },
                        {
                            type: Constants.SettingsTypes.TYPE_NUMBER,
                            key: 'CacheSettings.MaxIdleConns',
                            label: defineMessage({id: 'admin.cache.maxIdleConns', defaultMessage: 'Max Idle Conns:'}),
                            help_text: defineMessage({id: 'admin.cache.maxIdleConnsDescription', defaultMessage: 'The maximum number of idle connections to open to Redis.'}),
                            isDisabled: it.not(it.stateEquals('CacheSettings.CacheType', 'redis')),
                        },
                        {
                            type: Constants.SettingsTypes.TYPE_NUMBER,
                            key: 'CacheSettings.MaxActiveConns',
                            label: defineMessage({id: 'admin.cache.maxActiveConns', defaultMessage: 'Max Active Conns:'}),
                            help_text: defineMessage({id: 'admin.cache.maxActiveConnsDescription', defaultMessage: 'The maximum number of connections to open to Redis.'}),
                            isDisabled: it.not(it.stateEquals('CacheSettings.CacheType', 'redis')),
                        },
                    ],
                },
