...
export class SystemUsers extends React.PureComponent<Props, State> {
    ...
    handleRevokeAllSessions = async () => {
        ...
        if (data) {
            ...
            this.props.actions.logError({
                type: "critical",
                message: "Can't revoke all sessions",
            });
        }
    };
    ...
    nextPage = async (page: number) => {
        ...
        if (teamId === SearchUserTeamFilter.ALL_USERS) {
            ...
            await loadProfilesAndTeamMembers(
                page + 1,
                USERS_PER_PAGE,
                teamId,
                options,
    ...
    doSearch = debounce(
        async (
            ...
            const { data: profiles } = await this.props.actions.searchProfiles(
                term,
                options,
            );
                ...
                <label>
                    ...
                    >
                        ...
                        <option value={UserFilters.SYSTEM_GUEST}>
                            {Utils.localizeMessage(
                                "admin.system_users.guest",
                                "Guest",
                            )}
                        </option>
                        <option value={UserFilters.ACTIVE}>
                            {Utils.localizeMessage(
                                "admin.system_users.active",
                                "Active",
                            )}
                        </option>
                        ...
                        >
                            ...
                            <div className="pt-3 pb-3">
                                <button
                                    ...
                                    onClick={() =>
                                        this.handleShowRevokeAllSessionsModal()
                                    }
