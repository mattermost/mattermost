...
describe("components/admin_console/system_users/list/selectors", () => {
    ...
    describe("should search by term", () => {
        ...
        describe("over all profiles", () => {
            ...
            it("returning users users", () => {
                ...
                (
                    users.makeSearchProfilesStartingWithTerm as jest.Mock
                ).mockImplementation(() =>
                    jest.fn().mockReturnValue(expectedUsers),
                );
                expect(getUsers(state, loading, teamId, term, filter)).toEqual(
                    expectedUsers,
                );
            ...
            describe("falling back to fetching user by id", () => {
                ...
                it("and the user is found", () => {
                    ...
                    (users.getUser as jest.Mock).mockReturnValue(
                        expectedUsers[0],
                    );

                    expect(
                        getUsers(state, loading, teamId, term, filter),
        ...
        describe("and team id", () => {
            ...
            it("returning users users found in team", () => {
                ...
                expect(users.searchProfilesInTeam).toBeCalledWith(
                    state,
                    teamId,
                    term,
                    false,
    ...
    describe("should return", () => {
        ...
        it("profiles without a team", () => {
            ...
            const expectedUsers = [{ id: "id1" }, { id: "id2" }];
            (users.getProfilesWithoutTeam as jest.Mock).mockReturnValue(
                expectedUsers,
            );
        ...
        it("profiles for the given team", () => {
            ...
            const expectedUsers = [{ id: "id1" }, { id: "id2" }];
            (users.getProfilesInTeam as jest.Mock).mockReturnValue(
                expectedUsers,
            );
            expect(getUsers(state, loading, teamId, term, filter)).toEqual(
                expectedUsers,
    ...
    describe("filters", () => {
        ...
        it("all profiles with system admin", () => {
            ...
            expect(getUsers(state, loading, teamId, term, systemAdmin)).toEqual(
                expectedUsers,
            );
        ...
        it("inactive profiles without a team", () => {
            ...
            expect(getUsers(state, loading, teamId, term, inactive)).toEqual(
                expectedUsers,
            );
            expect(users.getProfilesWithoutTeam).toBeCalledWith(
                state,
                inactiveFilter,
            );
        });
        ...
        it("system admin profiles for the given team", () => {
            ...
            expect(users.getProfilesInTeam).toBeCalledWith(
                state,
                teamId,
                roleFilter,
            );
