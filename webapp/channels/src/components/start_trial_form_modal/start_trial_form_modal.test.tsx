...
import { act, renderWithIntl, screen } from "tests/react_testing_utils";
import type { RenderResult } from "tests/react_testing_utils";
...
describe("components/start_trial_form_modal/start_trial_form_modal", () => {
    ...
    test("should pre-fill email, fire trackEvent", async () => {
        ...
        expect(
            screen.getByDisplayValue("test@mattermost.com"),
        ).toBeInTheDocument();
