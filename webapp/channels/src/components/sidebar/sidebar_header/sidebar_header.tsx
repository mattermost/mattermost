...
const SidebarHeader: React.FC<Props> = (props: Props): JSX.Element => {
    ...
    const showCreateTutorialTip = useShowOnboardingTutorialStep(
        OnboardingTourSteps.CREATE_AND_JOIN_CHANNELS,
    );
    const showInviteTutorialTip = useShowOnboardingTutorialStep(
        ...
        <CompassThemeProvider theme={theme}>
            <SidebarHeaderContainer id={"sidebar-header-container"}>
                <OverlayTrigger
                    ...
                    placement="bottom"
                    overlay={
                        currentTeam.description?.length ? (
                ...
                <AddChannelDropdown
                    ...
                    handleOpenDirectMessagesModal={
                        props.handleOpenDirectMessagesModal
                    }
