...
const SidebarCategoryMenu = ({ category }: Props) => {
    const dispatch = useDispatch();
    const showUnreadsCategory = useSelector(shouldShowUnreadsCategory);
    const unreadsIds = useSelector((state: GlobalState) =>
        getUnreadsIdsForCategory(state, category),
    );
    ...
    const sortChannelsMenuItem = (
        <Menu.SubMenu
            ...
            menuAriaLabel={formatMessage({
                id: "sidebar_left.sidebar_category_menu.sort.dropdownAriaLabel",
                defaultMessage: "Sort submenu",
            })}
        >
            <Menu.Item
