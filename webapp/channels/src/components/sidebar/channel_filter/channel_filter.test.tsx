...
describe("components/sidebar/channel_filter", () => {
    ...
    test("should match snapshot", () => {
        const wrapper = shallowWithIntl(<ChannelFilterIntl {...baseProps} />);
    ...
    test("should match snapshot if the unread filter is enabled", () => {
        ...
        const wrapper = shallowWithIntl(<ChannelFilterIntl {...props} />);
    ...
    test("should enable the unread filter on toggle when it is disabled", () => {
        ...
        expect(baseProps.actions.setUnreadFilterEnabled).toHaveBeenCalledWith(
            true,
        );
    });
