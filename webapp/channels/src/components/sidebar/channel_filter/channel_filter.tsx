...
export class ChannelFilter extends React.PureComponent<Props> {
    ...
    componentWillUnmount() {
        document.removeEventListener(
            "keydown",
            this.handleUnreadFilterKeyPress,
        );
    }
    ...
    handleUnreadFilterKeyPress = (e: KeyboardEvent) => {
        if (
            ...
            e.shiftKey &&
            Keyboard.isKeyPressed(e, Constants.KeyCodes.U)
        ) {
            e.preventDefault();
            e.stopPropagation();
            this.toggleUnreadFilter();
    ...
    render() {
        ...
        let tooltipMessage = intl.formatMessage({
        ...
        const unreadsAriaLabel = intl.formatMessage({
            id: "sidebar_left.channel_filter.filterUnreadAria",
            defaultMessage: "unreads filter",
        });
