...
export default class Sidebar extends React.PureComponent<Props, State> {
    ...
    handleKeyDownEvent = (event: KeyboardEvent) => {
        ...
        if (ctrlOrMetaKeyPressed) {
            if (
                Keyboard.isKeyPressed(event, Constants.KeyCodes.FORWARD_SLASH)
            ) {
                ...
                Keyboard.isKeyPressed(event, Constants.KeyCodes.A) &&
                event.shiftKey
            ) {
                event.preventDefault();
    ...
    renderModals = () => {
        ...
        return <React.Fragment>{moreDirectChannelsModal}</React.Fragment>;
    };
            ...
            >
                {this.props.isMobileView ? (
                    ...
                    <SidebarHeader
                        ...
                        canCreateChannel={
                            this.props.canCreatePrivateChannel ||
                            this.props.canCreatePublicChannel
                        }
