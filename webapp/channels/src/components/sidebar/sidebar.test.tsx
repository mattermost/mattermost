...
describe("components/sidebar", () => {
    ...
    test("Should call Shortcut modal on FORWARD_SLASH+ctrl/meta", () => {
        ...
        expect(
            wrapper.instance().props.actions.openModal,
        ...
        expect(wrapper.instance().props.actions.openModal).toHaveBeenCalledWith(
        ...
        const baseState: DeepPartial<GlobalState> = {
            entities: {
                channels: {
                    ...
                    myMembers: {
                        channel1: TestHelper.getChannelMembershipMock({
                            channel_id: channel1.id,
                            user_id: currentUserId,
                            msg_count: 10,
                        }),
                        channel2: TestHelper.getChannelMembershipMock({
