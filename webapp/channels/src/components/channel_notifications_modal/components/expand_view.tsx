...
const makeReactSelectValue = (option: string, isDefault: boolean) => {
    return {
        value: option,
        label: isDefault ? makeDefaultOptionLabel(option) : option,
    };
};
        ...
        () =>
            sounds.map((sound) => {
                return {
                    value: sound,
                    label:
                        sound === globalNotificationSound
                            ? makeDefaultOptionLabel(sound)
                            : sound,
                };
            }),
        [globalNotificationSound],
