...
import ThemeProvider, {
    lightTheme,
} from "@mattermost/compass-components/utilities/theme"; // eslint-disable-line no-restricted-imports
...
const CompassThemeProvider = ({
    ...
    return <ThemeProvider theme={compassTheme}>{children}</ThemeProvider>;
};
