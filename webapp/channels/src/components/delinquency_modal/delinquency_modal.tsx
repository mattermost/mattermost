...
const DelinquencyModal = (props: DelinquencyModalProps) => {
    ...
    const show = useSelector((state: GlobalState) =>
        isModalOpen(state, ModalIdentifiers.DELINQUENCY_MODAL_DOWNGRADE),
    );
            ...
            openModal({
                ...
                dialogProps: {
                    ...
                    onClose: () =>
                        dispatch(
                            closeModalAction(
                                ModalIdentifiers.CLOUD_LIMITS_DOWNGRADE,
                            ),
                        ),
                    isAdminConsole,
                    planName,
    ...
    const ModalJSX = (
        ...
        >
            ...
            <Modal.Body className="DelinquencyModal__body">
                ...
                >
                    {(text) => (
                        <p className="DelinquencyModal__body__information">
                            {text}
                        </p>
                    )}
                </FormattedMessage>
    ...
    return (
        <CompassThemeProvider theme={theme}>{ModalJSX}</CompassThemeProvider>
    );
};
