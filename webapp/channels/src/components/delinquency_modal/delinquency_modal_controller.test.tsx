...
describe("components/delinquency_modal/delinquency_modal_controller", () => {
    ...
    it("Should show the modal if the admin hasn't a preference", () => {
        ...
        expect(
            screen.queryByText("Your workspace has been downgraded"),
        ).toBeInTheDocument();
    });
    ...
    it("Should fetch cloud products when on cloud", () => {
        ...
        const getCloudProds = jest
            .spyOn(cloudActions, "getCloudProducts")
            .mockImplementationOnce(
                jest.fn().mockReturnValue({ type: "mock_impl" }),
            );
