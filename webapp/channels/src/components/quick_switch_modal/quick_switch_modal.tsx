...
> {
    ...
    private handleSuggestionsReceived = (
        suggestions: ProviderSuggestions,
    ): void => {
        const loadingPropPresent = suggestions.items.some(
            (item: any) => item.loading,
        );
        this.setState({
                    ...
                    <div className="channel-switcher__suggestion-box">
                        ...
                        <SuggestionBox
                            ...
                            onSuggestionsReceived={
                                this.handleSuggestionsReceived
                            }
                            forceSuggestionsWhenBlur={true}
                            renderDividers={[
                                Constants.MENTION_UNREAD,
                                Constants.MENTION_RECENT_CHANNELS,
                            ]}
                        ...
                        {!this.state.shouldShowLoadingSpinner &&
                            ...
                            this.state.text && (
                                <NoResultsIndicator
                                    ...
                                    titleValues={{
                                        channelName: `"${this.state.pretext}"`,
                                    }}
                                />
                            )}
                    </div>
