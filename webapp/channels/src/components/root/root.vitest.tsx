...
vi.mock('actions/telemetry_actions');

vi.mock('components/announcement_bar', () => ({default: () => <div/>}));
vi.mock('components/team_sidebar', () => ({default: () => <div/>}));
vi.mock('components/mobile_view_watcher', () => ({default: () => <div/>}));
vi.mock('./performance_reporter_controller', () => ({default: () => <div/>}));
vi.mock('components/initial_loading_screen', () => ({
    default: {
        start: vi.fn(),
        stop: vi.fn(),
    },
...
vi.mock('mattermost-redux/actions/general', () => ({
    getFirstAdminSetupComplete: vi.fn(() => Promise.resolve({
...
describe('components/Root', () => {
    ...
    const baseProps: Props = {
        ...
        actions: {
            loadConfigAndMe: vi.fn().mockImplementation(() => {
            ...
            getProfiles: vi.fn(),
            loadRecentlyUsedCustomEmojis: vi.fn(),
            migrateRecentEmojis: vi.fn(),
            registerCustomPostRenderer: vi.fn(),
    ...
    beforeAll(() => {
        ...
        // Stub the global location object to mock reload
