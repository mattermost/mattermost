...
import {renderHook} from 'tests/vitest_react_testing_utils';

import {usePluginVisibilityInSharedChannel} from './usePluginVisibilityInSharedChannel';

vi.mock('mattermost-redux/selectors/entities/channels', async (importOriginal) => {
    const actual = await importOriginal<typeof import('mattermost-redux/selectors/entities/channels')>();
    return {
        ...actual,
        getChannel: vi.fn(),
    };
...
vi.mock('mattermost-redux/selectors/entities/general', async (importOriginal) => {
    const actual = await importOriginal<typeof import('mattermost-redux/selectors/entities/general')>();
    return {
        ...actual,
...
describe('usePluginVisibilityInSharedChannel', () => {
    ...
    const mockGetFeatureFlagValue = getFeatureFlagValue as ReturnType<typeof vi.fn>;
