...
export default function useShowAdminLimitReached() {
    ...
    const needsLoggedInLimitReachedCheck = useSelector(
        getNeedsLoggedInLimitReachedCheck,
    );
    const messageLimit = limits?.messages?.history;
    const [shownLimitsReachedOnLogin, setShownLimitsReachedOnLogin] =
        usePreference(
    ...
    if (
        ...
        shownLimitsReachedOnLogin === "true"
    ) {
        return;
    }
                ...
                dialogProps: {
                    ...
                    primaryAction: {
                        ...
                        onClick: () => {
                            ...
                            openPricingModal({
                                trackingLocation:
                                    "admin_login_limit_reached_dashboard",
                            });
                        },
                    },
                    onClose: () => {
