...
import {renderHook, act, waitFor} from 'tests/vitest_react_testing_utils';
...
describe('useAccessControlAttributes', () => {
    ...
    test('should use cached data if available and not expired', async () => {
        ...
        const {getChannelAccessControlAttributes} = await import('mattermost-redux/actions/channels');
        (getChannelAccessControlAttributes as ReturnType<typeof vi.fn>).mockClear();
