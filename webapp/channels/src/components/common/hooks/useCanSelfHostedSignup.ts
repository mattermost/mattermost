...
export default function useCanSelfHostedSignup(): SignupAvailability {
    const [cwsAvailability, setCwsAvailability] = useState(
        cwsAvailableEmptyState,
    );
    ...
    return useMemo(() => {
        return {
            ...
            ok:
                stripeAvailable &&
                cwsAvailability.cwsContacted &&
                cwsAvailability.cwsServiceOn &&
                !cwsAvailability.screeningInProgress,
        };
