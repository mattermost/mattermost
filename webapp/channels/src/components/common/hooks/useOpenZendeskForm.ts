...
import {
    getCloudSupportLink,
    getSelfHostedSupportLink,
    goToCloudSupportForm,
    goToSelfHostedSupportForm,
} from "utils/contact_support_sales";

export function useOpenCloudZendeskSupportForm(
    subject: string,
    description: string,
): [() => void, string] {
...
export function useOpenSelfHostedZendeskSupportForm(
    subject: string,
): [() => void, string] {
