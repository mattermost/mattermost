...
export default function useControlSelfHostedExpansionModal(
    options: HookOptions,
): ControlModal {
        ...
        return {
            ...
            open: async () => {
                const purchaseInProgress =
                    localStorage.getItem(STORAGE_KEY_EXPANSION_IN_PROGRESS) ===
                    "true";
                        ...
                        dispatch(
                            openModal({
                                ...
                                dialogProps: {
                                    ...
                                    storageKey:
                                        STORAGE_KEY_EXPANSION_IN_PROGRESS,
                                },
                            }),
                        );
                        return;
