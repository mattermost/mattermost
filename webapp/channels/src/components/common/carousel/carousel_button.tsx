...
const CarouselButton = ({
    ...
    const text =
        direction === Destination.NEXT
            ? formatMessage({
                  id: "carousel.nextButton",
                  defaultMessage: "Next",
              })
            : formatMessage({
                  id: "carousel.PreviousButton",
    ...
    if (btnsStyle === BtnStyle.CHEVRON) {
        return (
            <div
                className={
                    `chevron-button chevron-${orientation} ${direction}-btn` +
                    disabledClass
                }
    ...
    return (
        ...
        >
            {direction === Destination.PREV ? (
                <i className="icon-arrow-back-ios" />
            ) : null}
            {text}
            {direction === Destination.NEXT ? (
                <i className="icon-arrow-forward-ios" />
            ) : null}
        </a>
    );
};
