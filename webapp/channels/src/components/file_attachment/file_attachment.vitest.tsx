...
vi.mock('utils/utils', async () => {
    ...
    return {
        ...original,
        loadImage: vi.fn((id: string, callback: () => void) => {
            if (id !== 'noLoad') {
                callback();
            }
        }),
...
vi.mock('mattermost-redux/utils/file_utils', async () => {
    const original = await vi.importActual<typeof import('mattermost-redux/utils/file_utils')>('mattermost-redux/utils/file_utils');
    return {
        ...original,
...
describe('FileAttachment', () => {
    ...
    const baseProps = {
        ...
        handleFileDropdownOpened: vi.fn(() => null),
        actions: {
            openModal: vi.fn(),
        },
    };
