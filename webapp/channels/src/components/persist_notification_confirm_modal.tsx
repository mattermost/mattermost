...
import {
    getPersistentNotificationIntervalMinutes,
    getPersistentNotificationMaxRecipients,
...
import {
    HasNoMentions,
    HasSpecialMentions,
} from "./post_priority/error_messages";
...
function PersistNotificationConfirmModal({
    ...
    const getMentionCount = useMemo(
        makeGetUserOrGroupMentionCountFromMessage,
        [],
    );
    ...
    if (channelType === Constants.DM_CHANNEL) {
        ...
        body = <HasSpecialMentions specialMentions={specialMentions} />;
        confirmBtn = (
            <FormattedMessage
