...
export class MainMenu extends React.PureComponent<Props> {
    ...
    render() {
        ...
        const showIntegrations =
            !this.props.mobile &&
            someIntegrationEnabled &&
            this.props.canManageIntegrations;
        const teamsLimitReached =
            this.props.isStarterFree &&
            !this.props.isFreeTrial &&
            this.props.usageDeltaTeams >= 0;
        const createTeamRestricted =
            this.props.isCloud && (this.props.isFreeTrial || teamsLimitReached);
        ...
        if (guestAccessEnabled || canInviteTeamMember) {
            invitePeopleModal = (
                <Menu.ItemToggleModalRedux
                    ...
                    icon={
                        this.props.mobile && <i className="fa fa-user-plus" />
                    }
                    onClick={() =>
                        trackEvent(
                            "ui",
                            "click_sidebar_team_dropdown_invite_people",
                        )
                    }
                />
            );
        ...
        return this.props.mobile ? (
            <Menu
                ...
                ariaLabel={formatMessage({
                    id: "navbar_dropdown.menuAriaLabel",
            ...
            >
                ...
                <Menu.Group>
                    <Menu.ItemToggleModalRedux
                        ...
                        text={formatMessage({
                            id: "navbar_dropdown.profileSettings",
            ...
            <Menu
                id={this.props.id}
                ariaLabel={formatMessage({
                    id: "sidebar.team_menu.menuAriaLabel",
                    defaultMessage: "team menu",
                })}
            >
                <Menu.Group>
                    <TeamPermissionGate
                        ...
                        <Menu.ItemLink
                            ...
                            sibling={
                                createTeamRestricted && (
                                    <RestrictedIndicator
                                        feature={
                                            MattermostFeatures.CREATE_MULTIPLE_TEAMS
                                        }
                                        ...
                                        titleAdminPreTrial={formatMessage({
                                            ...
                                            defaultMessage:
                                                "Try unlimited teams with a free trial",
                                        })}
                                        ...
                                        titleEndUser={formatMessage({
                                            ...
                                            defaultMessage:
                                                "Multiple teams available in paid plans",
                                        })}
