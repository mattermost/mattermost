    ...
    handleClick = () => {
        ...
        updateChannelNotifyProps(user.id, channel.id, {
            mark_unread: (isMuted
                ...
                : NotificationLevels.MENTION) as "all" | "mention",
        });
    };

    render() {
        const { id, isMuted, channel } = this.props;
        ...
        if (
            ...
            text = isMuted
                ? localizeMessage(
                      "channel_header.unmuteConversation",
                      "Unmute Conversation",
                  )
                : localizeMessage(
            ...
            text = isMuted
                ? localizeMessage("channel_header.unmute", "Unmute Channel")
                : localizeMessage("channel_header.mute", "Mute Channel");
        }

        return (
            <Menu.ItemAction id={id} onClick={this.handleClick} text={text} />
        );
    }
}
