            ...
            <React.Fragment>
                ...
                <Menu.Group divider={divider}>
                    ...
                    <Menu.ItemToggleModalRedux
                        ...
                        show={
                            channel.type !== Constants.DM_CHANNEL && !isArchived
                        }
                ...
                <Menu.Group divider={divider}>
                    <Menu.ItemToggleModalRedux
                        ...
                        dialogProps={{ channel }}
                        text={localizeMessage(
                            "channel_header.setConversationHeader",
                            "Edit Conversation Header",
                        )}
                    />
                ...
                <Menu.Group divider={divider}>
                    ...
                    <MenuItemCloseMessage
                        ...
                        currentUser={user}
                    />
                    <MenuItemCloseChannel isArchived={isArchived} />
                </Menu.Group>
                <Menu.Group>{pluginItems}</Menu.Group>
                <Menu.Group divider={divider}>
                    <ChannelPermissionGate
                        channelId={channel.id}
                        teamId={channel.team_id}
