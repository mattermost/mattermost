...
const InputError = (props: Props) => {
    if (props.message) {
        ...
        return (
            <div
                className={`Input___customMessage Input___${props.custom.type}`}
            >
                <i
                    className={classNames(`icon ${props.custom.type}`, {
                        "icon-alert-outline":
                            props.custom.type === ItemStatus.WARNING,
                        "icon-alert-circle-outline":
                            props.custom.type === ItemStatus.ERROR,
                        "icon-information-outline":
                            props.custom.type === ItemStatus.INFO,
