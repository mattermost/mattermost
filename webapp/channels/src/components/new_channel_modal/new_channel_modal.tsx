...
export function getChannelTypeFromPermissions(
...
const NewChannelModal = () => {
    ...
    const pluginsComponentsList = useSelector(
        (state: GlobalState) => state.plugins.components,
    );
    const createBoardFromChannelPlugin =
        pluginsComponentsList?.CreateBoardFromTemplate;
    const newChannelWithBoardPulsatingDotState = useSelector(
        (state: GlobalState) =>
            getPreference(
                state,
                Preferences.APP_BAR,
    ...
    const [actionFromPluggable, setActionFromPluggable] = useState<
        | ((currentTeamId: string, channelId: string) => Promise<Board>)
        | undefined
    >(undefined);
    ...
    const handleOnModalConfirm = async () => {
        ...
        try {
            const { data: newChannel, error } = await dispatch(
            ...
            onCreateChannelError({
                message: formatMessage({
                    id: "channel_modal.error.generic",
    ...
    const addBoardToChannel = async (channelId: string) => {
        ...
        const action = actionFromPluggable as (
        ...
        if (newChannelWithBoardPulsatingDotState === "") {
            dispatch(
                setNewChannelWithBoardPreference({
                    [Preferences.NEW_CHANNEL_WITH_BOARD_TOUR_SHOWED]: false,
                }),
            );
        }
        return true;
            ...
            case ServerErrorId.CHANNEL_PURPOSE_SIZE:
                setPurposeError(
                    formatMessage({
                        ...
                        defaultMessage:
                            "The purpose exceeds the maximum of 250 characters",
                    }),
                );
                break;
    ...
    const newBoardInfoIcon = (
        <OverlayTrigger
            ...
            placement="right"
            overlay={
                <Tooltip id="new-channel-with-board-tooltip">
                    <div className="title">
                        <FormattedMessage
            ...
            <div className="new-channel-modal-body">
                <ChannelNameFormField
                    ...
                    placeholder={formatMessage({
                        id: "channel_modal.name.placeholder",
                        defaultMessage: "Enter a name for your new channel",
                    })}
                ...
                <PublicPrivateSelector
                    ...
                    publicButtonProps={{
                        title: formatMessage({
                            id: "channel_modal.type.public.title",
                            defaultMessage: "Public Channel",
                        }),
                        description: formatMessage({
                            id: "channel_modal.type.public.description",
                    ...
                    privateButtonProps={{
                        title: formatMessage({
                            id: "channel_modal.type.private.title",
                            defaultMessage: "Private Channel",
                        }),
                        description: formatMessage({
                            id: "channel_modal.type.private.description",
                ...
                <div className="new-channel-modal-purpose-container">
                    <textarea
                        ...
                        className={classNames(
                            ...
                            { "with-error": purposeError },
                        )}
                        placeholder={formatMessage({
                            id: "channel_modal.purpose.placeholder",
                            defaultMessage:
