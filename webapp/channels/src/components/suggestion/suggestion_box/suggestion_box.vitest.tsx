...
import {act, renderWithContext, screen, userEvent, waitFor} from 'tests/vitest_react_testing_utils';
...
describe('SuggestionBox', () => {
    ...
    test('should list suggestions based on typed text', async () => {
        ...
        const providerSpy = vi.spyOn(provider, 'handlePretextChanged');
    ...
    test('keyboard support and ARIA', async () => {
        ...
        const provider = new AtMentionProvider({
            ...
            autocompleteUsersInChannel: vi.fn().mockResolvedValue({data: []}),
            priorityProfiles: [],
            channelId: 'channelId',
            currentUserId: 'currentUserId',
            searchAssociatedGroupsForReference: vi.fn().mockResolvedValue({data: []}),
