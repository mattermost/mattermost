...
describe("ChannelMentionProvider.handlePretextChanged", () => {
    ...
    describe("basic cases", () => {
        ...
        test("should not match plain text", () => {
            const matched = provider.handlePretextChanged(
                "this is a test",
                resultsCallback,
            );
        ...
        test("should match a partial channel's name", () => {
            ...
            expect(autocompleteChannels).toHaveBeenCalledWith(
                "town-sq",
                expect.anything(),
                expect.anything(),
            );
        ...
        test("should only match at the end of the text", () => {
            const matched = provider.handlePretextChanged(
                "this is ~town-square, not ~off-topic",
                resultsCallback,
            );
    ...
    describe("matching text after completing a result", () => {
        ...
        test("should not continue to match a link that was completed, even after typing more text", () => {
            ...
            const matched = provider.handlePretextChanged(
                "This is ~town-square and a test",
                resultsCallback,
            );
        ...
        test("should start matching input again after another link is started", () => {
            ...
            const matched = provider.handlePretextChanged(
                "This is ~town-square and not ~off",
                resultsCallback,
            );
    ...
    test("should not continue to match after receiving no results until another possible link starts", () => {
        ...
        let matched = provider.handlePretextChanged(
            "This is ~no-results",
            resultsCallback,
        );
        ...
        matched = provider.handlePretextChanged(
            "This is ~no-results in a test",
            resultsCallback,
        );
        ...
        matched = provider.handlePretextChanged(
            "This is ~no-results in a test using ~town",
            resultsCallback,
        );
