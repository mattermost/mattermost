...
describe('AppCommandParser', () => {
    ...
    describe('getSuggestions', () => {
        ...
        test('create flag project dynamic select value', async () => {
            ...
            Client4.executeAppCall = vi.fn().mockResolvedValue(Promise.resolve({type: AppCallResponseTypes.OK, data: {items: [{label: 'special-label', value: 'special-value'}]}}));
    ...
    describe('composeCommandSubmitCall', () => {
        ...
        test('dynamic lookup test', async () => {
            ...
            const mockedExecute = vi.fn().mockResolvedValue(Promise.resolve({type: AppCallResponseTypes.OK, data: {items: [{label: 'special-label', value: 'special-value'}]}}));
