...
const SearchUserSuggestion = React.forwardRef<
    HTMLDivElement,
...
export default class SearchUserProvider extends Provider {
    private autocompleteUsersInTeam: (
        username: string,
    ) => Promise<UserAutocomplete>;
    constructor(
        userSearchFunc: (username: string) => Promise<UserAutocomplete>,
    ) {
        super();
