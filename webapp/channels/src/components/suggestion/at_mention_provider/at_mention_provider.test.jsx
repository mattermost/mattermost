...
describe('components/suggestion/at_mention_provider/AtMentionProvider', () => {
    ...
    it('should ignore pretexts that are not at-mentions', () => {
        ...
        expect(
            baseParams.searchAssociatedGroupsForReference,
    ...
    it('should suggest for "@"', async () => {
            ...
            searchAssociatedGroupsForReference: jest.fn().mockImplementation(
                () =>
                    new Promise((resolve) => {
                        ...
                        expect(
                            provider.updateMatches(resultCallback, itemsCall3),
                        ).toEqual(true);
                    }),
            ),
        };
        ...
        ).mockImplementation(() => [userid10, userid3, userid1, userid2]);
            ...
            searchAssociatedGroupsForReference: jest.fn().mockImplementation(
                () =>
                    new Promise((resolve) => {
                        ...
                        expect(
                            provider.updateMatches(resultCallback, itemsCall2),
                        ).toEqual(true);
                    }),
            ),
        };
