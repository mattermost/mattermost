...
describe('components/suggestion/at_mention_provider/AtMentionProvider', () => {
    ...
    const baseParams: Props = {
        ...
        autocompleteUsersInChannel: vi.fn().mockResolvedValue(false),
        autocompleteGroups: [groupid1, groupid2, groupid3],
        useChannelMentions: true,
        searchAssociatedGroupsForReference: vi.fn().mockResolvedValue(false),
        priorityProfiles: [],
    };
    ...
    it('should suggest for "@"', async () => {
        ...
        const params = {
            ...baseParams,
            autocompleteUsersInChannel: vi.fn().mockImplementation(() => new Promise((resolve) => {
                resolve({data: {
                    users: [userid4],
                    out_of_channel: [userid5, userid6],
                }});
            })),
            searchAssociatedGroupsForReference: vi.fn().mockImplementation(() => new Promise((resolve) => {
                resolve({
        ...
        vi.spyOn(provider, 'getProfilesWithLastViewAtInChannel').mockImplementation(() => [userid10, userid3, userid1, userid2]);
    ...
    it('should remove duplicates from results', async () => {
        ...
        const provider = new AtMentionProvider(params);
        vi.spyOn(provider, 'getProfilesWithLastViewAtInChannel').mockImplementation(() => [userid10, userid3, userid1, userid2, userid12]);
    ...
    it('should sort results based on last_viewed_at', async () => {
        ...
        const provider = new AtMentionProvider(params);
        vi.spyOn(provider, 'getProfilesWithLastViewAtInChannel').mockImplementation(() => [userid10, {...userid3, last_viewed_at: 10}, {...userid1, last_viewed_at: 11}, userid2, userid12]);
    ...
    it('should ignore channel mentions - @here, @channel and @all when useChannelMentions is false', () => {
        ...
        const provider = new AtMentionProvider(params);
        vi.spyOn(provider, 'getProfilesWithLastViewAtInChannel').mockImplementation(() => []);
