...
export default class GenericChannelProvider extends Provider {
    ...
    handlePretextChanged(
        ...
        this.autocompleteChannels(normalizedPretext, (channels: Channel[]) => {
