...
vi.mock('selectors/emojis', () => ({
    getEmojiMap: vi.fn(),
    getRecentEmojisNames: vi.fn(),
}));

const mockedGetEmojiMap = vi.mocked(getEmojiMap);
const mockedGetRecentEmojisNames = vi.mocked(getRecentEmojisNames);
