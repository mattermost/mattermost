...
export default function FilesFilterMenu(props: Props): JSX.Element {
    const toolTip = (
        <Tooltip id="files-filter-tooltip" className="hidden-xs">
            <FormattedMessage
            ...
            <MenuWrapper>
                ...
                >
                    ...
                    >
                        ...
                        <FilterVariantIcon size={18} color="currentColor" />
                    </IconContainer>
                </OverlayTrigger>
                <Menu ariaLabel={"file menu"} openLeft={true}>
                    <Menu.ItemAction
                    ...
                    <Menu.ItemAction
                        ...
                        icon={
                            props.selectedFilter === "documents" ? (
                                <i className="icon icon-check" />
                            ) : null
                        }
                    />
                    <Menu.ItemAction
                        ...
                        icon={
                            props.selectedFilter === "spreadsheets" ? (
                                <i className="icon icon-check" />
                            ) : null
                        }
                    />
                    <Menu.ItemAction
                        ...
                        icon={
                            props.selectedFilter === "presentations" ? (
                                <i className="icon icon-check" />
                            ) : null
                        }
                    />
