    ...
    switch (props.searchType) {
                ...
                formatMessage(
                    {
                        ...
                        defaultMessage:
                            "Some older files may not be shown because your workspace has met its file storage limit of {storage}. <a>{ctaAction}</a>",
                    },
                    {
                        ctaAction,
        ...
        case DataSearchTypes.MESSAGES_SEARCH_TYPE:
            if (
                ...
                !(currentMessagesUsage > messagesLimit)
            ) {
                return null;
            }
            return renderBanner(
                formatMessage(
                    {
                        ...
                        defaultMessage:
                            "Some older messages may not be shown because your workspace has over {messages} messages. <a>{ctaAction}</a>",
                    },
                    {
                        ctaAction,
