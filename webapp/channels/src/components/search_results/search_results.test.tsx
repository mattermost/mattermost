...
describe("components/SearchResults", () => {
    describe("shouldRenderFromProps", () => {
        ...
        test("should not render", () => {
            expect(
                arePropsEqual(props as any, { ...props } as any),
            ).toBeTruthy();
            expect(
                arePropsEqual(
                    props as any,
                    { ...props, results: [result1, result2] } as any,
                ),
            ).toBeTruthy();
            expect(
                arePropsEqual(
                    ...
                    {
                        ...props,
                        fileResults: [fileResult1, fileResult2],
                    } as any,
                ),
            ).toBeTruthy();
        });
        ...
        test("should render", () => {
            expect(
                !arePropsEqual(
                    props as any,
                    { ...props, prop1: "newprop" } as any,
                ),
            ).toBeTruthy();
            expect(
                !arePropsEqual(
                    props as any,
                    { ...props, results: [result2, result1] } as any,
                ),
            ).toBeTruthy();
            expect(
                !arePropsEqual(
                    ...
                    {
                        ...props,
                        results: [result1, result2, { test: "test" }],
                    } as any,
                ),
            ).toBeTruthy();
            expect(
                !arePropsEqual(
                    ...
                    {
                        ...props,
                        fileResults: [fileResult2, fileResult1],
                    } as any,
                ),
            ).toBeTruthy();
            expect(
