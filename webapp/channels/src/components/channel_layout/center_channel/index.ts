...
import {
    ...
    getLastViewedTypeByTeamName,
    getPreviousTeamId,
    getPreviousTeamLastViewedType,
} from "selectors/local_storage";
...
const mapStateToProps = (state: GlobalState, ownProps: OwnProps) => {
    const lastViewedType = getLastViewedTypeByTeamName(
        state,
    ...
    if (
        ...
        (previousTeamLastViewedType === PreviousViewedTypes.THREADS ||
            lastViewedType === PreviousViewedTypes.THREADS)
    ) {
