...
describe("components/channel_layout/ChannelController", () => {
    ...
    test("Should have os--windows class on body for windows 32 or windows 64", () => {
        expect(getClassnamesForBody("Win32")).toEqual([
            "app__body",
            "channel-view",
            "os--windows",
        ]);
        expect(getClassnamesForBody("Win64")).toEqual([
            "app__body",
            "channel-view",
            "os--windows",
        ]);
    ...
    test("Should have os--mac class on body for MacIntel or MacPPC", () => {
        expect(getClassnamesForBody("MacIntel")).toEqual([
            "app__body",
            "channel-view",
            "os--mac",
        ]);
        expect(getClassnamesForBody("MacPPC")).toEqual([
            "app__body",
            "channel-view",
            "os--mac",
        ]);
