...
jest.mock("mattermost-redux/actions/channels", () => ({
    ...
    getChannelByNameAndTeamName: jest.fn(() => ({
        type: "",
        data: {
            id: "channel_id3",
            name: "achannel3",
...
describe("Actions", () => {
    ...
    const channel4 = {
        id: "channel_id4",
        name: "additional-abilities---community-systems",
        team_id: "team_id1",
        type: "O",
    };
    const channel5 = {
        id: "channel_id5",
        name: "some-group-channel",
        team_id: "team_id1",
        type: "G",
    };
    const channel6 = {
    ...
    const initialState = {
        entities: {
            channels: {
                ...
                channels: {
                    channel_id1: channel1,
                    channel_id2: channel2,
                    channel_id3: channel3,
                    channel_id4: channel4,
                    channel_id5: channel5,
                    channel_id6: channel6,
                },
                myMembers: {
                    channel_id1: {
                ...
                channelsInTeam: {
                    team_id1: ["channel_id1"],
                    team_id2: ["channel_id2"],
                },
            },
            teams: {
    ...
    describe("getPathFromIdentifier", () => {
        test.each([
            {
                desc: "identifier is a channel name",
                expected: "channel_name",
                path: "channels",
                identifier: "channelName",
            },
            {
                desc: "identifier is a group id",
                expected: "group_channel_group_id",
                path: "channels",
                identifier: "9c992e32cc7b3e5651f68b0ead4935fdf40d67ff",
            },
            {
                desc: "channel exists and is type G",
                expected: "group_channel_group_id",
                path: "channels",
                identifier: "some-group-channel",
            },
            {
                desc: "identifier is a group id",
                expected: "group_channel_group_id",
            ...
            {
                desc: "identifier looks like a group id but matching channel is an open channel",
                expected: "channel_name",
                path: "channels",
                identifier: "additional-abilities--community-systems",
            },
            {
                desc: "identifier is in the format userid--userid2",
                expected: "channel_name",
                path: "channels",
                identifier:
                    "3y8ujrgtbfn78ja5nfms3qm5jw--3y8ujrgtbfn78ja5nfms3qm5jw",
            },
            {
                desc: "identifier is the username",
                expected: "direct_channel_username",
                path: "messages",
                identifier: "@user1",
            },
            {
                desc: "identifier is the user email",
                expected: "direct_channel_email",
                path: "messages",
                identifier: "user1@bladekick.com",
            },
            {
                desc: "identifier is the user id",
                expected: "direct_channel_user_id",
                path: "messages",
                identifier: "3y8ujrgtbfn78ja5nfms3qm5jw",
            },
            {
                desc: "the path is not right",
                expected: "error",
                path: "messages",
                identifier: "test",
            },
            ...
            async ({ expected, path, identifier }) => {
                const res = await getPathFromIdentifier(
                    initialState as any,
                    path,
                    identifier,
                );
        ...
        describe("identifier is 26 char long", () => {
            ...
            test.each([
                {
                    desc: "fetching a channel by id succeeds",
                    expected: "channel_id",
                    statusCode: 200,
                    identifier: "pjz4yj7jw7nzmmo3upi4htmt1y",
                },
                {
                    desc: "fetching a channel by id fails status 404",
                    expected: "channel_name",
                    statusCode: 404,
                    identifier: "channelnamethatis26charlon",
                },
                {
                    desc: "fetching a channel by id fails status not 404",
                    expected: "error",
                    statusCode: 403,
                    identifier: "channelnamethatis26charlon",
                },
                {
                    desc: "identifier is a channel name stored in redux (no fetching happens)",
                    expected: "channel_name",
                    identifier: "12345678901234567890123456",
                },
            ])(
                "Should return $expected if $desc",
                async ({ expected, statusCode, identifier }) => {
    ...
    describe("goToChannelByChannelName", () => {
        ...
        test("switch to private channel we don't have locally and get prompted if super user and then join", async () => {
            ...
            (joinChannel as jest.Mock).mockReturnValueOnce({
                type: "",
                data: { channel },
            });
            (getChannelByNameAndTeamName as jest.Mock).mockReturnValueOnce({
                type: "",
                data: channel,
            });
            await testStore.dispatch(
            ...
            expect(getChannelByNameAndTeamName).toHaveBeenCalledWith(
                "team1",
                channel.name,
                true,
            );
                ...
                goToDirectChannelByUserIds(
                    {
                        params: {
                            team: "team1",
                            identifier: "current_user_id__user_id2",
                            path: "/",
                        },
                        url: "",
                    },
                ...
                goToDirectChannelByEmail(
                    {
                        params: {
                            team: "team1",
                            identifier: "user2@bladekick.com",
                            path: "/",
                        },
                        url: "",
                    },
                ...
                goToDirectChannelByEmail(
                    {
                        params: {
                            team: "team1",
                            identifier: "user3@bladekick.com",
                            path: "/",
                        },
                        url: "",
                    },
