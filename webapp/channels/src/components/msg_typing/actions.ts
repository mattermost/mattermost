...
export function userStartedTyping(userId: string, channelId: string, rootId: string, now: number): ActionFunc {
...
function fillInMissingInfo(userId: string): ActionFunc {
