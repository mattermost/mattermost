...
vi.mock('utils/timezone', () => ({
    getCurrentMomentForTimezone: vi.fn(),
    isBeforeTime: vi.fn(),
}));

const mockGetCurrentMomentForTimezone = timezoneUtils.getCurrentMomentForTimezone as ReturnType<typeof vi.fn>;
const mockIsBeforeTime = timezoneUtils.isBeforeTime as ReturnType<typeof vi.fn>;
...
describe('components/datetime_input/DateTimeInput', () => {
    ...
    describe('user interactions', () => {
        test('should call setIsInteracting when date picker opens', async () => {
            const mockSetIsInteracting = vi.fn();
            const props = {
                ...baseProps,
