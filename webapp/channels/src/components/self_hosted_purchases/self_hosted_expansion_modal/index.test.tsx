...
describe('SelfHostedExpansionModal Open', () => {
    it('renders the form', () => {
        renderWithFullContext(<div id='root-portal'><SelfHostedExpansionModal/></div>, initialState);
...
describe('SelfHostedExpansionModal RHS Card', () => {
    ...
    it('New seats input cannot be less than 1', () => {
        ...
        renderWithFullContext(<div id='root-portal'><SelfHostedExpansionModal/></div>, state);
        fillForm(defaultSuccessForm);
