...
export default function SelfHostedExpansionSuccessPage(props: Props) {
    ...
    const titleText = (
        <FormattedMessage
            ...
            defaultMessage={
                "You've successfully updated your license seat count"
            }
        />
    );
    ...
    const formattedSubtitleText = (
        <FormattedMessage
            ...
            defaultMessage={
                "The license has been automatically applied to your Mattermost instance. Your updated invoice will be visible in the <billing>Billing section</billing> of the system console."
            }
            values={{
    ...
    const icon = <PaymentSuccessStandardSvg width={444} height={313} />;
