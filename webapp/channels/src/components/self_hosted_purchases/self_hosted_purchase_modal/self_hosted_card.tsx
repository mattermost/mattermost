...
} from "components/purchase_modal/purchase_modal";
...
export default function SelfHostedCard(props: Props) {
    ...
    const showPlanLabel =
        props.desiredProduct.sku === SelfHostedProducts.PROFESSIONAL;
    ...
    const comparePlan = (
        <button
            ...
            onClick={() => {
                ...
                openPricingModal({
                    trackingLocation: "purchase_modal_compare_plans_click",
                });
            }}
        >
            <FormattedMessage
    ...
    const comparePlanWrapper = (
        <div
            className={
                showPlanLabel ? "plan_comparison show_label" : "plan_comparison"
            }
        >
            {comparePlan}
        </div>
        ...
        <>
            ...
            <Card
                ...
                afterButtonContent={
                    <Consequences
                        isCloud={false}
                        licenseAgreementBtnText={intl.formatMessage({
                            id: "self_hosted_signup.cta",
