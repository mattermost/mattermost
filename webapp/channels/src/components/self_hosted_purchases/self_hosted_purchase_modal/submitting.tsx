...
function useConvertProgressToWaitingExplanation(
            ...
            return intl.formatMessage(
                {
                    ...
                    defaultMessage:
                        "Applying your {planName} license to your Mattermost instance",
                },
                { planName },
            );
        default:
...
export function convertProgressToBar(
    progress: ValueOf<typeof SelfHostedSignupProgress>,
): number {
    switch (progress) {
        case SelfHostedSignupProgress.START:
...
export default function Submitting(props: Props) {
    ...
    const waitingExplanation = useConvertProgressToWaitingExplanation(
        progress,
        props.desiredPlanName,
    );
    const footer = (
