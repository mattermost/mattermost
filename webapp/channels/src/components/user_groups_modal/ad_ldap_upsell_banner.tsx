...
function ADLDAPUpsellBanner() {
    ...
    const isSelfHostedProfessional =
        currentLicense?.SkuShortName === LicenseSkus.Professional;
    ...
    const currentLicenseEndDate = new Date(
        parseInt(currentLicense?.ExpiresAt, 10),
    );
    ...
    const confirmBanner = (
        <div className="ad_ldap_upsell_confirm">
            ...
            <div className="upsell-confirm-foreground">
                <p className="title">
                    {formatMessage({
                        id: "adldap_upsell_banner.confirm.title",
                ...
                <p className="subtitle">
                    {formatMessage(
                        {
                            id: "adldap_upsell_banner.confirm.license_trial",
                            defaultMessage:
                        ...
                        {
                            endDate: moment(currentLicenseEndDate)
                ...
                <div className="btns-container">
                    ...
                    >
                        {formatMessage({
                            id: "adldap_upsell_banner.confirm.learn_more",
                    ...
                    >
                        {formatMessage({
                            id: "adldap_upsell_banner.confirm.continue",
    ...
    let btn = (
        <StartTrialBtn
            ...
            message={formatMessage({
                id: "adldap_upsell_banner.trial_btn",
    ...
    if (prevTrialed) {
        btn = (
            <button className="ad-ldap-banner-btn" onClick={openSalesLink}>
                {formatMessage({
                    id: "adldap_upsell_banner.sales_btn",
                    defaultMessage: "Contact sales to use",
                })}
            </button>
        );
    }
    ...
    return (
        <div id="ad_ldap_upsell_banner" className="ad_ldap_upsell_banner">
            <div className="message">
                <i className="icon icon-information-outline" />
                {formatMessage({
                    id: "adldap_upsell_banner.banner_message",
                    defaultMessage: "AD/LDAP group sync creates groups faster",
                })}
            </div>
