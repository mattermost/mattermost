                            ...
                            >
                                <Menu.Group>
                                    <Menu.ItemAction
                                        ...
                                        text={intl.formatMessage({id: 'user_groups_modal.viewGroup', defaultMessage: 'View Group'})}
                                        disabled={false}
                                    />
                                </Menu.Group>
                                <Menu.Group>
                                    ...
                                    <Menu.ItemAction
                                        ...
                                        text={intl.formatMessage({id: 'user_groups_modal.restoreGroup', defaultMessage: 'Restore Group'})}
                                        disabled={false}
                                    />
                                </Menu.Group>
                            </Menu>
