    ...
    return (
        <div className={`ButtonExamples ${backgroundClass || ''}`}>
            <div style={{padding: '20px'}}>
                <h3 style={{marginBottom: '24px'}}>Button Component Examples</h3>
                
                <div style={{marginBottom: '24px'}}>
                    <h4 style={{marginBottom: '16px'}}>Emphasis Variants (Medium)</h4>
                ...
                <div style={{marginBottom: '24px'}}>
                    <h4 style={{marginBottom: '16px'}}>Size Variants (Primary)</h4>
                ...
                <div style={{marginBottom: '24px'}}>
                    <h4 style={{marginBottom: '16px'}}>With Icons</h4>
                    <div style={{display: 'flex', gap: '12px', flexWrap: 'wrap', marginBottom: '12px'}}>
                ...
                <div style={{marginBottom: '24px'}}>
                    <h4 style={{marginBottom: '16px'}}>Full Width</h4>
