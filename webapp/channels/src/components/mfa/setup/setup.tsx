                ...
                >
                    ...
                    <p>
                        <FormattedMessage
                            ...
                            defaultMessage="<strong>Step 2: <strong>Use Google Authenticator to scan this QR code, or manually type in the secret key.</strong>"
                            values={{
                                strong: (chunks: React.ReactNode) => <strong>{chunks}</strong>,
                            }}
                        />
                    ...
                    <p>
                        <FormattedMessage
                            id='mfa.setup.step3_mfa'
                            defaultMessage="<strong>Step 3: <strong>Enter the code generated by Google Authenticator.</strong>"
                            values={{
                                strong: (chunks: React.ReactNode) => <strong>{chunks}</strong>,
                            }}
                        />
