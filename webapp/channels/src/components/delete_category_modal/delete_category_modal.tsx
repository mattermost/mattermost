        ...
        >
            <span className='delete-category__helpText'>
                <FormattedMessage
                    ...
                    defaultMessage="Channels in <strong>{category_name}</strong> will move back to the Channels and Direct messages categories. You're not removed from any channels."
                    values={{
