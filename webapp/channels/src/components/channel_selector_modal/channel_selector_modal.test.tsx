...
describe("components/ChannelSelectorModal", () => {
    const channel1: ChannelWithTeamData = Object.assign(
        TestHelper.getChannelWithTeamDataMock({
            id: "channel-1",
            team_id: "teamid1",
        }),
    );
    const channel2: ChannelWithTeamData = Object.assign(
        TestHelper.getChannelWithTeamDataMock({
            id: "channel-2",
            team_id: "teamid2",
        }),
    );
    const channel3: ChannelWithTeamData = Object.assign(
        TestHelper.getChannelWithTeamDataMock({
            id: "channel-3",
            team_id: "teamid1",
        }),
    ...
    const defaultProps = {
        ...
        actions: {
            loadChannels: jest
                .fn()
                .mockResolvedValue({ data: [channel1, channel2, channel3] }),
    ...
    test("should match snapshot", () => {
        ...
        wrapper.setState({ channels: [channel1, channel2, channel3] });
