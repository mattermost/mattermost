...
function validateSeats(
    ...
    let errorPrefix = (
        <FormattedMessage id="plan.self_serve" defaultMessage="Self-serve" />
    );
    if (cloud) {
        errorPrefix = (
            <FormattedMessage id="plan.cloud" defaultMessage="Cloud" />
        );
    }
...
export default function SeatsCalculator(props: Props) {
    ...
    const total =
        "$" +
        intl.formatNumber(
            (parseFloat(props.seats.quantity) || 0) * annualPricePerSeat,
        ...
        <div className="SeatsCalculator">
            <div className="SeatsCalculator__table">
                        ...
                        <div className="icon">
                            ...
                            >
                                <InformationOutlineIcon
                                    size={18}
                                    color={
                                        "rgba(var(--center-channel-text-rgb), 0.72)"
                                    }
                                />
                            </OverlayTrigger>
                        </div>
                ...
                <div className="SeatsCalculator__seats-item">
                    ...
                    <div className="SeatsCalculator__seats-value">{total}</div>
                </div>
                <div className="SeatsCalculator__total">
                    ...
                    <div className="SeatsCalculator__total-value">{total}</div>
                </div>
            </div>
        </div>
    );
