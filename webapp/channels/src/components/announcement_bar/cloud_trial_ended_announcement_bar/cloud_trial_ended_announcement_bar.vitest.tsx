...
describe('components/global/CloudTrialEndAnnouncementBar', () => {
    ...
    it('Should show banner when not on free trial with a trial_end_at in the past', () => {
        ...
        vi.useFakeTimers();
        vi.setSystemTime(new Date('2022-06-20'));
        ...
        // Check that banner text is shown
        expect(screen.queryByText(/Your free trial has ended/i) || screen.queryByText(/workspace/i)).toBeInTheDocument();
