...
const NotifyAdminDowngradeDelinquencyBar = () => {
    ...
    const { isDelinquencySubscriptionHigherThan90Days } =
        useDelinquencySubscription();
    ...
    const notifyAdminRequestData = {
        ...
        required_plan:
            CloudProductToSku[product?.sku] ||
            CloudProductToSku[CloudProducts.PROFESSIONAL],
    ...
    return (
        <AnnouncementBar
            ...
            modalButtonText={t(
                "cloud_delinquency.banner.end_user_notify_admin_button",
            )}
