...
const mockUseGetServerLimits = vi.fn();
const mockUseOpenPricingModal = vi.fn();
...
vi.mock('components/common/hooks/useGetServerLimits', () => ({
    __esModule: true,
    default: (...args: any[]) => mockUseGetServerLimits(...args),
}));

vi.mock('components/common/hooks/useOpenPricingModal', () => ({
    __esModule: true,
    default: (...args: any[]) => mockUseOpenPricingModal(...args),
}));
...
describe('components/announcement_bar/PostHistoryLimitBanner', () => {
    let mockOpenPricingModalFn: any;
    let mockToLocaleDateString: any;

    beforeEach(() => {
        vi.clearAllMocks();

        mockOpenPricingModalFn = vi.fn();
        mockUseOpenPricingModal.mockReturnValue({openPricingModal: mockOpenPricingModalFn});
    ...
    describe('User Interactions', () => {
        it('should call openPricingModal when upgrade button is clicked', () => {
            ...
            expect(mockOpenPricingModalFn).toHaveBeenCalled();
        });
