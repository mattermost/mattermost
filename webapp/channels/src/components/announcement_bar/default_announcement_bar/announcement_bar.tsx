    ...
    enableToolTipIfNeeded = () => {
        ...
        if (elm) {
            ...
            if (typeof this.props.message == "string") {
                this.setState({
                    isStringContainingUrl: isStringContainingUrl(
                        this.props.message,
                    ),
                });
            }
        ...
        return (
            ...
            >
                <OverlayTrigger
                    ...
                    delayHide={
                        this.state.isStringContainingUrl
                            ? OVERLAY_ANNOUNCEMENT_HIDE_DELAY
                            : 0
                    }
                >
                            ...
                            <span className="announcement-bar__link">
                                {this.props.showModal && (
                                    <FormattedMessage
                                        ...
                                        defaultMessage={
                                            this.props.modalButtonDefaultText
                                        }
                                    >
                                        {(linkmessage) => (
                                            <ToggleModalButton
                                                ariaLabel={
                                                    linkmessage as unknown as string
                                                }
                                                className={
                                                    "color--link--adminack"
                                                }
                                                ...
                                                onClick={() =>
                                                    trackEvent(
                                                        "admin",
                                                        "click_warn_metric_learn_more",
                                                    )
                                                }
                                                modalId={
                                                    ModalIdentifiers.WARN_METRIC_ACK
                                                }
                                                dialogProps={{
                                                    warnMetricStatus:
                                                        this.props
