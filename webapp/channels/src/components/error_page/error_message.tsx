                                ...
                                values={{
                                    link: (
                                        <ErrorLink
                                            ...
                                            messageId={t(
                                                "error.oauth_missing_code.google.link",
                                            )}
                            ...
                            <FormattedMessage
                                ...
                                values={{
                                    link: (
                                        <ErrorLink
                                            url={
                                                "https://docs.mattermost.com/deployment/sso-office.html"
                                            }
                                            messageId={t(
                                                "error.oauth_missing_code.office365.link",
                                            )}
                                ...
                                values={{
                                    link: (
                                        <ErrorLink
                                            ...
                                            messageId={t(
                                                "error.oauth_missing_code.gitlab.link",
                                            )}
                            ...
                            <FormattedMessage
                                ...
                                values={{
                                    link: (
                                        <ErrorLink
                                            url={
                                                "https://forum.mattermost.com/c/trouble-shoot"
                                            }
                                            messageId={t(
                                                "error.oauth_missing_code.forum.link",
                                            )}
                                            defaultMessage={
