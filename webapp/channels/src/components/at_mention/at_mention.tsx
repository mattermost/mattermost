...
} from "components/user_group_popover/group_member_list/group_member_list";
...
export const AtMention = (props: Props) => {
    ...
    if (user) {
        ...
        highlightMention =
            !props.disableHighlight && user.id === props.currentUserId;
    } else if (group) {
        // if statement needed for union
