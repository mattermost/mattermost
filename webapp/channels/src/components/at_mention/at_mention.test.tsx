...
describe("components/AtMention", () => {
    const baseProps = {
        ...
        usersByUsername: {
            ...
            "userdot.": TestHelper.getUserMock({
                id: "abc3",
                username: "userdot.",
                first_name: "Dot",
                last_name: "Matrix",
        ...
        groupsByName: {
            developers: TestHelper.getGroupMock({
                id: "qwerty1",
                name: "developers",
                allow_reference: true,
            }),
            marketing: TestHelper.getGroupMock({
                id: "qwerty2",
                name: "marketing",
                allow_reference: false,
            }),
            accounting: TestHelper.getGroupMock({
                id: "qwerty3",
                name: "accounting",
                allow_reference: true,
            }),
    ...
    test("should match snapshot when mentioning a group that is allowed reference", () => {
        const wrapper = shallow(
            <AtMention {...baseProps} mentionName="developers">
                {"(at)-developers"}
            </AtMention>,
        );
    ...
    test("should match snapshot when mentioning a group that is not allowed reference", () => {
        const wrapper = shallow(
            <AtMention {...baseProps} mentionName="marketing">
                {"(at)-marketing"}
            </AtMention>,
        );
