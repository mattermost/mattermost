...
const TrialBenefitsModal = ({
    ...
    const show = useSelector((state: GlobalState) =>
        isModalOpen(state, ModalIdentifiers.TRIAL_BENEFITS_MODAL),
    );
    ...
    const inAdminConsole =
        matchPath(pathname, { path: "/admin_console" }) != null;
    ...
    const trialEndDate = moment
        .unix(
            (Number(license?.ExpiresAt) ||
                new Date(Date.now()).getTime() + trialLicenseDuration) / 1000,
        )
        .format("MMMM,DD,YYYY");

    const buttonLabel = formatMessage({
        id: "learn_more_trial_modal_step.learnMoreAboutFeature",
        ...
        () => [
            {
                id: "useSso",
                title: formatMessage({
                    id: "trial_benefits.modal.useSsoTitle",
                    defaultMessage: "Use SSO (with OpenID, SAML, Google, O365)",
                }),
                description: formatMessage({
                    id: "trial_benefits.modal.useSsoDescription",
                    defaultMessage:
                ...
                svgElement: <GuestAccessSvg width={400} height={180} />,
            ...
            },
            {
                id: "ldap",
                title: formatMessage({
                    id: "trial_benefits.modal.ldapTitle",
                    defaultMessage:
                        "Synchronize your Active Directory/LDAP groups",
                }),
                description: formatMessage({
                    id: "trial_benefits.modal.ldapDescription",
                    defaultMessage:
                ...
                svgElement: <MonitorImacLikeSVG width={400} height={180} />,
            ...
            },
            {
                id: "systemConsole",
                title: formatMessage({
                    id: "trial_benefits.modal.systemConsoleTitle",
                    defaultMessage:
                        "Provide controlled access to the System Console",
                }),
                description: formatMessage({
                    id: "trial_benefits.modal.systemConsoleDescription",
                    defaultMessage:
                ...
                svgElement: <SystemRolesSVG width={400} height={180} />,
            ...
            },
            {
                id: "playbooks",
                title: formatMessage({
                    id: "trial_benefits.modal.playbooksTitle",
                    defaultMessage: "Playbooks get superpowers",
                }),
                description: formatMessage({
                    id: "trial_benefits.modal.playbooksDescription",
                    defaultMessage:
                ...
                svgElement: <PersonWithChecklistSvg width={250} height={200} />,
                pageURL: "/playbooks/start",
                buttonLabel: formatMessage({
                    id: "trial_benefits.modal.playbooksButton",
    ...
    let trialJustStartedTitle = formatMessage({
        id: "trial_benefits.modal.trialStartTitle",
        defaultMessage:
            "Your trial has started! Explore the benefits of Enterprise",
    });

    if (isCloud) {
        trialJustStartedTitle = formatMessage({
            id: "trial_benefits.modal.trialStartTitleCloud",
    ...
    const trialJustStartedDeclaration = {
        ...
        svgElement: <HandsSvg width={200} height={100} />,
        bottomLeftMessage: formatMessage({
            id: "trial_benefits.modal.onlyVisibleToAdmins",
    ...
    const handleOnPrevNextSlideClick = useCallback(
        (slideIndex: number) => {
    ...
    const trialJustStartedScreen = ({
        ...
        if (isCloud && !inAdminConsole) {
            actionButton = (
                <a className="primary-button" onClick={invitePeople}>
                    <FormattedMessage
