...
> {
    ...
    constructor(props: TermsOfServiceProps) {
        ...
        this.formattedText = memoizeResult((text: string) =>
            formatText(text, {}, props.emojiMap),
        );
    }
    ...
    registerUserAction = async (
        accepted: boolean,
        success: (data: UpdateMyTermsOfServiceStatusResponse) => void,
    ): Promise<void> => {
