...
export default class CreateUserGroupsModal extends React.PureComponent<
    Props,
    State
> {
    ...
    isSaveEnabled = () => {
        return (
            ...
            this.state.mention.length > 0 &&
            this.state.usersToAdd.length > 0
        );
    };
    ...
    createGroup = async (users?: UserProfile[]) => {
        ...
        if (!displayName || !displayName.trim()) {
            this.setState({
                nameInputErrorText: Utils.localizeMessage(
        ...
        if (mention.length < 1) {
            this.setState({
                mentionInputErrorText: Utils.localizeMessage(
                    ...
                    <div className="user-groups-modal__content">
                        <div className="group-name-input-wrapper">
                            <Input
                                ...
                                customMessage={{
                                    ...
                                    value: this.state.nameInputErrorText,
                                }}
                            />
                        </div>
                        <div className="group-mention-input-wrapper">
                            <Input
                                ...
                                customMessage={{
                                    type: ItemStatus.ERROR,
                                    value: this.state.mentionInputErrorText,
                                }}
                            />
                        </div>
                        <h2>
                        ...
                        <div className="group-add-user">
                            <AddUserToGroupMultiSelect
                                ...
                                backButtonText={localizeMessage(
                                    "multiselect.cancelButton",
                                    "Cancel",
                                )}
                                backButtonClick={
                                    typeof this.props.backButtonCallback ===
                                    "function"
                                        ? this.goBack
                                        : this.doHide
                                }
