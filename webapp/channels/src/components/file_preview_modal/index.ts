...
const FilePreviewModal = makeAsyncComponent(
    "FilePreviewModal",
    React.lazy<React.ComponentType<Props>>(
        () => import("./file_preview_modal"),
    ),
);
...
function mapStateToProps(state: GlobalState, ownProps: OwnProps) {
    ...
    return {
        ...
        pluginFilePreviewComponents: state.plugins.components
            .FilePreview as unknown as FilePreviewComponent[],
