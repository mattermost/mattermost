...
const Column = ({
    ...
    return (
        <div
            ...
            tabIndex={0}
        >
            <div className="content-layout-column-svg">{SVGElement}</div>
            <h1 className="content-layout-column-title">{title}</h1>
            <p className="content-layout-column-message">{message}</p>
            {extraContent && (
