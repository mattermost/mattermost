...
describe("components/EditChannelHeaderModal", () => {
    ...
    test("should match snapshot, init", () => {
        const wrapper = shallow(<EditChannelHeaderModal {...baseProps} />);
    ...
    test("edit direct message channel", () => {
        ...
        const wrapper = shallow(
            <EditChannelHeaderModal {...baseProps} channel={dmChannel} />,
        );
    ...
    describe("handleSave", () => {
        ...
        test("on error, should not close modal and set server error state", async () => {
            baseProps.actions.patchChannel.mockResolvedValueOnce({
                error: serverError,
            });
    ...
    test("change header", () => {
        ...
        wrapper
            .find(Textbox)
            .simulate("change", { target: { value: "header" } });
    ...
    test("patch on save button click", () => {
        ...
        expect(baseProps.actions.patchChannel).toBeCalledWith("fake-id", {
            header: newHeader,
        });
    });
    ...
    test("patch on enter keypress event with ctrl", () => {
        const wrapper = shallow(
            <EditChannelHeaderModal {...baseProps} ctrlSend={true} />,
        );
    ...
    test("should show error only for invalid length", () => {
        ...
        wrapper.find(Textbox).simulate("change", {
            target: {
        ...
        expect(wrapper.state("serverError")).toStrictEqual({
        ...
        wrapper
            .find(Textbox)
            .simulate("change", { target: { value: "valid header" } });
