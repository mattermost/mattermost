...
describe("PostEmoji", () => {
    ...
    test("should render image when imageUrl is provided", () => {
        ...
        expect(
            screen.getByTitle(":" + baseProps.name + ":"),
        ).toBeInTheDocument();
        expect(screen.getByTitle(":" + baseProps.name + ":")).toHaveStyle(
    ...
    test("should render shortcode text within span when imageUrl is provided", () => {
        ...
        expect(screen.getByTitle(":" + baseProps.name + ":")).toHaveTextContent(
            `:${baseProps.name}:`,
        );
    });
    ...
    test("should render original text when imageUrl is empty", () => {
        ...
        expect(
            screen.queryByTitle(":" + baseProps.name + ":"),
