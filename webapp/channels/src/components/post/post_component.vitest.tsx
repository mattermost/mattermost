...
import {renderWithContext, screen, userEvent, act} from 'tests/vitest_react_testing_utils';
...
describe('PostComponent', () => {
    ...
    const baseProps: Props = {
        ...
        actions: {
            ...
            selectPost: vi.fn(),
            selectPostFromRightHandSideSearch: vi.fn(),
            removePost: vi.fn(),
            closeRightHandSide: vi.fn(),
            selectPostCard: vi.fn(),
            setRhsExpanded: vi.fn(),
            revealBurnOnReadPost: vi.fn(),
        },
    };
    ...
    describe('thread footer', () => {
        ...
        describe('reply/X replies link', () => {
            ...
            beforeEach(() => {
                vi.mocked(propsForRootPost.actions.selectPostFromRightHandSideSearch).mockClear();
                vi.mocked(getHistory().push).mockClear();
            });
