            ...
            buttonRender = (
                <span>
                    ...
                    <button
                        ...
                        aria-label={intl.formatMessage({id: 'setting_picture.select', defaultMessage: 'Select'})}
                    >
                        <FormattedMessage
                    ...
                    <button
                        ...
                        aria-label={this.props.loadingPicture ? intl.formatMessage({id: 'setting_picture.uploading', defaultMessage: 'Uploading...'}) : intl.formatMessage({id: 'setting_picture.save', defaultMessage: 'Save'})}
                    >
                        <LoadingWrapper
                    ...
                    >
                        ...
                        >
                            ...
                            <button
                                ...
                                aria-label={intl.formatMessage({id: 'setting_picture.cancel', defaultMessage: 'Cancel'})}
                            >
                                <FormattedMessage
