...
describe("components/ReactionList", () => {
    ...
    test("should render nothing when no reactions", () => {
        ...
        const wrapper = shallow<ReactionList>(<ReactionList {...props} />);

        expect(wrapper).toMatchSnapshot();
    });

    test("should render when there are reactions", () => {
        const wrapper = shallow<ReactionList>(<ReactionList {...baseProps} />);
    ...
    */
    test("should render consistently when reactions from state are not in the same order", () => {
        ...
        const reactionB = {
            ...reaction,
            emoji_name: "+1",
            create_at: reaction.create_at + 100,
        };
        const reactionC = {
            ...reaction,
            user_id: "x8pb0",
            create_at: reaction.create_at + 200,
        };
        ...
        const wrapper = shallow<ReactionList>(<ReactionList {...propsA} />);
