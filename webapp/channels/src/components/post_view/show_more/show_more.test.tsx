...
describe('components/post_view/ShowMore', () => {
    ...
    test('should match snapshot, PostMessageView on collapsed view with ellipsis overflow', async () => {
        const ref = React.createRef<ShowMore>();
        const {container} = await renderWithContext(
            <ShowMore
                {...baseProps}
    ...
    test('should match snapshot, PostMessageView on expanded view with ellipsis overflow', async () => {
        const ref = React.createRef<ShowMore>();
        const {container} = await renderWithContext(
            <ShowMore
                {...baseProps}
