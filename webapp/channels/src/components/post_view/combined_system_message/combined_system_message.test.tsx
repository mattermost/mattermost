...
describe("components/post_view/CombinedSystemMessage", () => {
    ...
    const baseProps = {
        ...
        userProfiles,
        actions: {
            getMissingProfilesByIds: emptyFunc as unknown as (
                userIds: string[],
            ) => ActionFunc,
            getMissingProfilesByUsernames: emptyFunc as unknown as (
                usernames: string[],
            ) => ActionFunc,
        },
    };
    ...
    test("should match snapshot when join leave messages are turned off", () => {
        const wrapper = shallowWithIntl(
            <CombinedSystemMessage {...baseProps} showJoinLeave={false} />,
        );
    ...
    test('should match snapshot, "removed from channel" message when join leave messages are turned off', () => {
        ...
        const wrapper = shallowWithIntl(<CombinedSystemMessage {...props} />);
    ...
    test("should call getMissingProfilesByIds and/or getMissingProfilesByUsernames on loadUserProfiles", () => {
        ...
        expect(
            props.actions.getMissingProfilesByUsernames,
