...
describe("PostList", () => {
    ...
    describe("renderRow", () => {
        ...
        test("should highlight the focused post", () => {
            ...
            expect(row.find(PostListRow).prop("shouldHighlight")).toEqual(
                false,
            );
    ...
    describe("onScroll", () => {
        ...
        test("should call canLoadMorePosts with AFTER_ID if loader is visible", () => {
            ...
            expect(baseProps.actions.canLoadMorePosts).toHaveBeenCalledWith(
    ...
    describe("Scroll correction logic on mount of posts at the top", () => {
        test("should return previous scroll position from getSnapshotBeforeUpdate", () => {
            ...
            expect(
                (instance.componentDidUpdate as jest.Mock).mock.calls[1][2],
            ).toEqual({ previousScrollTop: 10, previousScrollHeight: 100 });
            ...
            expect(
                (instance.componentDidUpdate as jest.Mock).mock.calls[2][2],
            ).toEqual({ previousScrollTop: 30, previousScrollHeight: 200 });
        });
    ...
    describe("renderRow", () => {
        test("should have appropriate classNames for rows with START_OF_NEW_MESSAGES and DATE_LINE", () => {
            ...
            expect(post5Row.prop("className")).toEqual(
                "post-row__padding bottom",
            );
        });
    ...
    describe("postIds state", () => {
        test("should have LOAD_NEWER_MESSAGES_TRIGGER and LOAD_OLDER_MESSAGES_TRIGGER", () => {
            ...
            expect(postListIdsState[0]).toBe(
                PostListRowListIds.LOAD_NEWER_MESSAGES_TRIGGER,
            );
            expect(postListIdsState[postListIdsState.length - 1]).toBe(
                PostListRowListIds.LOAD_OLDER_MESSAGES_TRIGGER,
            );
        });
    });
    ...
    describe("initScrollToIndex", () => {
        test("return date index if it is just above new message line", () => {
            ...
            expect(initScrollToIndex).toEqual({
                index: 6,
                position: "start",
                offset: -50,
            });
