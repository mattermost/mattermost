...
describe("LatestPostReader", () => {
    ...
    test("should render aria-label as a child in the given locale", () => {
        ...
        (useIntl as jest.Mock).mockImplementation(() =>
            createIntl({
                locale: "en",
                messages: enMessages,
                defaultLocale: "en",
        ...
        const prevMessage = screen.getByText(
            `January 1, ${author.username} wrote, This is a test`,
            { exact: false },
        );
        ...
        const message = screen.getByText(
            `${januaryInSpanish}, ${author.username} wrote, This is a test`,
            { exact: false },
        );
