    ...
    return (
        <>
            ...
            <div className="LessThanMaxFreeUsers">
                <EmptyStateThemeableSvg width={128} height={113} />
...
const MoreThanMaxFreeUsers = ({
    ...
    const modalId = channel.group_constrained
        ? ModalIdentifiers.ADD_GROUPS_TO_CHANNEL
        : ModalIdentifiers.CHANNEL_INVITE;
    const modal = channel.group_constrained
