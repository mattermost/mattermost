...
const PostMessagePreview = (props: Props) => {
    ...
    let avatar = (
        <Avatar size={"sm"} url={src} className={"avatar-post-preview"} />
    );
    ...
    if (
        metadata.channel_type === General.DM_CHANNEL ||
        metadata.channel_type === General.GM_CHANNEL
    ) {
        teamUrl = currentTeamUrl;
    }

    const previewFooter =
        channelDisplayName || previewFooterMessage ? (
                ...
                <div className="post-preview__header">
                    ...
                    >
                        <UserProfileComponent
                            ...
                            disablePopover={true}
                            overwriteName={
                                previewPost.props?.override_username || ""
                            }
                        />
                    </div>
