...
describe("components/post_view/index", () => {
    ...
    test("should return true if channel or if team data is not present", () => {
        expect(isChannelLoading({}, { id: "channelId" } as Channel)).toEqual(
            true,
        );
        expect(
            isChannelLoading({}, undefined, { id: "teamId" } as Team),
        ).toEqual(true);
    });
    ...
    test("should return true if channel is a DM and indetifier is not the same as teammate name", () => {
        ...
        expect(
            isChannelLoading(
                { identifier: "otherUsername" },
                channel,
                { id: "teamId" } as Team,
                { username: "diffrentName" } as UserProfile,
            ),
        ).toEqual(true);
    });
    ...
    test("should return true if channel is a GM and indetifier is not the same as channel name", () => {
        ...
        expect(
            isChannelLoading({ identifier: "notTheSameName" }, channel, {
                id: "teamId",
            } as Team),
        ).toEqual(true);
    });
    ...
    test("should return true if channel team id is not the same as current team id", () => {
        ...
        expect(
            isChannelLoading({ identifier: "username" }, channel, {
                id: "teamId",
            } as Team),
        ).toEqual(false);
    });
    ...
    test("should return true if teamMemberships exist but team is not part of membership", () => {
        ...
        expect(
            isChannelLoading(
                ...
                { id: "teamId" } as Team,
                undefined,
                { differentTeamId: {} as TeamMembership },
            ),
        ).toEqual(true);
    });
});
