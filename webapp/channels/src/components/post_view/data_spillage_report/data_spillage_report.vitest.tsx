...
const {
    ...
    mockedUsePost,
    mockGetPost,
    mockedUseContentFlaggingFields,
    mockedUsePostContentFlaggingValues,
    mockedUsePropertyCardViewChannelLoader,
    mockedUsePropertyCardViewTeamLoader,
    mockedUsePropertyCardViewPostLoader,
} = vi.hoisted(() => ({
    mockedUseUser: vi.fn(),
    mockUseChannel: vi.fn(),
    mockedUsePost: vi.fn(),
    mockGetPost: vi.fn(),
    mockedUseContentFlaggingFields: vi.fn(),
    mockedUsePostContentFlaggingValues: vi.fn(),
    mockedUsePropertyCardViewChannelLoader: vi.fn(),
    mockedUsePropertyCardViewTeamLoader: vi.fn(),
    mockedUsePropertyCardViewPostLoader: vi.fn(),
}));

vi.mock('components/common/hooks/useUser', () => ({
...
vi.mock('components/common/hooks/usePost', () => ({
    usePost: mockedUsePost,
}));
vi.mock('mattermost-redux/actions/posts', () => ({
    getPost: mockGetPost,
}));
vi.mock('components/common/hooks/useContentFlaggingFields', () => ({
    useContentFlaggingFields: mockedUseContentFlaggingFields,
    usePostContentFlaggingValues: mockedUsePostContentFlaggingValues,
}));
vi.mock('components/common/hooks/usePropertyCardViewChannelLoader', () => ({
    usePropertyCardViewChannelLoader: mockedUsePropertyCardViewChannelLoader,
}));
vi.mock('components/common/hooks/usePropertyCardViewTeamLoader', () => ({
    usePropertyCardViewTeamLoader: mockedUsePropertyCardViewTeamLoader,
}));
vi.mock('components/common/hooks/usePropertyCardViewPostLoader', () => ({
    usePropertyCardViewPostLoader: mockedUsePropertyCardViewPostLoader,
}));
...
describe('components/post_view/data_spillage_report/DataSpillageReport', () => {
    ...
    beforeEach(() => {
        ...
        mockGetPost.mockResolvedValue({type: 'MOCK_ACTION', data: reportedPost} as any);

        mockedUseContentFlaggingFields.mockReturnValue(contentFlaggingFields as any);
        mockedUsePostContentFlaggingValues.mockReturnValue(postContentFlaggingValues as any);
        mockedUsePropertyCardViewChannelLoader.mockReturnValue(reportedPostChannel);
        mockedUsePropertyCardViewTeamLoader.mockReturnValue(reportedPostTeam);
        mockedUsePropertyCardViewPostLoader.mockReturnValue(reportedPost);

        Client4.getFlaggedPost = vi.fn().mockResolvedValue(reportedPost);
        Client4.getChannel = vi.fn().mockResolvedValue(reportedPostChannel);
    });
