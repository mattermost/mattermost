...
describe('components/CommentedOnFilesMessage', () => {
    test('component state when no files', async () => {
        render(
    ...
    test('should match component state for single file', async () => {
        const fileInfos = [
    ...
    test('should match component state for multiple files', async () => {
        const fileInfos = [
