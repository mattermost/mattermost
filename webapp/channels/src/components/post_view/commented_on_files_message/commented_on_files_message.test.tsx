...
describe("components/CommentedOnFilesMessage", () => {
    ...
    test("component state when no files", () => {
        render(<CommentedOnFilesMessage {...baseProps} />);
    ...
    test("should match component state for single file", () => {
        ...
        render(<CommentedOnFilesMessage {...props} />);
    ...
    test("should match component state for multiple files", () => {
        ...
        renderWithIntl(<CommentedOnFilesMessage {...props} />);

        // total files = 3
        expect(screen.getByTestId("fileInfo")).toHaveTextContent(
            "image_3.png plus 2 other files",
        );
    });
});
