...
describe('components/AboutBuildModal', () => {
    ...
    beforeEach(() => {
        ...
        vi.spyOn(Client4, 'getLicenseLoadMetric').mockResolvedValue({load: 0});
    ...
    test('should show load metric when license is loaded and API returns data', async () => {
        ...
        vi.spyOn(Client4, 'getLicenseLoadMetric').mockResolvedValue({load: 75});
    ...
    test('should handle API errors gracefully', async () => {
        ...
        vi.spyOn(Client4, 'getLicenseLoadMetric').mockRejectedValue(new Error('API error'));
