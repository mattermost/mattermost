...
import type {
    DialogSubmission,
    DialogElement as TDialogElement,
...
> {
    ...
    render() {
        const { title, introductionText, iconUrl, submitLabel, elements } =
            this.props;
            ...
            >
                <form onSubmit={this.handleSubmit} autoComplete={"off"}>
                    <Modal.Header
                        closeButton={true}
                        style={{
                            borderBottom: elements == null ? "0px" : undefined,
                        }}
                    >
                        <Modal.Title
                            componentClass="h1"
