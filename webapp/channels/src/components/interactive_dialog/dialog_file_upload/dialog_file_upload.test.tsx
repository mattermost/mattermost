...
import type {Props} from './dialog_file_upload';
...
function renderComponent(overrides: Partial<Props> = {}) {
    ...
    return renderWithContext(<DialogFileUpload {...props}/>);
}
...
describe('components/interactive_dialog/dialog_file_upload/DialogFileUpload', () => {
    beforeEach(() => {
        jest.clearAllMocks();
        mockIdCounter = 0;
    });
