...
export const shouldSnapWhenSizeGrown = (
    newWidth: number,
    prevWidth: number,
    defaultWidth: number,
) => {
...
export const shouldSnapWhenSizeShrunk = (
    newWidth: number,
    prevWidth: number,
    defaultWidth: number,
) => {
...
export const shouldRhsOverlapChannelView = (size: SidebarSize) =>
