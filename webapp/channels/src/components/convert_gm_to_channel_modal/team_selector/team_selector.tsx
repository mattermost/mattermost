...
const TeamSelector = (props: Props): JSX.Element => {
    ...
    const teamValues = Object.values(props.teamsById)
        ...
        .sort((teamA, teamB) =>
            teamA.label.localeCompare(teamB.label, currentLocale),
        );
    ...
    return (
        <DropdownInput
            ...
            value={
                value
                    ? { label: value.display_name, value: value.id }
                    : undefined
            }
            options={teamValues}
            legend={formatMessage({
                id: "sidebar_left.sidebar_channel_modal.select_team_placeholder",
