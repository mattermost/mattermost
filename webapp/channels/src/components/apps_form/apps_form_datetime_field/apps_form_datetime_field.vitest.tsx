...
vi.mock('mattermost-redux/selectors/entities/timezone', () => ({
    getCurrentTimezone: vi.fn().mockReturnValue('America/New_York'),
}));

vi.mock('components/datetime_input/datetime_input', () => ({
    __esModule: true,
    ...
    getRoundedTime: vi.fn().mockImplementation((value: any) => value),
}));
