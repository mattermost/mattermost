...
export default function PurchaseInProgressModal(props: Props) {
    ...
    const purchaserUser = useSelector((state: GlobalState) =>
        getUserByEmail(state, props.purchaserEmail),
    );
    const header = (
        <FormattedMessage
    ...
    const sameUserAlreadyPurchasing =
        props.purchaserEmail === currentUser.email;
    ...
    return (
        ...
        >
            <div className="PurchaseInProgressModal__body">
                <CreditCardSvg height={350} width={350} />
