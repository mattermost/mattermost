// Copyright (c) 2015-present Nimbupani, Inc. All Rights Reserved.
        ...
        return (
            <p className="signup-body-message-subtitle">
                {formatMessage({
                    ...
                    defaultMessage:
                        "Create your Nimbupani account to start collaborating with your team",
                })}
            </p>
        );
    };
                    ...
                    text={formatMessage(
                        {
                            ...
                            defaultMessage:
                                "<span>I would like to receive Nimbupani security updates via newsletter.</span> By subscribing, I consent to receive emails from Nimbupani with product updates, promotions, and company news. I have read the <a>Privacy Policy</a> and understand that I can <aa>unsubscribe</aa> at any time",
                        },
                        {
                            a: (
            ...
            <div className="newsletter">
                {/* <span className="interested">
                    {formatMessage({
                        ...
                        defaultMessage:
                            "Interested in receiving Nimbupani security, product, promotions, and company updates updates via newsletter?",
                    })}
                </span>
                <span className="link">
                    {formatMessage(
