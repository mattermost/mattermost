...
describe("components/integrations/InstalledOutgoingWebhooks", () => {
    ...
    const defaultProps: ComponentProps<typeof InstalledOutgoingWebhooks> = {
        ...
        actions: {
            ...
            loadOutgoingHooksAndProfilesForTeam: jest
                .fn()
    ...
    test("should call regenOutgoingHookToken function", () => {
        ...
        expect(
            defaultProps.actions.regenOutgoingHookToken,
        ).toHaveBeenCalledTimes(1);
        expect(
            defaultProps.actions.regenOutgoingHookToken,
        ).toHaveBeenCalledWith(outgoingWebhooks[0].id);
    });
    ...
    test("should call removeOutgoingHook function", () => {
        ...
        expect(defaultProps.actions.removeOutgoingHook).toHaveBeenCalledTimes(
            1,
        );
        expect(defaultProps.actions.removeOutgoingHook).toHaveBeenCalledWith(
            outgoingWebhooks[1].id,
        );
