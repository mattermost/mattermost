...
describe("components/integrations/AbstractCommand", () => {
    ...
    test("should match snapshot", () => {
        const wrapper = shallowWithIntl(<AbstractCommand {...baseProps} />);
    ...
    test("should match snapshot, displays client error", () => {
        ...
        const wrapper = shallowWithIntl(<AbstractCommand {...props} />);
    ...
    test("should match state when method is called", () => {
        ...
        const trueUpdateAutocompleteEvent = {
            target: { checked: true },
        } as any;
        const falseeUpdateAutocompleteEvent = {
        ...
        const autocompleteHintEvent = {
            preventDefault: jest.fn(),
            target: { value: autocompleteHint },
        } as any;
        ...
        const autocompleteDescriptionEvent = {
            preventDefault: jest.fn(),
    ...
    test("should match state when handleSubmit is called", () => {
        ...
        const evt = {
            preventDefault: jest.fn(),
        } as unknown as FormEvent<Element>;
