...
export default class InstalledOAuthApps extends React.PureComponent<Props, State> {
    ...
    oauthAppCompare(a: OAuthApp, b: OAuthApp): number {
        ...
        if (!nameA) {
            nameA = intl.formatMessage({id: 'installed_integrations.unnamed_oauth_app', defaultMessage: 'Unnamed OAuth 2.0 Application'});
        }

        let nameB = b.name.toString();
        if (!nameB) {
            nameB = intl.formatMessage({id: 'installed_integrations.unnamed_oauth_app', defaultMessage: 'Unnamed OAuth 2.0 Application'});
        }
    ...
    render() {
        ...
        if (integrationsEnabled) {
            props = {
                ...
                addText: intl.formatMessage({id: 'installed_oauth_apps.add', defaultMessage: 'Add OAuth 2.0 Application'}),
        ...
        return (
            <BackstageList
                ...
                searchPlaceholder={intl.formatMessage({id: 'installed_oauth_apps.search', defaultMessage: 'Search OAuth 2.0 Applications'})}
