...
describe('components/integrations/ConfirmIntegration', () => {
    ...
    test('should match snapshot, oauthApps case', () => {
        const newProps = {...props, location: {search: getSearchString('oauth2-apps')}};
        const {container} = renderWithContext(
            <ConfirmIntegration {...newProps}/>,
            initialState,
        );
    ...
    test('should match snapshot, outgoingOAuthConnections case', () => {
        const newProps = {...props, location: {search: getSearchString('outgoing-oauth2-connections')}};
        const {container} = renderWithContext(
            <ConfirmIntegration {...newProps}/>,
            initialState,
        );
    ...
    test('should match snapshot, commands case', () => {
        const newProps = {...props, location: {search: getSearchString('commands')}};
        const {container} = renderWithContext(
            <ConfirmIntegration {...newProps}/>,
            initialState,
        );
    ...
    test('should match snapshot, incomingHooks case', () => {
        const newProps = {...props, location: {search: getSearchString('incoming_webhooks')}};
        const {container} = renderWithContext(
            <ConfirmIntegration {...newProps}/>,
            initialState,
        );
    ...
    test('should match snapshot, outgoingHooks case', () => {
        const newProps = {...props, location: {search: getSearchString('outgoing_webhooks')}};
        const {container} = renderWithContext(
            <ConfirmIntegration {...newProps}/>,
            initialState,
        );
    ...
    test('should match snapshot, outgoingHooks and bad identifier case', () => {
        const newProps = {...props, location: {search: getSearchString('outgoing_webhooks', 'bad')}};
        const {container} = renderWithContext(
            <ConfirmIntegration {...newProps}/>,
            initialState,
        );
    ...
    test('should match snapshot, bad integration type case', () => {
        const newProps = {...props, location: {search: getSearchString('bad')}};
        const {container} = renderWithContext(
            <ConfirmIntegration {...newProps}/>,
            initialState,
        );
