                            ...
                            cards={[
                                {
                                    ...
                                    tooltip: formatMessage({
                                        ...
                                        defaultMessage:
                                            "Subscribe to repositories, stay up to date with reviews, assignments",
                                    }),
                                },
                                {
                                ...
                                {
                                    onClick: () =>
                                        props.setOption("servicenow"),
                                    icon: <ServiceNowSVG />,
                                    id: t(
                                        "onboarding_wizard.plugins.servicenow",
                                    ),
                                        ...
                                        a: (
                                            ...
                                            <strong>
                                                <ExternalLink
                                                    ...
                                                    onClick={
                                                        props.handleVisitMarketPlaceClick
                                                    }
                                                >
                                                    {chunks}
                                                </ExternalLink>
