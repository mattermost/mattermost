...
> {
    ...
    handleConfirm = () => {
        ...
        if (this.props.categoryId) {
            this.props.actions.renameCategory(
    ...
    isConfirmDisabled = () => {
        return (
            !this.state.categoryName ||
            (Boolean(this.props.initialCategoryName) &&
                this.props.initialCategoryName === this.state.categoryName) ||
            this.state.categoryName.length > MAX_LENGTH
        );
    };
    ...
    render() {
        const { modalHeaderText, editButtonText, helpText } = this.getText();

        return (
            <GenericModal
                id="editCategoryModal"
                ariaLabel={localizeMessage(
                    "rename_category_modal.renameCategory",
                    "Rename Category",
                )}
            ...
            >
                <QuickInput
                    ...
                    placeholder={localizeMessage(
                        "edit_category_modal.placeholder",
                        "Name your category",
                    )}
                    clearable={true}
                ...
                />
                {Boolean(helpText) && (
                    <span className="edit-category__helpText">{helpText}</span>
                )}
            </GenericModal>
        );
    }
