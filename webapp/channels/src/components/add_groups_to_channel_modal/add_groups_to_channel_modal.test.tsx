...
describe("components/AddGroupsToChannelModal", () => {
    const baseProps: Props = {
        ...
        onExited: jest.fn(),
        actions: {
            getGroupsNotAssociatedToChannel: jest
                .fn()
            ...
            getAllGroupsAssociatedToChannel: jest
                .fn()
                .mockResolvedValue({ data: true }),
    ...
    test("should match snapshot", () => {
        const wrapper = shallow(<AddGroupsToChannelModal {...baseProps} />);
    ...
    test("should match state when handleSubmit is called", async () => {
        const linkGroupSyncable = jest
            .fn()
            .mockResolvedValue({ error: true, data: true });
        const actions = { ...baseProps.actions, linkGroupSyncable };
        const props = { ...baseProps, actions };
        const wrapper = shallow(<AddGroupsToChannelModal {...props} />);
        const instance = wrapper.instance() as AddGroupsToChannelModal;
    ...
    test("should match state when handlePageChange is called", () => {
        ...
        expect(
            baseProps.actions.getGroupsNotAssociatedToChannel,
    ...
    test("should match when renderOption is called", () => {
        ...
        const instance = wrapper.instance() as AddGroupsToChannelModal;
        expect(
            instance.renderOption(option, isSelected, onAdd),
        ).toMatchSnapshot();
        ...
        expect(
            instance.renderOption(optionBot, isSelected, onAdd),
        ).toMatchSnapshot();
    });
    ...
    test("should match when renderValue is called", () => {
        ...
        expect(
            (wrapper.instance() as AddGroupsToChannelModal).renderValue({
