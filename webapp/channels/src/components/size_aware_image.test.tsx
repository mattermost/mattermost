...
describe('components/SizeAwareImage', () => {
    ...
    test('should render an svg when first mounted with dimensions and img display set to none', async () => {
        const {container} = await renderWithContext(<SizeAwareImage {...baseProps}/>, state);
    ...
    test('img should have inherited class name from prop', async () => {
        const {container} = await renderWithContext(<SizeAwareImage {...{...baseProps, className: 'imgClass'}}/>, state);

        const img = container.querySelector('img');
        expect(img?.className).toEqual('imgClass');
    });

    test('should render a placeholder and has loader when showLoader is true', async () => {
        const props = {
            ...baseProps,
            showLoader: true,
        };
    ...
    test('should render a mini preview when showLoader is true and preview is set', async () => {
        const props = {
            ...baseProps,
            fileInfo: TestHelper.getFileInfoMock({
                ...baseProps.fileInfo,
    ...
    test('should render the actual image when first mounted without dimensions', async () => {
    ...
    test('should call onImageLoadFail when image load fails and should have svg', async () => {
        const {container} = await renderWithContext(<SizeAwareImage {...baseProps}/>, state);
    ...
    test('should match snapshot when handleSmallImageContainer prop is passed', async () => {
        const props = {
            ...baseProps,
    ...
    test('should properly set container div width for wider small image', async () => {
        const props = {
            ...baseProps,
            handleSmallImageContainer: true,
    ...
    test('should load download and copy link buttons when an image is mounted', async () => {
    ...
    test('should load download hyperlink with href set to fileURL', async () => {
        const fileURL = 'https://example.com/image.png';
        const props = {
            ...baseProps,
            fileURL,
    ...
    test('clicking the copy button calls getFilePublicLink', async () => {
        const fileURL = 'https://example.com/image.png';
    ...
    test('does not render copy button if enablePublicLink is false', async () => {
        const props = {
            ...baseProps,
