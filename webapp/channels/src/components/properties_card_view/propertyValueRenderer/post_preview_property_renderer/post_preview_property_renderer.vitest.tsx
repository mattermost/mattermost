...
import {renderWithContext, waitFor, act} from 'tests/vitest_react_testing_utils';
...
vi.mock('components/common/hooks/useChannel');
vi.mock('components/common/hooks/use_team');
vi.mock('components/common/hooks/usePost');
vi.mock('mattermost-redux/client');

const mockUseChannel = useChannel as ReturnType<typeof vi.fn>;
const mockUseTeam = useTeam as ReturnType<typeof vi.fn>;
const mockedUsePost = usePost as ReturnType<typeof vi.fn>;
...
describe('PostPreviewPropertyRenderer', () => {
    ...
    it('should return null when post is not found', async () => {
        // Suppress expected console.log from the component
