...
vi.mock('./text_property_renderer/textPropertyRenderer', () => {
    return {
        default: function MockTextPropertyRenderer({value}: {value: PropertyValue<unknown>}) {
            return <div data-testid='mock-text-property'>{String(value.value)}</div>;
        },
    };
});

vi.mock('./user_property_renderer/userPropertyRenderer', () => {
    return {
        default: function MockUserPropertyRenderer({value}: {field: PropertyField; value: PropertyValue<unknown>}) {
            return <div data-testid='mock-user-property'>{String(value.value)}</div>;
        },
    };
});

vi.mock('./select_property_renderer/selectPropertyRenderer', () => {
    return {
        default: function MockSelectPropertyRenderer({value}: {field: PropertyField; value: PropertyValue<unknown>}) {
            return <div data-testid='mock-select-property'>{String(value.value)}</div>;
        },
    };
});

vi.mock('./post_preview_property_renderer/post_preview_property_renderer', () => {
    return {
        default: function MockPostPreviewPropertyRenderer({value}: {value: PropertyValue<unknown>}) {
            return <div data-testid='mock-post-preview-property'>{String(value.value)}</div>;
        },
    };
});

vi.mock('./channel_property_renderer/channel_property_renderer', () => {
    return {
        default: function MockChannelPropertyRenderer({value}: {value: PropertyValue<unknown>}) {
            return <div data-testid='mock-channel-property'>{String(value.value)}</div>;
        },
    };
});

vi.mock('./team_property_renderer/team_property_renderer', () => {
    return {
        default: function MockTeamPropertyRenderer({value}: {value: PropertyValue<unknown>}) {
            return <div data-testid='mock-team-property'>{String(value.value)}</div>;
        },
    };
});

vi.mock('./timestamp_property_renderer/timestamp_property_renderer', () => {
    return {
        default: function MockTimestampPropertyRenderer({value}: {value: PropertyValue<unknown>}) {
