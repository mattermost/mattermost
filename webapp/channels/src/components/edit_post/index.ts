...
function mapStateToProps(state: GlobalState) {
    ...
    return {
        canEditPost: haveIChannelPermission(
            state,
            teamId,
            channelId,
            editPermission,
        ),
        canDeletePost: haveIChannelPermission(
            state,
            teamId,
            channelId,
            deletePermission,
        ...
        channelId,
        maxPostSize:
            parseInt(config.MaxPostSize || "0", 10) ||
