...
const AboutAreaChannel = ({
    ...
    return (
        <>
                            ...
                            channel.purpose && (
                                <LineLimiter
                                    ...
                                    moreText={formatMessage({
                                        id: "channel_info_rhs.about_area.channel_purpose.line_limiter.more",
                                        defaultMessage: "more",
                                    })}
                                    lessText={formatMessage({
                                        id: "channel_info_rhs.about_area.channel_purpose.line_limiter.less",
                                        defaultMessage: "less",
                                    })}
                                >
                        ...
                        content={
                            channel.header && (
                                <LineLimiter
                                    ...
                                    lineHeight={20}
                                    moreText={formatMessage({
                                        id: "channel_info_rhs.about_area.channel_header.line_limiter.more",
                                        defaultMessage: "more",
                                    })}
                                    lessText={formatMessage({
                                        id: "channel_info_rhs.about_area.channel_header.line_limiter.less",
                                        defaultMessage: "less",
                                    })}
                                >
            ...
            <ChannelId>
                {formatMessage({
                    id: "channel_info_rhs.about_area_id",
                    defaultMessage: "ID:",
                })}{" "}
                {channel.id}
            </ChannelId>
