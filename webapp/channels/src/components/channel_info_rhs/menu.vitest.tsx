...
describe('channel_info_rhs/menu', () => {
    const defaultProps = {
        ...
        actions: {
            ...
            getChannelStats: vi.fn().mockImplementation(() => Promise.resolve({data: {files_count: 3, pinnedpost_count: 12, member_count: 32}})),
        },
    };
    ...
    test('should display notifications preferences', async () => {
        ...
        props.actions.openNotificationSettings = vi.fn();
    ...
    test('should display the number of files', async () => {
        const props = {...defaultProps};
        props.actions.showChannelFiles = vi.fn();
    ...
    test('should display the pinned messages', async () => {
        const props = {...defaultProps};
        props.actions.showPinnedPosts = vi.fn();
    ...
    test('should display members', async () => {
        const props = {...defaultProps};
        props.actions.showChannelMembers = vi.fn();
