...
function mapStateToProps(state: GlobalState, ownProps: OwnProps) {
    ...
    const permissionToEditGroup = haveIGroupPermission(
        state,
        ownProps.groupId,
        Permissions.EDIT_CUSTOM_GROUP,
    );
    const permissionToJoinGroup = haveIGroupPermission(
        state,
        ownProps.groupId,
        Permissions.MANAGE_CUSTOM_GROUP_MEMBERS,
    );
    const permissionToLeaveGroup = haveIGroupPermission(
        state,
        ownProps.groupId,
        Permissions.MANAGE_CUSTOM_GROUP_MEMBERS,
    );
    ...
    const permissionToRestoreGroup = haveIGroupPermission(
        state,
        ownProps.groupId,
