            ...
            >
                ...
                >
                    <Menu.ItemAction
                        ...
                        text={Utils.localizeMessage(defineMessage({id: 'user_groups_modal.editDetails', defaultMessage: 'Edit Details'}))}
                        disabled={false}
                    />
                    <Menu.ItemAction
                        show={props.permissionToJoinGroup && !isGroupMember}
                        onClick={joinGroup}
                        text={Utils.localizeMessage(defineMessage({id: 'user_groups_modal.joinGroup', defaultMessage: 'Join Group'}))}
                        disabled={false}
                    />
                    <Menu.ItemAction
                        show={props.permissionToLeaveGroup && isGroupMember}
                        onClick={leaveGroup}
                        text={Utils.localizeMessage(defineMessage({id: 'user_groups_modal.leaveGroup', defaultMessage: 'Leave Group'}))}
                        disabled={false}
                        isDangerous={true}
                    />
                    <Menu.ItemAction
