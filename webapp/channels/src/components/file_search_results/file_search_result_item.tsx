...
> {
    ...
    private jumpToConv = (e: MouseEvent) => {
        e.stopPropagation();
        getHistory().push(
            `/${this.props.teamName}/pl/${this.props.fileInfo.post_id}`,
        );
    };

    private copyLink = () => {
        copyToClipboard(
            `${getSiteURL()}/${this.props.teamName}/pl/${
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        >
                            <a href="#" className="action-icon dots-icon">
                            ...
                            <Menu ariaLabel={"file menu"} openLeft={true}>
                                <Menu.ItemAction
                                    ...
                                    ariaLabel={localizeMessage(
                                        "file_search_result_item.open_in_channel",
                                        "Open in channel",
                                    )}
                                ...
                                <Menu.ItemAction
                                    ...
                                    ariaLabel={localizeMessage(
                                        "file_search_result_item.copy_link",
                                        "Copy link",
                                    )}
                                    text={localizeMessage(
                                        "file_search_result_item.copy_link",
                    ...
                    <OverlayTrigger
                        ...
                        overlay={
                            <Tooltip id="file-name__tooltip">
                                {localizeMessage(
                                    "file_search_result_item.download",
                                    "Download",
                                )}
                            </Tooltip>
                        }
