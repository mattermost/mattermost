...
jest.mock(
    "components/cloud_start_trial/cloud_start_trial_btn",
...
describe("components/learn_more_trial_modal/learn_more_trial_modal", () => {
    ...
    test("should show the learn more about trial modal carousel slides", () => {
        ...
        expect(
            wrapper.find("LearnMoreTrialModal").find("Carousel"),
        ).toHaveLength(1);
    });
    ...
    test("should call on close", () => {
        ...
        const wrapper = mountWithIntl(
            <Provider store={store}>
                <LearnMoreTrialModal {...props} onClose={mockOnClose} />
            </Provider>,
        );
    ...
    test("should call on exited", () => {
        ...
        const wrapper = mountWithIntl(
            <Provider store={store}>
                <LearnMoreTrialModal {...props} onExited={mockOnExited} />
            </Provider>,
        );
    ...
    test("should move the slides when clicking carousel next and prev buttons", () => {
        ...
        let activeSlideId = activeSlide
            .find("LearnMoreTrialModalStep")
            .props().id;
