...
const LearnMoreTrialModal = ({
    ...
    let startTrialBtnMsg = formatMessage({
    ...
    if (isCloud) {
        startTrialBtnMsg = formatMessage({
        ...
        () => [
            {
                id: "useSso",
                title: formatMessage({
                    id: "learn_more_about_trial.modal.useSsoTitle",
                    defaultMessage: "Use SSO (with OpenID, SAML, Google, O365)",
                }),
                description: formatMessage({
                    id: "learn_more_about_trial.modal.useSsoDescription",
                    defaultMessage:
            ...
            },
            {
                id: "ldap",
                title: formatMessage({
                    id: "learn_more_about_trial.modal.ldapTitle",
                    defaultMessage:
                        "Synchronize your Active Directory/LDAP groups",
                }),
                description: formatMessage({
                    id: "learn_more_about_trial.modal.ldapDescription",
                    defaultMessage:
            ...
            },
            {
                id: "systemConsole",
                title: formatMessage({
                    id: "learn_more_about_trial.modal.systemConsoleTitle",
                    defaultMessage:
                        "Provide controlled access to the System Console",
                }),
                description: formatMessage({
                    id: "learn_more_about_trial.modal.systemConsoleDescription",
                    defaultMessage:
    ...
    const getSlides = useMemo(
        () =>
            steps.map(({ id, ...rest }) => (
                <LearnMoreTrialModalStep {...rest} id={id} key={id} />
            )),
        [],
    );
