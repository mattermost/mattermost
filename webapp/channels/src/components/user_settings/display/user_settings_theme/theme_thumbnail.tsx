...
function ThemeThumbnail({
    ...
    return (
        <svg
            ...
            aria-labelledby={`${themeKey}-theme-icon`}
            role="img"
        >
            <title
                id={`${themeKey}-theme-icon`}
            >{`${themeName} theme icon`}</title>
            <rect
                style={{ fill: centerChannelBg }}
                x="0"
                y="0"
                width="112"
                height="86"
            ...
            <g>
                ...
                />
                <rect
                    style={{ fill: newMessageSeparator }}
                    x="50"
                    y="32"
                    width="62"
                    height="1"
