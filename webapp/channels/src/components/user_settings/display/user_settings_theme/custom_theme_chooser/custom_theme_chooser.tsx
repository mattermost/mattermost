...
> {
    ...
    onChangeHandle = (e: ChangeEvent<HTMLTextAreaElement>) =>
        e.stopPropagation();
    ...
    showCopySuccess = () => {
        const copySuccess: HTMLElement | null = document.querySelector(
            ".copy-theme-success",
        );
        if (copySuccess) {
    ...
    render() {
        ...
        return (
            <div className="appearance-section pt-2">
                ...
                <div className="row mt-3">{pasteBox}</div>
            </div>
        );
    }
}
