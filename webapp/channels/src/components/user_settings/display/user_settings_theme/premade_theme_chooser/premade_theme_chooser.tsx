...
const PremadeThemeChooser = ({
    ...
    for (const k in Preferences.THEMES) {
        if (Preferences.THEMES.hasOwnProperty(k)) {
            ...
            const premadeTheme: Theme = Object.assign(
                {},
                Preferences.THEMES[k as ThemeKey],
            );
                    ...
                    >
                        <label>
                            <ThemeThumbnail
                                ...
                                sidebarText={changeOpacity(
                                    premadeTheme.sidebarText,
                                    0.48,
                                )}
                                sidebarUnreadText={
                                    premadeTheme.sidebarUnreadText
                                }
                                ...
                                centerChannelColor={changeOpacity(
                                    premadeTheme.centerChannelColor,
                                    0.16,
                                )}
                                centerChannelBg={premadeTheme.centerChannelBg}
                                newMessageSeparator={
                                    premadeTheme.newMessageSeparator
                                }
