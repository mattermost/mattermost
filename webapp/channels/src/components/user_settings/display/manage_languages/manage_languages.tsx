...
export class ManageLanguage extends React.PureComponent<Props, State> {
    ...
    render() {
        ...
        const interfaceLanguageLabelAria = intl.formatMessage({
            id: "user.settings.languages.dropdown.arialabel",
            defaultMessage:
                "Dropdown selector to change the interface language",
        });
        ...
        const input = (
            <div key="changeLanguage">
                ...
                <div ref={this.reactSelectContainer} className="pt-2">
                    <ReactSelect
