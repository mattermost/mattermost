...
describe('plugin setting', () => {
    ...
    test('properly take the current value from the preferences', () => {
    ...
    test('onSubmit gets called', async () => {
        const mockSavePreferences = vi.spyOn(preferencesActions, 'savePreferences');
        const props = getBaseProps();
    ...
    test('does not update anything if nothing has changed', () => {
        const mockSavePreferences = vi.spyOn(preferencesActions, 'savePreferences');
        const props = getBaseProps();
        props.activeSection = SECTION_TITLE;
        renderWithContext(<PluginSetting {...props}/>);
    ...
    test('does not consider anything changed after moving back and forth between sections', () => {
        const mockSavePreferences = vi.spyOn(preferencesActions, 'savePreferences');
        const props = getBaseProps();
        props.activeSection = SECTION_TITLE;
