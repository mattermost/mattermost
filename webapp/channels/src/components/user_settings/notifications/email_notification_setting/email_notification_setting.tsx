...
> {
    ...
    constructor(props: Props) {
        ...
        this.state = {
            ...
            enableEmailBatching,
            sendEmailNotifications,
            newInterval: getEmailInterval(
                enableEmail && sendEmailNotifications,
                enableEmailBatching,
                emailInterval,
            ),
        };
    ...
    static getDerivedStateFromProps(nextProps: Props, prevState: State) {
        ...
        if (
            sendEmailNotifications !== prevState.sendEmailNotifications ||
    ...
    handleChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        const newInterval = parseInt(
            e.currentTarget.getAttribute("data-email-interval")!,
            10,
        );
    ...
    handleSubmit = async () => {
        ...
        if (
            this.props.emailInterval === newInterval &&
            this.props.enableEmail === this.state.enableEmail
        ) {
    ...
    renderMinSettingView = () => {
        const { enableEmail, sendEmailNotifications } = this.props;
        ...
        if (!this.props.sendEmailNotifications) {
            return (
                <SettingItemMax
                    ...
                    inputs={[
                        <div key="oauthEmailInfo" className="pt-2">
                            <FormattedMessage
                    ...
                    <div className="radio">
                        <label>
                            <input
                                ...
                                name="emailNotifications"
                                checked={
                                    newInterval === Preferences.INTERVAL_HOUR
                                }
                                data-enable-email={"true"}
                    ...
                    <fieldset>
                        ...
                        <div className="mt-5">
                            <FormattedMessage
                                ...
                                defaultMessage={
                                    "When enabled, any reply to a thread you're following will send an email notification."
                                }
                            />
                        </div>
                    </fieldset>
