...
class NotificationsTab extends React.PureComponent<Props, State> {
    ...
    handleSubmit = async () => {
        ...
        const { data: updatedUser, error } = (await this.props.updateMe({
            notify_props: data,
        })) as ActionResult<Partial<UserProfile>, ServerError>; // Fix in MM-46907
        if (updatedUser) {
    ...
    handleNotifyPushThread = (e: ChangeEvent<HTMLInputElement>): void => {
        const pushThreads = e.target.checked
            ? NotificationLevels.ALL
        ...
        if (active) {
            if (this.props.sendPushNotifications) {
                ...
                if (
                    ...
                    this.state.pushActivity === NotificationLevels.MENTION
                ) {
                            ...
                            <fieldset>
                                ...
                                <div className="checkbox">
                                    <label>
                                        <input
                                            ...
                                            checked={
                                                this.state.pushThreads ===
                                                NotificationLevels.ALL
                                            }
                                            onChange={
                                                this.handleNotifyPushThread
                                            }
                                        />
                                        <FormattedMessage
                                ...
                                <div className="mt-5">
                                    <FormattedMessage
                                        ...
                                        defaultMessage={
                                            "When enabled, any reply to a thread you're following will send a mobile push notification."
                                        }
                                    />
                                </div>
                            </fieldset>
    ...
    createKeywordsWithNotificationSection = () => {
        ...
        const isSectionExpanded =
            this.props.activeSection === "keysWithNotification";
        ...
        return (
            <div id="notificationSettings">
                <div className="modal-header">
                    ...
                    <h4 className="modal-title" ref={this.drawerRef}>
                ...
                <div ref={this.wrapperRef} className="user-settings">
                    ...
                    <DesktopNotificationSettings
                        ...
                        selectedSound={
                            this.state.desktopNotificationSound || "default"
                        }
                        callsSelectedSound={
                            this.state.callsNotificationSound || "default"
                        }
