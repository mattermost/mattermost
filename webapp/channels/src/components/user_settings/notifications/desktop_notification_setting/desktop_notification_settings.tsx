...
> {
    ...
    constructor(props: Props) {
        ...
        this.state = {
            ...
            callsSelectedOption: {
                value: props.callsSelectedSound,
                label: props.callsSelectedSound,
            },
            blurDropdown: false,
        };
    ...
    setDesktopNotificationSound: ReactSelect["onChange"] = (
    ...
    setCallsNotificationRing: ReactSelect["onChange"] = (
        selectedOption: ValueType<SelectedOption>,
    ): void => {
        if (selectedOption && "value" in selectedOption) {
            this.props.setParentState(
    ...
    buildMaximizedSetting = (): JSX.Element => {
        ...
        if (this.props.activity !== NotificationLevels.NONE) {
            ...
            if (this.props.sound === "true") {
                const sounds = Array.from(
                    NotificationSounds.notificationSounds.keys(),
                );
                ...
                notificationSelection = (
                    <div className="pt-2">
                        <ReactSelect
                            ...
                            components={{
                                SingleValue: (props) => (
                                    <div data-testid="displaySoundNotificationValue">
                                        {props.children}
                                    </div>
                                ),
                            }}
            ...
            if (this.props.isCallsRingingEnabled) {
                ...
                if (this.props.callsSound === "true") {
                    const callsSounds = Array.from(
                        NotificationSounds.callsNotificationSounds.keys(),
                    );
                    ...
                    callsNotificationSelection = (
                        <div className="pt-2">
                            <ReactSelect
                                ...
                                components={{
                                    SingleValue: (props) => (
                                        <div data-testid="displayCallsSoundNotificationValue">
                                            {props.children}
                                        </div>
                                    ),
                                }}
        ...
        if (
            ...
            NotificationLevels.MENTION === this.props.activity
        ) {
                    ...
                    <fieldset>
                        ...
                        <div className="mt-5">
                            <FormattedMessage
                                ...
                                defaultMessage={
                                    "When enabled, any reply to a thread you're following will send a desktop notification."
                                }
                            />
                        </div>
                    </fieldset>
    ...
    componentDidUpdate(prevProps: Props) {
        ...
        if (this.props.selectedSound !== prevProps.selectedSound) {
            this.setState({
                selectedOption: {
                    ...
                    label: this.props.selectedSound,
                },
            });
        }
        if (this.props.callsSelectedSound !== prevProps.callsSelectedSound) {
            this.setState({
                callsSelectedOption: {
                    value: this.props.callsSelectedSound,
                    label: this.props.callsSelectedSound,
                },
            });
        }
    }
