...
describe('components/user_settings/security/UserSettingsSecurityTab - Auth Service Messages', () => {
    ...
    const baseProps = {
        ...
        actions: {
            getMe: vi.fn(),
            updateUserPassword: vi.fn(() => Promise.resolve({data: true})),
    ...
    describe('Password section auth service messages', () => {
        test('should display GitLab message when user auth_service is gitlab', () => {
            const props = {
                ...baseProps,
                user: {
                    ...user,
        ...
        test('should display LDAP message when user auth_service is ldap', () => {
            const props = {
                ...baseProps,
                user: {
                    ...user,
        ...
        test('should display SAML message when user auth_service is saml', () => {
            const props = {
                ...baseProps,
                user: {
                    ...user,
        ...
        test('should display Google message when user auth_service is google', () => {
            const props = {
                ...baseProps,
                user: {
                    ...user,
        ...
        test('should display Office365 message when user auth_service is office365', () => {
            const props = {
                ...baseProps,
                user: {
                    ...user,
        ...
        test('should display Guest Magic Link message when user auth_service is magic_link', () => {
            const props = {
                ...baseProps,
                user: {
                    ...user,
        ...
        test('should not display password fields or auth message when user auth_service is openid (unhandled case)', () => {
            const props = {
                ...baseProps,
                user: {
                    ...user,
        ...
        test('should display password input fields when user auth_service is empty (email/password)', () => {
            const props = {
                ...baseProps,
                user: {
                    ...user,
