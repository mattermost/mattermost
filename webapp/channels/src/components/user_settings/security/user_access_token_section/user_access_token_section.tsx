    ...
    confirmRevokeToken = (tokenId: string) => {
        ...
        this.setState({
            ...
            confirmMessage: () => (
                <div className='alert alert-danger'>
                    <FormattedMessage
                        id='user.settings.tokens.confirmDeleteMessageText'
                        defaultMessage={
                            'Any integrations using this token will no longer be able to access the Mattermost API. You cannot undo this action.{br}{br}Are you sure you want to delete the <b>{description}</b> token?'
                        }
                        values={{
