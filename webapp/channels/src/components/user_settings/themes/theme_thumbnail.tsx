...
function ThemeThumbnail({
    ...
    return (
        <svg viewBox='0 0 112 86' fill='none' xmlns='http://www.w3.org/2000/svg' aria-labelledby={`${themeKey}-theme-icon`} role='img'>
            ...
            <g>
                ...
                <rect style={{fill: sidebarTextActiveBorder}} x='71' y='65' width='22' height='5' rx='2.5'/>
