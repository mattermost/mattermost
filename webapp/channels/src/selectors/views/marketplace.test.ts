...
describe("marketplace", () => {
    ...
    it("getListing should return all plugins and apps", () => {
        expect(getListing(state)).toEqual([
            samplePlugin,
    ...
    it("getInstalledListing should return only installed plugins and apps", () => {
        expect(getInstalledListing(state)).toEqual([
            sampleInstalledPlugin,
            sampleInstalledApp,
        ]);
    });
    ...
    it("getPlugins should return all plugins", () => {
        expect(getPlugins(state)).toEqual([
            samplePlugin,
            sampleInstalledPlugin,
        ]);
    });
    ...
    describe("getPlugin", () => {
        it("should return samplePlugin", () => {
            expect(getPlugin(state, "com.mattermost.nps")).toEqual(
                samplePlugin,
            );
        });

        it("should return sampleInstalledPlugin", () => {
            expect(getPlugin(state, "com.mattermost.test")).toEqual(
                sampleInstalledPlugin,
            );
        });
    ...
    describe("getError", () => {
        ...
        it("should return error value for sampleInstalledPlugin", () => {
            expect(getError(state, "com.mattermost.test")).toBe(
                "An error occurred",
            );
        });
