...
describe('Selectors.Views.ChannelSettings', () => {
    ...
    const setPermissionCheckResults = (permissionResults: Record<string, boolean>) => {
        vi.mocked(RolesSelectors.haveIChannelPermission).mockImplementation(
            (_state, _teamId, _channelId, permission) => {
    ...
    test('should return true when user has info tab permission for public channel', () => {
    ...
    test('should return true when user has info tab permission for private channel', () => {
        setPermissionCheckResults({
    ...
    test('should return true when user has banner tab permission', () => {
        setPermissionCheckResults({
    ...
    test('should return true when user has archive tab permission', () => {
        setPermissionCheckResults({
            [Permissions.MANAGE_PUBLIC_CHANNEL_PROPERTIES]: false,
            [Permissions.MANAGE_PUBLIC_CHANNEL_BANNER]: false,
    ...
    test('should return false when user has no permissions', () => {
        ...
        vi.mocked(RolesSelectors.haveIChannelPermission).mockImplementation(() => false);
    ...
    test('should return false for default channel with only archive permission', () => {
        setPermissionCheckResults({
            [Permissions.MANAGE_PUBLIC_CHANNEL_PROPERTIES]: false,
            [Permissions.MANAGE_PUBLIC_CHANNEL_BANNER]: false,
