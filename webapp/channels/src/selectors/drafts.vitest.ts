...
describe('makeGetDraftsByPrefix', () => {
    test('should return comment drafts when given the comment_draft prefix', () => {
    ...
    test('should return channel drafts when given the comment_draft prefix', () => {
...
describe('makeGetDraftsCount', () => {
    test('should return drafts count', () => {
