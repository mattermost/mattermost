...
describe("getRecentEmojisData", () => {
            ...
            entities: {
                emojis: {
                    customEmojis: {
                        ...
                        gitlab: TestHelper.getCustomEmojiMock({
                            name: "gitlab",
                        }),
                        thanks: TestHelper.getCustomEmojiMock({
                            name: "thanks",
                        }),
                    },
                },
    ...
    test("should not change skin tone of emojis with multiple skin tones", () => {
        const recentEmojis = [
            { name: "strawberry", usageCount: 1 },
            {
                name: "man_and_woman_holding_hands_medium_light_skin_tone_medium_dark_skin_tone",
                usageCount: 1,
            },
        ];
    ...
    test("should only recalculate if relevant preferences change", () => {
        ...
        state = mergeObjects(state, {
            preferences: {
                emojis: {
                    customEmoji: {
                        someNewEmoji: TestHelper.getCustomEmojiMock({
                            name: "someNewCustomEmoji",
                        }),
                    },
                },
            },
