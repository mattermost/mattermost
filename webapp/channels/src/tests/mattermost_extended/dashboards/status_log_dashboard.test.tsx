...
import StatusLogDashboard from 'components/admin_console/status_log_dashboard/status_log_dashboard';
...
jest.mock('components/admin_console/status_log_dashboard/status_notification_rules', () => ({
    __esModule: true,
