 ...
 * @return {object} keydown event object
 */
export const getAltKeyEvent = (e?: KeyboardEvent): KeyboardEvent => ({
    ...BASE_EVENT,
    ...(e || {}),
    altKey: true,
});
export const getCtrlKeyEvent = (e?: KeyboardEvent): KeyboardEvent => ({
    ...BASE_EVENT,
    ...(e || {}),
    ctrlKey: true,
});
export const getMetaKeyEvent = (e?: KeyboardEvent): KeyboardEvent => ({
    ...BASE_EVENT,
    ...(e || {}),
    metaKey: true,
});
export const getShiftKeyEvent = (e?: KeyboardEvent): KeyboardEvent => ({
    ...BASE_EVENT,
    ...(e || {}),
    shiftKey: true,
});
 ...
 */
export function testComponentForLineBreak(
    generateInstance: (input: string) => JSX.Element,
    getValue: (instance: React.Component<any, any>) => string,
    intlInjected = true,
) {
    const shallowRender: (instance: JSX.Element) => ShallowWrapper =
        intlInjected ? shallowWithIntl : shallow;
