...
describe('Actions.Emojis', () => {
    ...
    test('Invalid emoji are not stored in recents', async () => {
        ...
        // Note: The code always calls savePreferences, but with an empty array when no valid emojis are added
        const expectedActions = [{
            type: 'RECEIVED_PREFERENCES',
            args: [
                'current_user_id',
                [
                    {
                        ...
                        name: 'current_user_id',
                        user_id: 'current_user_id',
                        value: JSON.stringify([]), // Empty array - invalid emoji was not added
                    },
                ],
            ],
        }];
