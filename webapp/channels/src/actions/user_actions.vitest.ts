...
vi.mock('mattermost-redux/actions/users', async (importOriginal) => {
    const original = await importOriginal<typeof import('mattermost-redux/actions/users')>();
    return {
        ...original,
...
vi.mock('mattermost-redux/actions/teams', async (importOriginal) => {
    const original = await importOriginal<typeof import('mattermost-redux/actions/teams')>();
    return {
        ...original,
...
vi.mock('mattermost-redux/actions/channels', async (importOriginal) => {
    const original = await importOriginal<typeof import('mattermost-redux/actions/channels')>();
    return {
        ...original,
...
vi.mock('mattermost-redux/actions/preferences', async (importOriginal) => {
    const original = await importOriginal<typeof import('mattermost-redux/actions/preferences')>();
    return {
        ...original,
...
describe('Actions.User', () => {
    ...
    test('Should call getProfilesInGroupChannels on loadProfilesForGM', async () => {
        ...
        vi.mocked(store.getState).mockImplementation(testStore.getState);
        vi.mocked(store.dispatch as Dispatch<AnyAction>).mockImplementation(testStore.dispatch);
