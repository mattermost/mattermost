...
describe('notification_actions', () => {
    describe('sendDesktopNotification', () => {
        ...
        beforeEach(() => {
            vi.clearAllMocks();
            spy = vi.spyOn(utils, 'showNotification').mockReturnValue(async () => ({status: 'success'}));
            vi.spyOn(NotificationSounds, 'ding').mockImplementation(vi.fn());
        ...
        test('should default sound when no sound is specified', () => {
            const dingSpy = vi.spyOn(NotificationSounds, 'ding');
