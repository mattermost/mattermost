...
vi.mock('mattermost-redux/actions/channels', async (importOriginal) => {
    const actual = await importOriginal<typeof import('mattermost-redux/actions/channels')>();
    return {
        ...actual,
...
global.Date.now = vi.fn(() => POST_CREATED_TIME);
