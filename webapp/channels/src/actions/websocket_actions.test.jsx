...
describe("handleGroupAddedMemberEvent", () => {
    test("add to group in state", async () => {
        ...
        const msg = {
            data: {
                group_member:
                    '{"group_id":"group-1","user_id":"currentUserId","create_at":1691178673417,"delete_at":0}',
            },
            broadcast: {
    ...
    test("add to group not in state", async () => {
        ...
        const msg = {
            data: {
                group_member:
                    '{"group_id":"group-2","user_id":"currentUserId","create_at":1691178673417,"delete_at":0}',
            },
            broadcast: {
                user_id: "currentUserId",
            },
            ...
            payload: [
                {
                    ...
                    data: { id: "otherTeam", user_id: "guestId" },
                },
                {
                    type: "REMOVE_MEMBER_FROM_TEAM",
                    data: { team_id: "otherTeam", user_id: "guestId" },
                },
            ],
...
describe("handleNewPostEvent", () => {
    ...
    test("should receive post correctly", () => {
        ...
        expect(getMentionsAndStatusesForPosts).toHaveBeenCalledWith(
            [post],
            expect.anything(),
            expect.anything(),
        );
...
describe("reconnect", () => {
    test("should call syncPostsInChannel when socket reconnects", () => {
        reconnect();
        expect(syncPostsInChannel).toHaveBeenCalledWith(
            "otherChannel",
            "12345",
        );
    });
...
describe("handlePluginEnabled/handlePluginDisabled", () => {
    ...
    describe("handlePluginEnabled", () => {
        const baseManifest = {
            name: "Demo Plugin",
            description:
                "This plugin demonstrates the capabilities of a Mattermost plugin.",
            version: "0.2.0",
        ...
        test("when a plugin is enabled", () => {
            ...
            expect(dispatchArg.type).toBe(
                ActionTypes.RECEIVED_PLUGIN_COMPONENT,
            );
        ...
        test("when a plugin is upgraded", () => {
            ...
            expect(dispatchReceivedArg2.type).toBe(
                ActionTypes.RECEIVED_PLUGIN_COMPONENT,
            );
            ...
            expect(dispatchReceivedArg4.type).toBe(
                ActionTypes.REMOVED_WEBAPP_PLUGIN,
            );
    ...
    describe("handlePluginDisabled", () => {
        ...
        test("when a plugin is disabled", () => {
            ...
            expect(dispatchReceivedArg3.type).toBe(
                ActionTypes.REMOVED_WEBAPP_PLUGIN,
            );
