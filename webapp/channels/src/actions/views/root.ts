...
export function loadConfigAndMe(): ActionFunc {
...
export function registerPluginTranslationsSource(pluginId: string, sourceFunction: TranslationPluginFunction): ActionFunc {
...
export function loadTranslations(locale: string, url: string): ActionFunc {
    return async (dispatch) => {
