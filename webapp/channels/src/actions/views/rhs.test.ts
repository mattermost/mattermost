...
describe('rhs view actions', () => {
    ...
    describe('performSearch', () => {
        ...
        test('it dispatches searchPosts correctly for Recent Mentions', () => {
            ...
            compareStore.dispatch(SearchActions.searchFilesWithParams('', {include_deleted_channels: true, terms: mentionsQuotedTerms, is_or_search: true, time_zone_offset: timeZoneOffset, page: 0, per_page: 20}));
