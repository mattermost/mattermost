...
jest.mock("actions/hooks", () => ({
    ...
    runSlashCommandWillBePostedHooks: jest.fn((message, args) => () => ({
        data: { message, args },
    })),
}));
...
describe("rhs view actions", () => {
    ...
    describe("submitCommand", () => {
        ...
        test("it calls executeCommand", async () => {
            ...
            expect(
                HookActions.runSlashCommandWillBePostedHooks,
            ).toHaveBeenCalled();
        ...
        test("it calls submitPost on error.sendMessage", async () => {
            ...
            } = require("actions/views/create_comment"); // eslint-disable-like @typescript-eslint/no-var-requires
