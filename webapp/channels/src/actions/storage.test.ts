...
describe("Actions.Storage", () => {
    ...
    it("setItem", async () => {
        ...
        expect(store.getState().storage.storage.unknown_test.value).toBe(
            "value",
        );
        expect(
    ...
    it("removeItem", async () => {
        ...
        expect(store.getState().storage.storage.unknown_test1.value).toBe(
            "value1",
        );
        expect(store.getState().storage.storage.unknown_test2.value).toBe(
            "value2",
        );

        store.dispatch(Actions.removeItem("test1"));

        expect(typeof store.getState().storage.storage.unknown_test1).toBe(
            "undefined",
        );
        expect(store.getState().storage.storage.unknown_test2.value).toBe(
            "value2",
    ...
    it("setGlobalItem", async () => {
        ...
        expect(typeof store.getState().storage.storage.test.timestamp).not.toBe(
            "undefined",
        );
    });
