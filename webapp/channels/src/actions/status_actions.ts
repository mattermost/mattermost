 ...
 */
export function addVisibleUsersInCurrentChannelToStatusPool(): ActionFunc<boolean, GlobalState> {
    return (dispatch, getState) => {
        ...
        if (userIdsForStatus.length > 0) {
            dispatch(addUserIdsForStatusAndProfileFetchingPool({userIdsForStatus}));
        }
