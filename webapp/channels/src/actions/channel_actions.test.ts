...
jest.mock("mattermost-redux/actions/channels", () => ({
    fetchChannelsAndMembers: (...args: any) => ({
    ...
    addChannelMember: (...args: any) => ({
        type: "MOCK_ADD_CHANNEL_MEMBER",
        args,
    }),
    createDirectChannel: (...args: any) => ({
        type: "MOCK_CREATE_DIRECT_CHANNEL",
        args,
    }),
    createGroupChannel: (...args: any) => ({
...
describe("Actions.Channel", () => {
    ...
    test("addUsersToChannel", async () => {
        ...
        await testStore.dispatch(
            addUsersToChannel(fakeData.channel, fakeData.userIds),
        );
        expect(testStore.getActions()).toEqual(expectedActions);
    });
