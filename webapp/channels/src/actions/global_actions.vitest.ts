...
const getState = vi.mocked(reduxStore.getState);
...
describe('actions/global_actions', () => {
    ...
    describe('redirectUserToDefaultTeam', () => {
        test('should redirect to /select_team when no team is available', async () => {
        ...
        test('should redirect to last viewed channel in the last viewed team when the user have access to that team', async () => {
            const userId = 'user1';
        ...
        test('should redirect to last channel on first team with channels when the user have no channels in the current team', async () => {
            const userId = 'user1';
        ...
        test('should redirect to /select_team when the user have no channels in the any of his teams', async () => {
            const userId = 'user1';
            LocalStorageStore.setPreviousTeamId(userId, 'team1');
            LocalStorageStore.setPreviousChannelName(userId, 'team1', 'channel-in-team-1');
            LocalStorageStore.setPreviousChannelName(userId, 'team2', 'channel-in-team-2');
        ...
        test('should do nothing if there is not current user', async () => {
            const store = mockStore({
                entities: {
                    general: {
                        config: {
        ...
        test('should redirect to direct message if that\'s the most recently used', async () => {
            const userId = 'user1';
            const teamId = 'team1';
            const user2 = 'user2';
        ...
        test('should redirect to group message if that\'s the most recently used', async () => {
            const userId = 'user1';
            const teamId = 'team1';
            const user2 = 'user2';
            const directChannelId = `${userId}__${user2}`;
        ...
        test('should redirect to last channel on first team when current team is no longer available', async () => {
            const userId = 'user1';
