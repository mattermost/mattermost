...
export function postEphemeralCallResponseForPost(response: AppCallResponse, message: string, post: Post): NewActionFuncAsync {
...
export function postEphemeralCallResponseForChannel(response: AppCallResponse, message: string, channelID: string): NewActionFuncAsync {
    return sendEphemeralPost(
        message,
        channelID,
        '',
...
export function postEphemeralCallResponseForContext(response: AppCallResponse, message: string, context: AppContext): NewActionFuncAsync {
    return sendEphemeralPost(
        message,
        context.channel_id,
...
export function postEphemeralCallResponseForCommandArgs(response: AppCallResponse, message: string, args: CommandArgs): NewActionFuncAsync {
    return sendEphemeralPost(
        message,
        args.channel_id,
        args.root_id,
