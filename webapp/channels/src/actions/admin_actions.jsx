...
export async function uploadBrandImage(brandImage, success, error) {
    const { data, error: err } = await AdminActions.uploadBrandImage(
        brandImage,
    )(dispatch, getState);
    if (data && success) {
        success(data);
...
export async function deleteBrandImage(success, error) {
    const { data, error: err } = await AdminActions.deleteBrandImage()(
        dispatch,
        getState,
    );
    if (data && success) {
...
export async function uploadPrivateSamlCertificate(file, success, error) {
    const { data, error: err } =
        await AdminActions.uploadPrivateSamlCertificate(file)(
            dispatch,
            getState,
        );
    if (data && success) {
...
export async function uploadPublicLdapCertificate(file, success, error) {
    const { data, error: err } = await AdminActions.uploadPublicLdapCertificate(
        file,
    )(dispatch, getState);
    if (data && success) {
...
export async function uploadPrivateLdapCertificate(file, success, error) {
    const { data, error: err } =
        await AdminActions.uploadPrivateLdapCertificate(file)(
            dispatch,
            getState,
        );
    if (data && success) {
...
export async function removePublicSamlCertificate(success, error) {
    const { data, error: err } =
        await AdminActions.removePublicSamlCertificate()(dispatch, getState);
    if (data && success) {
        success(data);
    } else if (err && error) {
        error({ id: err.server_error_id, ...err });
...
export async function removePublicLdapCertificate(success, error) {
    const { data, error: err } =
        await AdminActions.removePublicLdapCertificate()(dispatch, getState);
    if (data && success) {
        success(data);
    } else if (err && error) {
        error({ id: err.server_error_id, ...err });
...
export async function removePrivateLdapCertificate(success, error) {
    const { data, error: err } =
        await AdminActions.removePrivateLdapCertificate()(dispatch, getState);
    if (data && success) {
        success(data);
    } else if (err && error) {
        error({ id: err.server_error_id, ...err });
...
export async function testSiteURL(success, error, siteURL) {
    const { data, error: err } = await dispatch(
        AdminActions.testSiteURL(siteURL),
    );
    if (data && success) {
        success(data);
    } else if (err && error) {
...
export async function getSamlMetadataFromIdp(success, error, samlMetadataURL) {
    const { data, error: err } = await dispatch(
        AdminActions.getSamlMetadataFromIdp(samlMetadataURL),
    );
    if (data && success) {
        success(data);
    } else if (err && error) {
...
export async function setSamlIdpCertificateFromMetadata(
    success,
    error,
    certData,
) {
    const { data, error: err } =
        await AdminActions.setSamlIdpCertificateFromMetadata(certData)(
            dispatch,
            getState,
        );
    if (data && success) {
...
export function requestTrialLicense(requestLicenseBody, page) {
    return async () => {
        try {
            ...
            const response =
                await Client4.requestTrialLicense(requestLicenseBody);
