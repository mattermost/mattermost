...
const values = {
    ...
    SYSCONSOLE_READ_SITE_CLASSIFICATION_MARKINGS: 'sysconsole_read_site_classification_markings',
    SYSCONSOLE_WRITE_SITE_CLASSIFICATION_MARKINGS: 'sysconsole_write_site_classification_markings',
...
values.SYSCONSOLE_READ_PERMISSIONS = [
    ...
    values.SYSCONSOLE_READ_SITE_CLASSIFICATION_MARKINGS,
...
values.SYSCONSOLE_WRITE_PERMISSIONS = [
    ...
    values.SYSCONSOLE_WRITE_SITE_CLASSIFICATION_MARKINGS,
