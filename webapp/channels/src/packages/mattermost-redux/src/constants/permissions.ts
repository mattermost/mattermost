...
const values = {
    ...
    SYSCONSOLE_READ_AI_RECAPS: 'sysconsole_read_ai_recaps',
    SYSCONSOLE_WRITE_AI_RECAPS: 'sysconsole_write_ai_recaps',
...
values.SYSCONSOLE_READ_PERMISSIONS = [
    ...
    values.SYSCONSOLE_READ_AI_RECAPS,
...
values.SYSCONSOLE_WRITE_PERMISSIONS = [
    ...
    values.SYSCONSOLE_WRITE_AI_RECAPS,
...
export const CHANNEL_WRITE_PERMISSIONS: ReadonlySet<string> = new Set([
    values.ADD_BOOKMARK_PRIVATE_CHANNEL,
    values.ADD_BOOKMARK_PUBLIC_CHANNEL,
    values.ADD_REACTION,
    values.CONVERT_PRIVATE_CHANNEL_TO_PUBLIC,
    values.CONVERT_PUBLIC_CHANNEL_TO_PRIVATE,
    values.CREATE_POST,
    values.CREATE_POST_EPHEMERAL,
    values.CREATE_POST_PUBLIC,
    values.DELETE_BOOKMARK_PRIVATE_CHANNEL,
    values.DELETE_BOOKMARK_PUBLIC_CHANNEL,
    values.DELETE_OTHERS_POSTS,
    values.DELETE_POST,
    values.DELETE_PRIVATE_CHANNEL,
    values.DELETE_PUBLIC_CHANNEL,
    values.EDIT_BOOKMARK_PRIVATE_CHANNEL,
    values.EDIT_BOOKMARK_PUBLIC_CHANNEL,
    values.EDIT_FILE_ATTACHMENT,
    values.EDIT_OTHERS_POSTS,
    values.EDIT_POST,
    values.MANAGE_CHANNEL_JOIN_REQUESTS,
    values.MANAGE_CHANNEL_ROLES,
    values.MANAGE_PRIVATE_CHANNEL_AUTO_TRANSLATION,
    values.MANAGE_PRIVATE_CHANNEL_BANNER,
    values.MANAGE_PRIVATE_CHANNEL_DISCOVERABILITY,
    values.MANAGE_PRIVATE_CHANNEL_MEMBERS,
    values.MANAGE_PRIVATE_CHANNEL_PROPERTIES,
    values.MANAGE_PUBLIC_CHANNEL_AUTO_TRANSLATION,
    values.MANAGE_PUBLIC_CHANNEL_BANNER,
    values.MANAGE_PUBLIC_CHANNEL_MEMBERS,
    values.MANAGE_PUBLIC_CHANNEL_PROPERTIES,
    values.ORDER_BOOKMARK_PRIVATE_CHANNEL,
    values.ORDER_BOOKMARK_PUBLIC_CHANNEL,
    values.REMOVE_OTHERS_REACTIONS,
    values.REMOVE_REACTION,
    values.UPLOAD_FILE,
    values.USE_CHANNEL_MENTIONS,
    values.USE_GROUP_MENTIONS,
    values.USE_SLASH_COMMANDS,
]);
