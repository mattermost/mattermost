...
const values = {
    ...
    SYSCONSOLE_READ_INTEGRATIONS_EMBEDDING: 'sysconsole_read_integrations_embedding',
    SYSCONSOLE_WRITE_INTEGRATIONS_EMBEDDING: 'sysconsole_write_integrations_embedding',
...
values.SYSCONSOLE_READ_PERMISSIONS = [
    ...
    values.SYSCONSOLE_READ_INTEGRATIONS_EMBEDDING,
...
values.SYSCONSOLE_WRITE_PERMISSIONS = [
    ...
    values.SYSCONSOLE_WRITE_INTEGRATIONS_EMBEDDING,
