...
export const RESOURCE_KEYS = {
    ...
    ENVIRONMENT: {
        ...
        SYSTEM_BUS: 'environment.system_bus',
...
export const ResourceToSysConsolePermissionsTable: Record<string, string[]> = {
    ...
    [RESOURCE_KEYS.ENVIRONMENT.SYSTEM_BUS]: [Permissions.SYSCONSOLE_READ_ENVIRONMENT_SYSTEM_BUS, Permissions.SYSCONSOLE_WRITE_ENVIRONMENT_SYSTEM_BUS],
