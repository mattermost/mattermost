...
export const RESOURCE_KEYS = {
    ...
    SITE: {
        ...
        CLASSIFICATION_MARKINGS: 'site.classification_markings',
        EMOJI: 'site.emoji',
        POSTS: 'site.posts',
...
export const ResourceToSysConsolePermissionsTable: Record<string, string[]> = {
    ...
    [RESOURCE_KEYS.SITE.CLASSIFICATION_MARKINGS]: [Permissions.SYSCONSOLE_READ_SITE_CLASSIFICATION_MARKINGS, Permissions.SYSCONSOLE_WRITE_SITE_CLASSIFICATION_MARKINGS],
