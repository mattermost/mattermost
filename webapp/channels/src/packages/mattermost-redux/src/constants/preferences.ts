...
const Preferences = {
    ...
    THEMES: {
        ...
        discord: {
            ...
            sidebarText: '#b9bbbe',
            sidebarUnreadText: '#ffffff',
            sidebarTextHoverBg: '#36393f',
            sidebarTextActiveBorder: '#7289da',
            sidebarTextActiveColor: '#ffffff',
            sidebarHeaderBg: '#23272a',
            sidebarHeaderTextColor: '#ffffff',
            sidebarTeamBarBg: '#23272a',
            ...
            centerChannelColor: '#dcddde',
            newMessageSeparator: '#f04747',
            linkColor: '#7289da',
            buttonBg: '#7289da',
            buttonColor: '#ffffff',
            errorTextColor: '#f04747',
            mentionHighlightBg: '#36393f',
        ...
        guilded: {
            ...
            sidebarText: '#a3a3ac',
            sidebarUnreadText: '#ffffff',
            sidebarTextHoverBg: '#36383e',
            sidebarTextActiveBorder: '#ececee',
            sidebarTextActiveColor: '#f8f8f8',
            sidebarHeaderBg: '#1e2025',
            sidebarHeaderTextColor: '#ffffff',
            sidebarTeamBarBg: '#1e2025',
            onlineIndicator: '#43b581',
            awayIndicator: '#faa61a',
            dndIndicator: '#f04747',
            mentionBg: '#ff0000',
            mentionBj: '#ff0000',
            mentionColor: '#ffffff',
            centerChannelBg: '#373943',
            centerChannelColor: '#ffffff',
            newMessageSeparator: '#df5353',
            linkColor: '#fef0b9',
            buttonBg: '#fab705',
            buttonColor: '#17140f',
            errorTextColor: '#f04747',
            mentionHighlightBg: '#454443',
            mentionHighlightLink: '#ffffff',
            codeTheme: 'monokai',
        },
