...
const Preferences = {
    ...
    THEMES: {
        techzen: {
            ...
            sidebarTextHoverBg: '#161b22',
            sidebarTextActiveBorder: '#e63434',
            sidebarTextActiveColor: '#ffffff',
            sidebarHeaderBg: '#090d13',
            sidebarHeaderTextColor: '#ffffff',
            sidebarTeamBarBg: '#060a0f',
            ...
            centerChannelColor: '#1a1a2e',
            newMessageSeparator: '#e63434',
            linkColor: '#137fec',
            buttonBg: '#137fec',
            buttonColor: '#ffffff',
            errorTextColor: '#e63434',
            mentionHighlightBg: '#fde8e8',
            mentionHighlightLink: '#9b1c1c',
            codeTheme: 'github',
        },
        denim: {
            type: 'Denim',
