...
export default keyMirror({
    ...
    INIT_CHANNELS_LOADED: null,
    RECEIVED_MY_CHANNEL_MEMBERS: null,
    INIT_CHANNEL_MEMBERSHIPS_LOADED: null,
    ...
    // Discoverable Private Channels — join requests
    RECEIVED_MY_CHANNEL_JOIN_REQUEST: null,
    RECEIVED_MY_CHANNEL_JOIN_REQUESTS: null,
    RECEIVED_CHANNEL_JOIN_REQUESTS: null,
    RECEIVED_CHANNEL_JOIN_REQUEST_COUNT: null,
    CHANNEL_JOIN_REQUEST_CREATED: null,
    CHANNEL_JOIN_REQUEST_UPDATED: null,
    CHANNEL_JOIN_REQUEST_REMOVED: null,
});
