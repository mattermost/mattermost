...
describe('Selectors.Users', () => {
    ...
    describe('getProfiles', () => {
        test('getProfiles without filter', () => {
        ...
        test('getProfiles with multiple filters', () => {
            const users = [user7];
    ...
    describe('getProfilesInCurrentTeam', () => {
        ...
        test('getProfilesInCurrentTeam include remote', () => {
        ...
        test('getProfilesInCurrentTeam with remote filter', () => {
            const users = [user1, user2, user7].sort(sortByUsername);
    ...
    describe('getProfilesNotInCurrentChannel', () => {
        test('getProfilesNotInCurrentChannel', () => {
        ...
        test('getProfilesNotInCurrentChannel include remote', () => {
        ...
        test('getProfilesNotInCurrentChannel with remote filter', () => {
            const users = [user2, user3].sort(sortByUsername);
            const filters = {exclude_remote: true};
    ...
    describe('getProfilesInTeam', () => {
        test('getProfilesInTeam without filter', () => {
            const users = [user1, user2, user7].sort(sortByUsername);
        ...
        test('getProfilesInTeam with role filter', () => {
        ...
        test('getProfilesInTeam with inactive filter', () => {
            const users = [user2, user7].sort(sortByUsername);
        ...
        test('getProfilesInTeam with active', () => {
            const users = [user1];
        ...
        test('getProfilesInTeam with role filters', () => {
        ...
        test('getProfilesInTeam with multiple filters', () => {
            const users = [user7];
    ...
    describe('searchProfilesStartingWithTerm', () => {
        test('searchProfiles without filter', () => {
        ...
        test('searchProfiles with filters', () => {
    ...
    test('searchProfilesInCurrentChannel', () => {
    ...
    test('searchProfilesNotInCurrentChannel', () => {
    ...
    test('searchProfilesInCurrentTeam', () => {
    ...
    describe('searchProfilesInTeam', () => {
        test('searchProfilesInTeam without filter', () => {
        ...
        test('searchProfilesInTeam with filter', () => {
    ...
    test('searchProfilesNotInCurrentTeam', () => {
    ...
    describe('searchProfilesWithoutTeam', () => {
        test('searchProfilesWithoutTeam without filter', () => {
        ...
        test('searchProfilesWithoutTeam with filter', () => {
    ...
    test('makeGetProfilesInChannel, unknown user id in channel', () => {
        const state = {
            ...testState,
            entities: {
                ...testState.entities,
    ...
    test('makeGetProfilesNotInChannel', () => {
    ...
    test('makeGetProfilesByIdsAndUsernames', () => {
    ...
    describe('makeGetDisplayName and makeDisplayNameGetter', () => {
        ...
        test('Should show full name since preferences is being used and LockTeammateNameDisplay is false', () => {
            const newTestState = {
                entities: {
        ...
        test('Should show show username since LockTeammateNameDisplay is true', () => {
            const newTestState = {
                entities: {
                    users: {profiles: newProfiles},
                    preferences: {
        ...
        test('Should show full name since license is false', () => {
            const newTestState = {
                entities: {
                    users: {profiles: newProfiles},
                    preferences: {
        ...
        test('Should show full name since license is not available', () => {
            const newTestState = {
                entities: {
                    users: {profiles: newProfiles},
                    preferences: {
        ...
        test('Should show Full name since license is not available and lock teammate name display is false', () => {
            const newTestState = {
                entities: {
                    users: {profiles: newProfiles},
                    preferences: {
        ...
        test('Should show username since no settings are available (falls back to default)', () => {
            const newTestState = {
                entities: {
                    users: {profiles: newProfiles},
                    preferences: {
    ...
    describe('filterProfiles', () => {
        test('no filter, return all users', () => {
