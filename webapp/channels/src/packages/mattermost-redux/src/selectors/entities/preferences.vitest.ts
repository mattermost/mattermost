...
describe('Selectors.Preferences', () => {
    ...
    describe('get theme', () => {
        ...
        test('mentionBj backwards compatability theme', () => {
            const currentTeamId = '1234';
        ...
        test('updates sideBarTeamBarBg variable when its not present', () => {
            const currentTeamId = '1234';
        ...
        test('custom theme with upper case colours', () => {
            const currentTeamId = '1234';
            const theme = {sidebarBg: '#FF0000'};
        ...
        test('custom theme with missing colours', () => {
            const currentTeamId = '1234';
            const theme = {sidebarBg: '#ff0000'};
        ...
        test('system theme with missing colours', () => {
            const currentTeamId = '1234';
            const theme = {
        ...
        test('should return the server-configured theme by default', () => {
            expect(Selectors.getTheme({
                entities: {
                    general: {
                        config: {
        ...
        test('returns the "default" theme if the server-configured value is not present', () => {
            expect(Selectors.getTheme({
                entities: {
                    general: {
                        config: {
...
describe('makeGetCategory', () => {
    ...
    test('should return preferences in a category', () => {
    ...
    test('should return the same preference objects unless they change', () => {
    ...
    test('should only return a new array when one of the preferences in that category changes', () => {
        let state = getBaseState();
...
describe('shouldShowJoinLeaveMessages', () => {
    ...
    test('set config to false, return false', () => {
        const state = {
            entities: {
                general: {
                    config: {
    ...
    test('if user preference, set default wont be used', () => {
        const state = {
            entities: {
                general: {
                    config: {
