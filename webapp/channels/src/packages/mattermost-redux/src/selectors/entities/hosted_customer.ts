...
export function getSelfHostedSignupProgress(
    state: GlobalState,
): ValueOf<typeof SelfHostedSignupProgress> {
    return state.entities.hostedCustomer.signupProgress;
}

export function getSelfHostedProducts(
    state: GlobalState,
...
export function getSelfHostedInvoices(
    state: GlobalState,
): Record<string, Invoice> {
    return state.entities.hostedCustomer.invoices.invoices;
}

export function getSelfHostedErrors(
    state: GlobalState,
): HostedCustomerState["errors"] {
    return state.entities.hostedCustomer.errors;
}

export function getTrueUpReviewProfile(
    state: GlobalState,
): TrueUpReviewProfileReducer {
