...
describe('Selectors.Roles', () => {
    ...
    test('should return my roles by scope on getMySystemRoles/getMyTeamRoles/getMyChannelRoles/getMyGroupRoles', () => {
    ...
    test('should return current loaded roles on getRoles', () => {
        const loadedRoles = {
            test_team1_role1: {permissions: ['team1_role1']},
            test_team2_role1: {permissions: ['team2_role1']},
            test_team2_role2: {permissions: ['team2_role2']},
    ...
    test('should return my system permission on getMySystemPermissions', () => {
    ...
    test('should return if i have a system permission on haveISystemPermission', () => {
    ...
    test('should return if i have a team permission on haveITeamPermission', () => {
    ...
    test('should return if i have a team permission on haveICurrentTeamPermission', () => {
    ...
    test('should return if i have a channel permission on haveIChannelPermission', () => {
    ...
    test('should return if i have a channel permission on haveICurrentChannelPermission', () => {
    ...
    test('should return group memberships on getGroupMemberships', () => {
        expect(Selectors.getGroupMemberships(testState)).toEqual({[group1.id]: {user_id: user.id, roles: 'custom_group_user'}});
    });

    test('should return if i have a group permission on haveIGroupPermission', () => {
    ...
    test('should return false if i dont have a group permission on haveIGroupPermission', () => {
        const roles = {
            test_team1_role1: {permissions: ['team1_role1']},
            test_team2_role1: {permissions: ['team2_role1']},
            test_team2_role2: {permissions: ['team2_role2']},
    ...
    test('should return group set with permissions on getGroupListPermissions', () => {
