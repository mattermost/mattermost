...
export const getAppsOAuthAppIDs: (state: GlobalState) => string[] =
    createSelector(
        "getAppsOAuthAppIDs",
        appsEnabled,
 ...
 */
export const getOutgoingHooksInCurrentTeam: (
    state: GlobalState,
) => OutgoingWebhook[] = createSelector(
...
export const getAllCommands: (state: GlobalState) => IDMappedObjects<Command> =
    createSelector(
        "getAllCommands",
        getCommands,
        getSystemCommands,
...
export const getAutocompleteCommandsList: (state: GlobalState) => Command[] =
    createSelector(
