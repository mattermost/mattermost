...
export const getAllLogs = createSelector("getAllLogs", getLogs, (logs) => {
...
export function getDataRetentionCustomPoliciesCount(
    state: GlobalState,
): number {
    return state.entities.admin.dataRetentionCustomPoliciesCount;
}

export function getDataRetentionCustomPolicy(
    state: GlobalState,
    id: string,
): DataRetentionCustomPolicy | undefined | null {
...
export function getPluginStatuses(
    state: GlobalState,
): Record<string, PluginStatusRedux> | undefined {
