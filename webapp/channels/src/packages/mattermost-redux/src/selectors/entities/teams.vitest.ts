...
describe('Selectors.Teams', () => {
    ...
    test('getJoinableTeamsUsingPermissions', () => {
    ...
    test('getSortedJoinableTeamsUsingPermissions', () => {
    ...
    test('getSortedListableTeamsUsingPermissions', () => {
        const privateTeams = [team2, team1];
        const openTeams = [team4, team3];
        const modifiedState = {
            entities: {
    ...
    test('getCurrentRelativeTeamUrl', () => {
    ...
    test('getCurrentTeamUrl with falsy currentTeam', () => {
        const siteURL = 'http://localhost:8065';
        const general = {
            config: {SiteURL: siteURL},
            credentials: {},
