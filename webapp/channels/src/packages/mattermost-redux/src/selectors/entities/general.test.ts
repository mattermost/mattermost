...
describe("Selectors.General", () => {
    it("canUploadFilesOnMobile", () => {
        expect(
            Selectors.canUploadFilesOnMobile({
                entities: {
                    general: {
                        config: {},
                        license: {
    ...
    describe("getAutolinkedUrlSchemes", () => {
        it("setting doesn't exist", () => {
            ...
            expect(Selectors.getAutolinkedUrlSchemes(state)).toEqual(
                General.DEFAULT_AUTOLINKED_URL_SCHEMES,
            );
            expect(Selectors.getAutolinkedUrlSchemes(state)).toEqual(
                Selectors.getAutolinkedUrlSchemes(state),
            );
        });
    ...
    describe("getFeatureFlagValue", () => {
        test("should return undefined when feature flag does not exist", () => {
            ...
            expect(
                Selectors.getFeatureFlagValue(state, "CoolFeature"),
            ).toBeUndefined();
        });
        ...
        test("should return the value of a valid feature flag", () => {
            ...
            expect(Selectors.getFeatureFlagValue(state, "CoolFeature")).toEqual(
                "true",
            );
        });
    });
    ...
    describe("firstAdminVisitMarketplaceStatus", () => {
        test("should return empty when status does not exist", () => {
            ...
            expect(
                Selectors.getFirstAdminVisitMarketplaceStatus(state),
            ).toEqual({});
        });
