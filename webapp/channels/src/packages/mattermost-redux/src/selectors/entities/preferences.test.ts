...
describe("Selectors.Preferences", () => {
    ...
    describe("get preference", () => {
        ...
        describe("should fallback to the default", () => {
            it("if name unknown", () => {
                expect(
                    Selectors.get(testState, category1, "unknown name"),
                ).toEqual("");
            });

            it("if category unknown", () => {
                expect(
                    Selectors.get(testState, "unknown category", name1),
                ).toEqual("");
            });
        });
    ...
    describe("get bool preference", () => {
        it("should return the requested value", () => {
            expect(Selectors.getBool(testState, category1, name1)).toEqual(
                value1 === "true",
            );
        });
        ...
        describe("should fallback to the default", () => {
            it("if name unknown", () => {
                expect(
                    Selectors.getBool(testState, category1, "unknown name"),
                ).toEqual(false);
            });

            it("if category unknown", () => {
                expect(
                    Selectors.getBool(testState, "unknown category", name1),
                ).toEqual(false);
            });
        });
    ...
    describe("get int preference", () => {
        it("should return the requested value", () => {
            expect(Selectors.getInt(testState, category2, name2)).toEqual(
                parseInt(value2, 10),
            );
        });
        ...
        describe("should fallback to the default", () => {
            it("if name unknown", () => {
                expect(
                    Selectors.getInt(testState, category2, "unknown name"),
                ).toEqual(0);
            });

            it("if category unknown", () => {
                expect(
                    Selectors.getInt(testState, "unknown category", name2),
                ).toEqual(0);
            });
        });
        ...
        describe("should fallback to the overridden default", () => {
            it("if name unknown", () => {
                expect(
                    Selectors.getInt(testState, category2, "unknown name", 100),
                ).toEqual(100);
            });

            it("if category unknown", () => {
                expect(
                    Selectors.getInt(testState, "unknown category", name2, 100),
                ).toEqual(100);
            });
        });
    });
    ...
    it("get direct channel show preferences", () => {
        expect(Selectors.getDirectShowPreferences(testState)).toEqual([
            dmPref1,
            dmPref2,
        ]);
    });
    ...
    it("get group channel show preferences", () => {
        expect(Selectors.getGroupShowPreferences(testState)).toEqual([
            prefGp1,
            prefGp2,
        ]);
    });
    ...
    it("get teammate name display setting", () => {
        ...
        ).toEqual(General.TEAMMATE_NAME_DISPLAY.SHOW_NICKNAME_FULLNAME);
    });
    ...
    describe("get theme", () => {
        it("default theme", () => {
            ...
            ).toEqual(Preferences.THEMES.denim);
        });
        ...
        it("custom theme", () => {
            ...
            expect(
                ...
                } as GlobalState).sidebarBg,
            ).toEqual(theme.sidebarBg);
        });
        ...
        it("mentionBj backwards compatability theme", () => {
            const currentTeamId = "1234";
            const theme: { mentionBj: string; mentionBg?: string } = {
                mentionBj: "#ff0000",
            };
            ...
            expect(
                ...
                } as GlobalState).mentionBg,
            ).toEqual(theme.mentionBj);
        ...
        it("updates sideBarTeamBarBg variable when its not present", () => {
            ...
            expect(
                ...
                } as GlobalState).sidebarTeamBarBg,
            ).toEqual(
                ThemeUtils.blendColors(
                    ...
                    preferences: {
                        myPreferences: {
                            ...
                            [getPreferenceKey(
                                ...
                                category: Preferences.CATEGORY_THEME,
                                name: currentTeamId,
                                value: JSON.stringify({ sidebarBg: "#ff0000" }),
                            },
                            [getPreferenceKey(
                                Preferences.CATEGORY_THEME,
                                otherTeamId,
                    ...
                    preferences: {
                        ...
                        myPreferences: {
                            ...
                            [getPreferenceKey(
                                ...
                                category: Preferences.CATEGORY_THEME,
                                name: currentTeamId,
                                value: JSON.stringify({ sidebarBg: "#0000ff" }),
                                user_id: "",
                            },
                        },
                    },
        ...
        it("custom theme with upper case colours", () => {
            ...
            ).toEqual(theme.sidebarBg.toLowerCase());
        });
        ...
        it("custom theme with missing colours", () => {
            ...
            expect(
                ...
                } as GlobalState).mentionHighlightLink,
            ).toEqual(Preferences.THEMES.denim.mentionHighlightLink);
        });
        ...
        it("system theme with missing colours", () => {
            ...
            expect(
                ...
                } as GlobalState).sidebarText,
            ).toEqual(Preferences.THEMES.indigo.sidebarText);
        });
        ...
        it("non-default system theme", () => {
            ...
            expect(
                ...
                } as GlobalState).codeTheme,
            ).toEqual(Preferences.THEMES.onyx.codeTheme);
        });
        ...
        it("should return the server-configured theme by default", () => {
            expect(
                ...
                } as unknown as GlobalState).codeTheme,
            ).toEqual(Preferences.THEMES.indigo.codeTheme);
            ...
            ).not.toEqual(Preferences.THEMES.indigo.codeTheme);
        });
        ...
        it('returns the "default" theme if the server-configured value is not present', () => {
            ...
            ).toEqual(Preferences.THEMES.denim.codeTheme);
        });
    });
                ...
                preferences: {
                    myPreferences: {
                        ...
                        [getPreferenceKey(
                            ...
                            value: JSON.stringify({ unreads_at_top: "false" }),
                        },
                    },
                },
            },
                ...
                preferences: {
                    myPreferences: {
                        [getPreferenceKey(
                            ...
                            value: JSON.stringify({ unreads_at_top: "true" }),
                        },
                    },
                },
            },
