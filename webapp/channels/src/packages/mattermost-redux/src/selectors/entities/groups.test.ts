...
describe("Selectors.Groups", () => {
    ...
    const channelAssociatedGroupIDs = [
    ...
    const testState = deepFreezeAndThrowOnMutation({
        entities: {
            groups: {
                ...
                myGroups: [group1.id, group4.id, group2.id],
            },
            teams: {
                teams: {
    ...
    it("getAssociatedGroupsByName", () => {
        const groupsByName = Selectors.getAssociatedGroupsByName(
            testState,
            teamID,
            channelID,
        );
    ...
    it("getGroupsAssociatedToTeam", () => {
        ...
        expect(Selectors.getGroupsAssociatedToTeam(testState, teamID)).toEqual(
            expected,
        );
    });

    it("getGroupsNotAssociatedToTeam", () => {
        const expected = [group3, group4];
        expect(
            Selectors.getGroupsNotAssociatedToTeam(testState, teamID),
        ).toEqual(expected);
    });
    ...
    it("getGroupsAssociatedToChannel", () => {
        const expected = [group3, group4];
        expect(
            Selectors.getGroupsAssociatedToChannel(testState, channelID),
        ).toEqual(expected);
    });
    ...
    it("getGroupsNotAssociatedToChannel", () => {
        const expected = [group1, group2];
        expect(
            Selectors.getGroupsNotAssociatedToChannel(
                testState,
                channelID,
                teamID,
            ),
        ...
        cloneState.entities.teams.groupsAssociatedToTeam[teamID].ids = [
            expectedAssociatedGroupID1,
        ];
    ...
    it("getGroupsAssociatedToTeamForReference", () => {
        const expected = [group1];
        expect(
            Selectors.getGroupsAssociatedToTeamForReference(testState, teamID),
        ).toEqual(expected);
    });

    it("getGroupsAssociatedToChannelForReference", () => {
        const expected = [group4];
        expect(
            Selectors.getGroupsAssociatedToChannelForReference(
                testState,
                channelID,
            ),
        ).toEqual(expected);
    ...
    it("makeGetAllAssociatedGroupsForReference", () => {
        const expected = [group1, group4, group5];
        const getAllAssociatedGroupsForReference =
            Selectors.makeGetAllAssociatedGroupsForReference();
        expect(getAllAssociatedGroupsForReference(testState, false)).toEqual(
            expected,
        );
    });
    ...
    it("getMyGroupMentionKeys", () => {
        ...
        expect(Selectors.getMyGroupMentionKeys(testState, false)).toEqual(
            expected,
        );
    });
    ...
    it("getMyGroupMentionKeysForChannel", () => {
        ...
        expect(
            Selectors.getMyGroupMentionKeysForChannel(
                testState,
                teamID,
                channelID,
            ),
