...
export const shouldShowUnreadsCategory: (state: GlobalState) => boolean =
    createSelector(
        ...
        (state: GlobalState) =>
            get(state, Preferences.CATEGORY_SIDEBAR_SETTINGS, ""),
        (state: GlobalState) =>
            getConfig(state).ExperimentalGroupUnreadChannels,
