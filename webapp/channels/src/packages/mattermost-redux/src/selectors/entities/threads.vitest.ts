...
describe('Selectors.Threads.getThreadOrderInCurrentTeam', () => {
    ...
    test('should return threads order in current team based on last reply time', () => {
...
describe('Selectors.Threads.getUnreadThreadOrderInCurrentTeam', () => {
    ...
    test('should return unread threads order in current team based on last reply time', () => {
        const user = TestHelper.fakeUserWithId();
...
describe('Selectors.Threads.getThreadsInCurrentTeam', () => {
    ...
    test('should return threads in current team', () => {
        const user = TestHelper.fakeUserWithId();
...
describe('Selectors.Threads.getThreadsInChannel', () => {
    ...
    test('should return threads in channel', () => {
        const user = TestHelper.fakeUserWithId();
...
describe('Selectors.Threads.getNewestThreadInTeam', () => {
    ...
    test('should return newest thread in team', () => {
        const user = TestHelper.fakeUserWithId();
