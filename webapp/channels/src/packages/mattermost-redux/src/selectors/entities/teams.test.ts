...
describe("Selectors.Teams", () => {
    ...
    membersInTeam[team1.id][user3.id] = {
        team_id: team1.id,
        user_id: user3.id,
        roles: General.TEAM_USER_ROLE,
    } as TeamMembership;
    ...
    it("getTeamsList", () => {
        expect(Selectors.getTeamsList(testState)).toEqual([
            team1,
            team2,
            team3,
            team4,
    ...
    it("getMembersInCurrentTeam", () => {
        expect(Selectors.getMembersInCurrentTeam(testState)).toEqual(
            membersInTeam[team1.id],
        );
    });

    it("getTeamMember", () => {
        expect(Selectors.getTeamMember(testState, team1.id, user2.id)).toEqual(
            membersInTeam[team1.id][user2.id],
        );
    });
    ...
    it("getSortedJoinableTeamsUsingPermissions", () => {
        ...
        const joinableTeams = Selectors.getSortedJoinableTeams(
            modifiedState,
            "en",
        );
        expect(joinableTeams[0]).toBe(openTeams[0]);
    ...
    it("getSortedListableTeamsUsingPermissions", () => {
        ...
        const listableTeams = Selectors.getSortedListableTeams(
            modifiedState,
            "en",
        );
        expect(listableTeams[0]).toBe(openTeams[0]);
    ...
    it("isCurrentUserCurrentTeamAdmin", () => {
        expect(Selectors.isCurrentUserCurrentTeamAdmin(testState)).toEqual(
            false,
        );
    });

    it("getMyTeamMember", () => {
        expect(Selectors.getMyTeamMember(testState, team1.id)).toEqual(
            myMembers[team1.id],
        );
    });
    ...
    it("getMySortedTeamIds", () => {
        ...
        const fromModifiedState = Selectors.getMySortedTeamIds(
            modifiedState,
            "en",
        );
    ...
    it("getCurrentRelativeTeamUrl", () => {
        expect(Selectors.getCurrentRelativeTeamUrl(testState)).toEqual(
            "/" + team1.name,
        );
        expect(
            Selectors.getCurrentRelativeTeamUrl({
    ...
    it("getCurrentTeamUrl", () => {
        ...
        expect(Selectors.getCurrentTeamUrl(withSiteURLState)).toEqual(
            siteURL + "/" + team1.name,
        );
        ...
        expect(Selectors.getCurrentTeamUrl(withCredentialURLState)).toEqual(
            credentialURL + "/" + team1.name,
        );
    });
