...
describe('integration utils', () => {
    describe('checkDialogElementForError', () => {
        ...
        test('should return error when value is falsey and not on the list of options', () => {
    ...
    describe('date and datetime validation', () => {
        test('should return null for valid date formats', () => {
        ...
        test('should return null for valid datetime formats', () => {
        ...
        test('should return error for invalid datetime formats', () => {
            const datetimeElement = TestHelper.getDialogElementMock({type: 'datetime'});
        ...
        test('should return required error for empty required fields', () => {
