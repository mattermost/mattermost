...
export function getEmailInterval(
    ...
    const validValuesWithEmailBatching = [
        INTERVAL_IMMEDIATE,
        INTERVAL_NEVER,
        INTERVAL_FIFTEEN_MINUTES,
        INTERVAL_HOUR,
    ];
    const validValuesWithoutEmailBatching = [
        INTERVAL_IMMEDIATE,
        INTERVAL_NEVER,
    ];
