...
describe("integration utils", () => {
    describe("checkDialogElementForError", () => {
        it("should return null error on optional text element", () => {
            expect(
                checkDialogElementForError(
                    TestHelper.getDialogElementMock({
                        type: "text",
                        optional: true,
                    }),
                    undefined,
        ...
        it("should return error on required element", () => {
            ...
            ).toBe("interactive_dialog.error.required");
        });
        ...
        it("should return error on too short text element", () => {
            ...
            ).toBe("interactive_dialog.error.too_short");
        });
        ...
        it("should return error on bad number element", () => {
            ...
            ).toBe("interactive_dialog.error.bad_number");
        });
        ...
        it("should return error on bad email element", () => {
            ...
            ).toBe("interactive_dialog.error.bad_email");
        });
        ...
        it("should return error on bad url element", () => {
            ...
            ).toBe("interactive_dialog.error.bad_url");
        });
        ...
        it("should return error when value is not in the options", () => {
            ...
            ).toBe("interactive_dialog.error.invalid_option");
        });
    ...
    describe("checkIfErrorsMatchElements", () => {
        it("should pass as returned error matches an element", () => {
            expect(
                checkIfErrorsMatchElements({ name1: "some error" } as any, [
                    TestHelper.getDialogElementMock({ name: "name1" }),
                ]),
            ).toBeTruthy();
            expect(
                checkIfErrorsMatchElements({ name1: "some error" } as any, [
                    TestHelper.getDialogElementMock({ name: "name1" }),
                    TestHelper.getDialogElementMock({ name: "name2" }),
                ]),
            ).toBeTruthy();
        });
        ...
        it("should fail as returned errors do not match an element", () => {
            expect(
                !checkIfErrorsMatchElements({ name17: "some error" } as any, [
                    TestHelper.getDialogElementMock({ name: "name1" }),
                    TestHelper.getDialogElementMock({ name: "name2" }),
                ]),
            ).toBeTruthy();
