...
describe('makeAddDateSeparatorsForSearchResults', () => {
    test('should add date separators for posts on different days', () => {
    ...
    test('should not add date separators for posts on the same day', () => {
        const addDateSeparatorsForSearchResults = makeAddDateSeparatorsForSearchResults();
        const time = Date.now();
        const today = new Date(time);
    ...
    test('should handle posts with no timezone information', () => {
        const addDateSeparatorsForSearchResults = makeAddDateSeparatorsForSearchResults();
        const time = Date.now();
        const today = new Date(time);
        const yesterday = new Date(time - (24 * 60 * 60 * 1000));
    ...
    test('should handle single post correctly', () => {
        const addDateSeparatorsForSearchResults = makeAddDateSeparatorsForSearchResults();
        const time = Date.now();
        const today = new Date(time);
    ...
    test('should handle posts spanning multiple days correctly', () => {
        const addDateSeparatorsForSearchResults = makeAddDateSeparatorsForSearchResults();
        const time = Date.now();
        const today = new Date(time);
        const yesterday = new Date(time - (24 * 60 * 60 * 1000));
...
describe('extractUserActivityData', () => {
    ...
    test('should return empty activity when empty ', () => {
    ...
    test('should return expected data for ADD_TO_CHANNEL', () => {
    ...
    test('should return expected data for ADD_TO_TEAM', () => {
    ...
    test('should return expected data for JOIN_TEAM', () => {
    ...
    test('should return expected data for LEAVE_CHANNEL', () => {
    ...
    test('should return expected data for LEAVE_TEAM', () => {
    ...
    test('should return expected data for REMOVE_FROM_CHANNEL', () => {
    ...
    test('should return expected data for REMOVE_FROM_TEAM', () => {
    ...
    test('should return expected data for multiple post types', () => {
...
describe('combineUserActivityData', () => {
    test('combineUserActivitySystemPost returns null when systemPosts is an empty array', () => {
        expect(combineUserActivitySystemPost([])).toBeFalsy();
    });
    test('correctly combine different post types and actorIds by order', () => {
    ...
    test('correctly combine same post types', () => {
        const postAddToChannel1 = TestHelper.getPostMock({type: PostTypes.ADD_TO_CHANNEL, user_id: 'user_id_1', props: {addedUserId: 'added_user_id_1', addedUsername: 'added_username_1'}});
    ...
    test('correctly combine Join and Leave Posts', () => {
        const postJoinChannel1 = TestHelper.getPostMock({type: PostTypes.JOIN_CHANNEL, user_id: 'user_id_1'});
        const postLeaveChannel1 = TestHelper.getPostMock({type: PostTypes.LEAVE_CHANNEL, user_id: 'user_id_1'});
    ...
    test('should only partially combine mismatched join and leave posts', () => {
        const postJoinChannel1 = TestHelper.getPostMock({type: PostTypes.JOIN_CHANNEL, user_id: 'user_id_1'});
        const postLeaveChannel1 = TestHelper.getPostMock({type: PostTypes.LEAVE_CHANNEL, user_id: 'user_id_1'});
        const postJoinChannel2 = TestHelper.getPostMock({type: PostTypes.JOIN_CHANNEL, user_id: 'user_id_2'});
        const postLeaveChannel2 = TestHelper.getPostMock({type: PostTypes.LEAVE_CHANNEL, user_id: 'user_id_2'});
    ...
    test('should not combine join and leave posts with other actions in between', () => {
        const postJoinChannel1 = TestHelper.getPostMock({type: PostTypes.JOIN_CHANNEL, user_id: 'user_id_1'});
        const postLeaveChannel1 = TestHelper.getPostMock({type: PostTypes.LEAVE_CHANNEL, user_id: 'user_id_1'});
