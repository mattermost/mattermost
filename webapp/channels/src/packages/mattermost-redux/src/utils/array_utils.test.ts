...
describe("insertWithoutDuplicates", () => {
    test("should add the item at the given location", () => {
        expect(insertWithoutDuplicates(["a", "b", "c", "d"], "z", 0)).toEqual([
            "z",
            "a",
            "b",
            "c",
        ...
        expect(insertWithoutDuplicates(["a", "b", "c", "d"], "z", 1)).toEqual([
            "a",
            "z",
            "b",
            "c",
        ...
        expect(insertWithoutDuplicates(["a", "b", "c", "d"], "z", 2)).toEqual([
            "a",
            "b",
            "z",
            "c",
        ...
        expect(insertWithoutDuplicates(["a", "b", "c", "d"], "z", 3)).toEqual([
            "a",
            "b",
            "c",
            "z",
        ...
        expect(insertWithoutDuplicates(["a", "b", "c", "d"], "z", 4)).toEqual([
            "a",
            "b",
            "c",
            "d",
    ...
    test("should move an item if it already exists", () => {
        expect(insertWithoutDuplicates(["a", "b", "c", "d"], "a", 0)).toEqual([
            "a",
            "b",
            "c",
            "d",
        ]);
        expect(insertWithoutDuplicates(["a", "b", "c", "d"], "a", 1)).toEqual([
            "b",
            "a",
            "c",
            "d",
        ]);
        expect(insertWithoutDuplicates(["a", "b", "c", "d"], "a", 2)).toEqual([
            "b",
            "c",
            "a",
            "d",
        ]);
        expect(insertWithoutDuplicates(["a", "b", "c", "d"], "a", 3)).toEqual([
            "b",
            "c",
            "d",
            "a",
...
describe("insertMultipleWithoutDuplicates", () => {
    ...
    test("should return the original array if nothing changed", () => {
        ...
        expect(
            insertMultipleWithoutDuplicates(input, ["a", "b", "c"], 0),
        ).toStrictEqual(input);
    });

    test("should just return the array if either the input or items to insert is blank", () => {
        expect(
            insertMultipleWithoutDuplicates([], ["a", "b", "c"], 0),
        ).toStrictEqual(["a", "b", "c"]);
        expect(
            insertMultipleWithoutDuplicates(["a", "b", "c"], [], 0),
        ).toStrictEqual(["a", "b", "c"]);
