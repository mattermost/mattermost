...
describe("PostUtils", () => {
    describe("shouldFilterJoinLeavePost", () => {
        it("show join/leave posts", () => {
            ...
            expect(
                shouldFilterJoinLeavePost(
                    TestHelper.getPostMock({ type: PostTypes.CHANNEL_DELETED }),
                    showJoinLeave,
                    "",
                ),
            ).toBe(false);
            ...
            expect(
                shouldFilterJoinLeavePost(
                    TestHelper.getPostMock({ type: PostTypes.CONVERT_CHANNEL }),
                    showJoinLeave,
                    "",
                ),
            ).toBe(false);
            expect(
                shouldFilterJoinLeavePost(
                    TestHelper.getPostMock({ type: PostTypes.EPHEMERAL }),
                    showJoinLeave,
                    "",
                ),
            ).toBe(false);
            expect(
                shouldFilterJoinLeavePost(
                    TestHelper.getPostMock({ type: PostTypes.HEADER_CHANGE }),
                    showJoinLeave,
                    "",
                ),
            ).toBe(false);
            expect(
                shouldFilterJoinLeavePost(
                    TestHelper.getPostMock({ type: PostTypes.PURPOSE_CHANGE }),
                    showJoinLeave,
                    "",
                ),
            ).toBe(false);
            ...
            expect(
                shouldFilterJoinLeavePost(
                    TestHelper.getPostMock({ type: PostTypes.JOIN_LEAVE }),
                    showJoinLeave,
                    "",
                ),
            ).toBe(false);
            expect(
                shouldFilterJoinLeavePost(
                    TestHelper.getPostMock({ type: PostTypes.JOIN_CHANNEL }),
                    showJoinLeave,
                    "",
                ),
            ).toBe(false);
            expect(
                shouldFilterJoinLeavePost(
                    TestHelper.getPostMock({ type: PostTypes.LEAVE_CHANNEL }),
                    showJoinLeave,
                    "",
                ),
            ).toBe(false);
            expect(
                shouldFilterJoinLeavePost(
                    TestHelper.getPostMock({ type: PostTypes.ADD_REMOVE }),
                    showJoinLeave,
                    "",
                ),
            ).toBe(false);
            expect(
                shouldFilterJoinLeavePost(
                    TestHelper.getPostMock({ type: PostTypes.ADD_TO_CHANNEL }),
                    showJoinLeave,
                    "",
                ),
            ).toBe(false);
            expect(
                shouldFilterJoinLeavePost(
                    TestHelper.getPostMock({
                        type: PostTypes.REMOVE_FROM_CHANNEL,
                    }),
                    showJoinLeave,
                    "",
                ),
            ...
            expect(
                shouldFilterJoinLeavePost(
                    TestHelper.getPostMock({ type: PostTypes.JOIN_TEAM }),
                    showJoinLeave,
                    "",
                ),
            ).toBe(false);
            expect(
                shouldFilterJoinLeavePost(
                    TestHelper.getPostMock({ type: PostTypes.LEAVE_TEAM }),
                    showJoinLeave,
                    "",
                ),
            ).toBe(false);
            expect(
                shouldFilterJoinLeavePost(
                    TestHelper.getPostMock({ type: PostTypes.ADD_TO_TEAM }),
                    showJoinLeave,
                    "",
                ),
            ).toBe(false);
            expect(
                shouldFilterJoinLeavePost(
                    TestHelper.getPostMock({
                        type: PostTypes.REMOVE_FROM_TEAM,
                    }),
                    showJoinLeave,
                    "",
                ),
        ...
        it("always join/leave posts for the current user", () => {
            ...
            expect(
                shouldFilterJoinLeavePost(
                    TestHelper.getPostMock({
                        ...
                        props: { username, addedUsername: otherUsername },
                    }),
                    showJoinLeave,
                    username,
                ),
            ...
            expect(
                shouldFilterJoinLeavePost(
                    TestHelper.getPostMock({
                        type: PostTypes.REMOVE_FROM_CHANNEL,
                        props: { removedUsername: otherUsername },
                    }),
                    showJoinLeave,
                    username,
                ),
        ...
        it("should work with new permissions version", () => {
            ...
            expect(
                !canEditPost(
                    ...
                    channelId,
                    userId,
                    TestHelper.getPostMock({ user_id: userId }),
                ),
            ).toBeTruthy();
            expect(
                !canEditPost(
            ...
            expect(
                !canEditPost(
                    ...
                    channelId,
                    userId,
                    TestHelper.getPostMock({ user_id: "other" }),
                ),
            ).toBeTruthy();
            expect(
                !canEditPost(
            ...
            newVersionState.entities.roles = {
                roles: {
                    system_role: TestHelper.getRoleMock({
            ...
            newVersionState.entities.roles = {
                roles: {
                    ...
                    team_role: TestHelper.getRoleMock({
                        permissions: [Permissions.EDIT_POST],
                    }),
                    channel_role: TestHelper.getRoleMock({ permissions: [] }),
                },
            ...
            newVersionState.entities.roles = {
                roles: {
                    system_role: TestHelper.getRoleMock({ permissions: [] }),
                    team_role: TestHelper.getRoleMock({ permissions: [] }),
                    channel_role: TestHelper.getRoleMock({
                        permissions: [Permissions.EDIT_POST],
                    }),
                },
                pending: new Set(),
        ...
        const testCases = [
...

            {
                input: TestHelper.getPostMock({
                    type: PostTypes.CHANNEL_DELETED,
                }),
                output: true,
            },
            {
                input: TestHelper.getPostMock({
                    type: PostTypes.CHANNEL_UNARCHIVED,
                }),
                output: true,
            },
            {
            ...
            {
                input: TestHelper.getPostMock({
                    type: PostTypes.CONVERT_CHANNEL,
                }),
                output: true,
            },
            {
                input: TestHelper.getPostMock({ type: PostTypes.EPHEMERAL }),
                output: true,
            },
            {
                input: TestHelper.getPostMock({
            ...
            {
                input: TestHelper.getPostMock({
                    type: PostTypes.HEADER_CHANGE,
                }),
                output: true,
            },
            {
                input: TestHelper.getPostMock({
                    type: PostTypes.PURPOSE_CHANGE,
                }),
                output: true,
            },

            {
                input: TestHelper.getPostMock({ type: PostTypes.JOIN_LEAVE }),
                output: true,
            }, // deprecated system type
            {
                input: TestHelper.getPostMock({ type: PostTypes.ADD_REMOVE }),
                output: true,
            }, // deprecated system type

            {
                input: TestHelper.getPostMock({
                    type: PostTypes.COMBINED_USER_ACTIVITY,
                }),
                output: true,
            },
            ...
            {
                input: TestHelper.getPostMock({ type: PostTypes.JOIN_CHANNEL }),
                output: true,
            },
            {
                input: TestHelper.getPostMock({
            ...
            {
                input: TestHelper.getPostMock({ type: PostTypes.ADD_TO_TEAM }),
                output: true,
            },
            {
                input: TestHelper.getPostMock({ type: PostTypes.JOIN_TEAM }),
                output: true,
            },
            {
                input: TestHelper.getPostMock({ type: PostTypes.LEAVE_TEAM }),
                output: true,
            },
            {
                input: TestHelper.getPostMock({
    ...
    describe("isUserActivityPost", () => {
        ...
        testCases.forEach((testCase) => {
            it(`should identify if post is user activity - add/remove/join/leave channel/team: isUserActivityPost('${testCase.input}') should return ${testCase.output}`, () => {
                expect(isUserActivityPost(testCase.input)).toBe(
                    testCase.output,
                );
            });
        });
    ...
    describe("isPostCommentMention", () => {
        ...
        it("should return true as root post is by user", () => {
            ...
            const isCommentMention = isPostCommentMention({
                currentUser,
                post,
                rootPost,
                threadRepliedToByCurrentUser: false,
            });
    ...
    describe("getEmbedFromMetadata", () => {
        ...
        it("should return first entry in embed key", () => {
            ...
            const embedData = getEmbedFromMetadata({
                embeds: [embedValue, { type: "image", url: "url1" }],
            } as Post["metadata"]);
