...
describe('PostUtils', () => {
    describe('shouldFilterJoinLeavePost', () => {
        ...
        test('always join/leave posts for the current user', () => {
    ...
    describe('canEditPost', () => {
        ...
        test('should work with new permissions version', () => {
            let newVersionState = {
                entities: {
                    general: {
                        serverVersion: '4.9.0',
    ...
    describe('isSystemMessage', () => {
        ...
        testCases.forEach((testCase) => {
            test(`should identify if post is system message: isSystemMessage('${testCase.input}') should return ${testCase.output}`, () => {
    ...
    describe('shouldIgnorePost', () => {
        test('should return false if system message is adding current user', () => {
        ...
        test('should return true if system message is adding a different user', () => {
            const currentUserId = 'czduet3upjfupy9xnqswrxaqea';
            const post = TestHelper.getPostMock({
                type: PostTypes.ADD_TO_CHANNEL,
                props: {
    ...
    describe('isUserActivityPost', () => {
        ...
        testCases.forEach((testCase) => {
            test(`should identify if post is user activity - add/remove/join/leave channel/team: isUserActivityPost('${testCase.input}') should return ${testCase.output}`, () => {
    ...
    describe('isPostCommentMention', () => {
        ...
        test('should return true as root post is by user', () => {
            const post = TestHelper.getPostMock({
        ...
        test('should return false as root post is not by user and did not participate in thread', () => {
            const post = TestHelper.getPostMock({
                user_id: 'someotherUser',
            });
        ...
        test('should return false post is by current User', () => {
            const post = TestHelper.getPostMock({
                user_id: 'currentUser',
            });
        ...
        test('should return true as post is by current User but it is a webhhok and user participated in thread', () => {
            const post = TestHelper.getPostMock({
                user_id: 'currentUser',
                props: {
                    from_webhook: 'true',
        ...
        test('should return false as root post is not by currentUser and notify_props is root', () => {
            const post = TestHelper.getPostMock({
                user_id: 'someotherUser',
            });
        ...
        test('should return true as root post is by currentUser and notify_props is root', () => {
            const post = TestHelper.getPostMock({
                user_id: 'someotherUser',
            });
    ...
    describe('getEmbedFromMetadata', () => {
        test('should return null if no metadata is not passed as argument', () => {
            const embedData = (getEmbedFromMetadata as any)();
            expect(embedData).toBe(null);
        });

        test('should return null if argument does not contain embed key', () => {
            const embedData = (getEmbedFromMetadata as any)({});
            expect(embedData).toBe(null);
        });

        test('should return null if embed key in argument is empty', () => {
            const embedData = (getEmbedFromMetadata as any)({embeds: []});
            expect(embedData).toBe(null);
        });

        test('should return first entry in embed key', () => {
    ...
    describe('isPermalink', () => {
        test('should return true if post contains permalink', () => {
            const post = TestHelper.getPostMock({
        ...
        test('should return false if post contains an embed that is not a permalink', () => {
            const post = TestHelper.getPostMock({
        ...
        test('should return false if post has no embeds', () => {
    ...
    describe('shouldUpdatePost', () => {
        ...
        test('should return true for new posts', () => {
            const post = TestHelper.getPostMock({
                ...storedPost,
                update_at: 100,
            });
        ...
        test('should return false for older posts', () => {
            const post = {
                ...storedPost,
                update_at: 40,
            };
        ...
        test('should return true for newer posts', () => {
            const post = TestHelper.getPostMock({
                id: 'post1',
                message: 'test',
                update_at: 400,
        ...
        test('should return false for same posts', () => {
            const post = {...storedPost};
            expect(shouldUpdatePost(post, storedPost)).toBe(false);
        });

        test('should return true for same posts with participants changed', () => {
            const post = {
                ...storedPost,
                participants: [],
            };
        ...
        test('should return true for same posts with reply_count changed', () => {
            const post = {
                ...storedPost,
                reply_count: 2,
            };
        ...
        test('should return true for same posts with is_following changed', () => {
            const post = {
                ...storedPost,
                is_following: true,
            };
        ...
        test('should return true for same posts with metadata in received post and not in stored post', () => {
            const post = TestHelper.getPostMock({
                ...storedPost,
