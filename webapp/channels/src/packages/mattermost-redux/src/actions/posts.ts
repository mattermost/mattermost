...
import {bindClientFunc, combineResults, forceLogoutIfNecessary} from 'mattermost-redux/actions/helpers';
import {
    deletePreferences,
    savePreferences,
...
import type {ActionFunc, ActionFuncPromiseDoNotUse, ActionResult, DispatchFunc, GetStateFunc} from 'mattermost-redux/types/actions';
...
export function createPost(post: Post, files: any[] = []): ActionFunc {
...
export function createPostImmediately(post: Post, files: any[] = []): ActionFunc {
    return async (dispatch, getState) => {
        const state = getState();
        const currentUserId = state.entities.users.currentUserId;
        const timestamp = Date.now();
...
export function deletePost(post: ExtendedPost): ActionFunc {
    return async (dispatch, getState) => {
        const state = getState();
        const delPost = {...post};
...
export function setUnreadPost(userId: string, postId: string): ActionFunc {
    return async (dispatch, getState) => {
        let state = getState();
...
export function getPostThread(rootId: string, fetchThreads = true): ActionFuncPromiseDoNotUse {
    return async (dispatch, getState) => {
...
export function getNewestPostThread(rootId: string): ActionFunc {
...
export function getPosts(channelId: string, page = 0, perPage = Posts.POST_CHUNK_SIZE, fetchThreads = true, collapsedThreadsExtended = false): ActionFunc {
    return async (dispatch, getState) => {
        let posts;
        const collapsedThreadsEnabled = isCollapsedThreadsEnabled(getState());
        try {
...
export function getPostsUnread(channelId: string, fetchThreads = true, collapsedThreadsExtended = false): ActionFunc {
    return async (dispatch, getState) => {
...
export function getPostsSince(channelId: string, since: number, fetchThreads = true, collapsedThreadsExtended = false): ActionFunc {
    return async (dispatch, getState) => {
        let posts;
        try {
            const collapsedThreadsEnabled = isCollapsedThreadsEnabled(getState());
...
export function getPostsBefore(channelId: string, postId: string, page = 0, perPage = Posts.POST_CHUNK_SIZE, fetchThreads = true, collapsedThreadsExtended = false): ActionFunc {
    return async (dispatch, getState) => {
        let posts;
        try {
            const collapsedThreadsEnabled = isCollapsedThreadsEnabled(getState());
...
export function getPostsAfter(channelId: string, postId: string, page = 0, perPage = Posts.POST_CHUNK_SIZE, fetchThreads = true, collapsedThreadsExtended = false): ActionFunc {
    return async (dispatch, getState) => {
        let posts;
        try {
            const collapsedThreadsEnabled = isCollapsedThreadsEnabled(getState());
...
export function getPostsAround(channelId: string, postId: string, perPage = Posts.POST_CHUNK_SIZE / 2, fetchThreads = true, collapsedThreadsExtended = false): ActionFunc {
    return async (dispatch, getState) => {
        let after;
        let thread;
        let before;
...
export function getThreadsForPosts(posts: Post[], fetchThreads = true): ActionFunc {
...
export function getPostsByIds(ids: string[]): ActionFunc {
    return async (dispatch, getState) => {
        let posts;
...
export function addPostReminder(userId: string, postId: string, timestamp: number): ActionFunc {
    return async (dispatch, getState) => {
        try {
...
export function doPostActionWithCookie(postId: string, actionId: string, actionCookie: string, selectedOption = ''): ActionFunc {
    return async (dispatch, getState) => {
        let data;
        try {
 ...
 */
export function resetReloadPostsInChannel(): ActionFunc {
    return async (dispatch, getState) => {
        dispatch({
...
export function acknowledgePost(postId: string): ActionFunc {
    return async (dispatch, getState) => {
        const userId = getCurrentUserId(getState());
...
export function unacknowledgePost(postId: string): ActionFunc {
    return async (dispatch, getState) => {
        const userId = getCurrentUserId(getState());
