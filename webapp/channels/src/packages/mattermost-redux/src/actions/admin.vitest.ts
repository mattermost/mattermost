...
describe('Actions.Admin', () => {
    ...
    test('getEnvironmentConfig', async () => {
        nock(Client4.getBaseRoute()).
    ...
    test('createComplianceReport', async () => {
        const job = {
            desc: 'testjob',
    ...
    test('getComplianceReports', async () => {
        const job = {
            desc: 'testjob',
            emails: 'joram@example.com',
            keywords: 'testkeyword',
    ...
    test('getSamlCertificateStatus', async () => {
        nock(Client4.getBaseRoute()).
    ...
    test('uploadPublicSamlCertificate', async () => {
    ...
    test('uploadPrivateSamlCertificate', async () => {
        const testFileData = fs.createReadStream('src/packages/mattermost-redux/test/assets/images/test.png');
    ...
    test('uploadIdpSamlCertificate', async () => {
        const testFileData = fs.createReadStream('src/packages/mattermost-redux/test/assets/images/test.png');
    ...
    test('removePublicSamlCertificate', async () => {
        nock(Client4.getBaseRoute()).
    ...
    test('removePrivateSamlCertificate', async () => {
        nock(Client4.getBaseRoute()).
    ...
    test('removeIdpSamlCertificate', async () => {
        nock(Client4.getBaseRoute()).
    ...
    test('uploadPublicLdapCertificate', async () => {
        const testFileData = fs.createReadStream('src/packages/mattermost-redux/test/assets/images/test.png');
    ...
    test('uploadPrivateLdapCertificate', async () => {
        const testFileData = fs.createReadStream('src/packages/mattermost-redux/test/assets/images/test.png');
    ...
    test('removePublicLdapCertificate', async () => {
        nock(Client4.getBaseRoute()).
    ...
    test('removePrivateLdapCertificate', async () => {
        nock(Client4.getBaseRoute()).
    ...
    test('purgeElasticsearchIndexes', async () => {
        nock(Client4.getBaseRoute()).
    ...
    test('getStandardAnalytics', async () => {
        nock(Client4.getBaseRoute()).
            get('/analytics/old').
            query(true).
            times(2).
    ...
    test('getAdvancedAnalytics', async () => {
        nock(Client4.getBaseRoute()).
            get('/analytics/old').
            query(true).
            times(2).
    ...
    test('getPostsPerDayAnalytics', async () => {
        nock(Client4.getBaseRoute()).
            get('/analytics/old').
            query(true).
            times(2).
    ...
    test('getUsersPerDayAnalytics', async () => {
        nock(Client4.getBaseRoute()).
            get('/analytics/old').
            query(true).
            times(2).
    ...
    test('overwriteInstallPlugin', async () => {
    ...
    test('installPluginFromUrl', async () => {
        const downloadUrl = 'testplugin.tar.gz';
        const testPlugin = {id: 'testplugin', webapp: {bundle_path: '/static/somebundle.js'}};
    ...
    test('getLdapGroups is_linked', async () => {
        let scope = nock(Client4.getBaseRoute()).
    ...
    test('getLdapGroups is_configured', async () => {
        let scope = nock(Client4.getBaseRoute()).
    ...
    test('getLdapGroups with name query', async () => {
        let scope = nock(Client4.getBaseRoute()).
    ...
    test('getSamlMetadataFromIdp', async () => {
        nock(Client4.getBaseRoute()).
    ...
    test('setSamlIdpCertificateFromMetadata', async () => {
        nock(Client4.getBaseRoute()).
            post('/saml/certificate/idp').
            reply(200, OK_RESPONSE);
    ...
    test('getDataRetentionCustomPolicies', async () => {
        const policies = {
            policies: [
                {
                    id: 'id1',
    ...
    test('getDataRetentionCustomPolicy', async () => {
        const policy = {
            id: 'id1',
            display_name: 'Test Policy',
            post_duration: 100,
    ...
    test('getDataRetentionCustomPolicyTeams', async () => {
        const teams = [
            {
                ...TestHelper.fakeTeam(),
                policy_id: 'id1',
    ...
    test('getDataRetentionCustomPolicyChannels', async () => {
        const channels = [
            {
    ...
    test('searchDataRetentionCustomPolicyTeams', async () => {
        nock(Client4.getBaseRoute()).
    ...
    test('searchDataRetentionCustomPolicyChannels', async () => {
        nock(Client4.getBaseRoute()).
    ...
    test('createDataRetentionCustomPolicy', async () => {
        const policy = {
            display_name: 'Test',
            post_duration: 100,
    ...
    test('updateDataRetentionCustomPolicy', async () => {
        nock(Client4.getBaseRoute()).
    ...
    test('removeDataRetentionCustomPolicyTeams', async () => {
        const teams = [
            {
                ...TestHelper.fakeTeam(),
                policy_id: 'id1',
    ...
    test('removeDataRetentionCustomPolicyChannels', async () => {
        const channels = [
            {
                ...TestHelper.fakeChannel('teamId1'),
                policy_id: 'id1',
