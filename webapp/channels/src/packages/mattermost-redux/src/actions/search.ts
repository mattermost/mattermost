...
import type {ActionResult, NewActionFuncAsync, NewActionFuncOldVariantDoNotUse} from 'mattermost-redux/types/actions';
...
export function getMissingChannelsFromFiles(files: Map<string, FileSearchResultItem>): NewActionFuncAsync {
    return async (dispatch, getState) => {
        const {
            channels,
            membersInChannel,
...
export function searchPostsWithParams(teamId: string, params: SearchParameter): NewActionFuncAsync<PostSearchResults> {
    return async (dispatch, getState) => {
...
export function getMorePostsForSearch(): NewActionFuncAsync {
    return async (dispatch, getState) => {
...
export function searchFilesWithParams(teamId: string, params: SearchParameter): NewActionFuncAsync<FileSearchResults> {
    return async (dispatch, getState) => {
        const isGettingMore = params.page > 0;
        dispatch({
...
export function getPinnedPosts(channelId: string): NewActionFuncAsync<PostList> {
    return async (dispatch, getState) => {
...
export function clearPinnedPosts(channelId: string): NewActionFuncAsync { // HARRISONTODO remove me
    return async (dispatch) => {
        dispatch({
...
export function removeSearchTerms(teamId: string, terms: string): NewActionFuncAsync { // HARRISONTODO remove me
    return async (dispatch) => {
        dispatch({
