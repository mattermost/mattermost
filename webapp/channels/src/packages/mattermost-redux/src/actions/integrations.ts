...
export function getCommands(teamId: string) { // HARRISONTODO remove me
    return bindClientFunc({
...
export function getAutocompleteCommands(teamId: string, page = 0, perPage: number = General.PAGE_SIZE_DEFAULT) { // HARRISONTODO remove me
    return bindClientFunc({
...
export function executeCommand(command: string, args: CommandArgs) { // HARRISONTODO remove me
    return bindClientFunc({
