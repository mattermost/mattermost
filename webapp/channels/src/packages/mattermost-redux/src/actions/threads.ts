...
export function fetchThreads(userId: string, teamId: string, {before = '', after = '', perPage = ThreadConstants.THREADS_CHUNK_SIZE, unread = false, totalsOnly = false, threadsOnly = false, extended = false, since = 0} = {}): ActionFunc {
...
export function getThreads(userId: string, teamId: string, {before = '', after = '', perPage = ThreadConstants.THREADS_CHUNK_SIZE, unread = false, extended = true} = {}): ActionFunc {
...
export function getThreadCounts(userId: string, teamId: string): ActionFunc {
    return async (dispatch) => {
...
export function getCountsAndThreadsSince(userId: string, teamId: string, since?: number): ActionFunc {
    return async (dispatch) => {
...
export function getThread(userId: string, teamId: string, threadId: string, extended = true): ActionFunc {
    return async (dispatch, getState) => {
        let thread;
        try {
...
export function markAllThreadsInTeamRead(userId: string, teamId: string): ActionFunc {
    return async (dispatch, getState) => {
        try {
...
export function markThreadAsUnread(userId: string, teamId: string, threadId: string, postId: string): ActionFunc {
    return async (dispatch, getState) => {
        try {
...
export function markLastPostInThreadAsUnread(userId: string, teamId: string, threadId: string): ActionFunc {
    return async (dispatch, getState) => {
...
export function updateThreadRead(userId: string, teamId: string, threadId: string, timestamp: number): ActionFunc {
    return async (dispatch, getState) => {
        try {
...
export function setThreadFollow(userId: string, teamId: string, threadId: string, newState: boolean): ActionFunc {
    return async (dispatch, getState) => {
