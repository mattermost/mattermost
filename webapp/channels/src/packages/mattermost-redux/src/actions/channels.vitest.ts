...
describe('Actions.Channels', () => {
    ...
    test('getChannelAndMyMember', async () => {
        nock(Client4.getBaseRoute()).
            get(`/channels/${TestHelper.basicChannel!.id}`).
            reply(200, TestHelper.basicChannel!);
    ...
    test('fetchChannelsAndMembers', async () => {
        nock(Client4.getBaseRoute()).
            post('/users').
            query(true).
            reply(201, TestHelper.fakeUserWithId());
    ...
    describe('markChannelAsRead', () => {
        ...
        test('one unread DM channel', async () => {
            const channelId = TestHelper.generateId();
        ...
        test('two unread channels, same team, reading one', async () => {
        ...
        test('two unread channels, different teams, reading one', async () => {
            const channelId1 = TestHelper.generateId();
            const channelId2 = TestHelper.generateId();
    ...
    test('getAllChannelsWithCount', async () => {
        const userClient = TestHelper.createClient4();
    ...
    test('removeChannelMember', async () => {
        const channelId = TestHelper.basicChannel!.id;
    ...
    test('updateChannelScheme', async () => {
        TestHelper.mockLogin();
        store.dispatch({
            type: UserTypes.LOGIN_SUCCESS,
        });
    ...
    test('markGroupChannelOpen', async () => {
        const channelId = TestHelper.generateId();
    ...
    test('getChannelModerations', async () => {
        const channelID = 'cid10000000000000000000000';
    ...
    test('patchChannelModerations', async () => {
        const channelID = 'cid10000000000000000000000';
    ...
    test('fetchAllMyChannelMembers', async () => {
