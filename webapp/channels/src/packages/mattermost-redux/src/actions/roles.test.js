...
describe("Actions.Roles", () => {
    ...
    it("getRolesByNames", async () => {
        ...
        await Actions.getRolesByNames(["system_admin"])(
            store.dispatch,
            store.getState,
        );
        ...
        expect(roles.system_admin.permissions).toEqual(
            TestHelper.basicRoles.system_admin.permissions,
        );
    });
    ...
    it("getRoleByName", async () => {
        nock(Client4.getRolesRoute())
            ...
            .reply(200, TestHelper.basicRoles.system_admin);
        await Actions.getRoleByName("system_admin")(
            store.dispatch,
            store.getState,
        );
    ...
    it("getRole", async () => {
        ...
        await Actions.getRole(TestHelper.basicRoles.system_admin.id)(
            store.dispatch,
            store.getState,
        );
    ...
    it("loadRolesIfNeeded", async () => {
        ...
        await Actions.loadRolesIfNeeded(["test"])(
            store.dispatch,
            () => fakeState,
        );
        ...
        await Actions.loadRolesIfNeeded(["test", "test2"])(
            store.dispatch,
            () => fakeState,
        );
        expect(mock1.isDone()).toBe(false);
    ...
    it("editRole", async () => {
        ...
        const mock = nock(Client4.getRolesRoute())
            .put(
                "/" + roleId + "/patch",
                JSON.stringify({ id: roleId, test: "test" }),
            )
            .reply(200, {});

        await Actions.editRole({ id: roleId, test: "test" })(
            store.dispatch,
            store.state,
        );
