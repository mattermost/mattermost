...
describe('Actions.Search', () => {
    ...
    it('Perform Search', async () => {
        ...
        await store.dispatch(Actions.searchPosts(TestHelper.basicTeam!.id, search1, false, false));
        ...
        await store.dispatch(Actions.searchPostsWithParams(TestHelper.basicTeam!.id, {terms: search1, page: 1} as SearchParameter));
        state = getState();
        ...
        //reply(201, {user_id: TestHelper.basicUser.id, channel_id: TestHelper.basicChannel.id});
        //
        //await store.dispatch(Actions.searchPosts(
        ...
        // Clear a recent term
        //await store.dispatch(Actions.removeSearchTerms(TestHelper.basicTeam.id, search2));
        //state = getState();
        //recent = state.entities.search.recent;
        //results = state.entities.search.results;
        //searchIsPresent = recent[TestHelper.basicTeam.id].findIndex((r) => r.terms === search1);
    ...
    it('Perform Files Search', async () => {
        ...
        await store.dispatch(Actions.searchFiles(TestHelper.basicTeam!.id, search1, false, false));
        ...
        await store.dispatch(Actions.searchFilesWithParams(TestHelper.basicTeam!.id, {terms: search1, page: 1} as SearchParameter));
        state = getState();
        current = state.entities.search.current[TestHelper.basicTeam!.id];
        recent = state.entities.search.recent;
