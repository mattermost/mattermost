...
describe("Actions.Emojis", () => {
    ...
    it("deleteCustomEmoji", async () => {
        ...
        await Actions.deleteCustomEmoji(created.id)(
            store.dispatch,
            store.getState,
        );
    ...
    it("searchCustomEmojis", async () => {
        ...
        await Actions.searchCustomEmojis(created.name, { prefix_only: true })(
            store.dispatch,
            store.getState,
        );
    ...
    it("autocompleteCustomEmojis", async () => {
        ...
        await Actions.autocompleteCustomEmojis(created.name)(
            store.dispatch,
            store.getState,
        );
    ...
    it("getCustomEmoji", async () => {
        ...
        await Actions.getCustomEmoji(created.id)(
            store.dispatch,
            store.getState,
        );
    ...
    it("getCustomEmojiByName", async () => {
        ...
        await Actions.getCustomEmojiByName(created.name)(
            store.dispatch,
            store.getState,
        );
        ...
        await Actions.getCustomEmojiByName(missingName)(
            store.dispatch,
            store.getState,
        );
        ...
        expect(
            state.entities.emojis.nonExistentEmoji.has(missingName),
        ).toBeTruthy();
    });
    ...
    describe("getCustomEmojisByName", () => {
        test("should be able to request a single emoji", async () => {
            ...
            const state = store.getState();
            expect(state.entities.emojis.customEmoji[emoji1.id]).toEqual(
                emoji1,
            );
        });
        ...
        test("should be able to request multiple emojis", async () => {
            ...
            await store.dispatch(
                Actions.getCustomEmojisByName(["emoji1", "emoji2"]),
            );
            ...
            expect(state.entities.emojis.customEmoji[emoji2.id]).toEqual(
                emoji2,
            );
        });
        ...
        test("should correctly track non-existent emojis", async () => {
            ...
            expect(state.entities.emojis.nonExistentEmoji).toEqual(
                new Set(["emoji2"]),
            );
        });
        ...
        test("should be able to request over 200 emojis", async () => {
            ...
            const state = store.getState();
            expect(Object.keys(state.entities.emojis.customEmoji)).toHaveLength(
                emojis.length,
            );
            for (const emoji of emojis) {
                expect(state.entities.emojis.customEmoji[emoji.id]).toEqual(
                    emoji,
                );
            }
        });
    ...
    it("getCustomEmojisInText", async () => {
        ...
        await Actions.getCustomEmojisInText(
            `some text :${created.name}: :${missingName}:`,
