...
describe("Actions.Teams", () => {
    ...
    it("getTeamsForUser", async () => {
        ...
        await Actions.getTeamsForUser(TestHelper.basicUser!.id)(
            store.dispatch,
            store.getState,
        );
    ...
    it("createTeam", async () => {
        nock(Client4.getBaseRoute())
            .post("/teams")
            .reply(201, TestHelper.fakeTeamWithId());
        await Actions.createTeam(TestHelper.fakeTeam())(
            store.dispatch,
            store.getState,
        );

        const { teams, myMembers, currentTeamId } =
            store.getState().entities.teams;
    ...
    it("unarchiveTeam", async () => {
        ...
        await Actions.unarchiveTeam(secondTeam.id)(
            store.dispatch,
            store.getState,
        );
    ...
    it("regenerateTeamInviteId", async () => {
        ...
        await Actions.regenerateTeamInviteId(team!.id)(
            store.dispatch,
            store.getState,
        );
        const { teams } = store.getState().entities.teams;
    ...
    it("Join Open Team", async () => {
        ...
        await Actions.joinTeam(team.invite_id, team.id)(
            store.dispatch,
            store.getState,
        );
    ...
    it("getMyTeamMembers and getMyTeamUnreads", async () => {
        ...
        expect(
            Object.prototype.hasOwnProperty.call(member, "mention_count"),
        ).toBeTruthy();
    });
    ...
    it("getTeamMembersForUser", async () => {
        ...
        await Actions.getTeamMembersForUser(TestHelper.basicUser!.id)(
            store.dispatch,
            store.getState,
        );
        ...
        expect(
            membersInTeam[TestHelper.basicTeam!.id][TestHelper.basicUser!.id],
        ).toBeTruthy();
    });
    ...
    it("getTeamMember", async () => {
        ...
        await Actions.getTeamMember(TestHelper.basicTeam!.id, user.id)(
            store.dispatch,
            store.getState,
        );
    ...
    it("getTeamMembers", async () => {
        ...
        const { data: member1 } = (await Actions.addUserToTeam(
        ...
        const { data: member2 } = (await Actions.addUserToTeam(
            TestHelper.basicTeam!.id,
            user2.id,
        )(store.dispatch, store.getState)) as ActionResult;
    ...
    it("getTeamMembersByIds", async () => {
        ...
        await Actions.getTeamMembersByIds(TestHelper.basicTeam!.id, [
            user1.id,
            user2.id,
        ])(store.dispatch, store.getState);
    ...
    it("getTeamStats", async () => {
        nock(Client4.getTeamRoute(TestHelper.basicTeam!.id))
            ...
            .reply(200, {
                team_id: TestHelper.basicTeam!.id,
                total_member_count: 2605,
                active_member_count: 2571,
            });
        await Actions.getTeamStats(TestHelper.basicTeam!.id)(
            store.dispatch,
            store.getState,
        );
    ...
    it("addUserToTeam", async () => {
        ...
        await Actions.addUserToTeam(TestHelper.basicTeam!.id, user.id)(
            store.dispatch,
            store.getState,
        );
        const members = store.getState().entities.teams.membersInTeam;
    ...
    it("addUsersToTeam", async () => {
        ...
        await Actions.addUsersToTeam(TestHelper.basicTeam!.id, [
            user.id,
            user2.id,
        ])(store.dispatch, store.getState);
        ...
        expect(
            profilesInTeam[TestHelper.basicTeam!.id].has(user.id),
        ).toBeTruthy();
        expect(
            profilesInTeam[TestHelper.basicTeam!.id].has(user2.id),
        ).toBeTruthy();
    });
    ...
    describe("removeUserFromTeam", () => {
        ...
        test("should remove the user from the team", async () => {
            ...
            expect(state.entities.users.profilesInTeam[team.id]).toEqual(
                new Set(),
            );
            expect(state.entities.users.profilesNotInTeam[team.id]).toEqual(
                new Set([user.id]),
            );
        });
    ...
    it("updateTeamMemberRoles", async () => {
        ...
        await Actions.updateTeamMemberRoles(
            TestHelper.basicTeam!.id,
            user.id,
            roles.split(" "),
        )(store.dispatch, store.getState);
        ...
        expect(members[TestHelper.basicTeam!.id]).toBeTruthy();
        expect(members[TestHelper.basicTeam!.id][user.id]).toBeTruthy();
        expect(members[TestHelper.basicTeam!.id][user.id].roles).toEqual(
            roles.split(" "),
        );
    });
    ...
    it("sendEmailInvitesToTeam", async () => {
        nock(Client4.getTeamRoute(TestHelper.basicTeam!.id))
            .post("/invite/email")
            .reply(200, OK_RESPONSE);
        const { data } = (await Actions.sendEmailInvitesToTeam(
            TestHelper.basicTeam!.id,
            ["fakeemail1@example.com", "fakeemail2@example.com"],
        )(store.dispatch, store.getState)) as ActionResult;
    ...
    it("checkIfTeamExists", async () => {
        ...
        let { data: exists } = (await Actions.checkIfTeamExists(
        ...
        const { data } = (await Actions.checkIfTeamExists("junk")(
            store.dispatch,
            store.getState,
        )) as ActionResult;
        exists = data;
    ...
    it("setTeamIcon", async () => {
        ...
        const { data } = (await Actions.setTeamIcon(team!.id, imageData as any)(
            store.dispatch,
            store.getState,
        )) as ActionResult;
        expect(data).toEqual(OK_RESPONSE);
    ...
    it("removeTeamIcon", async () => {
        ...
        const { data } = (await Actions.removeTeamIcon(team!.id)(
            store.dispatch,
            store.getState,
        )) as ActionResult;
        expect(data).toEqual(OK_RESPONSE);
    ...
    it("updateTeamScheme", async () => {
        ...
        await Actions.updateTeamScheme(id, schemeId)(
            store.dispatch,
            store.getState,
        );
    ...
    it("membersMinusGroupMembers", async () => {
        ...
        nock(Client4.getBaseRoute())
            .get(
                `/teams/${teamID}/members_minus_group_members?group_ids=${groupIDs.join(
                    ",",
    ...
    it("searchTeams", async () => {
        ...
        nock(Client4.getBaseRoute())
            .post("/teams/search")
            .reply(200, {
                teams: [TestHelper.basicTeam, userTeam],
                total_count: 2,
            });

        const response = await store.dispatch(
            Actions.searchTeams("test", { page: 0, per_page: 1 }),
        );
