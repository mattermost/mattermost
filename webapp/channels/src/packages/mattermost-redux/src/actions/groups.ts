...
export function linkGroupSyncable(
    groupID: string,
    syncableID: string,
    ...
    return async (dispatch: DispatchFunc, getState: GetStateFunc) => {
        let data;
        try {
            data = await Client4.linkGroupSyncable(
                groupID,
                syncableID,
                syncableType,
                patch,
        ...
        switch (syncableType) {
            case SyncableType.Team:
                dispatches.push({
                    ...
                    data: { teamID: syncableID, groups: [{ id: groupID }] },
                });
...
export function unlinkGroupSyncable(
    ...
    return async (dispatch: DispatchFunc, getState: GetStateFunc) => {
        try {
            await Client4.unlinkGroupSyncable(
                groupID,
                syncableID,
                syncableType,
            );
        ...
        switch (syncableType) {
            case SyncableType.Team:
                ...
                dispatches.push({
                    type: GroupTypes.RECEIVED_GROUPS_NOT_ASSOCIATED_TO_TEAM,
                    data: { teamID: syncableID, groups: [{ id: groupID }] },
                });
                break;
            case SyncableType.Channel:
...
export function getGroupSyncables(
    ...
    return async (dispatch: DispatchFunc, getState: GetStateFunc) => {
        ...
        dispatch(batchActions([{ type, data, group_id: groupID }]));

        return { data: true };
    };
}

export function patchGroupSyncable(
    groupID: string,
    syncableID: string,
    syncableType: SyncableType,
    patch: SyncablePatch,
    ...
    return async (dispatch: DispatchFunc, getState: GetStateFunc) => {
        let data;
        try {
            data = await Client4.patchGroupSyncable(
                groupID,
                syncableID,
                syncableType,
                patch,
...
export function getGroupsNotAssociatedToTeam(
    teamID: string,
    q = "",
    page = 0,
    ...
    return bindClientFunc({
        ...
        onSuccess: [GroupTypes.RECEIVED_GROUPS],
        params: [teamID, q, page, perPage, source],
    });
}

export function getGroupsNotAssociatedToChannel(
    channelID: string,
    q = "",
    page = 0,
    perPage: number = General.PAGE_SIZE_DEFAULT,
...
export function getAllGroupsAssociatedToTeam(
    teamID: string,
    ...
    return bindClientFunc({
        clientFunc: async (param1, param2, param3) => {
            const result = await Client4.getAllGroupsAssociatedToTeam(
                param1,
                param2,
                param3,
            );
...
export function getAllGroupsAssociatedToChannelsInTeam(
    teamID: string,
    filterAllowReference = false,
): ActionFunc {
    return bindClientFunc({
        clientFunc: async (param1, param2) => {
            const result = await Client4.getAllGroupsAssociatedToChannelsInTeam(
                param1,
                param2,
            );
        ...
        onSuccess: [
            GroupTypes.RECEIVED_ALL_GROUPS_ASSOCIATED_TO_CHANNELS_IN_TEAM,
        ],
        params: [teamID, filterAllowReference],
    });
}

export function getAllGroupsAssociatedToChannel(
    channelID: string,
    filterAllowReference = false,
    includeMemberCount = false,
): ActionFunc {
    return bindClientFunc({
        clientFunc: async (param1, param2, param3) => {
            const result = await Client4.getAllGroupsAssociatedToChannel(
                param1,
                param2,
                param3,
            );
...
export function getGroupsAssociatedToTeam(
    ...
    return bindClientFunc({
        clientFunc: async (param1, param2, param3, param4, param5) => {
            const result = await Client4.getGroupsAssociatedToTeam(
                param1,
                param2,
                param3,
                param4,
...
export function getGroupsAssociatedToChannel(
    ...
    return bindClientFunc({
        clientFunc: async (param1, param2, param3, param4, param5) => {
            const result = await Client4.getGroupsAssociatedToChannel(
                param1,
                param2,
                param3,
                param4,
...
export function patchGroup(
    groupID: string,
    patch: GroupPatch | CustomGroupPatch,
): ActionFunc {
    return bindClientFunc({
...
export function getGroupsByUserIdPaginated(
...
export function createGroupWithUserIds(
    ...
    return async (dispatch: DispatchFunc, getState: GetStateFunc) => {
        ...
        dispatch({ type: GroupTypes.CREATE_GROUP_SUCCESS, data });
...
export function searchGroups(params: GroupSearchParams): ActionFunc {
    return async (dispatch: DispatchFunc, getState: GetStateFunc) => {
        ...
        const dispatches: AnyAction[] = [
            { type: GroupTypes.RECEIVED_GROUPS, data },
        ];
        ...
        if (params.include_channel_member_count) {
            dispatches.push({
                ...
                data,
                channelId: params.include_channel_member_count,
            });
        }
        dispatch(batchActions(dispatches));
