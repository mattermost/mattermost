...
describe('Actions.Posts', () => {
    ...
    it('getPostsUnread should load recent posts when unreadScrollPosition is startFromNewest and unread posts are not the latestPosts', async () => {
        ...
        await mockStore.dispatch(Actions.getPostsUnread(channelId));
        const {posts} = getState().entities.posts;
    ...
    it('flagPost', async () => {
        ...
        store.dispatch(Actions.flagPost(post1.id));
    ...
    it('unflagPost', async () => {
        ...
        nock(Client4.getUsersRoute()).
            ...
            reply(200, OK_RESPONSE);
        store.dispatch(Actions.unflagPost(post1.id));
        state = getState();
    ...
    it('pinPost', async () => {
        ...
        nock(Client4.getBaseRoute()).
            ...
            reply(200, postList);
        await store.dispatch(Actions.getPostThread(post1.id));

        nock(Client4.getBaseRoute()).
            post(`/posts/${post1.id}/pin`).
            reply(200, OK_RESPONSE);
        await store.dispatch(Actions.pinPost(post1.id));
    ...
    it('unpinPost', async () => {
        ...
        nock(Client4.getBaseRoute()).
            ...
            reply(200, OK_RESPONSE);
        await store.dispatch(Actions.unpinPost(post1.id));
    ...
    it('removeReaction', async () => {
        ...
        nock(Client4.getUsersRoute()).
            ...
            reply(200, OK_RESPONSE);
        await store.dispatch(Actions.removeReaction(post1.id, emojiName));
    ...
    it('getReactionsForPost', async () => {
        ...
        await store.dispatch(Actions.getReactionsForPost(post1.id));
    ...
    it('getCustomEmojiForReaction', async () => {
        ...
        const {data: created} = await store.dispatch(createCustomEmoji(
            {
        ...
        await store.dispatch(Actions.getCustomEmojiForReaction(missingEmojiName));
    ...
    it('addMessageIntoHistory', async () => {
        ...
        await store.dispatch(Actions.addMessageIntoHistory('test1'));
        ...
        await store.dispatch(Actions.addMessageIntoHistory('test2'));
        ...
        await store.dispatch(Actions.addMessageIntoHistory('test3'));
    ...
    it('resetHistoryIndex', async () => {
        ...
        await store.dispatch(Actions.moveHistoryIndexBack(Posts.MESSAGE_TYPES.POST));
        await store.dispatch(Actions.moveHistoryIndexBack(Posts.MESSAGE_TYPES.POST));
        await store.dispatch(Actions.moveHistoryIndexBack(Posts.MESSAGE_TYPES.COMMENT));
        ...
        await store.dispatch(Actions.resetHistoryIndex(Posts.MESSAGE_TYPES.POST));
        ...
        await store.dispatch(Actions.resetHistoryIndex(Posts.MESSAGE_TYPES.COMMENT));
    ...
    it('moveHistoryIndexForward', async () => {
        ...
        await store.dispatch(Actions.moveHistoryIndexForward(Posts.MESSAGE_TYPES.POST));
        ...
        await store.dispatch(Actions.moveHistoryIndexForward(Posts.MESSAGE_TYPES.COMMENT));
