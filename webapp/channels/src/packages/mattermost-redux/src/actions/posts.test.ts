...
describe("Actions.Posts", () => {
    ...
    it("maintain postReplies", async () => {
        ...
        await Actions.createPostImmediately(post)(
            store.dispatch,
            store.getState,
        );
        ...
        await Actions.createPostImmediately(post2)(
            store.dispatch,
            store.getState,
        );
    ...
    it("resetCreatePostRequest", async () => {
        ...
        expect(createRequest.error.status_code).toEqual(
            createPostError.status_code,
        );
    ...
    it("createPost with file attachments", async () => {
        ...
        nock(Client4.getBaseRoute())
            ...
            .reply(201, {
                ...
                file_ids: [files[0].id, files[1].id, files[2].id],
            });
        ...
        const postIdForFiles =
            state.entities.files.fileIdsByPostId[newPost!.id];
    ...
    it("editPost", async () => {
        ...
        expect(posts[post.id].message).toEqual(`${message} (edited)`);
    });
    ...
    it("deletePost", async () => {
        ...
        nock(Client4.getBaseRoute())
            .post("/posts")
            .reply(201, TestHelper.fakePostWithId(channelId));
        await Actions.createPost(TestHelper.fakePost(channelId))(
            store.dispatch,
            store.getState,
        );
        ...
        await Actions.deletePost(initialPosts.posts[postId])(
            store.dispatch,
            store.getState,
        );
        ...
        expect(posts[postId].state).toEqual(Posts.POST_DELETED);
    });
    ...
    it("deletePostWithReaction", async () => {
        ...
        await Actions.addReaction(post1.id, emojiName)(
            store.dispatch,
            store.getState,
        );
        ...
        expect(
            reactions[post1.id][TestHelper.basicUser!.id + "-" + emojiName],
        ).toBeTruthy();
    ...
    it("removePost", async () => {
        ...
        const post4 = TestHelper.getPostMock({
            id: "post4",
            channel_id: "channel1",
            root_id: "post1",
            create_at: 1004,
    ...
    it("getPostThread", async () => {
        ...
        store.dispatch(
            Actions.receivedPostsInChannel(
                { order: [post.id], posts: { [post.id]: post } } as PostList,
                channelId,
            ),
        );
        ...
        nock(Client4.getBaseRoute())
            .get(
                `/posts/${post.id}/thread?skipFetchThreads=false&collapsedThreads=true&collapsedThreadsExtended=false&direction=down&perPage=60`,
            )
            .reply(200, postList);
        ...
        const found = postsInChannel[channelId].find(
            (block) => block.order.indexOf(comment.id) !== -1,
        );
    ...
    it("getPostEditHistory", async () => {
        ...
        await Actions.getPostEditHistory(postId)(
            store.dispatch,
            store.getState,
        );
    ...
    it("getPosts", async () => {
        const post0 = TestHelper.getPostMock({
            id: "post0",
            channel_id: "channel1",
            create_at: 1000,
            message: "",
    ...
    it("getNeededAtMentionedUsernames", async () => {
        ...
        ).toEqual(new Set(["bbb", "ccc"]));

        expect(
            Actions.getNeededAtMentionedUsernamesAndGroups(state, [
                TestHelper.getPostMock({ message: "@bbb. @ccc.ddd" }),
            ]),
        ).toEqual(new Set(["bbb.", "bbb", "ccc.ddd"]));
        ...
        ).toEqual(new Set(["bbb", "ccc", "ddd", "eee", "fff", "ggg"]));
    ...
    it("getPostsSince", async () => {
        ...
        const result = await store.dispatch(
            Actions.getPostsSince("channel1", post2.create_at),
        );
    ...
    it("getPostsBefore", async () => {
        ...
        const result = await store.dispatch(
            Actions.getPostsBefore(channelId, "post3", 0, 10),
        );
    ...
    it("getPostsAfter", async () => {
        ...
        const result = await store.dispatch(
            Actions.getPostsAfter(channelId, "post1", 0, 10),
        );
    ...
    it("getPostsAround", async () => {
        ...
        const result = await store.dispatch(
            Actions.getPostsAround(channelId, postId),
        );
        ...
        const { posts, postsInChannel, postsInThread } =
            store.getState().entities.posts;
    ...
    it("setUnreadPost", async () => {
        ...
        expect(state.entities.channels.myMembers[channelId].mention_count).toBe(
            1,
        );
        expect(
    ...
    it("pinPost", async () => {
        ...
        nock(Client4.getBaseRoute())
            .get(
                `/posts/${post1.id}/thread?skipFetchThreads=false&collapsedThreads=true&collapsedThreadsExtended=false&direction=down&perPage=60`,
            )
            .reply(200, postList);
        ...
        const pinnedPostCount =
            stats[TestHelper.basicChannel!.id].pinnedpost_count;
    ...
    it("addReaction", async () => {
        ...
        expect(reactions).toBeTruthy();
        expect(
            reactions[TestHelper.basicUser!.id + "-" + emojiName],
        ).toBeTruthy();
    });
    ...
    it("getCustomEmojiForReaction", async () => {
        ...
        await Actions.getCustomEmojiForReaction(missingEmojiName)(
            dispatch,
            getState,
        );
        ...
        expect(
            state.entities.emojis.nonExistentEmoji.has(missingEmojiName),
        ).toBeTruthy();
    });
    ...
    it("doPostAction", async () => {
        nock(Client4.getBaseRoute())
            .post(
                "/posts/posth67ja7ntdkek6g13dp3wka/actions/action7ja7ntdkek6g13dp3wka",
            )
            .reply(200, {});
    ...
    it("resetHistoryIndex", async () => {
        ...
        let index =
            getState().entities.posts.messagesHistory.index[
        ...
        await Actions.moveHistoryIndexBack(Posts.MESSAGE_TYPES.POST)(dispatch);
        await Actions.moveHistoryIndexBack(Posts.MESSAGE_TYPES.COMMENT)(
            dispatch,
        );
    ...
    it("moveHistoryIndexForward", async () => {
        ...
        await Actions.moveHistoryIndexForward(Posts.MESSAGE_TYPES.POST)(
            dispatch,
        );
        ...
        await Actions.moveHistoryIndexForward(Posts.MESSAGE_TYPES.COMMENT)(
            dispatch,
        );
    ...
    describe("getMentionsAndStatusesForPosts", () => {
        describe("different values for posts argument", () => {
            ...
            it("null", async () => {
                await Actions.getMentionsAndStatusesForPosts(
                    null as any,
                    dispatch as any,
                    getState,
                );
    ...
    describe("getThreadsForPosts", () => {
        ...
        beforeEach(async () => {
            ...
            comment = TestHelper.getPostMock({
                id: TestHelper.generateId(),
                root_id: post1.id,
                channel_id: channelId,
                message: "",
            ...
            nock(Client4.getBaseRoute())
                .get(
                    `/posts/${post1.id}/thread?skipFetchThreads=false&collapsedThreads=false&collapsedThreadsExtended=false&direction=down&perPage=60`,
                )
        ...
        it("handlesNull", async () => {
            const ret = await store.dispatch(
                Actions.getThreadsForPosts(null as any),
            );
            ...
            expect(postsInChannel[channelId]).toBeTruthy();
            expect(postsInChannel[channelId][0].order).toEqual([
                post2.id,
                post3.id,
            ]);
    ...
    describe("receivedPostsBefore", () => {
        it("Should return default false for oldest key if param does not exist", () => {
            ...
            const result = Actions.receivedPostsBefore(
                posts,
                "channelId",
                "beforePostId",
            );
    ...
    describe("receivedPostsInChannel", () => {
        ...
        it("Should return true for oldest and recent keys", () => {
            const posts = {} as PostList;
            const result = Actions.receivedPostsInChannel(
                posts,
                "channelId",
                true,
                true,
