...
import type {GetGroupsParams, SyncablePatch} from '@mattermost/types/groups';
...
describe('Actions.Groups', () => {
    ...
    it('linkGroupSyncable', async () => {
        ...
        await store.dispatch(Actions.linkGroupSyncable(groupID, teamID, SyncableType.Team, {} as SyncablePatch));
        await store.dispatch(Actions.linkGroupSyncable(groupID, channelID, SyncableType.Channel, {} as SyncablePatch));
