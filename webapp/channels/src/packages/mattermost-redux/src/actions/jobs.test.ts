...
describe("Actions.Jobs", () => {
    ...
    it("createJob", async () => {
        ...
        nock(Client4.getBaseRoute()).post("/jobs").reply(201, {
    ...
    it("getJob", async () => {
        ...
        await Actions.getJob("six4h67ja7ntdkek6g13dp3wka")(
            store.dispatch,
            store.getState,
        );
    ...
    it("cancelJob", async () => {
        ...
        await Actions.cancelJob("six4h67ja7ntdkek6g13dp3wka")(
            store.dispatch,
            store.getState,
        );
    ...
    it("getJobsByType", async () => {
        ...
        await Actions.getJobsByType("data_retention")(
            store.dispatch,
            store.getState,
        );
