...
describe("Actions.Admin", () => {
    ...
    it("getConfig", async () => {
        ...
        nock(Client4.getBaseRoute()).get("/terms_of_service").reply(200, {
    ...
    it("updateConfig", async () => {
        ...
        const { data } = (await Actions.getConfig()(
            store.dispatch,
            store.getState,
        )) as ActionResult;
        ...
        nock(Client4.getBaseRoute()).put("/config").reply(200, updated);
    ...
    it("testEmail", async () => {
        nock(Client4.getBaseRoute()).get("/config").reply(200, {});

        const { data: config } = (await Actions.getConfig()(
            store.dispatch,
            store.getState,
        )) as ActionResult;
    ...
    it("testSiteURL", async () => {
        ...
        await Actions.testSiteURL("http://lo.cal")(
            store.dispatch,
            store.getState,
        );
    ...
    it("createComplianceReport", async () => {
        ...
        nock(Client4.getBaseRoute()).post("/compliance/reports").reply(201, {
    ...
    it("getComplianceReport", async () => {
        ...
        const { data: report } = (await Actions.createComplianceReport(job)(
            store.dispatch,
            store.getState,
        )) as ActionResult;
        ...
        await Actions.getComplianceReport(report.id)(
            store.dispatch,
            store.getState,
        );
    ...
    it("uploadBrandImage", async () => {
        ...
        await Actions.uploadBrandImage(testImageData as any)(
            store.dispatch,
            store.getState,
        );
    ...
    it("testLdap", async () => {
        nock(Client4.getBaseRoute()).post("/ldap/test").reply(200, OK_RESPONSE);
    ...
    it("syncLdap", async () => {
        nock(Client4.getBaseRoute()).post("/ldap/sync").reply(200, OK_RESPONSE);
    ...
    it("getSamlCertificateStatus", async () => {
        ...
        await Actions.getSamlCertificateStatus()(
            store.dispatch,
            store.getState,
        );
    ...
    it("uploadPublicSamlCertificate", async () => {
        const testFileData = fs.createReadStream(
            "src/packages/mattermost-redux/test/assets/images/test.png",
        );
        ...
        await Actions.uploadPublicSamlCertificate(testFileData as any)(
            store.dispatch,
            store.getState,
        );
    ...
    it("uploadPrivateSamlCertificate", async () => {
        ...
        await Actions.uploadPrivateSamlCertificate(testFileData as any)(
            store.dispatch,
            store.getState,
        );
    ...
    it("uploadIdpSamlCertificate", async () => {
        ...
        await Actions.uploadIdpSamlCertificate(testFileData as any)(
            store.dispatch,
            store.getState,
        );
    ...
    it("removePublicSamlCertificate", async () => {
        ...
        await Actions.removePublicSamlCertificate()(
            store.dispatch,
            store.getState,
        );
    ...
    it("removePrivateSamlCertificate", async () => {
        ...
        await Actions.removePrivateSamlCertificate()(
            store.dispatch,
            store.getState,
        );
    ...
    it("removeIdpSamlCertificate", async () => {
        ...
        await Actions.removeIdpSamlCertificate()(
            store.dispatch,
            store.getState,
        );
    ...
    it("uploadPublicLdapCertificate", async () => {
        ...
        await Actions.uploadPublicLdapCertificate(testFileData as any)(
            store.dispatch,
            store.getState,
        );
    ...
    it("uploadPrivateLdapCertificate", async () => {
        ...
        await Actions.uploadPrivateLdapCertificate(testFileData as any)(
            store.dispatch,
            store.getState,
        );
    ...
    it("removePublicLdapCertificate", async () => {
        ...
        await Actions.removePublicLdapCertificate()(
            store.dispatch,
            store.getState,
        );
    ...
    it("removePrivateLdapCertificate", async () => {
        ...
        await Actions.removePrivateLdapCertificate()(
            store.dispatch,
            store.getState,
        );
    ...
    it("purgeElasticsearchIndexes", async () => {
        ...
        await Actions.purgeElasticsearchIndexes()(
            store.dispatch,
            store.getState,
        );
    ...
    it("uploadLicense", async () => {
        ...
        await Actions.uploadLicense(testFileData as any)(
            store.dispatch,
            store.getState,
        );
    ...
    it("removeLicense", async () => {
        nock(Client4.getBaseRoute()).delete("/license").reply(200, OK_RESPONSE);
    ...
    it("getStandardAnalytics", async () => {
        nock(Client4.getBaseRoute())
            ...
            .times(2)
            .reply(200, [
                { name: "channel_open_count", value: 495 },
                { name: "channel_private_count", value: 19 },
                { name: "post_count", value: 2763 },
                { name: "unique_user_count", value: 316 },
                { name: "team_count", value: 159 },
                { name: "total_websocket_connections", value: 1 },
                { name: "total_master_db_connections", value: 8 },
                { name: "total_read_db_connections", value: 0 },
                { name: "daily_active_users", value: 22 },
                { name: "monthly_active_users", value: 114 },
                { name: "registered_users", value: 500 },
            ]);

        await Actions.getStandardAnalytics()(store.dispatch, store.getState);
        await Actions.getStandardAnalytics(TestHelper.basicTeam!.id)(
            store.dispatch,
            store.getState,
        );
        ...
        expect(
            teamAnalytics[TestHelper.basicTeam!.id][
                Stats.TOTAL_PUBLIC_CHANNELS
            ] > 0,
        ).toBeTruthy();
    });
    ...
    it("getAdvancedAnalytics", async () => {
        nock(Client4.getBaseRoute())
            ...
            .times(2)
            .reply(200, [
                { name: "file_post_count", value: 24 },
                { name: "hashtag_post_count", value: 876 },
                { name: "incoming_webhook_count", value: 16 },
                { name: "outgoing_webhook_count", value: 18 },
                { name: "command_count", value: 14 },
                { name: "session_count", value: 149 },
            ]);

        await Actions.getAdvancedAnalytics()(store.dispatch, store.getState);
        await Actions.getAdvancedAnalytics(TestHelper.basicTeam!.id)(
            store.dispatch,
            store.getState,
        );
        ...
        expect(teamAnalytics[TestHelper.basicTeam!.id]).toBeTruthy();
        expect(
            teamAnalytics[TestHelper.basicTeam!.id][Stats.TOTAL_SESSIONS] > 0,
        ).toBeTruthy();
    });
    ...
    it("getPostsPerDayAnalytics", async () => {
        nock(Client4.getBaseRoute())
            ...
            .times(2)
            .reply(200, [
                { name: "2017-06-18", value: 16 },
                { name: "2017-06-16", value: 209 },
                { name: "2017-06-12", value: 35 },
                { name: "2017-06-08", value: 227 },
                { name: "2017-06-07", value: 27 },
                { name: "2017-06-06", value: 136 },
                { name: "2017-06-05", value: 127 },
                { name: "2017-06-04", value: 39 },
                { name: "2017-06-02", value: 3 },
                { name: "2017-05-31", value: 52 },
                { name: "2017-05-30", value: 52 },
                { name: "2017-05-29", value: 9 },
                { name: "2017-05-26", value: 198 },
                { name: "2017-05-25", value: 144 },
                { name: "2017-05-24", value: 1130 },
                { name: "2017-05-23", value: 146 },
            ]);

        await Actions.getPostsPerDayAnalytics()(store.dispatch, store.getState);
        await Actions.getPostsPerDayAnalytics(TestHelper.basicTeam!.id)(
            store.dispatch,
            store.getState,
        );
        ...
        expect(teamAnalytics[TestHelper.basicTeam!.id]).toBeTruthy();
        expect(
            teamAnalytics[TestHelper.basicTeam!.id][Stats.POST_PER_DAY],
        ).toBeTruthy();
    });
    ...
    it("getUsersPerDayAnalytics", async () => {
        nock(Client4.getBaseRoute())
            ...
            .times(2)
            .reply(200, [
                { name: "2017-06-18", value: 2 },
                { name: "2017-06-16", value: 47 },
                { name: "2017-06-12", value: 4 },
                { name: "2017-06-08", value: 55 },
                { name: "2017-06-07", value: 2 },
                { name: "2017-06-06", value: 1 },
                { name: "2017-06-05", value: 2 },
                { name: "2017-06-04", value: 13 },
                { name: "2017-06-02", value: 1 },
                { name: "2017-05-31", value: 3 },
                { name: "2017-05-30", value: 4 },
                { name: "2017-05-29", value: 3 },
                { name: "2017-05-26", value: 40 },
                { name: "2017-05-25", value: 26 },
                { name: "2017-05-24", value: 43 },
                { name: "2017-05-23", value: 3 },
            ]);

        await Actions.getUsersPerDayAnalytics()(store.dispatch, store.getState);
        await Actions.getUsersPerDayAnalytics(TestHelper.basicTeam!.id)(
            store.dispatch,
            store.getState,
        );
        ...
        expect(
            teamAnalytics[TestHelper.basicTeam!.id][
                Stats.USERS_WITH_POSTS_PER_DAY
            ],
        ).toBeTruthy();
    });
    ...
    it("uploadPlugin", async () => {
        ...
        const testPlugin = {
            id: "testplugin",
            webapp: { bundle_path: "/static/somebundle.js" },
        };

        nock(Client4.getBaseRoute()).post("/plugins").reply(200, testPlugin);
        await Actions.uploadPlugin(testFileData as any, false)(
            store.dispatch,
            store.getState,
        );
    ...
    it("overwriteInstallPlugin", async () => {
        ...
        await Actions.installPluginFromUrl(downloadUrl, false)(
            store.dispatch,
            store.getState,
        );
    ...
    it("getPluginStatuses", async () => {
        ...
        expect(
            !pluginStatuses[testPluginStatus2.plugin_id].active,
        ).toBeTruthy();
    });
    ...
    it("removePlugin", async () => {
        ...
        await Actions.removePlugin(testPlugin.id)(
            store.dispatch,
            store.getState,
        );
    ...
    it("enablePlugin", async () => {
        ...
        await Actions.enablePlugin(testPlugin.id)(
            store.dispatch,
            store.getState,
        );
    ...
    it("disablePlugin", async () => {
        ...
        await Actions.disablePlugin(testPlugin.id)(
            store.dispatch,
            store.getState,
        );
    ...
    it("getLdapGroups is_linked", async () => {
        ...
        await Actions.getLdapGroups(0, 100, { q: "", is_linked: true })(
            store.dispatch,
            store.getState,
        );
        ...
        await Actions.getLdapGroups(0, 100, { q: "", is_linked: false })(
            store.dispatch,
            store.getState,
        );
    ...
    it("getLdapGroups is_configured", async () => {
        ...
        await Actions.getLdapGroups(0, 100, { q: "", is_configured: true })(
            store.dispatch,
            store.getState,
        );
        ...
        await Actions.getLdapGroups(0, 100, { q: "", is_configured: false })(
            store.dispatch,
            store.getState,
        );
    ...
    it("getLdapGroups with name query", async () => {
        ...
        await Actions.getLdapGroups(0, 100, { q: "est" })(
            store.dispatch,
            store.getState,
        );
        ...
        await Actions.getLdapGroups(0, 100, { q: "esta" })(
            store.dispatch,
            store.getState,
        );
    ...
    it("linkLdapGroup", async () => {
        ...
        expect(
            groups[key].mattermost_group_id === "new-mattermost-id",
        ).toBeTruthy();
    ...
    it("getSamlMetadataFromIdp", async () => {
        ...
        await Actions.getSamlMetadataFromIdp("")(
            store.dispatch,
            store.getState,
        );
        ...
        expect(
            metadataResponse.idp_descriptor_url === samlIdpDescriptorURL,
        ).toBeTruthy();
        expect(
            metadataResponse.idp_public_certificate ===
                samlIdpPublicCertificateText,
        ).toBeTruthy();
    });
    ...
    it("setSamlIdpCertificateFromMetadata", async () => {
        ...
        await Actions.setSamlIdpCertificateFromMetadata(
            samlIdpPublicCertificateText,
        )(store.dispatch, store.getState);
    ...
    it("sendWarnMetricAck", async () => {
        ...
        await Actions.sendWarnMetricAck(
            warnMetricAck.id,
            false,
        )(store.dispatch);
    ...
    it("getDataRetentionCustomPolicy", async () => {
        ...
        await Actions.getDataRetentionCustomPolicy("id1")(
            store.dispatch,
            store.getState,
        );
    ...
    it("getDataRetentionCustomPolicyTeams", async () => {
        ...
        await Actions.getDataRetentionCustomPolicyTeams("id1")(
            store.dispatch,
            store.getState,
        );
    ...
    it("getDataRetentionCustomPolicyChannels", async () => {
        ...
        await Actions.getDataRetentionCustomPolicyChannels("id1")(
            store.dispatch,
            store.getState,
        );
    ...
    it("searchDataRetentionCustomPolicyTeams", async () => {
        ...
        const response = await store.dispatch(
            Actions.searchDataRetentionCustomPolicyTeams("id1", "test", {}),
        );
    ...
    it("searchDataRetentionCustomPolicyChannels", async () => {
        ...
        const response = await store.dispatch(
            Actions.searchDataRetentionCustomPolicyChannels("id1", "test", {}),
        );
    ...
    it("createDataRetentionCustomPolicy", async () => {
        ...
        await Actions.createDataRetentionCustomPolicy(policy)(
            store.dispatch,
            store.getState,
        );
    ...
    it("updateDataRetentionCustomPolicy", async () => {
        ...
        await Actions.updateDataRetentionCustomPolicy("id1", {
            display_name: "Test123",
            post_duration: 365,
        } as CreateDataRetentionCustomPolicy)(store.dispatch, store.getState);

        const updateState = store.getState();
        const policyState =
            updateState.entities.admin.dataRetentionCustomPolicies;
    ...
    it("removeDataRetentionCustomPolicyTeams", async () => {
        ...
        await Actions.removeDataRetentionCustomPolicyTeams("id1", ["teamId2"])(
            store.dispatch,
            store.getState,
        );
    ...
    it("removeDataRetentionCustomPolicyChannels", async () => {
        ...
        await Actions.removeDataRetentionCustomPolicyChannels("id1", [
            "channelId2",
        ])(store.dispatch, store.getState);
