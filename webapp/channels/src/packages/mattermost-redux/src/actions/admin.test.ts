...
describe('Actions.Admin', () => {
    ...
    it('updateConfig', async () => {
        ...
        const {data} = await store.dispatch(Actions.getConfig()) as ActionResult;
    ...
    it('testEmail', async () => {
        ...
        const {data: config} = await store.dispatch(Actions.getConfig()) as ActionResult;
    ...
    it('createComplianceReport', async () => {
        ...
        const {data: created} = await store.dispatch(Actions.createComplianceReport(job)) as ActionResult;
    ...
    it('getComplianceReport', async () => {
        ...
        const {data: report} = await store.dispatch(Actions.createComplianceReport(job)) as ActionResult;
