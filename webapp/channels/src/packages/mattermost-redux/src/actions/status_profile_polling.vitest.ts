...
describe('Actions.StatusProfilePolling', () => {
    ...
    test('batchFetchStatusesProfilesGroupsFromPosts with empty posts', async () => {
        const {data} = await store.dispatch(Actions.batchFetchStatusesProfilesGroupsFromPosts([]));
        expect(data).toBe(false);
    });

    test('batchFetchStatusesProfilesGroupsFromPosts with posts', async () => {
    ...
    test('batchFetchStatusesProfilesGroupsFromPosts with post metadata', async () => {
    ...
    test('getUsersFromMentionedUsernamesAndGroups', async () => {
    ...
    test('getUsersFromMentionedUsernamesAndGroups without license', async () => {
        const usernamesAndGroups = ['user1', 'group1'];
