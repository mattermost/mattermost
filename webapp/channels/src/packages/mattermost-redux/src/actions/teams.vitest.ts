...
describe('Actions.Teams', () => {
    ...
    test('getTeams with total count', async () => {
        let team = {...TestHelper.fakeTeam(), allow_open_invite: true};
    ...
    test('regenerateTeamInviteId', async () => {
    ...
    test('getMyTeamMembers and getMyTeamUnreads', async () => {
    ...
    test('getTeamMembersForUser', async () => {
    ...
    test('sendEmailInvitesToTeam', async () => {
        nock(Client4.getTeamRoute(TestHelper.basicTeam!.id)).
            post('/invite/email').
            reply(200, OK_RESPONSE);
    ...
    test('membersMinusGroupMembers', async () => {
