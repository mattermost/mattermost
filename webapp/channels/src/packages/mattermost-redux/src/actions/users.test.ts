...
describe("Actions.Users", () => {
    ...
    it("updateMyTermsOfServiceStatus accept terms", async () => {
        ...
        await Actions.updateMyTermsOfServiceStatus("1", true)(
            store.dispatch,
            store.getState,
        );
        ...
        const currentUser =
            store.getState().entities.users.profiles[currentUserId];
    ...
    it("updateMyTermsOfServiceStatus reject terms", async () => {
        ...
        await Actions.updateMyTermsOfServiceStatus("1", false)(
            store.dispatch,
            store.getState,
        );

        const { currentUserId, myAcceptedTermsOfServiceId } =
    ...
    it("logout", async () => {
        ...
        await TestHelper.basicClient4!.login(
    ...
    it("getProfilesByIds", async () => {
        ...
        nock(Client4.getBaseRoute()).post("/users/ids").reply(200, [user]);

        await Actions.getProfilesByIds([user.id])(
            store.dispatch,
            store.getState,
        );
        const { profiles } = store.getState().entities.users;
    ...
    it("getMissingProfilesByIds", async () => {
        ...
        await Actions.getMissingProfilesByIds([user.id])(
            store.dispatch,
            store.getState,
        );
        const { profiles } = store.getState().entities.users;
    ...
    it("getProfilesByUsernames", async () => {
        ...
        await Actions.getProfilesByUsernames([user.username])(
            store.dispatch,
            store.getState,
        );
        const { profiles } = store.getState().entities.users;
    ...
    it("getProfilesInTeam", async () => {
        ...
        await Actions.getProfilesInTeam(TestHelper.basicTeam!.id, 0)(
            store.dispatch,
            store.getState,
        );
    ...
    it("getProfilesNotInTeam", async () => {
        ...
        await Actions.getProfilesNotInTeam(
            team!.id,
            false,
            0,
    ...
    it("getProfilesWithoutTeam", async () => {
        ...
        const { profilesWithoutTeam, profiles } =
            store.getState().entities.users;
    ...
    it("getProfilesInChannel", async () => {
        ...
        await Actions.getProfilesInChannel(TestHelper.basicChannel!.id, 0)(
            store.dispatch,
            store.getState,
        );
    ...
    it("getProfilesNotInChannel", async () => {
        ...
        const { profiles, profilesNotInChannel } =
            store.getState().entities.users;
    ...
    it("getProfilesInGroup", async () => {
        ...
        await Actions.getProfilesInGroup(TestHelper.basicGroup!.id, 0)(
            store.dispatch,
            store.getState,
        );
    ...
    it("getUser", async () => {
        ...
        nock(Client4.getBaseRoute()).get(`/users/${user.id}`).reply(200, user);

        await Actions.getUser(user.id)(store.dispatch, store.getState);
    ...
    it("getUserByUsername", async () => {
        ...
        await Actions.getUserByUsername(user.username)(
            store.dispatch,
            store.getState,
        );
    ...
    it("getUserByEmail", async () => {
        ...
        await Actions.getUserByEmail(user.email)(
            store.dispatch,
            store.getState,
        );
    ...
    it("searchProfiles", async () => {
        ...
        nock(Client4.getBaseRoute()).post("/users/search").reply(200, [user]);

        await Actions.searchProfiles(user!.username)(
            store.dispatch,
            store.getState,
        );
    ...
    it("getStatusesByIds", async () => {
        ...
        await Actions.getStatusesByIds([TestHelper.basicUser!.id])(
            store.dispatch,
            store.getState,
        );
    ...
    it("getStatus", async () => {
        ...
        await Actions.getStatus(user!.id)(store.dispatch, store.getState);
    ...
    it("getSessions", async () => {
            ...
            .reply(200, [
                {
                    ...
                    create_at: 1507756921338,
                    expires_at: 1510348921338,
                    last_activity_at: 1507821125630,
                    user_id: TestHelper.basicUser!.id,
                    device_id: "",
        ...
        await Actions.getSessions(TestHelper.basicUser!.id)(
            store.dispatch,
            store.getState,
        );
    ...
    it("revokeSession", async () => {
        ...
        nock(Client4.getBaseRoute())
            ...
            .reply(200, OK_RESPONSE);
        await Actions.revokeSession(TestHelper.basicUser!.id, sessions[0].id)(
            store.dispatch,
            store.getState,
        );
    ...
    it("revokeSession and logout", async () => {
        ...
        const { data: revokeSessionResponse } = (await Actions.revokeSession(
            TestHelper.basicUser!.id,
            sessions[0].id,
        )(store.dispatch, store.getState)) as ActionResult;
        expect(revokeSessionResponse).toBe(true);

        nock(Client4.getBaseRoute()).get("/users").reply(401, {});
        ...
        nock(Client4.getBaseRoute())
            .post("/users/login")
            .reply(200, basicUser!);
        const response = await TestHelper.basicClient4!.login(
            TestHelper.basicUser!.email,
            "password1",
        );
    ...
    it("revokeAllSessionsForCurrentUser", async () => {
        ...
        nock(Client4.getBaseRoute())
            ...
            .reply(200, OK_RESPONSE);
        const { data } = (await Actions.revokeAllSessionsForUser(user!.id)(
            store.dispatch,
            store.getState,
        )) as ActionResult;
        expect(data).toBe(true);

        nock(Client4.getBaseRoute()).get("/users").query(true).reply(401, {});
        await Actions.getProfiles(0)(store.dispatch, store.getState);
    ...
    it("revokeSessionsForAllUsers", async () => {
        ...
        nock(Client4.getBaseRoute())
            ...
            .reply(200, OK_RESPONSE);
        const { data } = (await Actions.revokeSessionsForAllUsers()(
            store.dispatch,
            store.getState,
        )) as ActionResult;
        expect(data).toBe(true);
    ...
    it("getUserAudits", async () => {
        ...
        await Actions.getUserAudits(TestHelper.basicUser!.id)(
            store.dispatch,
            store.getState,
        );
    ...
    it("autocompleteUsers", async () => {
        ...
        const autocompleteRequest =
            store.getState().requests.users.autocompleteUsers;
        const { profiles, profilesNotInChannel, profilesInChannel } =
            store.getState().entities.users;
    ...
    it("generateMfaSecret", async () => {
        ...
        const { data } = (await Actions.generateMfaSecret("me")(
            store.dispatch,
            store.getState,
        )) as ActionResult;
    ...
    it("updateUserActive", async () => {
        ...
        nock(Client4.getBaseRoute())
            ...
            .reply(200, OK_RESPONSE);
        await Actions.updateUserActive(user.id, false)(
            store.dispatch,
            store.getState,
        );
    ...
    it("verifyUserEmail", async () => {
        ...
        const { data } = (await Actions.verifyUserEmail("sometoken")(
            store.dispatch,
            store.getState,
        )) as ActionResult;
    ...
    it("sendVerificationEmail", async () => {
        ...
        const { data } = (await Actions.sendVerificationEmail(
            TestHelper.basicUser!.email,
        )(store.dispatch, store.getState)) as ActionResult;
    ...
    it("resetUserPassword", async () => {
        ...
        const { data } = (await Actions.resetUserPassword(
            "sometoken",
            "newpassword",
        )(store.dispatch, store.getState)) as ActionResult;
    ...
    it("sendPasswordResetEmail", async () => {
        ...
        const { data } = (await Actions.sendPasswordResetEmail(
            TestHelper.basicUser!.email,
        )(store.dispatch, store.getState)) as ActionResult;
    ...
    it("uploadProfileImage", async () => {
        ...
        const testImageData = fs.createReadStream(
            "src/packages/mattermost-redux/test/assets/images/test.png",
        );
        ...
        await Actions.uploadProfileImage(currentUserId, testImageData)(
            store.dispatch,
            store.getState,
        );
    ...
    it("setDefaultProfileImage", async () => {
        ...
        await Actions.setDefaultProfileImage(currentUserId)(
            store.dispatch,
            store.getState,
        );
    ...
    it("switchEmailToOAuth", async () => {
        ...
        const { data } = (await Actions.switchEmailToOAuth(
            "gitlab",
            TestHelper.basicUser!.email,
            TestHelper.basicUser!.password,
        )(store.dispatch, store.getState)) as ActionResult;
    ...
    it("switchOAuthToEmail", async () => {
        ...
        const { data } = (await Actions.switchOAuthToEmail(
            "gitlab",
            TestHelper.basicUser!.email,
            TestHelper.basicUser!.password,
        )(store.dispatch, store.getState)) as ActionResult;
    ...
    it("switchEmailToLdap", async () => {
        ...
        const { data } = (await Actions.switchEmailToLdap(
            TestHelper.basicUser!.email,
            TestHelper.basicUser!.password,
            "someid",
            "somepassword",
    ...
    it("switchLdapToEmail", (done) => {
        async function test() {
            ...
            const { data } = (await Actions.switchLdapToEmail(
                "somepassword",
                TestHelper.basicUser!.email,
                TestHelper.basicUser!.password,
            )(store.dispatch, store.getState)) as ActionResult;
    ...
    it("createUserAccessToken", (done) => {
        async function test() {
            ...
            const { data } = (await Actions.createUserAccessToken(
                currentUserId,
                "test token",
            )(store.dispatch, store.getState)) as ActionResult;
            ...
            expect(
                !userAccessTokensByUser[currentUserId][data.id].token,
            ).toBeTruthy();
            done();
        }
    ...
    it("getUserAccessToken", async () => {
        ...
        await Actions.getUserAccessToken(data.id)(
            store.dispatch,
            store.getState,
        );

        const { myUserAccessTokens } = store.getState().entities.users;
        const { userAccessTokensByUser, userAccessTokens } =
            store.getState().entities.admin;
    ...
    it("getUserAccessTokensForUser", async () => {
        ...
        await Actions.getUserAccessTokensForUser(currentUserId)(
            store.dispatch,
            store.getState,
        );
    ...
    it("revokeUserAccessToken", async () => {
        ...
        let { userAccessTokensByUser, userAccessTokens } =
            store.getState().entities.admin;
        ...
        await Actions.revokeUserAccessToken(data.id)(
            store.dispatch,
            store.getState,
        );
        ...
        userAccessTokensByUser =
            store.getState().entities.admin.userAccessTokensByUser;
    ...
    it("disableUserAccessToken", async () => {
        ...
        expect(
            !userAccessTokensByUser[currentUserId][testId].token,
        ).toBeTruthy();
        expect(userAccessTokens).toBeTruthy();
        expect(userAccessTokens[data.id]).toBeTruthy();
        expect(!userAccessTokens[data.id].token).toBeTruthy();
        ...
        await Actions.disableUserAccessToken(testId)(
            store.dispatch,
            store.getState,
        );
        ...
        expect(userAccessTokensByUser[currentUserId][testId]).toBeTruthy();
        expect(
            !userAccessTokensByUser[currentUserId][testId].is_active,
        ).toBeTruthy();
        expect(
            !userAccessTokensByUser[currentUserId][testId].token,
        ).toBeTruthy();
    ...
    it("enableUserAccessToken", async () => {
        ...
        await Actions.enableUserAccessToken(testId)(
            store.dispatch,
            store.getState,
        );
    ...
    it("clearUserAccessTokens", async () => {
        ...
        await Actions.createUserAccessToken(currentUserId, "test token")(
            store.dispatch,
            store.getState,
        );
