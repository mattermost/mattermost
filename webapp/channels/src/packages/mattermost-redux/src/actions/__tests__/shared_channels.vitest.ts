...
describe('shared_channels actions', () => {
    ...
    test('fetchChannelRemotes should fetch and dispatch remotes', async () => {
        ...
        (Client4.getSharedChannelRemoteInfos as ReturnType<typeof vi.fn>).mockResolvedValueOnce(remotes);
    ...
    test('fetchChannelRemotes should fetch if remotes exist but forceRefresh is true', async () => {
        ...
        (Client4.getSharedChannelRemoteInfos as ReturnType<typeof vi.fn>).mockResolvedValueOnce(newRemotes);
