...
describe("Actions.Files", () => {
    ...
    it("getFilesForPost", async () => {
        ...
        const testImageData = fs.createReadStream(
            `src/packages/mattermost-redux/test/assets/images/${testFileName}`,
        );
        ...
        nock(Client4.getBaseRoute())
            ...
            .reply(201, {
                file_infos: [
                    {
                        ...
                        create_at: 1507921547541,
                        update_at: 1507921547541,
                        delete_at: 0,
                        name: "test.png",
                        extension: "png",
                        size: 258428,
                ...
                client_ids: [TestHelper.generateId()],
            });

        const fileUploadResp = await basicClient4!.uploadFile(imageFormData);
        ...
        nock(Client4.getBaseRoute())
            .post("/posts")
            .reply(201, {
                ...TestHelper.fakePostWithId("undefined"),
                ...fakePostForFile,
            });
        ...
        await Actions.getFilesForPost(postForFile.id)(
            store.dispatch,
            store.getState,
        );

        const { files: allFiles, fileIdsByPostId } =
            store.getState().entities.files;
    ...
    it("getFilePublicLink", async () => {
        ...
        expect(
            "https://mattermost.com/files/ndans23ry2rtjd1z73g6i5f3fc/public?h=rE1-b2N1VVVMsAQssjwlfNawbVOwUy1TRDuTeGC_tys",
        ).toEqual(filePublicLink);
