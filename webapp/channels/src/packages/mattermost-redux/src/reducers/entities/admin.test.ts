...
import reducer, {
    convertAnalyticsRowsToStats,
} from "mattermost-redux/reducers/entities/admin";
...
describe("reducers.entities.admin", () => {
    describe("pluginStatuses", () => {
        it("initial state", () => {
            ...
            const actualState = reducer(
                { pluginStatuses: state } as ReducerState,
    ...
    describe("ldapGroups", () => {
        it("initial state", () => {
            ...
            const actualState = reducer(
                { ldapGroups: state } as ReducerState,
                action as GenericAction,
            );
    ...
    describe("Data Retention", () => {
        it("initial state", () => {
            ...
            const actualState = reducer(
                { dataRetentionCustomPolicies: state } as ReducerState,
                action as GenericAction,
            );
            expect(actualState.dataRetentionCustomPolicies).toEqual(
                expectedState,
            );
        });
        ...
        it("DELETE_DATA_RETENTION_CUSTOM_POLICY_SUCCESS", () => {
            ...
            const actualState = reducer(
                {
                    dataRetentionCustomPolicies: state,
