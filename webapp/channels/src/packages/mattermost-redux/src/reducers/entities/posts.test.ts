...
function toPostsRecord(
    partials: Record<string, Partial<Post>>,
): Record<string, Post> {
...
describe("postsInChannel", () => {
    describe("receiving a new post", () => {
        it("should do nothing without posts loaded for the channel", () => {
            ...
            const nextState = reducers.postsInChannel(
                state,
                {
                    type: PostTypes.RECEIVED_NEW_POST,
        ...
        it("should store the new post when the channel has recent posts", () => {
            const state = deepFreeze({
                channel1: [{ order: ["post2", "post3"], recent: true }],
            });
        ...
        it("should not store the new post when the channel only has older posts", () => {
            const state = deepFreeze({
                channel1: [{ order: ["post2", "post3"], recent: false }],
            });
    ...
    describe("receiving consecutive recent posts in the channel", () => {
        it("should save posts in the correct order", () => {
            const state = deepFreeze({
                channel1: [{ order: ["post2", "post4"], recent: true }],
            });
        ...
        it("should not save posts in an older block, even if they may be adjacent", () => {
            const state = deepFreeze({
                channel1: [{ order: ["post3", "post4"], recent: false }],
            });
        ...
        it("should not save posts in the recent block even if new posts may be adjacent", () => {
            const state = deepFreeze({
                channel1: [{ order: ["post3", "post4"], recent: true }],
            });
    ...
    describe("receiving consecutive posts in the channel that are not recent", () => {
        it("should save posts in the correct order", () => {
            const state = deepFreeze({
                channel1: [{ order: ["post2", "post4"], recent: false }],
            });
    ...
    describe("receiving posts before", () => {
        ...
        it("should add posts to existing block", () => {
            const state = deepFreeze({
                channel1: [{ order: ["post1", "post2"], recent: false }],
            });
    ...
    describe("deleting a post", () => {
        ...
        it("should remove empty blocks", () => {
            ...
            expect(nextState).not.toBe(state);
            expect(nextState).toEqual({
                channel1: [{ order: ["post4"], recent: false }],
            });
        });
    });
    ...
    describe("removing a post", () => {
        it("should remove the post", () => {
            ...
            expect(nextState).not.toBe(state);
            expect(nextState).toEqual({
                channel1: [{ order: ["post1", "post3"], recent: false }],
            });
        });
        ...
        it("should remove comments on the post", () => {
            ...
            expect(nextState).not.toBe(state);
            expect(nextState).toEqual({
                channel1: [{ order: ["post1", "post4"], recent: false }],
            });
        });
        ...
        it("should remove empty blocks", () => {
            ...
            expect(nextState).not.toBe(state);
            expect(nextState).toEqual({
                channel1: [{ order: ["post2"], recent: false }],
            });
        });
    });
        ...
        describe(`when a channel is deleted (${actionType})`, () => {
            it("should remove any posts in that channel", () => {
                const state = deepFreeze({
                    ...
                    channel2: [{ order: ["post4", "post5"], recent: false }],
                });
...
describe("mergePostBlocks", () => {
    ...
    it("should do nothing with only one block", () => {
        const blocks: PostOrderBlock[] = [{ order: ["a"], recent: false }];
    ...
    it("should merge two blocks containing exactly the same posts", () => {
        ...
        expect(nextBlocks).toEqual([{ order: ["a"], recent: false }]);
    });
    ...
    it("should keep merged blocks marked as recent", () => {
        ...
        expect(nextBlocks).not.toBe(blocks);
        expect(nextBlocks).toEqual([{ order: ["a", "b", "c"], recent: true }]);
    });
    ...
    it("should keep merged blocks marked as oldest", () => {
        ...
        expect(nextBlocks).not.toBe(blocks);
        expect(nextBlocks).toEqual([{ order: ["a", "b", "c"], oldest: true }]);
    });
    ...
    it("should remove empty blocks", () => {
        ...
        expect(nextBlocks).toEqual([{ order: ["a", "b"], recent: true }]);
    });
});
    ...
    for (const actionType of [
        ...
        describe(`receiving a single post (${actionType})`, () => {
            it("should replace a previously pending comment", () => {
                ...
                const nextState = reducers.postsInThread(
                    state,
                    {
                        type: actionType,
                        data: {
        ...
        describe(`single post received (${actionType})`, () => {
            ...
            it("should save opengraph data", () => {
                ...
                expect(nextState).toEqual({
                    post: {
                        "https://example.com":
                            action.data.metadata.embeds[0].data,
                    },
                });
            });
        });
    ...
    describe("receiving multiple posts", () => {
        ...
        it("should save opengraph data", () => {
            ...
            expect(nextState).toEqual({
                post1: {
                    "https://example.com":
                        action.data.posts.post1.metadata.embeds[0].data,
                },
            });
        });
        ...
        it("should save reactions for multiple posts", () => {
            ...
            expect(nextState).toEqual({
                ...
                post2: {
                    "https://google.ca":
                        action.data.posts.post2.metadata.embeds[0].data,
                },
            });
        });
    });
...
describe("postsReplies", () => {
    ...
    describe("received post", () => {
        const testTable = [
            {
                name: "pending post (no id)",
                action: PostTypes.RECEIVED_POST,
                state: { ...initialState },
                post: { root_id: "123" },
                nextState: { ...initialState },
            },
            {
                name: "root post (no root_id)",
                action: PostTypes.RECEIVED_POST,
                state: { ...initialState },
                post: { id: "123" },
                nextState: { ...initialState },
            ...
            {
                name: "new reply without reply count",
                action: PostTypes.RECEIVED_POST,
                state: { ...initialState },
                post: { id: "123", root_id: "123" },
                nextState: { ...initialState, 123: 3 },
            },
            {
                name: "new reply with reply count",
                action: PostTypes.RECEIVED_POST,
                state: { ...initialState },
                post: { id: "123", root_id: "123", reply_count: 7 },
                nextState: { ...initialState, 123: 7 },
            },
            {
                name: "pending post (no id) (new post action)",
                action: PostTypes.RECEIVED_NEW_POST,
                state: { ...initialState },
                post: { root_id: "123" },
                nextState: { ...initialState },
            },
            {
                name: "root post (no root_id) (new post action)",
                action: PostTypes.RECEIVED_NEW_POST,
                state: { ...initialState },
                post: { id: "123" },
                nextState: { ...initialState },
            ...
            {
                name: "new reply without reply count (new post action)",
                action: PostTypes.RECEIVED_NEW_POST,
                state: { ...initialState },
                post: { id: "123", root_id: "123" },
                nextState: { ...initialState, 123: 3 },
            ...
            {
                name: "new reply with reply count (new post action)",
                action: PostTypes.RECEIVED_NEW_POST,
                state: { ...initialState },
                post: { id: "123", root_id: "123", reply_count: 7 },
                nextState: { ...initialState, 123: 7 },
    ...
    describe("received posts", () => {
        const testTable = [
            {
                name: "received empty posts list",
    ...
    describe("deleted posts", () => {
        const testTable = [
            {
                name: "deleted not tracked post",
                action: PostTypes.POST_DELETED,
                state: { ...initialState },
                post: { id: "000", root_id: "111" },
                nextState: { ...initialState },
            },
            {
                name: "deleted reply",
                action: PostTypes.POST_DELETED,
                state: { ...initialState },
                post: { id: "000", root_id: "123" },
                nextState: { ...initialState, 123: 2 },
            },
            {
                name: "deleted root post",
                action: PostTypes.POST_DELETED,
                state: { ...initialState },
                post: { id: "123" },
                nextState: { 456: 6, 789: 9 },
            },
        ];
        for (const testCase of testTable) {
            it(testCase.name, () => {
...
describe("limitedViews", () => {
    ...
    it(`${CloudTypes.RECEIVED_CLOUD_LIMITS} clears out limited views if there are no longer message limits`, () => {
        const nextState = reducers.limitedViews(
            { ...zeroState, threads: { rootId: 123 } },
            {
