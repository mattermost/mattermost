...
export function subscriptionStats(
    state: LicenseSelfServeStatusReducer | null = null,
    action: GenericAction,
): LicenseSelfServeStatusReducer | null {
    switch (action.type) {
...
function products(
    state: Record<string, Product> | null = null,
    action: GenericAction,
) {
    switch (action.type) {
...
function invoices(
    state: Record<string, Invoice> | null = null,
    action: GenericAction,
) {
    switch (action.type) {
...
export function limits(
    state: LimitsReducer = emptyLimits,
    action: GenericAction,
) {
    switch (action.type) {
...
function selfHostedSignup(
    state: SelfHostedSignupReducer = initialSelfHostedSignup,
    action: GenericAction,
): SelfHostedSignupReducer {
    switch (action.type) {
