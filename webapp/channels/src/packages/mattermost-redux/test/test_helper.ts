...
class TestHelper {
    ...
    getChannelMock = (override?: Partial<Channel>) => {
        return Object.assign(
            this.fakeChannel(override?.team_id || ""),
            override,
        );
    };
    ...
    fakeChannelNotifyProps = (
        override: Partial<ChannelNotifyProps>,
    ): ChannelNotifyProps => {
        return {
            desktop: "default",
            desktop_sound: "off",
    ...
    fakeUserNotifyProps = (
        override: Partial<UserNotifyProps>,
    ): UserNotifyProps => {
        return {
            desktop: "default",
            desktop_sound: "true",
    ...
    getPostMock = (override?: Partial<Post>) => {
        return Object.assign(
            this.fakePost(override?.channel_id || ""),
            override,
        );
    };
    ...
    mockLogin = () => {
        ...
        nock(clientBaseRoute).get("/users/me").reply(200, this.basicUser!);
        ...
        nock(clientBaseRoute)
            ...
            .reply(200, [
                { team_id: this.basicTeam!.id, msg_count: 0, mention_count: 0 },
            ]);
    ...
    initMockEntities = () => {
        ...
        this.basicTeamMember = this.fakeTeamMember(
            this.basicUser.id,
            this.basicTeam.id,
        );
        this.basicChannel = this.fakeChannelWithId(this.basicTeam.id);
        this.basicChannelMember = this.fakeChannelMember(
            this.basicUser.id,
            this.basicChannel.id,
        );
        this.basicPost = {
            ...this.fakePostWithId(this.basicChannel.id),
            create_at: 1507841118796,
        };
        this.basicRoles = {
            system_admin: {
            ...
            system_user: {
                ...
                permissions: ["system_user_permission"],
                scheme_managed: true,
                built_in: true,
                create_at: 0,
                update_at: 0,
            ...
            team_admin: {
                ...
                permissions: ["team_admin_permission"],
                scheme_managed: true,
                built_in: true,
                create_at: 0,
                update_at: 0,
            ...
            team_user: {
                ...
                permissions: ["team_user_permission"],
                scheme_managed: true,
                built_in: true,
                create_at: 0,
                update_at: 0,
            ...
            channel_admin: {
                ...
                permissions: ["channel_admin_permission"],
                scheme_managed: true,
                built_in: true,
                create_at: 0,
                update_at: 0,
            ...
            channel_user: {
                ...
                permissions: ["channel_user_permission"],
                scheme_managed: true,
                built_in: true,
                create_at: 0,
                update_at: 0,
