...
describe('Reducers.Storage', () => {
    ...
    test('Storage.REMOVE_GLOBAL_ITEM', () => {
    ...
    describe('Storage.ACTION_ON_GLOBAL_ITEMS_WITH_PREFIX', () => {
        test('should call the provided action on the given objects', () => {
        ...
        test('should return the original state if no results change', () => {
            const state = storageReducer({
                storage: {
                    prefix_key1: {value: 1, timestamp: now},
                    prefix_key2: {value: 2, timestamp: now},
    ...
    test('Storage.STORAGE_REHYDRATE', () => {
        let nextState = storageReducer(
            {
                storage: {},
            } as ReducerState,
