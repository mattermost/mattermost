...
export const selectedThreadIdInTeam = (
    state: ViewsState["threads"]["selectedThreadIdInTeam"] = {},
...
export const lastViewedAt = (
    state: ViewsState["threads"]["lastViewedAt"] = {},
    action: GenericAction,
) => {
    switch (action.type) {
...
export function manuallyUnread(
    state: ViewsState["threads"]["manuallyUnread"] = {},
    action: GenericAction,
) {
    switch (action.type) {
        case Threads.CHANGED_LAST_VIEWED_AT:
...
export function toastStatus(
    state: ViewsState["threads"]["toastStatus"] = false,
    action: GenericAction,
) {
    switch (action.type) {
