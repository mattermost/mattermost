...
function modalFilters(
    state: ViewsState["search"]["modalFilters"] = {},
...
function systemUsersSearch(
    state: Partial<ViewsState["search"]["systemUsersSearch"]> = {},
    action: GenericAction,
) {
    switch (action.type) {
...
function userGridSearch(
    state: Partial<ViewsState["search"]["userGridSearch"]> = {},
    action: GenericAction,
) {
    switch (action.type) {
...
function channelListSearch(
    state: Partial<ViewsState["search"]["channelListSearch"]> = {},
    action: GenericAction,
) {
    switch (action.type) {
