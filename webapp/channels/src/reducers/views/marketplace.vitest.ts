...
describe('marketplace', () => {
    ...
    describe(ActionTypes.INSTALLING_MARKETPLACE_ITEM, () => {
        ...
        test('should set installing for not already installing plugin', () => {
            const action = {
        ...
        test('should no-op for already installing plugin', () => {
            const action = {
                type: ActionTypes.INSTALLING_MARKETPLACE_ITEM,
                id: 'plugin1',
            };
        ...
        test('should clear error for previously failed plugin', () => {
            const action = {
                type: ActionTypes.INSTALLING_MARKETPLACE_ITEM,
                id: 'plugin3',
            };
    ...
    describe(ActionTypes.INSTALLING_MARKETPLACE_ITEM_FAILED, () => {
        ...
        test('should clear installing and set error', () => {
            const action = {
    ...
    describe(ActionTypes.MODAL_CLOSE, () => {
        ...
        test('should no-op for different modal', () => {
            const action = {
        ...
        test('should clear state for marketplace modal', () => {
            const action = {
                type: ActionTypes.MODAL_CLOSE,
