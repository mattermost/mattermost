...
// Components exposed on window FOR INTERNAL PLUGIN USE ONLY.
window.Components = {
    Textbox,
    Timestamp,
    ChannelInviteModal,
...
// This is a prototype of the Product API for use by internal plugins only
window.ProductApi = {
    useWebSocket,
    useWebSocketClient,
...
// Desktop App module containing the app info and a series of helpers
