...
> & {
    suggestionListStyle?: React.ComponentPropsWithRef<
        typeof Textbox
    >["suggestionListPosition"];
};

const PluginTextbox = React.forwardRef(
    (props: Props, ref?: React.Ref<BaseTextbox>) => {
        const { suggestionListStyle, ...otherProps } = props;
