...
import type { TranslationPluginFunction } from "actions/views/root";
import {
...
function dispatchPluginComponentAction(
    name: keyof PluginsState["components"],
    pluginId: string,
...
export default class PluginRegistry {
    ...
    registerRootComponent = reArg(
        ["component"],
        ({ component }: DPluginComponentProp) => {
    ...
    // Accepts a React component. Returns a unique identifier.
    registerPopoverUserAttributesComponent = reArg(
        ["component"],
        ({ component }: DPluginComponentProp) => {
    ...
    // Accepts a React component. Returns a unique identifier.
    registerPopoverUserActionsComponent = reArg(
        ["component"],
        ({ component }: DPluginComponentProp) => {
            return dispatchPluginComponentAction(
                "PopoverUserActions",
    ...
    // Accepts a React component. Returns a unique identifier.
    registerLeftSidebarHeaderComponent = reArg(
        ["component"],
        ({ component }: DPluginComponentProp) => {
            return dispatchPluginComponentAction(
                "LeftSidebarHeader",
    ...
    // Accepts a React component. Returns a unique identifier.
    registerBottomTeamSidebarComponent = reArg(
        ["component"],
        ({ component }: DPluginComponentProp) => {
            return dispatchPluginComponentAction(
                "BottomTeamSidebar",
    ...
    // Accepts a React component. Returns a unique identifier.
    registerPostMessageAttachmentComponent = reArg(
        ["component"],
        ({ component }: DPluginComponentProp) => {
            return dispatchPluginComponentAction(
    ...
    registerLinkTooltipComponent = reArg(
        ["component"],
        ({ component }: DPluginComponentProp) => {
            return dispatchPluginComponentAction(
                "LinkTooltip",
    ...
    // Accepts a React component. Returns a unique identifier.
    registerActionAfterChannelCreation = reArg(
        ["component", "action"],
        ({ component, action }) => {
            const id = generateId();
    ...
    registerChannelHeaderButtonAction = reArg(
        ["icon", "action", "dropdownText", "tooltipText"],
        ({
            icon,
            action,
            dropdownText,
    ...
    registerCallButtonAction = reArg(
        ...
        ({
            ...
            action: (
                ...
                myCurrentChannelMembership: ChannelMembership,
            ) => void;
        }) => {
            const id = generateId();
    ...
    registerPostTypeComponent = reArg(
        ["type", "component"],
        ({ type, component }) => {
            const id = generateId();
    ...
    // Accepts a string type and a component.
    // Returns a unique identifier.
    registerPostCardTypeComponent = reArg(
        ["type", "component"],
        ({ type, component }) => {
            const id = generateId();
    ...
    // Returns a unique identifier.
    registerPostWillRenderEmbedComponent = reArg(
        ["match", "component", "toggleable"],
        ({ match, component, toggleable }) => {
            const id = generateId();
    ...
    // Accepts a React component. Returns a unique identifier.
    registerPostActionComponent = reArg(
        ["component"],
        ({ component }: DPluginComponentProp) => {
            return dispatchPluginComponentAction(
                "PostAction",
    ...
    // Accepts a React component. Returns a unique identifier.
    registerPostEditorActionComponent = reArg(
        ["component"],
        ({ component }: DPluginComponentProp) => {
            return dispatchPluginComponentAction(
                "PostEditorAction",
    ...
    // Accepts a React component. Returns a unique identifier.
    registerCodeBlockActionComponent = reArg(
        ["component"],
        ({ component }: DPluginComponentProp) => {
            return dispatchPluginComponentAction(
                "CodeBlockAction",
    ...
    // Accepts a React component. Returns a unique identifier.
    registerNewMessagesSeparatorActionComponent = reArg(
        ["component"],
        ({ component }: DPluginComponentProp) => {
            return dispatchPluginComponentAction(
        ...
        ({
            ...
            const registerMenuItem = (
                ...
                return function registerSubMenuItem(...args: TInnerParams) {
                    if (parentMenuId) {
                        throw new Error(
                            "Submenus are currently limited to a single level.",
                        );
                    }
            ...
            return {
                id,
                rootRegisterMenuItem: registerMenuItem(
                    this.id,
                    id,
                    null,
                    text,
    ...
    // Accepts a React component. Returns a unique identifier.
    registerPostDropdownMenuComponent = reArg(
        ["component"],
        ({ component }: DPluginComponentProp) => {
            return dispatchPluginComponentAction(
    ...
    // Accepts a string id.
    // Returns undefined in all cases.
    unregisterPostTypeComponent = reArg(
        ["componentId"],
        ({ componentId }: { componentId: string }) => {
            store.dispatch({
    ...
    registerFilePreviewComponent = reArg(
        ["override", "component"],
        ({ override, component }) => {
            const id = generateId();
    ...
    registerTranslations = reArg(
        ["getTranslationsForLocale"],
        ({
            getTranslationsForLocale,
        }: {
            getTranslationsForLocale: TranslationPluginFunction;
        }) => {
            store.dispatch(
    ...
    registerAdminConsoleCustomSetting = reArg(
        ...
        ({
            ...
            store.dispatch(
                registerAdminConsoleCustomSetting(this.id, key, component, {
                    showTitle,
                }),
            );
        },
    ...
    // Returns a unique identifier.
    registerSidebarChannelLinkLabelComponent = reArg(
        ["component"],
        ({ component }: DPluginComponentProp) => {
            return dispatchPluginComponentAction(
    ...
    // All parameters are required.
    // Returns a unique identifier.
    registerChannelToastComponent = reArg(
        ["component"],
        ({ component }: DPluginComponentProp) => {
            return dispatchPluginComponentAction(
                "ChannelToast",
    ...
    registerAppBarComponent = reArg(
        ...
        ({
            ...
            const registeredRhsComponent =
                rhsComponent &&
                this.registerRightHandSidebarComponent({
                    title: rhsTitle,
                    component: rhsComponent,
                });
                ...
                data: {
                    ...
                    ...(registeredRhsComponent
                        ? {
                              action: () =>
                                  store.dispatch(
                                      registeredRhsComponent.toggleRHSPlugin,
                                  ),
            ...
            return registeredRhsComponent
                ? { id, rhsComponent: registeredRhsComponent }
                : id;
        },
    );
