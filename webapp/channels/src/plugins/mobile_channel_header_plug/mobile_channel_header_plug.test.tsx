...
import MobileChannelHeaderPlug, {
    RawMobileChannelHeaderPlug,
} from "plugins/mobile_channel_header_plug/mobile_channel_header_plug";
...
describe("plugins/MobileChannelHeaderPlug", () => {
    ...
    test("should call handleBindingClick on fireAppAction", () => {
        ...
        const handleBindingClick = jest
            .fn()
            .mockResolvedValue({ data: { type: AppCallResponseTypes.OK } });
        ...
        expect(handleBindingClick).toBeCalledWith(
            testBinding,
            context,
            expect.anything(),
        );
