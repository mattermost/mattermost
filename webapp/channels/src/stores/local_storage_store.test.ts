...
import LocalStorageStore, {
    getPenultimateChannelNameKey,
} from "stores/local_storage_store";
...
describe("stores/LocalStorageStore", () => {
    ...
    describe("testing previous channel", () => {
        test("should remove previous channel without subpath", () => {
            ...
            expect(
                LocalStorageStore.getPenultimateChannelName(userId1, teamId1),
            ).toEqual(channel2);
    ...
    describe("test removing penultimate channel", () => {
        test("should remove previous channel without subpath", () => {
            ...
            expect(
                LocalStorageStore.getItem(
                    getPenultimateChannelNameKey(userId1, teamId1),
                ),
            ).toEqual(null);
        });
    });
