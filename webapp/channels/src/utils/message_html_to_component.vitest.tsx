...
`;
    ...
    test('Inline markdown image', () => {
        ...
        // Verify MarkdownImage renders - check for the image alt text
        const {container} = renderWithContext(component);
        expect(container.querySelector('img[alt="Mattermost"]')).toBeInTheDocument();
    });
    ...
    test('Inline markdown image where image is link', () => {
        ...
        // Verify linked image renders
        const {container} = renderWithContext(component);
        expect(container.querySelector('a img[alt="Mattermost"]')).toBeInTheDocument();
    });
    ...
    test('At mention', () => {
        ...
        // Render to verify at mention is displayed
        let {container} = renderWithContext(component);
        expect(container.textContent).toContain('@joram');
        ...
        // Render to verify at mention is displayed
        ({container} = renderWithContext(component));
        expect(container.textContent).toContain('@joram');
    });
