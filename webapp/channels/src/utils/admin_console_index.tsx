...
function extractTextsFromSection(
    ...
    if (section.schema) {
        if (section.schema.settings) {
            ...
            section.schema.sections.forEach((schemaSection: any) => {
                texts.push(
                    ...extractTextFromSettings(schemaSection.settings, intl)
                );
            });
        }
    }
...
export function adminDefinitionsToUrlsAndTexts(
...
function addToIndex(
    entries: Record<string, Array<string | string[]>>,
    idx: Index
) {
