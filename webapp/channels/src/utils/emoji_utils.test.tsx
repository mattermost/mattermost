...
describe("convertEmojiSkinTone", () => {
    test("should convert a default skin toned emoji", () => {
        ...
        expect(convertEmojiSkinTone(emoji, "1F3FB")).toBe(
            getEmoji("nose_light_skin_tone"),
        );
        expect(convertEmojiSkinTone(emoji, "1F3FC")).toBe(
            getEmoji("nose_medium_light_skin_tone"),
        );
        expect(convertEmojiSkinTone(emoji, "1F3FD")).toBe(
            getEmoji("nose_medium_skin_tone"),
        );
        expect(convertEmojiSkinTone(emoji, "1F3FE")).toBe(
            getEmoji("nose_medium_dark_skin_tone"),
        );
        expect(convertEmojiSkinTone(emoji, "1F3FF")).toBe(
            getEmoji("nose_dark_skin_tone"),
        );
    });
    ...
    test("should convert a non-default skin toned emoji", () => {
        ...
        expect(convertEmojiSkinTone(emoji, "1F3FB")).toBe(
            getEmoji("ear_light_skin_tone"),
        );
        expect(convertEmojiSkinTone(emoji, "1F3FC")).toBe(
            getEmoji("ear_medium_light_skin_tone"),
        );
        expect(convertEmojiSkinTone(emoji, "1F3FD")).toBe(
            getEmoji("ear_medium_skin_tone"),
        );
        expect(convertEmojiSkinTone(emoji, "1F3FE")).toBe(
            getEmoji("ear_medium_dark_skin_tone"),
        );
        expect(convertEmojiSkinTone(emoji, "1F3FF")).toBe(
            getEmoji("ear_dark_skin_tone"),
        );
    });
    ...
    test("should convert a gendered emoji", () => {
        ...
        expect(convertEmojiSkinTone(emoji, "default")).toBe(
            getEmoji("male-teacher"),
        );
        expect(convertEmojiSkinTone(emoji, "1F3FB")).toBe(
            getEmoji("male-teacher_light_skin_tone"),
        );
        expect(convertEmojiSkinTone(emoji, "1F3FC")).toBe(
            getEmoji("male-teacher_medium_light_skin_tone"),
        );
        expect(convertEmojiSkinTone(emoji, "1F3FD")).toBe(
            getEmoji("male-teacher_medium_skin_tone"),
        );
        expect(convertEmojiSkinTone(emoji, "1F3FE")).toBe(
            getEmoji("male-teacher_medium_dark_skin_tone"),
        );
        expect(convertEmojiSkinTone(emoji, "1F3FF")).toBe(
            getEmoji("male-teacher_dark_skin_tone"),
        );
    });
    ...
    test("should convert emojis made up of ZWJ sequences", () => {
        ...
        expect(convertEmojiSkinTone(astronaut, "default")).toBe(
            getEmoji("astronaut"),
        );
        expect(convertEmojiSkinTone(astronaut, "1F3FB")).toBe(
            getEmoji("astronaut_light_skin_tone"),
        );
        expect(convertEmojiSkinTone(astronaut, "1F3FC")).toBe(
            getEmoji("astronaut_medium_light_skin_tone"),
        );
        expect(convertEmojiSkinTone(astronaut, "1F3FD")).toBe(
            getEmoji("astronaut_medium_skin_tone"),
        );
        expect(convertEmojiSkinTone(astronaut, "1F3FE")).toBe(
            getEmoji("astronaut_medium_dark_skin_tone"),
        );
        expect(convertEmojiSkinTone(astronaut, "1F3FF")).toBe(
            getEmoji("astronaut_dark_skin_tone"),
        );

        const redHairedWoman = getEmoji("red_haired_woman_dark_skin_tone");

        expect(convertEmojiSkinTone(redHairedWoman, "default")).toBe(
            getEmoji("red_haired_woman"),
        );
        expect(convertEmojiSkinTone(redHairedWoman, "1F3FB")).toBe(
            getEmoji("red_haired_woman_light_skin_tone"),
        );
        expect(convertEmojiSkinTone(redHairedWoman, "1F3FC")).toBe(
            getEmoji("red_haired_woman_medium_light_skin_tone"),
        );
        expect(convertEmojiSkinTone(redHairedWoman, "1F3FD")).toBe(
            getEmoji("red_haired_woman_medium_skin_tone"),
        );
        expect(convertEmojiSkinTone(redHairedWoman, "1F3FE")).toBe(
            getEmoji("red_haired_woman_medium_dark_skin_tone"),
        );
        expect(convertEmojiSkinTone(redHairedWoman, "1F3FF")).toBe(
            getEmoji("red_haired_woman_dark_skin_tone"),
        );
    });
