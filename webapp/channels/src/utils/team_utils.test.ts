...
describe("TeamUtils.filterAndSortTeamsByDisplayName", () => {
    const teamA = TH.getTeamMock({
        id: "team_id_a",
        name: "team-a",
        display_name: "Team A",
        delete_at: 0,
    });
    const teamB = TH.getTeamMock({
        id: "team_id_b",
        name: "team-b",
        display_name: "Team A",
        delete_at: 0,
    });
    const teamC = TH.getTeamMock({
        id: "team_id_c",
        name: "team-c",
        display_name: "Team C",
        delete_at: null as unknown as number,
    });
    const teamD = TH.getTeamMock({
        id: "team_id_d",
        name: "team-d",
        display_name: "Team D",
    });
    const teamE = TH.getTeamMock({
        id: "team_id_e",
        name: "team-e",
        display_name: "Team E",
        delete_at: 1,
    });
    const teamF = TH.getTeamMock({
        id: "team_id_i",
        name: "team-f",
    ...
    test("should return correct sorted teams", () => {
        for (const data of [
            ...
            {
                teams: [teamE, teamD, teamC, teamB, teamA],
                result: [teamA, teamB, teamC, teamD],
            },
            {
