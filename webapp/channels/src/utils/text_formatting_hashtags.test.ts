...
describe("TextFormatting.Hashtags with default setting", () => {
    it("Not hashtags", () => {
        expect(
            TextFormatting.formatText("# hashtag", {}, emojiMap).trim(),
        ).toBe('<h1 class="markdown__heading">hashtag</h1>');
    ...
    it("Hashtags", () => {
        ...
        expect(
            TextFormatting.formatText("#test-test", {}, emojiMap).trim(),
        ).toBe(
            "<p><a class='mention-link' href='#' data-hashtag='#test-test'>#test-test</a></p>",
        );

        expect(
            TextFormatting.formatText("#test_test", {}, emojiMap).trim(),
        ).toBe(
        ...
        expect(
            TextFormatting.formatText("#test1/#test2", {}, emojiMap).trim(),
        ).toBe(
    ...
    it("Formatted hashtags", () => {
        ...
        expect(
            TextFormatting.formatText("**#test**", {}, emojiMap).trim(),
        ).toBe(
            "<p><strong><a class='mention-link' href='#' data-hashtag='#test'>#test</a></strong></p>",
        );

        expect(
            TextFormatting.formatText("__#test__", {}, emojiMap).trim(),
        ).toBe(
            "<p><strong><a class='mention-link' href='#' data-hashtag='#test'>#test</a></strong></p>",
        );
    ...
    it("Potential hashtags with other entities nested", () => {
        ...
        expect(
            TextFormatting.formatText("#@test", options, emojiMap).trim(),
        ).toBe('<p>#<span data-mention="test">@test</span></p>');
        ...
        expect(
            TextFormatting.formatText("#:mattermost:", {}, emojiMap).trim(),
        ).toBe('<p>#<span data-emoticon="mattermost">:mattermost:</span></p>');

        expect(
            TextFormatting.formatText("#test@example.com", {}, emojiMap).trim(),
        ).toBe(
...
describe("TextFormatting.Hashtags with various settings", () => {
    it("Boundary of MinimumHashtagLength", () => {
        ...
        ).toBe("<p>This is a sentence #疑 containing a hashtag</p>");
    });
});
