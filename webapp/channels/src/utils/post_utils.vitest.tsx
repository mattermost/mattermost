...
describe('PostUtils.splitMessageBasedOnCaretPosition', () => {
    ...
    test('should return an object with two strings when given context and message', () => {
...
describe('PostUtils.isWithinCodeBlock', () => {
    ...
    test('should return true if caret is within a code block', () => {
    ...
    test('should return false if caret is not within a code block', () => {
        const [caretPosition, message] = getCaretAndMsg(`
            |This is a line of text
            |${TRIPLE_BACKTICKS}
            |    fun main() {
    ...
    test('should handle code blocks with language tags', () => {
        const [caretPosition, message] = getCaretAndMsg(`
            |This is a line of text
    ...
    test('should handle caret in front of code block', () => {
        const [caretPosition, message] = getCaretAndMsg(`
    ...
    test('should handle caret behind code block', () => {
        const [caretPosition, message] = getCaretAndMsg(`
            |${TRIPLE_BACKTICKS}kotlin
            |   fun main() {
            |       println("Test")
    ...
    test('should handle consecutive code blocks', () => {
        const [caretPosition, message] = getCaretAndMsg(`
            |${TRIPLE_BACKTICKS}
            |   Code Block 1
            |${TRIPLE_BACKTICKS}
    ...
    test('should handle caret position at 0', () => {
    ...
    test('should handle whitespace within and around code blocks', () => {
        const [caretPosition, message] = getCaretAndMsg(`
            |${TRIPLE_BACKTICKS}
            |   Test text asd 1
            |        ${CARET_MARKER}
