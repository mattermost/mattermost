...
export const DocLinksRemote = {
    ...
    CUSTOM_TERMS_OF_SERVICE: 'https://docs.mattermost.com/cloud/cloud-administration/custom-terms-of-service.html',
    DATA_RETENTION: 'https://docs.mattermost.com/administration/data-retention.html',
    ...
    GUEST_ACCOUNTS_DEPLOYMENT: 'https://docs.mattermost.com/deployment/guest-accounts.html',
    ...
    OPENID_CONNECT: 'https://docs.mattermost.com/cloud/cloud-administration/sso-openid-connect.html',
    SAML_SSO: 'https://www.mattermost.com/docs-saml/?utm_medium=product&utm_source=product-feature-discovery&utm_content=saml',
    ...
    SYSTEM_ROLES: 'https://docs.mattermost.com/deployment/admin-roles.html',
    ...
    MESSAGE_PRIORITY: 'https://mattermost.com/pl/message-priority/',
    OUTGOING_OAUTH_CONNECTIONS: 'https://mattermost.com/pl/outgoing-oauth-connections',
    TROUBLESHOOT_NOTIFICATIONS: 'https://mattermost.com/pl/troubleshoot-notifications',
    ABOUT_NOTIFICATIONS: 'https://mattermost.com/pl/about-notifications',
    USER_GUIDE: 'https://docs.mattermost.com/guides/use-mattermost.html',
};

export const DocLinksLocal = {
    ABOUT_TEAMS: '/static/docs/welcome/about-teams.html#team-url',
    ADMIN_GUIDE: '/static/docs/guides/administration.html',
    ADMIN_GUIDE_CLOUD: '/static/docs/guides/administration.html#cloud-workspace-management',
    ADVANCED_LOGGING: '/static/docs/comply/audit-log.html',
    ANNOUNCEMENT_BANNER: '/static/docs/administration/announcement-banner.html',
    BLEVE_SEARCH: '/static/docs/deploy/bleve-search.html',
    CONFIGURE_DOCUMENT_CONTENT_SEARCH: '/static/docs/configure/environment-configuration-settings.html#enable-document-search-by-content',
    CONFIGURE_AD_LDAP_QUERY_TIMEOUT: '/static/docs/configure-ad-ldap-query-timeout',
    CONFIGURE_OVERRIDE_SAML_BIND_DATA_WITH_LDAP: '/static/docs/deployment/sso-saml-ldapsync.html',
    COMPILANCE_EXPORT: '/static/docs/comply/compliance-export.html',
    COMPILANCE_MONITORING: '/static/docs/compliance-export',
    CUSTOM_TERMS_OF_SERVICE: '/static/docs/cloud/cloud-administration/custom-terms-of-service.html',
    DATA_RETENTION: '/static/docs/administration/data-retention.html',
    DATA_RETENTION_POLICY: '/static/docs/comply/data-retention-policy.html',
    DEFAULT_LDAP_GROUP_SYNC: '/static/docs/onboard/onboard/ad-ldap-groups-synchronization.html',
    DESKTOP_MANAGED_RESOURCES: '/static/docs/install/desktop-app-managed-resources.html',
    ELASTICSEARCH: '/static/docs/scale/elasticsearch.html',
    ENABLE_CLIENT_SIDE_CERTIFICATION: '/static/docs/deployment/certificate-based-authentication.html',
    ENABLE_HARDENED_MODE: '/static/docs/administration/config-settings.html',
    FORMAT_MESSAGES: '/static/docs/messaging/formatting-text.html',
    FILE_STORAGE: '/static/docs/configure/environment-configuration-settings.html',
    GUEST_ACCOUNTS_DEPLOYMENT: '/static/docs/deployment/guest-accounts.html',
    GUEST_ACCOUNTS: '/static/docs/onboard/guest-accounts.html',
    HIGH_AVAILABILITY_CLUSTER: '/static/docs/scale/high-availability-cluster.html',
    IN_PRODUCT_NOTICES: '/static/docs/manage/in-product-notices.html',
    LDAP_SETUP: '/static/docs/onboard/ad-ldap.html',
    LDAP_GROUP_SYNC: '/static/docs/deployment/ldap-group-sync.html',
    MANAGE_CUSTOM_GROUPS: '/static/docs/welcome/manage-custom-groups.html',
    MOBILE_SECURITY: '/static/docs/configure/environment-configuration-settings.html#mobile-security',
    MULTI_FACTOR_AUTH: '/static/docs/deployment/auth.html',
    ONBOARD_ADVANCED_PERMISSIONS: '/static/docs/onboard/advanced-permissions.html',
    ONBOARD_LDAP: '/static/docs/configure/authentication-configuration-settings.html#ad-ldap',
    OPENID_CONNECT: '/static/docs/cloud/cloud-administration/sso-openid-connect.html',
    SAML_SSO: '/static/docs/onboard/sso-saml.html',
    SELF_HOSTED_BILLING: "/static/docs/manage/self-hosted-billing.html",
    SESSION_LENGTHS: '/static/docs/configure/environment-configuration-settings.html#session-lengths',
    SETUP_IMAGE_PROXY: '/static/docs/deploy/image-proxy.html',
    SETUP_LDAP: '/static/docs/configure/authentication-configuration-settings.html#ad-ldap',
    SETUP_PERFORMANCE_MONITORING: '/static/docs/deployment/metrics.html',
    SETUP_PUSH_NOTIFICATIONS: '/static/docs/deploy/mobile-hpns.html',
    SETUP_SAML: '/static/docs/pl/setup-saml',
    SETUP_SSO_SAML: '/static/docs/onboard/sso-saml.html',
    SHARE_LINKS_TO_MESSAGES: '/static/docs/messaging/sharing-messages.html',
    SITE_URL: '/static/docs/configure/environment-configuration-settings.html#site-url',
    SSL_CERTIFICATE: '/static/docs/onboard/ssl-client-certificate.html',
    SYSTEM_ROLES: '/static/docs/deployment/admin-roles.html',
    TRUE_UP_REVIEW: '/static/docs/about/self-hosted-subscriptions.html#quarterly-true-up-reports-from-v7-9',
    TRUSTED_CONNECTION: '/static/docs/configure/environment-configuration-settings.html#dev-allowuntrustedinternalconnections',
    UPGRADE_SERVER: '/static/docs/upgrade/upgrading-mattermost-server.html',
    LDAP_ID_MIGRATE: '/static/docs/manage/command-line-tools.html#mattermost-ldap-idmigrate',
    MOBILE_APP_IOS: 'https://mattermost.com/mattermost-ios-app/',
    MOBILE_APP_ANDROID: 'https://mattermost.com/mattermost-android-app/',
    DEFAULT_BOT_ACCOUNTS: 'https://developers.mattermost.com/integrate/reference/bot-accounts/',
    DEFAULT_LDAP_GROUP_CONSTRAINED: '/static/docs/onboard/ad-ldap-groups-synchronization.html#use-ad-ldap-synchronized-groups-to-manage-team-or-private-channel-membership',
    CLOUD_IP_FILTERING: '/static/docs/manage/cloud-ip-filtering.html',
    DEFAULT_MATTERMOST_MARKETPLACE: '/static/docs/default-mattermost-marketplace.html',
    USER_STATS_LEARN_MORE: '/static/docs/deploy/postgres-migration.html',
    MESSAGE_PRIORITY: '/static/docs/channels/message-priority.html',
    OUTGOING_OAUTH_CONNECTIONS: 'https://developers.mattermost.com/integrate/slash-commands/outgoing-oauth-connections',
    TROUBLESHOOT_NOTIFICATIONS: '/static/docs/preferences/troubleshoot-notifications.html',
    ABOUT_NOTIFICATIONS: '/static/docs/preferences/manage-your-notifications.html',
    USER_GUIDE: '/static/docs/guides/use-mattermost.html',
};

export var DocLinks = DocLinksRemote;
