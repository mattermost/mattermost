...
export const DocLinks = {
    ...
    ADVANCED_LOGGING: '/static/docs/advanced-logging',
    ANNOUNCEMENT_BANNER: '/static/docs/administration/announcement-banner.html',
    BLEVE_SEARCH: '/static/docs/deploy/bleve-search.html',
    CONFIGURE_DOCUMENT_CONTENT_SEARCH: '/static/docs/configure-document-content-search',
    CONFIGURE_AD_LDAP_QUERY_TIMEOUT: '/static/docs/configure-ad-ldap-query-timeout',
    CONFIGURE_OVERRIDE_SAML_BIND_DATA_WITH_LDAP: '/static/docs/configure-override-saml-bind-data-with-ldap',
    COMPILANCE_EXPORT: '/static/docs/compliance-export',
    COMPILANCE_MONITORING: '/static/docs/compliance-monitoring',
    ...
    DATA_RETENTION_POLICY: '/static/docs/data-retention-policy',
    DEFAULT_LDAP_GROUP_SYNC: '/static/docs/default-ldap-group-sync',
    DESKTOP_MANAGED_RESOURCES: '/static/docs/desktop-managed-resources',
    ELASTICSEARCH: '/static/docs/setup-elasticsearch',
    ENABLE_CLIENT_SIDE_CERTIFICATION: '/static/docs/enable-client-side-certification',
    ENABLE_HARDENED_MODE: '/static/docs/enable-hardened-mode',
    FORMAT_MESSAGES: '/static/docs/format-messages',
    FILE_STORAGE: '/static/docs/configure-file-storage',
    ...
    HIGH_AVAILABILITY_CLUSTER: '/static/docs/high-availability-cluster',
    IN_PRODUCT_NOTICES: '/static/docs/in-product-notices',
    LDAP_SETUP: 'https://www.mattermost.com/docs-adldap/?utm_medium=product&utm_source=product-feature-discovery&utm_content=adldap',
    ...
    MULTI_FACTOR_AUTH: '/static/docs/multi-factor-authentication',
    ONBOARD_ADVANCED_PERMISSIONS: '/static/docs/advanced-permissions',
    ONBOARD_LDAP: '/static/docs/setup-ldap',
    OPENID_CONNECT: '/static/docs/cloud/cloud-administration/sso-openid-connect.html',
    SAML_SSO: 'https://www.mattermost.com/docs-saml/?utm_medium=product&utm_source=product-feature-discovery&utm_content=saml',
    SELF_HOSTED_BILLING: HostedCustomerLinks.SELF_HOSTED_BILLING,
    SESSION_LENGTHS: '/static/docs/configure-session-lengths',
    SETUP_IMAGE_PROXY: '/static/docs/setup-image-proxy',
    SETUP_LDAP: '/static/docs/setup-ldap',
    SETUP_PERFORMANCE_MONITORING: '/static/docs/setup-performance-monitoring',
    SETUP_PUSH_NOTIFICATIONS: '/static/docs/setup-push-notifications',
    SETUP_SAML: '/static/docs/pl/setup-saml',
    SETUP_SSO_SAML: 'http://docs.mattermost.com/deployment/sso-saml.html',
    SHARE_LINKS_TO_MESSAGES: '/static/docs/share-links-to-messages',
    SITE_URL: '/static/docs/configure-site-url',
    SSL_CERTIFICATE: '/static/docs/setup-ssl-client-certificate',
    SYSTEM_ROLES: '/static/docs/deployment/admin-roles.html',
    TRUE_UP_REVIEW: '/static/docs/true-up-documentation',
    TRUSTED_CONNECTION: '/static/docs/default-allow-untrusted-internal-connections',
    UPGRADE_SERVER: '/static/docs/upgrade-mattermost',
    LDAP_ID_MIGRATE: '/static/docs/manage/command-line-tools.html#mattermost-ldap-idmigrate',
    MOBILE_APP_IOS: '/static/docs/ios-app/',
    MOBILE_APP_ANDROID: '/static/docs/android-app/',
    DEFAULT_BOT_ACCOUNTS: '/static/docs/default-bot-accounts',
    DEFAULT_LDAP_GROUP_CONSTRAINED: '/static/docs/default-ldap-group-constrained-team-channel.html',
    CLOUD_IP_FILTERING: '/static/docs/cloud-ip-filtering',
    DEFAULT_MATTERMOST_MARKETPLACE: '/static/docs/default-mattermost-marketplace.html',
    USER_STATS_LEARN_MORE: '/static/docs/user-stats-learn-more',
    MESSAGE_PRIORITY: '/static/docs/message-priority/',
    OUTGOING_OAUTH_CONNECTIONS: '/static/docs/outgoing-oauth-connections',
};
