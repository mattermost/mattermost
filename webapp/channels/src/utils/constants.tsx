...
export const Preferences = {
    ...
    ALWAYS_SHOW_REMOTE_USER_HOUR_DEFAULT: 'false',
...
export const ActionTypes = keyMirror({
    ...
    RECEIVED_PLUGIN_POST_PRIORITY_TYPE: null,
    REMOVED_PLUGIN_POST_PRIORITY_TYPE: null,
    ...
    ENCRYPTED_FILE_METADATA_RECEIVED: null,
    ENCRYPTED_FILE_DECRYPTION_STARTED: null,
    ENCRYPTED_FILE_DECRYPTED: null,
    ENCRYPTED_FILE_DECRYPTION_FAILED: null,
    ENCRYPTED_FILE_CLEANUP: null,
    ENCRYPTED_FILE_THUMBNAIL_GENERATED: null,
    ENCRYPTED_FILE_ORIGINAL_INFO_RECEIVED: null,
...
export const RHSStates = {
    ...
    THREAD_FOLLOWERS: 'thread-followers',
};
