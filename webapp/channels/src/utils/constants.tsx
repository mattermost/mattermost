...
export const WarnMetricTypes = {
    ...
    SYSTEM_WARN_METRIC_NUMBER_OF_CHANNELS_5:
        "warn_metric_number_of_channels_50",
...
export const AnnouncementBarMessages = {
    ...
    WARN_METRIC_STATUS_NUMBER_OF_USERS: t(
        "announcement_bar.warn_metric_status.number_of_users.text",
    ),
    WARN_METRIC_STATUS_NUMBER_OF_USERS_ACK: t(
        "announcement_bar.warn_metric_status.number_of_users_ack.text",
    ),
    WARN_METRIC_STATUS_NUMBER_OF_POSTS: t(
        "announcement_bar.warn_metric_status.number_of_posts.text",
    ),
    WARN_METRIC_STATUS_NUMBER_OF_POSTS_ACK: t(
        "announcement_bar.warn_metric_status.number_of_posts_ack.text",
    ),
...
export const searchHintOptions = [
    ...
    },
    {
        searchTerm: "Before:",
        message: {
            id: t("search_list_option.before"),
    ...
    },
    {
        searchTerm: "-",
        message: {
            id: t("search_list_option.exclude"),
    ...
    },
    {
        searchTerm: '""',
        message: {
            id: t("search_list_option.phrases"),
...
export const searchFilesHintOptions = [
    {
        searchTerm: "From:",
        message: {
            id: t("search_files_list_option.from"),
    ...
    },
    {
        searchTerm: "In:",
        message: {
            id: t("search_files_list_option.in"),
    ...
    },
    {
        searchTerm: "On:",
        message: {
            id: t("search_files_list_option.on"),
    ...
    },
    {
        searchTerm: "Before:",
        message: {
            id: t("search_files_list_option.before"),
    ...
    },
    {
        searchTerm: "After:",
        message: {
            id: t("search_files_list_option.after"),
    ...
    },
    {
        searchTerm: "Ext:",
        message: {
            id: t("search_files_list_option.ext"),
    ...
    },
    {
        searchTerm: "-",
        message: {
            id: t("search_files_list_option.exclude"),
            defaultMessage: "Exclude search terms",
        },
        additionalDisplay: "—",
    },
    {
        searchTerm: '""',
        message: {
            id: t("search_files_list_option.phrases"),
