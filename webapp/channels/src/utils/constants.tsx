...
export const StoragePrefixes = {
  ...
  HIDE_NOTIFICATION_PERMISSION_REQUEST_BANNER:
    "hideNotificationPermissionRequestBanner",
};
...
export const LicenseLinks = {
  ...
  UNSUPPORTED_UPGRADE_LINK:
    "https://docs.mattermost.com/administration-guide/upgrade/enterprise-install-upgrade.html#upgrading-to-enterprise-edition-from-mattermost-team-edition",
};
...
export const searchFilesHintOptions = [
  ...
  },
  {
    ...
    message: defineMessage({
      ...
      defaultMessage: "Files with an extension",
    }),
  },
  {
    searchTerm: "-",
