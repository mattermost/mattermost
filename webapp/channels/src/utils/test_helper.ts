...
export class TestHelper {
    ...
    public static getUserAccessTokenMock(
        override?: Partial<UserAccessToken>,
    ): UserAccessToken {
    ...
    public static getChannelWithTeamDataMock(
        override?: Partial<ChannelWithTeamData>,
    ): ChannelWithTeamData {
    ...
    public static getCategoryMock(
        override?: Partial<ChannelCategory>,
    ): ChannelCategory {
    ...
    public static getChannelMembershipMock(
        ...
        const notifyProps = Object.assign(
            {},
            defaultNotifyProps,
            overrideNotifyProps,
        );
    ...
    public static getTeamMembershipMock(
        override: Partial<TeamMembership>,
    ): TeamMembership {
    ...
    public static getIncomingWebhookMock(
        override: Partial<IncomingWebhook> = {},
    ): IncomingWebhook {
    ...
    public static getOutgoingWebhookMock(
        override: Partial<OutgoingWebhook> = {},
    ): OutgoingWebhook {
    ...
    public static makeProduct(name: string): ProductComponent {
        return {
            ...
            pluginId: "",
            switcherIcon:
                `product-${name.toLowerCase()}` as ProductComponent["switcherIcon"],
            switcherText: name,
            baseURL: "",
            switcherLinkURL: "",
            mainComponent: () => null,
    ...
    public static getCustomEmojiMock(
        override: Partial<CustomEmoji>,
    ): CustomEmoji {
        return {
            id: "emoji_id",
            name: "emoji",
    ...
    public static getSystemEmojiMock(
        override: Partial<SystemEmoji>,
    ): SystemEmoji {
        return {
            name: "",
            category: "recent",
    ...
    public static getCloudLicenseMock(
        override: ClientLicense = {},
    ): ClientLicense {
        return {
    ...
    public static getPreferencesMock(
        override: Array<{ category: string; name: string; value: string }> = [],
        userId = "",
    ...
    public static getSubscriptionMock(
        ...
        return {
            ...
            create_at: 0,
            seats: 0,
            last_invoice: TestHelper.getInvoiceMock({
                subscription_id: override.id || "",
            }),
            trial_end_at: 0,
            is_free_trial: "false",
            ...override,
    ...
    public static getCloudCustomerMock(
        override: Partial<CloudCustomer> = {},
    ): CloudCustomer {
        return {
            id: "",
            billing_address: {
