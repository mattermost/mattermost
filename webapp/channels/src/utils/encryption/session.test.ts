...
import {storeKeyPair, storeSessionId, hasEncryptionKeys, clearAllEncryptionKeys} from './storage';
import {
...
jest.mock('./use_decrypt_post', () => ({
    clearDecryptionCache: jest.fn(),
}));

const {getEncryptionStatus, registerPublicKey, getChannelMemberKeys} = require('./api');
const {clearDecryptionCache} = require('./use_decrypt_post');
