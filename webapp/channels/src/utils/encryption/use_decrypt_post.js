...
exports.useDecryptPost = useDecryptPost;
exports.clearDecryptionCache = clearDecryptionCache;
/**
 ...
 */
function useDecryptPost(post, userId) {
    const dispatch = (0, react_redux_1.useDispatch)();
    const postIdRef = (0, react_1.useRef)(null);
    (0, react_1.useEffect)(() => {
        ...
        const attemptDecryption = async () => {
            ...
            try {
                ...
                if (result.post.props?.encryption_status) {
                    ...
                    dispatch((0, posts_1.receivedPost)(result.post));
                ...
                dispatch((0, posts_1.receivedPost)({
                    ...post,
                    props: {
                        ...post.props,
