...
// Discovery builds turn React warnings into browser exceptions that the E2E harness can collect.
...
/**
 * Warnings for legacy APIs, render impurity, and effect ordering exposed by StrictMode.
 */
...
export function installReactStrictModeDiagnostics() {
    ...
    const reportWarning = (...args: unknown[]) => {
