 ...
 */
export function isUnhandledLineBreakKeyCombo(
    ...
    return Boolean(
        Keyboard.isKeyPressed(e, Constants.KeyCodes.ENTER) &&
            ...
            e.altKey &&
            !UserAgent.isSafari() &&
            !Keyboard.cmdOrCtrlPressed(e), // alt/option + enter is already handled in Safari, so don't handle again
    );
}
...
export function getRemainingDaysFromFutureTimestamp(
    timestamp?: number,
): number {
...
export function addTimeToTimestamp(
    ...
    return timeline === TimeInformation.FUTURE
 ...
 */
export function isDateWithinDaysRange(
    timestamp: number,
    days: number,
    timeline: TimeDirection,
): boolean {
    ...
    return timeline === TimeInformation.PAST
        ? daysSince <= days
        : daysSince >= days;
}

export function getLocaleDateFromUTC(
    timestamp: number,
...
export function getFileIconPath(fileInfo: FileInfo) {
    const fileType = getFileType(
        fileInfo.extension,
    ) as keyof typeof Constants.ICON_FROM_TYPE;
...
export function getCompassIconClassName(
    fileTypeIn: string,
    outline = true,
    large = false,
) {
    const fileType =
        fileTypeIn.toLowerCase() as keyof typeof Constants.ICON_FROM_TYPE;
    let icon = "generic";
    ...
    return `icon-file-${icon}${outline ? "-outline" : ""}${
        large ? "-large" : ""
    }`;
}
...
export function toRgbValues(hexStr: string): string {
    const rgbaStr = `${parseInt(hexStr.substr(1, 2), 16)}, ${parseInt(
        hexStr.substr(3, 2),
        16,
...
export function applyTheme(theme: Theme) {
    if (theme.centerChannelColor) {
        ...
        changeCss(
            ".app__body .file-preview, .app__body .post-image__details, .app__body .markdown__table th, .app__body .markdown__table td, .app__body .webhooks__container, .app__body .dropdown-menu",
        ...
        changeCss(
            ".app__body .popover .popover__row",
            "border-color:" + changeOpacity(theme.centerChannelColor, 0.2),
        );
        changeCss(
        ...
        changeCss(
            ".app__body .MenuWrapper .MenuItem > button:hover, .app__body .Menu .MenuItem > button:hover, .app__body .MenuWrapper .MenuItem > button:focus, .app__body .MenuWrapper .SubMenuItem > div:focus, .app__body .MenuWrapper .MenuItem > a:hover, .MenuItem > div:hover, .SubMenuItemContainer:not(.hasDivider):hover, .app__body .dropdown-menu div > a:focus, .app__body .dropdown-menu div > a:hover, .dropdown-menu li > a:focus, .app__body .dropdown-menu li > a:hover",
            "background:" + changeOpacity(theme.centerChannelColor, 0.1),
        );
        changeCss(
            ".app__body .MenuWrapper .MenuItem > button:hover, .app__body .Menu .MenuItem > button:hover, .app__body .MenuWrapper .MenuItem > button:focus, .app__body .MenuWrapper .SubMenuItem > div:focus, .app__body .MenuWrapper .MenuItem > a:hover, .app__body .MenuWrapper .MenuItem > div:hover, .app__body .MenuWrapper .SubMenuItemContainer:not(.hasDivider):hover, .app__body .MenuWrapper .SubMenuItemContainer:not(.hasDivider):focus, .app__body .MenuWrapper .SubMenuItemContainer:focus, .app__body .dropdown-menu div > a:focus, .app__body .dropdown-menu div > a:hover, .dropdown-menu li > a:focus, .app__body .dropdown-menu li > a:hover",
        ...
        changeCss(
            ...
            "border-color:" + changeOpacity(theme.centerChannelColor, 0.16),
        );
        changeCss(
        ...
        changeCss(
            ".app__body .search-item-container",
            "border-color:" + changeOpacity(theme.centerChannelColor, 0.1),
        );
        changeCss(
        ...
        changeCss(
            ".app__body .channel-intro, .app__body hr, .app__body .modal .settings-modal .settings-table .settings-content .appearance-section .theme-elements__header, .app__body .user-settings .authorized-app:not(:last-child)",
            "border-color:" + changeOpacity(theme.centerChannelColor, 0.2),
        );
        changeCss(
        ...
        changeCss(
            "@media(min-width: 768px){.app__body .post.post--editing",
            "background:" + changeOpacity(theme.buttonBg, 0.08),
        );
        changeCss(
        ...
        changeCss(
            ".app__body .post.post--compact .post-image__column .post-image__details svg, .app__body .modal .about-modal .about-modal__logo svg, .app__body .status svg, .app__body .edit-post__actions .icon svg",
    ...
    if (theme.linkColor) {
        changeCss(
            ".app__body .more-modal__list .a11y--focused, .app__body .post.a11y--focused, .app__body .channel-header.a11y--focused, .app__body .post-create.a11y--focused, .app__body .user-popover.a11y--focused, .app__body .post-message__text.a11y--focused",
            "box-shadow: inset 0 0 1px 3px " +
                changeOpacity(theme.linkColor, 0.5) +
                ", inset 0 0 0 1px " +
                theme.linkColor,
        );
        changeCss(
        ...
        changeCss(
            ".app__body .channel-header .channel-header__favorites.inactive:hover, .app__body a, .app__body a:focus, .app__body a:hover, .app__body .color--link, .app__body a:focus, .app__body .color--link:hover",
        ...
        changeCss(
            ".app__body .channel-header .channel-header_plugin-dropdown a:hover",
            "background:" + changeOpacity(theme.linkColor, 0.08),
        );
        changeCss(".app__body .post .post__reply", "fill:" + theme.linkColor);
        changeCss(
            ".app__body .post .card-icon__container.active svg, .app__body .post .post__reply",
        ...
        changeCss(
            ".app__body .channel-header .channel-header_plugin-dropdown a:hover .fa",
            "color:" + theme.linkColor,
        );
        changeCss(
    ...
    if (theme.errorTextColor) {
        ...
        changeCss(
            ".app__body .btn-danger:hover",
            "background:" + blendColors(theme.errorTextColor, "#000000", 0.1),
        );
        changeCss(
            ".app__body .btn-danger:active",
            "background:" + blendColors(theme.errorTextColor, "#000000", 0.2),
        );
    }

    if (theme.mentionHighlightBg) {
        changeCss(
            ".app__body .search-highlight",
    ...
    cssVars({
        variables: {
            ...
            "mention-highlight-link-rgb": toRgbValues(
                theme.mentionHighlightLink,
            ),
            "mention-highlight-bg-mixed-rgb": dropAlpha(
                blendColors(
            ...
            "pinned-highlight-bg-mixed-rgb": dropAlpha(
                blendColors(
                    theme.centerChannelBg,
                    theme.mentionHighlightBg,
                    0.24,
            ...
            "own-highlight-bg-rgb": dropAlpha(
                blendColors(
                    theme.mentionHighlightBg,
            ...
            "sidebar-header-text-color-rgb": toRgbValues(
                theme.sidebarHeaderTextColor,
            ),
            "sidebar-text-rgb": toRgbValues(theme.sidebarText),
            "sidebar-text-active-border-rgb": toRgbValues(
                theme.sidebarTextActiveBorder,
            ),
            "sidebar-text-active-color-rgb": toRgbValues(
...
function changeCss(className: string, classValue: string) {
    let styleEl: HTMLStyleElement = document.querySelector(
...
function updateCodeTheme(codeTheme: string) {
    ...
    if (
        link &&
        cssPath !==
            (link.attributes as LinkHTMLAttributes<HTMLLinkElement>).href
    ) {
...
export function getSuggestionBoxAlgn(
    ...
    const { x: caretXCoordinateInTxtArea, y: caretYCoordinateInTxtArea } =
        getCaretXYCoordinate(textArea);
    const { w: viewportWidth, h: viewportHeight } = getViewportSize();
    const { offsetWidth: textAreaWidth } = textArea;

    const suggestionBoxWidth = Math.min(
        textAreaWidth,
        Constants.SUGGESTION_LIST_MAXWIDTH,
    );

    // value in pixels for the offsetLeft for the textArea
    const { top: txtAreaOffsetTop, left: txtAreaOffsetLft } =
        offsetTopLeft(textArea);
    ...
    const xBoxRightCoordinate =
        caretXCoordinateInTxtArea + txtAreaOffsetLft + suggestionBoxWidth;
    ...
    return {
        ...
        placementShift:
            txtAreaOffsetTop +
                caretYCoordinateInTxtArea +
                Constants.SUGGESTION_LIST_MAXHEIGHT >
            viewportHeight - Constants.POST_AREA_HEIGHT,
    };
}
...
export function getPxToSubstract(char = "@") {
    ...
    if (char === "@") {
        ...
        const mentionNamePaddingLft = convertEmToPixels(
            document.documentElement,
            Constants.MENTION_NAME_PADDING_LEFT,
        );
    ...
    request.onprogress = (e) => {
        if (onProgress) {
            ...
            if (e.lengthComputable) {
                ...
                total = parseInt(
                    (e.target as any).getResponseHeader(
...
export function imageURLForUser(
...
export function imageURLForTeam(
...
export function isFileTransfer(files: DataTransfer) {
    ...
    return (
        ...
        (files.types.indexOf
            ...
            : files.types.includes("application/x-moz-file"))
    );
}
...
export function isTextTransfer(dataTransfer: DataTransfer) {
    return ["text/plain", "text/unicode", "Text"].some((type) =>
 ...
 */
export function localizeAndFormatMessage(
    id: string,
    defaultMessage: string,
    template: { [name: string]: any } | undefined,
) {
...
function isChannelOrPermalink(link: string) {
    let match = /\/([a-z0-9\-_]+)\/channels\/([a-z0-9\-__][a-z0-9\-__.]+)/.exec(
        link,
    );
    if (match) {
        return {
...
export async function handleFormattedTextClick(
    e: React.MouseEvent,
    ...
    const channelMentionAttribute = (e.target as any).getAttributeNode(
    ...
    if (hashtagAttribute) {
        ...
        if (
                ...
                if (match) {
                    ...
                    if (team && team.delete_at === 0) {
                        ...
                        if (match.type === "channel") {
                            ...
                            channel = getChannelsNameMapInTeam(state, team.id)[
                            ...
                            if (post) {
                                ...
                                if (!channel) {
                                    const { data: channelData } =
                                        await store.dispatch(
                                            getChannelAction(post.channel_id),
                                        );
                                    channel = channelData;
                                }
                            }
                        ...
                        if (
                            ...
                            let member =
                                getMyChannelMemberships(state)[channel.id];
                            if (!member) {
            ...
            if (
                match &&
                match.type === "permalink" &&
                isTeamSameWithCurrentTeam(state, match.teamName) &&
                isReply &&
                crtEnabled
            ) {
                focusPost(match.postId ?? "", linkAttribute.value, user.id, {
...
export function deleteKeysFromObject(
...
export function isTextSelectedInPostOrReply(
    ...
    const { selectionStart, selectionEnd } = e.target as TextboxElement;
...
export function getDatePickerLocalesForDateFns(
    locale: string,
