...
export function applyTheme(theme: Theme) {
    ...
    if (theme.centerChannelColor) {
        ...
        changeCss('.app__body .attachment .attachment__content, .app__body .attachment-actions button, .app__body .mm-blocks .mm-blocks-container--flow-horizontal .btn', 'border-color:' + changeOpacity(theme.centerChannelColor, 0.16));
        changeCss('.app__body .attachment-actions button:focus, .app__body .attachment-actions button:hover, .app__body .mm-blocks .mm-blocks-container--flow-horizontal .btn:focus, .app__body .mm-blocks .mm-blocks-container--flow-horizontal .btn:hover', 'border-color:' + changeOpacity(theme.centerChannelColor, 0.5));
        changeCss('.app__body .attachment-actions button:focus, .app__body .attachment-actions button:hover, .app__body .mm-blocks .mm-blocks-container--flow-horizontal .btn:focus, .app__body .mm-blocks .mm-blocks-container--flow-horizontal .btn:hover', 'background:' + changeOpacity(theme.centerChannelColor, 0.03));
