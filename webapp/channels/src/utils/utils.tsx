...
export function applyTheme(theme: Theme) {
    if (theme.centerChannelColor) {
        ...
        changeCss('.app__body .help-text, .app__body .post .post-waiting, .app__body .post.post--system .post__body', 'color:' + changeOpacity(theme.centerChannelColor, 0.64));
        ...
        changeCss('.app__body .channel-header .pinned-posts-button svg', 'fill:' + changeOpacity(theme.centerChannelColor, 0.64));
        changeCss('.app__body .channel-header .channel-header_plugin-dropdown svg', 'fill:' + changeOpacity(theme.centerChannelColor, 0.64));
    ...
    if (theme.linkColor) {
        ...
        changeCss('.app__body .channel-header .pinned-posts-button:hover svg', 'fill:' + changeOpacity(theme.linkColor, 0.64));
    ...
    cssVars({
        variables: {
            ...
            'sidebar-text-60': changeOpacity(theme.sidebarText, 0.64),
            ...
            'center-channel-bg-56': changeOpacity(theme.centerChannelBg, 0.64),
            'center-channel-color-56': changeOpacity(theme.centerChannelColor, 0.64),
            ...
            'button-bg-56': changeOpacity(theme.buttonBg, 0.64),
            'button-color-56': changeOpacity(theme.buttonColor, 0.64),
