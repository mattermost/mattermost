...
describe('plugin setting extraction', () => {
    ...
    afterEach(() => {
        // Clear mock calls so the vitest setup's afterEach doesn't see these expected warnings
        warnSpy.mockClear();
        warnSpy.mockRestore();
    });
    ...
    test('action gets properly added', () => {
        const config = getFullExample();
        const res = extractPluginConfiguration(config, 'PluginId');
        expect(res).toBeTruthy();
    ...
    test('sections get properly added', () => {
        const config = getFullExample();
        const res = extractPluginConfiguration(config, 'PluginId');
        expect(res).toBeTruthy();
        expect(res?.sections).toHaveLength(2);
    ...
    test('reject configs without name', () => {
        const config: any = getFullExample();
        config.uiName = '';
        let res = extractPluginConfiguration(config, 'PluginId');
    ...
    test('filter out sections without a title', () => {
        const config: any = getFullExample();
    ...
    test('filter out settings without a type', () => {
        const config: any = getFullExample();
    ...
    test('filter out settings without a name', () => {
        const config: any = getFullExample();
    ...
    test('filter out settings without a default value', () => {
        const config: any = getFullExample();
    ...
    test('filter out radio options without a text', () => {
        const config: any = getFullExample();
    ...
    test('filter out radio options without a value', () => {
        const config: any = getFullExample();
    ...
    test('reject configs without valid sections', () => {
        const config = getFullExample();
        config.sections = [{
            settings: [],
            title: 'foo',
    ...
    test('filter out invalid sections', () => {
        const config = getFullExample();
    ...
    test('filter out sections without valid settings', () => {
        const config = getFullExample();
    ...
    test('filter out invalid settings', () => {
        const config = getFullExample();
        if ('settings' in config.sections[0] && 'options' in config.sections[0].settings[0]) {
            config.sections[0].settings[0].options = [];
        }
    ...
    test('filter out radio settings without valid options', () => {
        const config = getFullExample();
        if ('settings' in config.sections[0] && 'options' in config.sections[0].settings[0]) {
            config.sections[0].settings[0].options[0].value = '';
    ...
    test('filter out ill defined action', () => {
    ...
    test('(future proof) filter out extra config arguments', () => {
        const config: any = getFullExample();
    ...
    test('(future proof) filter out extra section arguments', () => {
        const config: any = getFullExample();
    ...
    test('(future proof) filter out extra setting arguments', () => {
        const config: any = getFullExample();
    ...
    test('(future proof) filter out extra option arguments', () => {
        const config: any = getFullExample();
    ...
    test('(future proof) filter out unknown settings', () => {
        const config: any = getFullExample();
    ...
    describe('custom components', () => {
        ...
        test('missing setting component', () => {
        ...
        test('missing section component', () => {
            const config: any = getCustomExample();
        ...
        test('invalid setting component', () => {
            const config: any = getCustomExample();
        ...
        test('invalid section component', () => {
            const config: any = getCustomExample();
