...
describe("TextFormatting.AtMentions", () => {
    describe("At mentions", () => {
        const tests: StringsTest[] = [
            ...
            {
                actual: TextFormatting.autolinkAtMentions(
                    'abc"@user"def',
                    new Map(),
                ),
    ...
    it("Highlighted at mentions", () => {
        expect(
            TextFormatting.formatText(
                "@user",
                { atMentions: true, mentionKeys: [{ key: "@user" }] },
                emptyEmojiMap,
            ).trim(),
        ).toEqual(
        ...
        expect(
            TextFormatting.formatText(
                "@channel",
                { atMentions: true, mentionKeys: [{ key: "@channel" }] },
                emptyEmojiMap,
            ).trim(),
        ).toEqual(
        ...
        expect(
            TextFormatting.formatText(
                "@all",
                { atMentions: true, mentionKeys: [{ key: "@all" }] },
                emptyEmojiMap,
            ).trim(),
        ).toEqual(
        ...
        expect(
            TextFormatting.formatText(
                "@foo.com",
                { atMentions: true, mentionKeys: [{ key: "@foo.com" }] },
                emptyEmojiMap,
            ).trim(),
        ).toEqual(
        ...
        expect(
            TextFormatting.formatText(
                ...
                {
                    atMentions: true,
                    mentionKeys: [{ key: "@foo.com" }, { key: "@bar.com" }],
                },
                emptyEmojiMap,
            ).trim(),
        ).toEqual(
    ...
    describe("Mix highlight at mentions", () => {
        const tests: StringsTest[] = [
            {
                actual: TextFormatting.formatText(
                    "@foo.com @bar.com",
                    { atMentions: true, mentionKeys: [{ key: "@foo.com" }] },
                    emptyEmojiMap,
                ).trim(),
            ...
            },
            {
                actual: TextFormatting.formatText(
                    "@foo.com @bar.com",
                    { atMentions: true, mentionKeys: [{ key: "@bar.com" }] },
                    emptyEmojiMap,
                ).trim(),
                expected:
