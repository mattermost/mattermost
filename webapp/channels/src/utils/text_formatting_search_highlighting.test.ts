...
describe("TextFormatting.searchHighlighting", () => {
    const testCases = [
        ...
        },
        {
            ...
            expected:
                '<p>These are <span class="search-highlight">words</span> in a <span class="search-highlight">sentence</span>.</p>',
        },
        {
            ...
            expected:
                '<p>These are <span class="search-highlight">words in a sentence</span>. This is a sentence with words.</p>',
        },
        {
        ...
        },
        {
            ...
            searchTerm: "@words sentence",
            expected:
                '<p>These are <span class="search-highlight"><span data-mention="words">@words</span></span> in a <span class="search-highlight"><span data-mention="sentence.">@sentence.</span></span></p>',
        },
        {
            ...
            searchTerm: "words",
            expected:
                '<p>These are <span class="codespan__pre-wrap"><code><span class="search-highlight">words</span> in a sentence</code></span>.</p>',
        },
        {
        ...
        },
        {
            ...
            searchTerm: "words",
            expected:
                '<p>These are <a class="theme markdown__link" href="https://example.com" rel="noreferrer" target="_blank"><span class="search-highlight">words</span> in a sentence</a>.</p>',
        },
        {
            ...
            searchTerm: "example",
            expected:
                '<p>These are <a class="theme markdown__link search-highlight" href="https://example.com" rel="noreferrer" target="_blank">words in a sentence</a>.</p>',
        },
        {
