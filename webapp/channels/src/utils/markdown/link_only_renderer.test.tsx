...
describe("formatWithRenderer | LinkOnlyRenderer", () => {
    const testCases = [
        ...
        },
        {
            ...
            inputText:
                "Inline `code` has ``double backtick`` and ```triple backtick``` around it.",
            outputText:
                "Inline code has double backtick and triple backtick around it.",
        },
        {
        ...
        },
        {
            ...
            outputText:
                'H6 header <a class="theme markdown__link" href="https://mattermost.com" target="_blank">' +
        ...
        {
            description:
                "strong & em: Bold and italics with **asterisks and _underscores_**.",
        ...
        },
        {
            ...
            outputText:
                '<a class="theme markdown__link" href="http://localhost:8065" target="_blank">' +
                "inline-style link</a>",
        },
        {
        ...
        },
        {
            ...
            outputText:
                'Do you like <a class="theme markdown__link" href="http://www.mattermost.com" target="_blank">' +
        ...
        },
        {
            ...
            outputText:
                'Let&#39;s try <a class="theme markdown__link" href="http://example/result?things={stuff}" target="_blank">http://example/result?things={stuff}</a>',
        },
    ];
    ...
    testCases.forEach((testCase) =>
        it(testCase.description, () => {
            expect(
                formatWithRenderer(testCase.inputText, linkOnlyRenderer),
            ).toEqual(testCase.outputText);
        }),
    );
});
