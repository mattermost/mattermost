...
const applyMarkdownToSelection = ({
    ...
    const hasCurrentMarkdown =
        ...
        suffix.startsWith(closingDelimiter);
...
function applyBoldItalicMarkdown({
    ...
    message,
    markdownMode,
}: ApplySpecificMarkdownOptions & Pick<ApplyMarkdownOptions, "markdownMode">) {
    const BOLD_MD = "**";
    const ITALIC_MD = "*";
