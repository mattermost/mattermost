...
- b
- c`;
            const expected = '<ul className="markdown__list"><li>a</li><li>b</li><li>c</li></ul>';
...
2. b
3. c`;
            const expected = '<ol className="markdown__list" style="counter-reset: list 0"><li>a</li><li>b</li><li>c</li></ol>';
...
1. b
2. c`;
            const expected = '<ol className="markdown__list" style="counter-reset: list -1"><li>a</li><li>b</li><li>c</li></ol>';
...
1. b
1. c`;
            const expected = '<ol className="markdown__list" style="counter-reset: list 998"><li>a</li><li>b</li><li>c</li></ol>';
