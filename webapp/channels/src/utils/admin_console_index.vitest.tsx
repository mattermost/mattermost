...
describe('AdminConsoleIndex.generateIndex', () => {
    test('should generate an index where I can search', () => {
    ...
    test.skip('should generate a index where I can search in other language', () => {
    ...
    test('should generate a index including the plugin settings', () => {
        const intl = createIntl({locale: 'en', messages: enMessages, defaultLocale: 'en'});
