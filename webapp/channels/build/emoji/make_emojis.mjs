...
/*
* This script will generate the emoji files for both the webapp and server to use emojis from emoji-datasource
...
// This file is automatically generated via \`/webapp/channels/build/make_emojis.mjs\`. Do not modify it manually.
// Before committing, please run \`go generate ./server/public/model/emoji_data.go\` from the root of the repository.

//go:generate gofmt -w $GOFILE
...
Promise.all(endResults).then(() => {
    ...
    console.log(warnLogColor, '[WARNING] Remember to run `go generate ./server/public/model/emoji_data.go` from the root of the repository.');
