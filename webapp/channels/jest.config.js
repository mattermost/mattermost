...
const config = {
    ...
    transformIgnorePatterns: [
        'node_modules/(?!react-native|react-router|pdfjs-dist|p-queue|react-pdf|p-timeout|@mattermost/compass-components|@mattermost/compass-icons|cidr-regex|ip-regex)',
    ],
    transform: {
