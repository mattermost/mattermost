...
const targetIsEslint =
    NPM_TARGET === "check" || NPM_TARGET === "fix" || process.env.VSCODE_CWD;

const DEV = targetIsRun || targetIsStats || targetIsDevServer;

const STANDARD_EXCLUDE = [/node_modules/];
    ...
    plugins: [
        ...
        new CopyWebpackPlugin({
            patterns: [
                ...
                { from: "src/images/logo-email.png", to: "images" },
                {
                    from: "src/images/browser-icons",
                    to: "images/browser-icons",
                },
                { from: "src/images/cloud", to: "images" },
                {
                    from: "src/images/welcome_illustration_new.png",
                    to: "images",
                },
                ...
                {
                    from: "src/images/forgot_password_illustration.png",
                    to: "images",
                },
                ...
                {
                    from: "src/images/admin-onboarding-background.jpg",
                    to: "images",
                },
                ...
                {
                    from: "src/images/cloud-upgrade-person-hand-to-face.png",
                    to: "images",
                },
        ...
        new WebpackPwaManifest({
            ...
            icons: [
                ...
                {
                    src: path.resolve(
                        "src/images/favicon/apple-touch-icon-120x120.png",
                    ),
                    type: "image/png",
                    sizes: "120x120",
                    ios: true,
                ...
                {
                    src: path.resolve(
                        "src/images/favicon/apple-touch-icon-144x144.png",
                    ),
                    type: "image/png",
                    sizes: "144x144",
                    ios: true,
                ...
                {
                    src: path.resolve(
                        "src/images/favicon/apple-touch-icon-152x152.png",
                    ),
                    type: "image/png",
                    sizes: "152x152",
                    ios: true,
                ...
                {
                    src: path.resolve(
                        "src/images/favicon/apple-touch-icon-57x57.png",
                    ),
                    type: "image/png",
                    sizes: "57x57",
                    ios: true,
                ...
                {
                    src: path.resolve(
                        "src/images/favicon/apple-touch-icon-60x60.png",
                    ),
                    type: "image/png",
                    sizes: "60x60",
                    ios: true,
                ...
                {
                    src: path.resolve(
                        "src/images/favicon/apple-touch-icon-72x72.png",
                    ),
                    type: "image/png",
                    sizes: "72x72",
                    ios: true,
                ...
                {
                    src: path.resolve(
                        "src/images/favicon/apple-touch-icon-76x76.png",
                    ),
                    type: "image/png",
                    sizes: "76x76",
                    ios: true,
...
async function initializeModuleFederation() {
    ...
    async function getRemoteContainers() {
        ...
        for (const product of products) {
            remotes[
                product.name
            ] = `${product.name}@[window.basename]/static/products/${product.name}/remote_entry.js?bt=${buildTimestamp}`;
        }
    ...
    const moduleFederationPluginOptions = {
        ...
        shared: [
            ...
            makeSharedModules(
                ["@mattermost/client", "@mattermost/types", "luxon"],
                false,
            ),
...
if (targetIsDevServer) {
    const proxyToServer = {
        logLevel: "silent",
        target:
            process.env.MM_SERVICESETTINGS_SITEURL ?? "http://localhost:8065",
        xfwd: true,
    };
