...
[Mattermost](https://mattermost.com) is an open core, self-hostable collaboration platform offering persistent chat & ChatOps, workflow, and toolchain automation, integrated voice, screen, file and content sharing, and AI-enhanced information synthesis. This repo is the primary source for core development on the Mattermost platform; it's written in Go and React and runs as a single Linux binary with MySQL or PostgreSQL. A new compiled version is released under an MIT license every month on the 16th.
