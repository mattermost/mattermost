...
- [Find "Help Wanted" projects](https://github.com/mattermost/mattermost/issues?page=1&q=is%3Aissue+is%3Aopen+%22Help+Wanted%22&utf8=%E2%9C%93)
...
- **X** - Follow [Mattermost on X](https://twitter.com/mattermost).
...
- **IRC** - Join the #matterbridge channel on [Libera Chat](https://libera.chat/) (thanks to [matterircd](https://github.com/42wim/matterircd)).
